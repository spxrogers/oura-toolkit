 ...
 */
@JsonPropertyOrder({
  MultiDocumentResponsePublicModifiedSleepModel.JSON_PROPERTY_DATA,
  MultiDocumentResponsePublicModifiedSleepModel.JSON_PROPERTY_NEXT_TOKEN
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.14.0")
public class MultiDocumentResponsePublicModifiedSleepModel {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nonnull
  private List<PublicModifiedSleepModel> data = new ArrayList<>();
  ...
  public MultiDocumentResponsePublicModifiedSleepModel data(@javax.annotation.Nonnull List<PublicModifiedSleepModel> data) {
    this.data = data;
    return this;
  }

  public MultiDocumentResponsePublicModifiedSleepModel addDataItem(PublicModifiedSleepModel dataItem) {
    if (this.data == null) {
  ...
  public List<PublicModifiedSleepModel> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@javax.annotation.Nonnull List<PublicModifiedSleepModel> data) {
    this.data = data;
  }


  public MultiDocumentResponsePublicModifiedSleepModel nextToken(@javax.annotation.Nullable String nextToken) {
  ...
  /**
   * Return true if this MultiDocumentResponse_PublicModifiedSleepModel_ object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    MultiDocumentResponsePublicModifiedSleepModel multiDocumentResponsePublicModifiedSleepModel = (MultiDocumentResponsePublicModifiedSleepModel) o;
    return Objects.equals(this.data, multiDocumentResponsePublicModifiedSleepModel.data) &&
        Objects.equals(this.nextToken, multiDocumentResponsePublicModifiedSleepModel.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class MultiDocumentResponsePublicModifiedSleepModel {\n");
