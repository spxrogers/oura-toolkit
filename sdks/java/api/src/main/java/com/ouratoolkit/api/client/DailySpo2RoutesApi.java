...
public class DailySpo2RoutesApi {
  ...
  public DailySpo2RoutesApi() {
    this(Configuration.getDefaultApiClient());
  }

  public DailySpo2RoutesApi(ApiClient apiClient) {
   ...
   */
  public MultiDocumentResponsePublicDailySpO2 multipleDailySpo2DocumentsV2UsercollectionDailySpo2Get(@javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, @javax.annotation.Nullable String nextToken, @javax.annotation.Nullable String fields) throws ApiException {
    ApiResponse<MultiDocumentResponsePublicDailySpO2> localVarResponse = multipleDailySpo2DocumentsV2UsercollectionDailySpo2GetWithHttpInfo(startDate, endDate, nextToken, fields);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<MultiDocumentResponsePublicDailySpO2> multipleDailySpo2DocumentsV2UsercollectionDailySpo2GetWithHttpInfo(@javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, @javax.annotation.Nullable String nextToken, @javax.annotation.Nullable String fields) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = multipleDailySpo2DocumentsV2UsercollectionDailySpo2GetRequestBuilder(startDate, endDate, nextToken, fields);
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("multipleDailySpo2DocumentsV2UsercollectionDailySpo2Get", localVarResponse);
        }
  ...
  private HttpRequest.Builder multipleDailySpo2DocumentsV2UsercollectionDailySpo2GetRequestBuilder(@javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, @javax.annotation.Nullable String nextToken, @javax.annotation.Nullable String fields) throws ApiException {

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/v2/usercollection/daily_spo2";
   ...
   * @throws ApiException if fails to make API call
   */
  public PublicDailySpO2 singleDailySpo2DocumentV2UsercollectionDailySpo2DocumentIdGet(@javax.annotation.Nonnull String documentId) throws ApiException {
    ApiResponse<PublicDailySpO2> localVarResponse = singleDailySpo2DocumentV2UsercollectionDailySpo2DocumentIdGetWithHttpInfo(documentId);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<PublicDailySpO2> singleDailySpo2DocumentV2UsercollectionDailySpo2DocumentIdGetWithHttpInfo(@javax.annotation.Nonnull String documentId) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = singleDailySpo2DocumentV2UsercollectionDailySpo2DocumentIdGetRequestBuilder(documentId);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("singleDailySpo2DocumentV2UsercollectionDailySpo2DocumentIdGet", localVarResponse);
        }
        if (localVarResponse.body() == null) {
  ...
  private HttpRequest.Builder singleDailySpo2DocumentV2UsercollectionDailySpo2DocumentIdGetRequestBuilder(@javax.annotation.Nonnull String documentId) throws ApiException {
    // verify the required parameter 'documentId' is set
    if (documentId == null) {
      throw new ApiException(400, "Missing the required parameter 'documentId' when calling singleDailySpo2DocumentV2UsercollectionDailySpo2DocumentIdGet");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/v2/usercollection/daily_spo2/{document_id}"
