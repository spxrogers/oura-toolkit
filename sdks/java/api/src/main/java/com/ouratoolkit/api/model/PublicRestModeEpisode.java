 ...
 */
@JsonPropertyOrder({
  PublicRestModeEpisode.JSON_PROPERTY_TAGS,
  PublicRestModeEpisode.JSON_PROPERTY_TIMESTAMP
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.14.0")
public class PublicRestModeEpisode {
  ...
  public PublicRestModeEpisode tags(@javax.annotation.Nonnull List<String> tags) {
    this.tags = tags;
    return this;
  }

  public PublicRestModeEpisode addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public PublicRestModeEpisode timestamp(@javax.annotation.Nullable String timestamp) {
  ...
  /**
   * Return true if this PublicRestModeEpisode object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PublicRestModeEpisode publicRestModeEpisode = (PublicRestModeEpisode) o;
    return Objects.equals(this.tags, publicRestModeEpisode.tags) &&
        Objects.equals(this.timestamp, publicRestModeEpisode.timestamp);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tags, timestamp);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PublicRestModeEpisode {\n");
