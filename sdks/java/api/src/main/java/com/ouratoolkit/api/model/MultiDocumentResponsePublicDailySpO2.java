 ...
 */
@JsonPropertyOrder({
  MultiDocumentResponsePublicDailySpO2.JSON_PROPERTY_DATA,
  MultiDocumentResponsePublicDailySpO2.JSON_PROPERTY_NEXT_TOKEN
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.14.0")
public class MultiDocumentResponsePublicDailySpO2 {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nonnull
  private List<PublicDailySpO2> data = new ArrayList<>();
  ...
  public MultiDocumentResponsePublicDailySpO2 data(@javax.annotation.Nonnull List<PublicDailySpO2> data) {
    this.data = data;
    return this;
  }

  public MultiDocumentResponsePublicDailySpO2 addDataItem(PublicDailySpO2 dataItem) {
    if (this.data == null) {
  ...
  public List<PublicDailySpO2> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@javax.annotation.Nonnull List<PublicDailySpO2> data) {
    this.data = data;
  }


  public MultiDocumentResponsePublicDailySpO2 nextToken(@javax.annotation.Nullable String nextToken) {
  ...
  /**
   * Return true if this MultiDocumentResponse_PublicDailySpO2_ object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    MultiDocumentResponsePublicDailySpO2 multiDocumentResponsePublicDailySpO2 = (MultiDocumentResponsePublicDailySpO2) o;
    return Objects.equals(this.data, multiDocumentResponsePublicDailySpO2.data) &&
        Objects.equals(this.nextToken, multiDocumentResponsePublicDailySpO2.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class MultiDocumentResponsePublicDailySpO2 {\n");
