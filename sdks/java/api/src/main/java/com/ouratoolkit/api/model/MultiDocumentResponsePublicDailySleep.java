 ...
 */
@JsonPropertyOrder({
  MultiDocumentResponsePublicDailySleep.JSON_PROPERTY_DATA,
  MultiDocumentResponsePublicDailySleep.JSON_PROPERTY_NEXT_TOKEN
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.14.0")
public class MultiDocumentResponsePublicDailySleep {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nonnull
  private List<PublicDailySleep> data = new ArrayList<>();
  ...
  public MultiDocumentResponsePublicDailySleep data(@javax.annotation.Nonnull List<PublicDailySleep> data) {
    this.data = data;
    return this;
  }

  public MultiDocumentResponsePublicDailySleep addDataItem(PublicDailySleep dataItem) {
    if (this.data == null) {
  ...
  public List<PublicDailySleep> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@javax.annotation.Nonnull List<PublicDailySleep> data) {
    this.data = data;
  }


  public MultiDocumentResponsePublicDailySleep nextToken(@javax.annotation.Nullable String nextToken) {
  ...
  /**
   * Return true if this MultiDocumentResponse_PublicDailySleep_ object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    MultiDocumentResponsePublicDailySleep multiDocumentResponsePublicDailySleep = (MultiDocumentResponsePublicDailySleep) o;
    return Objects.equals(this.data, multiDocumentResponsePublicDailySleep.data) &&
        Objects.equals(this.nextToken, multiDocumentResponsePublicDailySleep.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class MultiDocumentResponsePublicDailySleep {\n");
