...
import com.ouratoolkit.api.model.PersonalInfoResponse;
...
public class PersonalInfoRoutesApi {
  ...
  public PersonalInfoRoutesApi() {
    this(Configuration.getDefaultApiClient());
  }

  public PersonalInfoRoutesApi(ApiClient apiClient) {
   ...
   */
  public PersonalInfoResponse singlePersonalInfoDocumentV2UsercollectionPersonalInfoGet() throws ApiException {
    ApiResponse<PersonalInfoResponse> localVarResponse = singlePersonalInfoDocumentV2UsercollectionPersonalInfoGetWithHttpInfo();
   ...
   * Single Personal Info Document
   * 
   * @return ApiResponse&lt;PersonalInfoResponse&gt;
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<PersonalInfoResponse> singlePersonalInfoDocumentV2UsercollectionPersonalInfoGetWithHttpInfo() throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = singlePersonalInfoDocumentV2UsercollectionPersonalInfoGetRequestBuilder();
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("singlePersonalInfoDocumentV2UsercollectionPersonalInfoGet", localVarResponse);
        }
        if (localVarResponse.body() == null) {
          return new ApiResponse<PersonalInfoResponse>(
        ...
        return new ApiResponse<PersonalInfoResponse>(
            localVarResponse.statusCode(),
            localVarResponse.headers().map(),
            responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<PersonalInfoResponse>() {})
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  private HttpRequest.Builder singlePersonalInfoDocumentV2UsercollectionPersonalInfoGetRequestBuilder() throws ApiException {

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/v2/usercollection/personal_info";
