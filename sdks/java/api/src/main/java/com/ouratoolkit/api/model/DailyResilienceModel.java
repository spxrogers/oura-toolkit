...
import com.ouratoolkit.api.model.LongTermResilienceLevel;
import com.ouratoolkit.api.model.ResilienceContributors;
 ...
 */
@JsonPropertyOrder({
  DailyResilienceModel.JSON_PROPERTY_ID,
  DailyResilienceModel.JSON_PROPERTY_DAY,
  DailyResilienceModel.JSON_PROPERTY_CONTRIBUTORS,
  DailyResilienceModel.JSON_PROPERTY_LEVEL
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.14.0")
public class DailyResilienceModel {
  ...
  @javax.annotation.Nonnull
  private ResilienceContributors contributors;

  public static final String JSON_PROPERTY_LEVEL = "level";
  @javax.annotation.Nonnull
  private LongTermResilienceLevel level;

  public DailyResilienceModel() { 
  }

  public DailyResilienceModel id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public DailyResilienceModel day(@javax.annotation.Nonnull LocalDate day) {
    this.day = day;
    return this;
  }
  ...
  public DailyResilienceModel contributors(@javax.annotation.Nonnull ResilienceContributors contributors) {
  ...
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public ResilienceContributors getContributors() {
    return contributors;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CONTRIBUTORS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setContributors(@javax.annotation.Nonnull ResilienceContributors contributors) {
    this.contributors = contributors;
  }


  public DailyResilienceModel level(@javax.annotation.Nonnull LongTermResilienceLevel level) {
    this.level = level;
    return this;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public LongTermResilienceLevel getLevel() {
    return level;
  }
  ...
  @JsonProperty(JSON_PROPERTY_LEVEL)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setLevel(@javax.annotation.Nonnull LongTermResilienceLevel level) {
    this.level = level;
  }


  /**
   * Return true if this DailyResilienceModel object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DailyResilienceModel dailyResilienceModel = (DailyResilienceModel) o;
    return Objects.equals(this.id, dailyResilienceModel.id) &&
        Objects.equals(this.day, dailyResilienceModel.day) &&
        Objects.equals(this.contributors, dailyResilienceModel.contributors) &&
        Objects.equals(this.level, dailyResilienceModel.level);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, day, contributors, level);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DailyResilienceModel {\n");
