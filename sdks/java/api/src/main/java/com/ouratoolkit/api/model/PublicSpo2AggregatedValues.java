 ...
 */
@JsonPropertyOrder({
  PublicSpo2AggregatedValues.JSON_PROPERTY_AVERAGE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.14.0")
public class PublicSpo2AggregatedValues {
  ...
  public PublicSpo2AggregatedValues average(@javax.annotation.Nonnull BigDecimal average) {
  ...
  /**
   * Return true if this PublicSpo2AggregatedValues object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PublicSpo2AggregatedValues publicSpo2AggregatedValues = (PublicSpo2AggregatedValues) o;
    return Objects.equals(this.average, publicSpo2AggregatedValues.average);
  }
  ...
  public String toString() {
    ...
    sb.append("class PublicSpo2AggregatedValues {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getAverage() != null) {
      joiner.add(String.format("%saverage%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getAverage()))));
    }
