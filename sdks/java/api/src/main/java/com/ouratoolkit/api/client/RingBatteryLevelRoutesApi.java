...
import com.ouratoolkit.api.model.ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet;
...
public class RingBatteryLevelRoutesApi {
  ...
  public RingBatteryLevelRoutesApi() {
    this(Configuration.getDefaultApiClient());
  }

  public RingBatteryLevelRoutesApi(ApiClient apiClient) {
   ...
   * @param latest If True, returns most recent sample. (optional)
   ...
   * @return ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet
   * @throws ApiException if fails to make API call
   */
  public ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet multipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet(@javax.annotation.Nullable OffsetDateTime startDatetime, @javax.annotation.Nullable OffsetDateTime endDatetime, @javax.annotation.Nullable String nextToken, @javax.annotation.Nullable Boolean latest, @javax.annotation.Nullable String fields) throws ApiException {
    ApiResponse<ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet> localVarResponse = multipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGetWithHttpInfo(startDatetime, endDatetime, nextToken, latest, fields);
   ...
   * @param latest If True, returns most recent sample. (optional)
   * @param fields Comma-separated list of fields to include in the response, in addition to the always returned fields. Defaults to all fields if not provided. (optional)
   * @return ApiResponse&lt;ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet&gt;
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet> multipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGetWithHttpInfo(@javax.annotation.Nullable OffsetDateTime startDatetime, @javax.annotation.Nullable OffsetDateTime endDatetime, @javax.annotation.Nullable String nextToken, @javax.annotation.Nullable Boolean latest, @javax.annotation.Nullable String fields) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = multipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGetRequestBuilder(startDatetime, endDatetime, nextToken, latest, fields);
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("multipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet", localVarResponse);
        }
        if (localVarResponse.body() == null) {
          return new ApiResponse<ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet>(
        ...
        return new ApiResponse<ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet>(
            localVarResponse.statusCode(),
            localVarResponse.headers().map(),
            responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet>() {})
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  private HttpRequest.Builder multipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGetRequestBuilder(@javax.annotation.Nullable OffsetDateTime startDatetime, @javax.annotation.Nullable OffsetDateTime endDatetime, @javax.annotation.Nullable String nextToken, @javax.annotation.Nullable Boolean latest, @javax.annotation.Nullable String fields) throws ApiException {

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/v2/usercollection/ring_battery_level";
