...
public class DailyActivityRoutesApi {
  ...
  public DailyActivityRoutesApi() {
    this(Configuration.getDefaultApiClient());
  }

  public DailyActivityRoutesApi(ApiClient apiClient) {
   ...
   */
  public MultiDocumentResponsePublicDailyActivity multipleDailyActivityDocumentsV2UsercollectionDailyActivityGet(@javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, @javax.annotation.Nullable String nextToken, @javax.annotation.Nullable String fields) throws ApiException {
    ApiResponse<MultiDocumentResponsePublicDailyActivity> localVarResponse = multipleDailyActivityDocumentsV2UsercollectionDailyActivityGetWithHttpInfo(startDate, endDate, nextToken, fields);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<MultiDocumentResponsePublicDailyActivity> multipleDailyActivityDocumentsV2UsercollectionDailyActivityGetWithHttpInfo(@javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, @javax.annotation.Nullable String nextToken, @javax.annotation.Nullable String fields) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = multipleDailyActivityDocumentsV2UsercollectionDailyActivityGetRequestBuilder(startDate, endDate, nextToken, fields);
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("multipleDailyActivityDocumentsV2UsercollectionDailyActivityGet", localVarResponse);
        }
  ...
  private HttpRequest.Builder multipleDailyActivityDocumentsV2UsercollectionDailyActivityGetRequestBuilder(@javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, @javax.annotation.Nullable String nextToken, @javax.annotation.Nullable String fields) throws ApiException {

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/v2/usercollection/daily_activity";
   ...
   * @throws ApiException if fails to make API call
   */
  public PublicDailyActivity singleDailyActivityDocumentV2UsercollectionDailyActivityDocumentIdGet(@javax.annotation.Nonnull String documentId) throws ApiException {
    ApiResponse<PublicDailyActivity> localVarResponse = singleDailyActivityDocumentV2UsercollectionDailyActivityDocumentIdGetWithHttpInfo(documentId);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<PublicDailyActivity> singleDailyActivityDocumentV2UsercollectionDailyActivityDocumentIdGetWithHttpInfo(@javax.annotation.Nonnull String documentId) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = singleDailyActivityDocumentV2UsercollectionDailyActivityDocumentIdGetRequestBuilder(documentId);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("singleDailyActivityDocumentV2UsercollectionDailyActivityDocumentIdGet", localVarResponse);
        }
        if (localVarResponse.body() == null) {
  ...
  private HttpRequest.Builder singleDailyActivityDocumentV2UsercollectionDailyActivityDocumentIdGetRequestBuilder(@javax.annotation.Nonnull String documentId) throws ApiException {
    // verify the required parameter 'documentId' is set
    if (documentId == null) {
      throw new ApiException(400, "Missing the required parameter 'documentId' when calling singleDailyActivityDocumentV2UsercollectionDailyActivityDocumentIdGet");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/v2/usercollection/daily_activity/{document_id}"
