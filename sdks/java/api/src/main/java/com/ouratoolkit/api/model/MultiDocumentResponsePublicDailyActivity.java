 ...
 */
@JsonPropertyOrder({
  MultiDocumentResponsePublicDailyActivity.JSON_PROPERTY_DATA,
  MultiDocumentResponsePublicDailyActivity.JSON_PROPERTY_NEXT_TOKEN
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.14.0")
public class MultiDocumentResponsePublicDailyActivity {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nonnull
  private List<PublicDailyActivity> data = new ArrayList<>();
  ...
  public MultiDocumentResponsePublicDailyActivity data(@javax.annotation.Nonnull List<PublicDailyActivity> data) {
    this.data = data;
    return this;
  }

  public MultiDocumentResponsePublicDailyActivity addDataItem(PublicDailyActivity dataItem) {
    if (this.data == null) {
  ...
  public List<PublicDailyActivity> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@javax.annotation.Nonnull List<PublicDailyActivity> data) {
    this.data = data;
  }


  public MultiDocumentResponsePublicDailyActivity nextToken(@javax.annotation.Nullable String nextToken) {
  ...
  /**
   * Return true if this MultiDocumentResponse_PublicDailyActivity_ object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    MultiDocumentResponsePublicDailyActivity multiDocumentResponsePublicDailyActivity = (MultiDocumentResponsePublicDailyActivity) o;
    return Objects.equals(this.data, multiDocumentResponsePublicDailyActivity.data) &&
        Objects.equals(this.nextToken, multiDocumentResponsePublicDailyActivity.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class MultiDocumentResponsePublicDailyActivity {\n");
