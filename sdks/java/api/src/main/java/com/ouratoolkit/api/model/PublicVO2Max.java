 ...
 */
@JsonPropertyOrder({
  PublicVO2Max.JSON_PROPERTY_ID,
  PublicVO2Max.JSON_PROPERTY_DAY,
  PublicVO2Max.JSON_PROPERTY_TIMESTAMP,
  PublicVO2Max.JSON_PROPERTY_VO2_MAX
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.14.0")
public class PublicVO2Max {
  ...
  public static final String JSON_PROPERTY_VO2_MAX = "vo2_max";
  @javax.annotation.Nonnull
  ...
  public PublicVO2Max id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public PublicVO2Max day(@javax.annotation.Nullable String day) {
    this.day = day;
    return this;
  }
  ...
  public PublicVO2Max timestamp(@javax.annotation.Nullable String timestamp) {
  ...
  public PublicVO2Max vo2Max(@javax.annotation.Nonnull Integer vo2Max) {
    this.vo2Max = vo2Max;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  @JsonProperty(JSON_PROPERTY_VO2_MAX)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  @JsonProperty(JSON_PROPERTY_VO2_MAX)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setVo2Max(@javax.annotation.Nonnull Integer vo2Max) {
    this.vo2Max = vo2Max;
  }


  /**
   * Return true if this PublicVO2Max object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PublicVO2Max publicVO2Max = (PublicVO2Max) o;
    return Objects.equals(this.id, publicVO2Max.id) &&
        Objects.equals(this.day, publicVO2Max.day) &&
        Objects.equals(this.timestamp, publicVO2Max.timestamp) &&
        Objects.equals(this.vo2Max, publicVO2Max.vo2Max);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, day, timestamp, vo2Max);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PublicVO2Max {\n");
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    day: ").append(toIndentedString(day)).append("\n");
    sb.append("    timestamp: ").append(toIndentedString(timestamp)).append("\n");
    sb.append("    vo2Max: ").append(toIndentedString(vo2Max)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `vo2_max` to the URL query string
    if (getVo2Max() != null) {
      joiner.add(String.format("%svo2_max%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getVo2Max()))));
    }
