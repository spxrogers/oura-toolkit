 ...
 */
@JsonPropertyOrder({
  CreateWebhookSubscriptionRequest.JSON_PROPERTY_CALLBACK_URL,
  CreateWebhookSubscriptionRequest.JSON_PROPERTY_VERIFICATION_TOKEN,
  CreateWebhookSubscriptionRequest.JSON_PROPERTY_EVENT_TYPE,
  CreateWebhookSubscriptionRequest.JSON_PROPERTY_DATA_TYPE
})
...
public class CreateWebhookSubscriptionRequest {
  ...
  public CreateWebhookSubscriptionRequest callbackUrl(@javax.annotation.Nonnull String callbackUrl) {
  ...
  public CreateWebhookSubscriptionRequest verificationToken(@javax.annotation.Nonnull String verificationToken) {
  ...
  public CreateWebhookSubscriptionRequest eventType(@javax.annotation.Nonnull WebhookOperation eventType) {
  ...
  public CreateWebhookSubscriptionRequest dataType(@javax.annotation.Nonnull ExtApiV2DataType dataType) {
  ...
  /**
   * Return true if this CreateWebhookSubscriptionRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.callbackUrl, createWebhookSubscriptionRequest.callbackUrl) &&
        Objects.equals(this.verificationToken, createWebhookSubscriptionRequest.verificationToken) &&
        Objects.equals(this.eventType, createWebhookSubscriptionRequest.eventType) &&
        Objects.equals(this.dataType, createWebhookSubscriptionRequest.dataType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(callbackUrl, verificationToken, eventType, dataType);
  }
