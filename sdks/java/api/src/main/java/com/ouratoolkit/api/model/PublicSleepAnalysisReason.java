...
public enum PublicSleepAnalysisReason {
  ...
  PublicSleepAnalysisReason(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static PublicSleepAnalysisReason fromValue(String value) {
    for (PublicSleepAnalysisReason b : PublicSleepAnalysisReason.values()) {
