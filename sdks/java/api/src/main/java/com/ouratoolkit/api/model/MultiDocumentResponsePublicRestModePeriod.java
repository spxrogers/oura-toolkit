 ...
 */
@JsonPropertyOrder({
  MultiDocumentResponsePublicRestModePeriod.JSON_PROPERTY_DATA,
  MultiDocumentResponsePublicRestModePeriod.JSON_PROPERTY_NEXT_TOKEN
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.14.0")
public class MultiDocumentResponsePublicRestModePeriod {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nonnull
  private List<PublicRestModePeriod> data = new ArrayList<>();
  ...
  public MultiDocumentResponsePublicRestModePeriod data(@javax.annotation.Nonnull List<PublicRestModePeriod> data) {
    this.data = data;
    return this;
  }

  public MultiDocumentResponsePublicRestModePeriod addDataItem(PublicRestModePeriod dataItem) {
    if (this.data == null) {
  ...
  public List<PublicRestModePeriod> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@javax.annotation.Nonnull List<PublicRestModePeriod> data) {
    this.data = data;
  }


  public MultiDocumentResponsePublicRestModePeriod nextToken(@javax.annotation.Nullable String nextToken) {
  ...
  /**
   * Return true if this MultiDocumentResponse_PublicRestModePeriod_ object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    MultiDocumentResponsePublicRestModePeriod multiDocumentResponsePublicRestModePeriod = (MultiDocumentResponsePublicRestModePeriod) o;
    return Objects.equals(this.data, multiDocumentResponsePublicRestModePeriod.data) &&
        Objects.equals(this.nextToken, multiDocumentResponsePublicRestModePeriod.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class MultiDocumentResponsePublicRestModePeriod {\n");
