 ...
 */
@JsonPropertyOrder({
  TagModel.JSON_PROPERTY_ID,
  TagModel.JSON_PROPERTY_DAY,
  TagModel.JSON_PROPERTY_TEXT,
  TagModel.JSON_PROPERTY_TIMESTAMP,
  TagModel.JSON_PROPERTY_TAGS
})
...
public class TagModel {
  ...
  public TagModel id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public TagModel day(@javax.annotation.Nonnull LocalDate day) {
    this.day = day;
    return this;
  }
  ...
  public TagModel text(@javax.annotation.Nullable String text) {
    this.text = text;
    return this;
  }
  ...
  public TagModel timestamp(@javax.annotation.Nullable String timestamp) {
  ...
  public TagModel tags(@javax.annotation.Nonnull List<String> tags) {
    this.tags = tags;
    return this;
  }

  public TagModel addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, tagModel.id) &&
        Objects.equals(this.day, tagModel.day) &&
        Objects.equals(this.text, tagModel.text) &&
        Objects.equals(this.timestamp, tagModel.timestamp) &&
        Objects.equals(this.tags, tagModel.tags);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, day, text, timestamp, tags);
  }
