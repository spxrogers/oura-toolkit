 ...
 */
@JsonPropertyOrder({
  MultiDocumentResponseDailyResilienceModel.JSON_PROPERTY_DATA,
  MultiDocumentResponseDailyResilienceModel.JSON_PROPERTY_NEXT_TOKEN
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.14.0")
public class MultiDocumentResponseDailyResilienceModel {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nonnull
  private List<DailyResilienceModel> data = new ArrayList<>();
  ...
  public MultiDocumentResponseDailyResilienceModel data(@javax.annotation.Nonnull List<DailyResilienceModel> data) {
    this.data = data;
    return this;
  }

  public MultiDocumentResponseDailyResilienceModel addDataItem(DailyResilienceModel dataItem) {
    if (this.data == null) {
  ...
  public List<DailyResilienceModel> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@javax.annotation.Nonnull List<DailyResilienceModel> data) {
    this.data = data;
  }


  public MultiDocumentResponseDailyResilienceModel nextToken(@javax.annotation.Nullable String nextToken) {
  ...
  /**
   * Return true if this MultiDocumentResponse_DailyResilienceModel_ object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    MultiDocumentResponseDailyResilienceModel multiDocumentResponseDailyResilienceModel = (MultiDocumentResponseDailyResilienceModel) o;
    return Objects.equals(this.data, multiDocumentResponseDailyResilienceModel.data) &&
        Objects.equals(this.nextToken, multiDocumentResponseDailyResilienceModel.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class MultiDocumentResponseDailyResilienceModel {\n");
