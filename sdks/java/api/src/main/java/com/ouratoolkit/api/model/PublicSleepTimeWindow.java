 ...
 */
@JsonPropertyOrder({
  PublicSleepTimeWindow.JSON_PROPERTY_DAY_TZ,
  PublicSleepTimeWindow.JSON_PROPERTY_END_OFFSET,
  PublicSleepTimeWindow.JSON_PROPERTY_START_OFFSET
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.14.0")
public class PublicSleepTimeWindow {
  public static final String JSON_PROPERTY_DAY_TZ = "day_tz";
  @javax.annotation.Nonnull
  private Integer dayTz;
  ...
  public PublicSleepTimeWindow dayTz(@javax.annotation.Nonnull Integer dayTz) {
    this.dayTz = dayTz;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  @JsonProperty(JSON_PROPERTY_DAY_TZ)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public Integer getDayTz() {
    return dayTz;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DAY_TZ)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setDayTz(@javax.annotation.Nonnull Integer dayTz) {
    this.dayTz = dayTz;
  }


  public PublicSleepTimeWindow endOffset(@javax.annotation.Nonnull Integer endOffset) {
  ...
  @JsonProperty(JSON_PROPERTY_END_OFFSET)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setEndOffset(@javax.annotation.Nonnull Integer endOffset) {
    this.endOffset = endOffset;
  }


  public PublicSleepTimeWindow startOffset(@javax.annotation.Nonnull Integer startOffset) {
  ...
  @JsonProperty(JSON_PROPERTY_START_OFFSET)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setStartOffset(@javax.annotation.Nonnull Integer startOffset) {
    this.startOffset = startOffset;
  }


  /**
   * Return true if this PublicSleepTimeWindow object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PublicSleepTimeWindow publicSleepTimeWindow = (PublicSleepTimeWindow) o;
    return Objects.equals(this.dayTz, publicSleepTimeWindow.dayTz) &&
        Objects.equals(this.endOffset, publicSleepTimeWindow.endOffset) &&
        Objects.equals(this.startOffset, publicSleepTimeWindow.startOffset);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dayTz, endOffset, startOffset);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PublicSleepTimeWindow {\n");
    sb.append("    dayTz: ").append(toIndentedString(dayTz)).append("\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `day_tz` to the URL query string
    if (getDayTz() != null) {
      joiner.add(String.format("%sday_tz%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getDayTz()))));
    }

    // add `end_offset` to the URL query string
    if (getEndOffset() != null) {
      joiner.add(String.format("%send_offset%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEndOffset()))));
    }

    // add `start_offset` to the URL query string
    if (getStartOffset() != null) {
      joiner.add(String.format("%sstart_offset%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getStartOffset()))));
    }
