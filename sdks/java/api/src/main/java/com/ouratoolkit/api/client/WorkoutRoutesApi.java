...
public class WorkoutRoutesApi {
  ...
  public WorkoutRoutesApi() {
    this(Configuration.getDefaultApiClient());
  }

  public WorkoutRoutesApi(ApiClient apiClient) {
   ...
   */
  public MultiDocumentResponsePublicWorkout multipleWorkoutDocumentsV2UsercollectionWorkoutGet(@javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, @javax.annotation.Nullable String nextToken, @javax.annotation.Nullable String fields) throws ApiException {
    ApiResponse<MultiDocumentResponsePublicWorkout> localVarResponse = multipleWorkoutDocumentsV2UsercollectionWorkoutGetWithHttpInfo(startDate, endDate, nextToken, fields);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<MultiDocumentResponsePublicWorkout> multipleWorkoutDocumentsV2UsercollectionWorkoutGetWithHttpInfo(@javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, @javax.annotation.Nullable String nextToken, @javax.annotation.Nullable String fields) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = multipleWorkoutDocumentsV2UsercollectionWorkoutGetRequestBuilder(startDate, endDate, nextToken, fields);
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("multipleWorkoutDocumentsV2UsercollectionWorkoutGet", localVarResponse);
        }
  ...
  private HttpRequest.Builder multipleWorkoutDocumentsV2UsercollectionWorkoutGetRequestBuilder(@javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, @javax.annotation.Nullable String nextToken, @javax.annotation.Nullable String fields) throws ApiException {

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/v2/usercollection/workout";
   ...
   * @throws ApiException if fails to make API call
   */
  public PublicWorkout singleWorkoutDocumentV2UsercollectionWorkoutDocumentIdGet(@javax.annotation.Nonnull String documentId) throws ApiException {
    ApiResponse<PublicWorkout> localVarResponse = singleWorkoutDocumentV2UsercollectionWorkoutDocumentIdGetWithHttpInfo(documentId);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<PublicWorkout> singleWorkoutDocumentV2UsercollectionWorkoutDocumentIdGetWithHttpInfo(@javax.annotation.Nonnull String documentId) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = singleWorkoutDocumentV2UsercollectionWorkoutDocumentIdGetRequestBuilder(documentId);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("singleWorkoutDocumentV2UsercollectionWorkoutDocumentIdGet", localVarResponse);
        }
        if (localVarResponse.body() == null) {
  ...
  private HttpRequest.Builder singleWorkoutDocumentV2UsercollectionWorkoutDocumentIdGetRequestBuilder(@javax.annotation.Nonnull String documentId) throws ApiException {
    // verify the required parameter 'documentId' is set
    if (documentId == null) {
      throw new ApiException(400, "Missing the required parameter 'documentId' when calling singleWorkoutDocumentV2UsercollectionWorkoutDocumentIdGet");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/v2/usercollection/workout/{document_id}"
