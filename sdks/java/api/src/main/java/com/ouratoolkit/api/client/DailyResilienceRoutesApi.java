...
public class DailyResilienceRoutesApi {
  ...
  public DailyResilienceRoutesApi() {
    this(Configuration.getDefaultApiClient());
  }

  public DailyResilienceRoutesApi(ApiClient apiClient) {
   ...
   */
  public MultiDocumentResponseDailyResilienceModel multipleDailyResilienceDocumentsV2UsercollectionDailyResilienceGet(@javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, @javax.annotation.Nullable String nextToken, @javax.annotation.Nullable String fields) throws ApiException {
    ApiResponse<MultiDocumentResponseDailyResilienceModel> localVarResponse = multipleDailyResilienceDocumentsV2UsercollectionDailyResilienceGetWithHttpInfo(startDate, endDate, nextToken, fields);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<MultiDocumentResponseDailyResilienceModel> multipleDailyResilienceDocumentsV2UsercollectionDailyResilienceGetWithHttpInfo(@javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, @javax.annotation.Nullable String nextToken, @javax.annotation.Nullable String fields) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = multipleDailyResilienceDocumentsV2UsercollectionDailyResilienceGetRequestBuilder(startDate, endDate, nextToken, fields);
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("multipleDailyResilienceDocumentsV2UsercollectionDailyResilienceGet", localVarResponse);
        }
   ...
   * @throws ApiException if fails to make API call
   */
  public DailyResilienceModel singleDailyResilienceDocumentV2UsercollectionDailyResilienceDocumentIdGet(@javax.annotation.Nonnull String documentId) throws ApiException {
    ApiResponse<DailyResilienceModel> localVarResponse = singleDailyResilienceDocumentV2UsercollectionDailyResilienceDocumentIdGetWithHttpInfo(documentId);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<DailyResilienceModel> singleDailyResilienceDocumentV2UsercollectionDailyResilienceDocumentIdGetWithHttpInfo(@javax.annotation.Nonnull String documentId) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = singleDailyResilienceDocumentV2UsercollectionDailyResilienceDocumentIdGetRequestBuilder(documentId);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("singleDailyResilienceDocumentV2UsercollectionDailyResilienceDocumentIdGet", localVarResponse);
        }
        if (localVarResponse.body() == null) {
  ...
  private HttpRequest.Builder singleDailyResilienceDocumentV2UsercollectionDailyResilienceDocumentIdGetRequestBuilder(@javax.annotation.Nonnull String documentId) throws ApiException {
    // verify the required parameter 'documentId' is set
    if (documentId == null) {
      throw new ApiException(400, "Missing the required parameter 'documentId' when calling singleDailyResilienceDocumentV2UsercollectionDailyResilienceDocumentIdGet");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/v2/usercollection/daily_resilience/{document_id}"
