 ...
 */
@JsonPropertyOrder({
  MultiDocumentResponsePublicSession.JSON_PROPERTY_DATA,
  MultiDocumentResponsePublicSession.JSON_PROPERTY_NEXT_TOKEN
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.14.0")
public class MultiDocumentResponsePublicSession {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nonnull
  private List<PublicSession> data = new ArrayList<>();
  ...
  public MultiDocumentResponsePublicSession data(@javax.annotation.Nonnull List<PublicSession> data) {
    this.data = data;
    return this;
  }

  public MultiDocumentResponsePublicSession addDataItem(PublicSession dataItem) {
    if (this.data == null) {
  ...
  public List<PublicSession> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@javax.annotation.Nonnull List<PublicSession> data) {
    this.data = data;
  }


  public MultiDocumentResponsePublicSession nextToken(@javax.annotation.Nullable String nextToken) {
  ...
  /**
   * Return true if this MultiDocumentResponse_PublicSession_ object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    MultiDocumentResponsePublicSession multiDocumentResponsePublicSession = (MultiDocumentResponsePublicSession) o;
    return Objects.equals(this.data, multiDocumentResponsePublicSession.data) &&
        Objects.equals(this.nextToken, multiDocumentResponsePublicSession.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class MultiDocumentResponsePublicSession {\n");
