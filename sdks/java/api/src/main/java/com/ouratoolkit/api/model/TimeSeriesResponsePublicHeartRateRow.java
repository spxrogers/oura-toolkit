...
import com.ouratoolkit.api.model.PublicHeartRateRow;
 ...
 */
@JsonPropertyOrder({
  TimeSeriesResponsePublicHeartRateRow.JSON_PROPERTY_DATA,
  TimeSeriesResponsePublicHeartRateRow.JSON_PROPERTY_NEXT_TOKEN
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.14.0")
public class TimeSeriesResponsePublicHeartRateRow {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nonnull
  private List<PublicHeartRateRow> data = new ArrayList<>();
  ...
  public TimeSeriesResponsePublicHeartRateRow data(@javax.annotation.Nonnull List<PublicHeartRateRow> data) {
    this.data = data;
    return this;
  }

  public TimeSeriesResponsePublicHeartRateRow addDataItem(PublicHeartRateRow dataItem) {
    if (this.data == null) {
  ...
  public List<PublicHeartRateRow> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@javax.annotation.Nonnull List<PublicHeartRateRow> data) {
    this.data = data;
  }


  public TimeSeriesResponsePublicHeartRateRow nextToken(@javax.annotation.Nullable String nextToken) {
  ...
  /**
   * Return true if this TimeSeriesResponse_PublicHeartRateRow_ object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TimeSeriesResponsePublicHeartRateRow timeSeriesResponsePublicHeartRateRow = (TimeSeriesResponsePublicHeartRateRow) o;
    return Objects.equals(this.data, timeSeriesResponsePublicHeartRateRow.data) &&
        equalsNullable(this.nextToken, timeSeriesResponsePublicHeartRateRow.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class TimeSeriesResponsePublicHeartRateRow {\n");
