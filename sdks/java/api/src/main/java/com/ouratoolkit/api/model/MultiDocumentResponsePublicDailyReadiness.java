 ...
 */
@JsonPropertyOrder({
  MultiDocumentResponsePublicDailyReadiness.JSON_PROPERTY_DATA,
  MultiDocumentResponsePublicDailyReadiness.JSON_PROPERTY_NEXT_TOKEN
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.14.0")
public class MultiDocumentResponsePublicDailyReadiness {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nonnull
  private List<PublicDailyReadiness> data = new ArrayList<>();
  ...
  public MultiDocumentResponsePublicDailyReadiness data(@javax.annotation.Nonnull List<PublicDailyReadiness> data) {
    this.data = data;
    return this;
  }

  public MultiDocumentResponsePublicDailyReadiness addDataItem(PublicDailyReadiness dataItem) {
    if (this.data == null) {
  ...
  public List<PublicDailyReadiness> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@javax.annotation.Nonnull List<PublicDailyReadiness> data) {
    this.data = data;
  }


  public MultiDocumentResponsePublicDailyReadiness nextToken(@javax.annotation.Nullable String nextToken) {
  ...
  /**
   * Return true if this MultiDocumentResponse_PublicDailyReadiness_ object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    MultiDocumentResponsePublicDailyReadiness multiDocumentResponsePublicDailyReadiness = (MultiDocumentResponsePublicDailyReadiness) o;
    return Objects.equals(this.data, multiDocumentResponsePublicDailyReadiness.data) &&
        Objects.equals(this.nextToken, multiDocumentResponsePublicDailyReadiness.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class MultiDocumentResponsePublicDailyReadiness {\n");
