...
public enum PublicDailyStressSummary {
  ...
  PublicDailyStressSummary(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static PublicDailyStressSummary fromValue(String value) {
    for (PublicDailyStressSummary b : PublicDailyStressSummary.values()) {
