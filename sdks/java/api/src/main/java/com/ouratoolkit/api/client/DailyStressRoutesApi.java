...
public class DailyStressRoutesApi {
  ...
  public DailyStressRoutesApi() {
    this(Configuration.getDefaultApiClient());
  }

  public DailyStressRoutesApi(ApiClient apiClient) {
   ...
   */
  public MultiDocumentResponsePublicDailyStress multipleDailyStressDocumentsV2UsercollectionDailyStressGet(@javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, @javax.annotation.Nullable String nextToken, @javax.annotation.Nullable String fields) throws ApiException {
    ApiResponse<MultiDocumentResponsePublicDailyStress> localVarResponse = multipleDailyStressDocumentsV2UsercollectionDailyStressGetWithHttpInfo(startDate, endDate, nextToken, fields);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<MultiDocumentResponsePublicDailyStress> multipleDailyStressDocumentsV2UsercollectionDailyStressGetWithHttpInfo(@javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, @javax.annotation.Nullable String nextToken, @javax.annotation.Nullable String fields) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = multipleDailyStressDocumentsV2UsercollectionDailyStressGetRequestBuilder(startDate, endDate, nextToken, fields);
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("multipleDailyStressDocumentsV2UsercollectionDailyStressGet", localVarResponse);
        }
  ...
  private HttpRequest.Builder multipleDailyStressDocumentsV2UsercollectionDailyStressGetRequestBuilder(@javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, @javax.annotation.Nullable String nextToken, @javax.annotation.Nullable String fields) throws ApiException {

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/v2/usercollection/daily_stress";
   ...
   * @throws ApiException if fails to make API call
   */
  public PublicDailyStress singleDailyStressDocumentV2UsercollectionDailyStressDocumentIdGet(@javax.annotation.Nonnull String documentId) throws ApiException {
    ApiResponse<PublicDailyStress> localVarResponse = singleDailyStressDocumentV2UsercollectionDailyStressDocumentIdGetWithHttpInfo(documentId);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<PublicDailyStress> singleDailyStressDocumentV2UsercollectionDailyStressDocumentIdGetWithHttpInfo(@javax.annotation.Nonnull String documentId) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = singleDailyStressDocumentV2UsercollectionDailyStressDocumentIdGetRequestBuilder(documentId);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("singleDailyStressDocumentV2UsercollectionDailyStressDocumentIdGet", localVarResponse);
        }
        if (localVarResponse.body() == null) {
  ...
  private HttpRequest.Builder singleDailyStressDocumentV2UsercollectionDailyStressDocumentIdGetRequestBuilder(@javax.annotation.Nonnull String documentId) throws ApiException {
    // verify the required parameter 'documentId' is set
    if (documentId == null) {
      throw new ApiException(400, "Missing the required parameter 'documentId' when calling singleDailyStressDocumentV2UsercollectionDailyStressDocumentIdGet");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/v2/usercollection/daily_stress/{document_id}"
