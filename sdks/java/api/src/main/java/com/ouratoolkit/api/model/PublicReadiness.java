 ...
 */
@JsonPropertyOrder({
  PublicReadiness.JSON_PROPERTY_CONTRIBUTORS,
  PublicReadiness.JSON_PROPERTY_SCORE,
  PublicReadiness.JSON_PROPERTY_TEMPERATURE_DEVIATION,
  PublicReadiness.JSON_PROPERTY_TEMPERATURE_TREND_DEVIATION
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.14.0")
public class PublicReadiness {
  ...
  public PublicReadiness contributors(@javax.annotation.Nonnull PublicReadinessContributors contributors) {
  ...
  public PublicReadiness score(@javax.annotation.Nullable Integer score) {
  ...
  public PublicReadiness temperatureDeviation(@javax.annotation.Nullable BigDecimal temperatureDeviation) {
  ...
  public PublicReadiness temperatureTrendDeviation(@javax.annotation.Nullable BigDecimal temperatureTrendDeviation) {
  ...
  /**
   * Return true if this PublicReadiness object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PublicReadiness publicReadiness = (PublicReadiness) o;
    return Objects.equals(this.contributors, publicReadiness.contributors) &&
        equalsNullable(this.score, publicReadiness.score) &&
        equalsNullable(this.temperatureDeviation, publicReadiness.temperatureDeviation) &&
        equalsNullable(this.temperatureTrendDeviation, publicReadiness.temperatureTrendDeviation);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(contributors, hashCodeNullable(score), hashCodeNullable(temperatureDeviation), hashCodeNullable(temperatureTrendDeviation));
  }
  ...
  public String toString() {
    ...
    sb.append("class PublicReadiness {\n");
