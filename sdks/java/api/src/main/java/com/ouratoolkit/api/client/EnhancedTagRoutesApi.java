...
public class EnhancedTagRoutesApi {
  ...
  public EnhancedTagRoutesApi() {
    this(Configuration.getDefaultApiClient());
  }

  public EnhancedTagRoutesApi(ApiClient apiClient) {
   ...
   * @param fields N/A. This route does not support field selection yet, all fields will be returned. (optional)
   * @return MultiDocumentResponseEnhancedTagModel
   * @throws ApiException if fails to make API call
   */
  public MultiDocumentResponseEnhancedTagModel multipleEnhancedTagDocumentsV2UsercollectionEnhancedTagGet(@javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, @javax.annotation.Nullable String nextToken, @javax.annotation.Nullable String fields) throws ApiException {
    ApiResponse<MultiDocumentResponseEnhancedTagModel> localVarResponse = multipleEnhancedTagDocumentsV2UsercollectionEnhancedTagGetWithHttpInfo(startDate, endDate, nextToken, fields);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<MultiDocumentResponseEnhancedTagModel> multipleEnhancedTagDocumentsV2UsercollectionEnhancedTagGetWithHttpInfo(@javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, @javax.annotation.Nullable String nextToken, @javax.annotation.Nullable String fields) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = multipleEnhancedTagDocumentsV2UsercollectionEnhancedTagGetRequestBuilder(startDate, endDate, nextToken, fields);
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("multipleEnhancedTagDocumentsV2UsercollectionEnhancedTagGet", localVarResponse);
        }
  ...
  private HttpRequest.Builder multipleEnhancedTagDocumentsV2UsercollectionEnhancedTagGetRequestBuilder(@javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, @javax.annotation.Nullable String nextToken, @javax.annotation.Nullable String fields) throws ApiException {

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/v2/usercollection/enhanced_tag";
   ...
   * @throws ApiException if fails to make API call
   */
  public EnhancedTagModel singleEnhancedTagDocumentV2UsercollectionEnhancedTagDocumentIdGet(@javax.annotation.Nonnull String documentId) throws ApiException {
    ApiResponse<EnhancedTagModel> localVarResponse = singleEnhancedTagDocumentV2UsercollectionEnhancedTagDocumentIdGetWithHttpInfo(documentId);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<EnhancedTagModel> singleEnhancedTagDocumentV2UsercollectionEnhancedTagDocumentIdGetWithHttpInfo(@javax.annotation.Nonnull String documentId) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = singleEnhancedTagDocumentV2UsercollectionEnhancedTagDocumentIdGetRequestBuilder(documentId);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("singleEnhancedTagDocumentV2UsercollectionEnhancedTagDocumentIdGet", localVarResponse);
        }
        if (localVarResponse.body() == null) {
  ...
  private HttpRequest.Builder singleEnhancedTagDocumentV2UsercollectionEnhancedTagDocumentIdGetRequestBuilder(@javax.annotation.Nonnull String documentId) throws ApiException {
    // verify the required parameter 'documentId' is set
    if (documentId == null) {
      throw new ApiException(400, "Missing the required parameter 'documentId' when calling singleEnhancedTagDocumentV2UsercollectionEnhancedTagDocumentIdGet");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/v2/usercollection/enhanced_tag/{document_id}"
