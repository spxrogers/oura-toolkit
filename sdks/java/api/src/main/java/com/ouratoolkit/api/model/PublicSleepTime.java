...
import com.ouratoolkit.api.model.PublicSleepTimeRecommendation;
import com.ouratoolkit.api.model.PublicSleepTimeStatus;
import com.ouratoolkit.api.model.PublicSleepTimeWindow;
 ...
 */
@JsonPropertyOrder({
  PublicSleepTime.JSON_PROPERTY_ID,
  PublicSleepTime.JSON_PROPERTY_DAY,
  PublicSleepTime.JSON_PROPERTY_OPTIMAL_BEDTIME,
  PublicSleepTime.JSON_PROPERTY_RECOMMENDATION,
  PublicSleepTime.JSON_PROPERTY_STATUS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.14.0")
public class PublicSleepTime {
  ...
  public static final String JSON_PROPERTY_OPTIMAL_BEDTIME = "optimal_bedtime";
  private JsonNullable<PublicSleepTimeWindow> optimalBedtime = JsonNullable.<PublicSleepTimeWindow>undefined();

  public static final String JSON_PROPERTY_RECOMMENDATION = "recommendation";
  private JsonNullable<PublicSleepTimeRecommendation> recommendation = JsonNullable.<PublicSleepTimeRecommendation>undefined();

  public static final String JSON_PROPERTY_STATUS = "status";
  private JsonNullable<PublicSleepTimeStatus> status = JsonNullable.<PublicSleepTimeStatus>undefined();

  public PublicSleepTime() { 
  }

  public PublicSleepTime id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public PublicSleepTime day(@javax.annotation.Nullable String day) {
    this.day = day;
    return this;
  }
  ...
  public PublicSleepTime optimalBedtime(@javax.annotation.Nullable PublicSleepTimeWindow optimalBedtime) {
    this.optimalBedtime = JsonNullable.<PublicSleepTimeWindow>of(optimalBedtime);
    return this;
  }
  ...
  @javax.annotation.Nullable
  @JsonIgnore
  public PublicSleepTimeWindow getOptimalBedtime() {
        return optimalBedtime.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_OPTIMAL_BEDTIME)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<PublicSleepTimeWindow> getOptimalBedtime_JsonNullable() {
    return optimalBedtime;
  }
  
  @JsonProperty(JSON_PROPERTY_OPTIMAL_BEDTIME)
  public void setOptimalBedtime_JsonNullable(JsonNullable<PublicSleepTimeWindow> optimalBedtime) {
    this.optimalBedtime = optimalBedtime;
  }

  public void setOptimalBedtime(@javax.annotation.Nullable PublicSleepTimeWindow optimalBedtime) {
    this.optimalBedtime = JsonNullable.<PublicSleepTimeWindow>of(optimalBedtime);
  }


  public PublicSleepTime recommendation(@javax.annotation.Nullable PublicSleepTimeRecommendation recommendation) {
    this.recommendation = JsonNullable.<PublicSleepTimeRecommendation>of(recommendation);
    return this;
  }
  ...
  @javax.annotation.Nullable
  @JsonIgnore
  public PublicSleepTimeRecommendation getRecommendation() {
  ...
  public JsonNullable<PublicSleepTimeRecommendation> getRecommendation_JsonNullable() {
    return recommendation;
  }
  
  @JsonProperty(JSON_PROPERTY_RECOMMENDATION)
  public void setRecommendation_JsonNullable(JsonNullable<PublicSleepTimeRecommendation> recommendation) {
    this.recommendation = recommendation;
  }

  public void setRecommendation(@javax.annotation.Nullable PublicSleepTimeRecommendation recommendation) {
    this.recommendation = JsonNullable.<PublicSleepTimeRecommendation>of(recommendation);
  }


  public PublicSleepTime status(@javax.annotation.Nullable PublicSleepTimeStatus status) {
    this.status = JsonNullable.<PublicSleepTimeStatus>of(status);
    return this;
  }
  ...
  @javax.annotation.Nullable
  @JsonIgnore
  public PublicSleepTimeStatus getStatus() {
  ...
  public JsonNullable<PublicSleepTimeStatus> getStatus_JsonNullable() {
    return status;
  }
  
  @JsonProperty(JSON_PROPERTY_STATUS)
  public void setStatus_JsonNullable(JsonNullable<PublicSleepTimeStatus> status) {
    this.status = status;
  }

  public void setStatus(@javax.annotation.Nullable PublicSleepTimeStatus status) {
    this.status = JsonNullable.<PublicSleepTimeStatus>of(status);
  }


  /**
   * Return true if this PublicSleepTime object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PublicSleepTime publicSleepTime = (PublicSleepTime) o;
    return Objects.equals(this.id, publicSleepTime.id) &&
        Objects.equals(this.day, publicSleepTime.day) &&
        equalsNullable(this.optimalBedtime, publicSleepTime.optimalBedtime) &&
        equalsNullable(this.recommendation, publicSleepTime.recommendation) &&
        equalsNullable(this.status, publicSleepTime.status);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, day, hashCodeNullable(optimalBedtime), hashCodeNullable(recommendation), hashCodeNullable(status));
  }
  ...
  public String toString() {
    ...
    sb.append("class PublicSleepTime {\n");
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    day: ").append(toIndentedString(day)).append("\n");
    sb.append("    optimalBedtime: ").append(toIndentedString(optimalBedtime)).append("\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `optimal_bedtime` to the URL query string
    if (getOptimalBedtime() != null) {
      joiner.add(getOptimalBedtime().toUrlQueryString(prefix + "optimal_bedtime" + suffix));
    }

    // add `recommendation` to the URL query string
    if (getRecommendation() != null) {
      joiner.add(String.format("%srecommendation%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getRecommendation()))));
    }
