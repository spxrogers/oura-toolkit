...
public enum PublicRingHardwareType {
  ...
  PublicRingHardwareType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static PublicRingHardwareType fromValue(String value) {
    for (PublicRingHardwareType b : PublicRingHardwareType.values()) {
