...
public class DailyReadinessRoutesApi {
  ...
  public DailyReadinessRoutesApi() {
    this(Configuration.getDefaultApiClient());
  }

  public DailyReadinessRoutesApi(ApiClient apiClient) {
  ...
  public MultiDocumentResponsePublicDailyReadiness multipleDailyReadinessDocumentsV2UsercollectionDailyReadinessGet(@javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, @javax.annotation.Nullable String nextToken, @javax.annotation.Nullable String fields) throws ApiException {
    ApiResponse<MultiDocumentResponsePublicDailyReadiness> localVarResponse = multipleDailyReadinessDocumentsV2UsercollectionDailyReadinessGetWithHttpInfo(startDate, endDate, nextToken, fields);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<MultiDocumentResponsePublicDailyReadiness> multipleDailyReadinessDocumentsV2UsercollectionDailyReadinessGetWithHttpInfo(@javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, @javax.annotation.Nullable String nextToken, @javax.annotation.Nullable String fields) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = multipleDailyReadinessDocumentsV2UsercollectionDailyReadinessGetRequestBuilder(startDate, endDate, nextToken, fields);
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("multipleDailyReadinessDocumentsV2UsercollectionDailyReadinessGet", localVarResponse);
        }
  ...
  private HttpRequest.Builder multipleDailyReadinessDocumentsV2UsercollectionDailyReadinessGetRequestBuilder(@javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, @javax.annotation.Nullable String nextToken, @javax.annotation.Nullable String fields) throws ApiException {

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/v2/usercollection/daily_readiness";
   ...
   * @throws ApiException if fails to make API call
   */
  public PublicDailyReadiness singleDailyReadinessDocumentV2UsercollectionDailyReadinessDocumentIdGet(@javax.annotation.Nonnull String documentId) throws ApiException {
    ApiResponse<PublicDailyReadiness> localVarResponse = singleDailyReadinessDocumentV2UsercollectionDailyReadinessDocumentIdGetWithHttpInfo(documentId);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<PublicDailyReadiness> singleDailyReadinessDocumentV2UsercollectionDailyReadinessDocumentIdGetWithHttpInfo(@javax.annotation.Nonnull String documentId) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = singleDailyReadinessDocumentV2UsercollectionDailyReadinessDocumentIdGetRequestBuilder(documentId);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("singleDailyReadinessDocumentV2UsercollectionDailyReadinessDocumentIdGet", localVarResponse);
        }
        if (localVarResponse.body() == null) {
  ...
  private HttpRequest.Builder singleDailyReadinessDocumentV2UsercollectionDailyReadinessDocumentIdGetRequestBuilder(@javax.annotation.Nonnull String documentId) throws ApiException {
    // verify the required parameter 'documentId' is set
    if (documentId == null) {
      throw new ApiException(400, "Missing the required parameter 'documentId' when calling singleDailyReadinessDocumentV2UsercollectionDailyReadinessDocumentIdGet");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/v2/usercollection/daily_readiness/{document_id}"
