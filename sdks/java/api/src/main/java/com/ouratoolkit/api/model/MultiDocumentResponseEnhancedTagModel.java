 ...
 */
@JsonPropertyOrder({
  MultiDocumentResponseEnhancedTagModel.JSON_PROPERTY_DATA,
  MultiDocumentResponseEnhancedTagModel.JSON_PROPERTY_NEXT_TOKEN
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.14.0")
public class MultiDocumentResponseEnhancedTagModel {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nonnull
  private List<EnhancedTagModel> data = new ArrayList<>();
  ...
  public MultiDocumentResponseEnhancedTagModel data(@javax.annotation.Nonnull List<EnhancedTagModel> data) {
    this.data = data;
    return this;
  }

  public MultiDocumentResponseEnhancedTagModel addDataItem(EnhancedTagModel dataItem) {
    if (this.data == null) {
  ...
  public List<EnhancedTagModel> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@javax.annotation.Nonnull List<EnhancedTagModel> data) {
    this.data = data;
  }


  public MultiDocumentResponseEnhancedTagModel nextToken(@javax.annotation.Nullable String nextToken) {
  ...
  /**
   * Return true if this MultiDocumentResponse_EnhancedTagModel_ object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    MultiDocumentResponseEnhancedTagModel multiDocumentResponseEnhancedTagModel = (MultiDocumentResponseEnhancedTagModel) o;
    return Objects.equals(this.data, multiDocumentResponseEnhancedTagModel.data) &&
        Objects.equals(this.nextToken, multiDocumentResponseEnhancedTagModel.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class MultiDocumentResponseEnhancedTagModel {\n");
