...
public enum WebhookOperation {
  ...
  @JsonCreator
  public static WebhookOperation fromValue(String value) {
    for (WebhookOperation b : WebhookOperation.values()) {
