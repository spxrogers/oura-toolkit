 ...
 */
@JsonPropertyOrder({
  MultiDocumentResponseTagModel.JSON_PROPERTY_DATA,
  MultiDocumentResponseTagModel.JSON_PROPERTY_NEXT_TOKEN
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.14.0")
public class MultiDocumentResponseTagModel {
  ...
  public MultiDocumentResponseTagModel data(@javax.annotation.Nonnull List<TagModel> data) {
    this.data = data;
    return this;
  }

  public MultiDocumentResponseTagModel addDataItem(TagModel dataItem) {
    if (this.data == null) {
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@javax.annotation.Nonnull List<TagModel> data) {
    this.data = data;
  }


  public MultiDocumentResponseTagModel nextToken(@javax.annotation.Nullable String nextToken) {
  ...
  /**
   * Return true if this MultiDocumentResponse_TagModel_ object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    MultiDocumentResponseTagModel multiDocumentResponseTagModel = (MultiDocumentResponseTagModel) o;
    return Objects.equals(this.data, multiDocumentResponseTagModel.data) &&
        Objects.equals(this.nextToken, multiDocumentResponseTagModel.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class MultiDocumentResponseTagModel {\n");
