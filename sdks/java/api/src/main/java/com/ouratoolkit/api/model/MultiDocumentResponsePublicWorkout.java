 ...
 */
@JsonPropertyOrder({
  MultiDocumentResponsePublicWorkout.JSON_PROPERTY_DATA,
  MultiDocumentResponsePublicWorkout.JSON_PROPERTY_NEXT_TOKEN
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.14.0")
public class MultiDocumentResponsePublicWorkout {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nonnull
  private List<PublicWorkout> data = new ArrayList<>();
  ...
  public MultiDocumentResponsePublicWorkout data(@javax.annotation.Nonnull List<PublicWorkout> data) {
    this.data = data;
    return this;
  }

  public MultiDocumentResponsePublicWorkout addDataItem(PublicWorkout dataItem) {
    if (this.data == null) {
  ...
  public List<PublicWorkout> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@javax.annotation.Nonnull List<PublicWorkout> data) {
    this.data = data;
  }


  public MultiDocumentResponsePublicWorkout nextToken(@javax.annotation.Nullable String nextToken) {
  ...
  /**
   * Return true if this MultiDocumentResponse_PublicWorkout_ object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    MultiDocumentResponsePublicWorkout multiDocumentResponsePublicWorkout = (MultiDocumentResponsePublicWorkout) o;
    return Objects.equals(this.data, multiDocumentResponsePublicWorkout.data) &&
        Objects.equals(this.nextToken, multiDocumentResponsePublicWorkout.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class MultiDocumentResponsePublicWorkout {\n");
