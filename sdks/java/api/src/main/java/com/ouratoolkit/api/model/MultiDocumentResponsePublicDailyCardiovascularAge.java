 ...
 */
@JsonPropertyOrder({
  MultiDocumentResponsePublicDailyCardiovascularAge.JSON_PROPERTY_DATA,
  MultiDocumentResponsePublicDailyCardiovascularAge.JSON_PROPERTY_NEXT_TOKEN
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.14.0")
public class MultiDocumentResponsePublicDailyCardiovascularAge {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nonnull
  private List<PublicDailyCardiovascularAge> data = new ArrayList<>();
  ...
  public MultiDocumentResponsePublicDailyCardiovascularAge data(@javax.annotation.Nonnull List<PublicDailyCardiovascularAge> data) {
    this.data = data;
    return this;
  }

  public MultiDocumentResponsePublicDailyCardiovascularAge addDataItem(PublicDailyCardiovascularAge dataItem) {
    if (this.data == null) {
  ...
  public List<PublicDailyCardiovascularAge> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@javax.annotation.Nonnull List<PublicDailyCardiovascularAge> data) {
    this.data = data;
  }


  public MultiDocumentResponsePublicDailyCardiovascularAge nextToken(@javax.annotation.Nullable String nextToken) {
  ...
  /**
   * Return true if this MultiDocumentResponse_PublicDailyCardiovascularAge_ object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    MultiDocumentResponsePublicDailyCardiovascularAge multiDocumentResponsePublicDailyCardiovascularAge = (MultiDocumentResponsePublicDailyCardiovascularAge) o;
    return Objects.equals(this.data, multiDocumentResponsePublicDailyCardiovascularAge.data) &&
        Objects.equals(this.nextToken, multiDocumentResponsePublicDailyCardiovascularAge.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class MultiDocumentResponsePublicDailyCardiovascularAge {\n");
