...
public enum PublicSleepAlgorithmVersion {
  ...
  PublicSleepAlgorithmVersion(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static PublicSleepAlgorithmVersion fromValue(String value) {
    for (PublicSleepAlgorithmVersion b : PublicSleepAlgorithmVersion.values()) {
