...
public class RingConfigurationRoutesApi {
  ...
  public RingConfigurationRoutesApi() {
    this(Configuration.getDefaultApiClient());
  }

  public RingConfigurationRoutesApi(ApiClient apiClient) {
   ...
   */
  public MultiDocumentResponsePublicRingConfiguration multipleRingConfigurationDocumentsV2UsercollectionRingConfigurationGet(@javax.annotation.Nullable String fields, @javax.annotation.Nullable String nextToken) throws ApiException {
    ApiResponse<MultiDocumentResponsePublicRingConfiguration> localVarResponse = multipleRingConfigurationDocumentsV2UsercollectionRingConfigurationGetWithHttpInfo(fields, nextToken);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<MultiDocumentResponsePublicRingConfiguration> multipleRingConfigurationDocumentsV2UsercollectionRingConfigurationGetWithHttpInfo(@javax.annotation.Nullable String fields, @javax.annotation.Nullable String nextToken) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = multipleRingConfigurationDocumentsV2UsercollectionRingConfigurationGetRequestBuilder(fields, nextToken);
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("multipleRingConfigurationDocumentsV2UsercollectionRingConfigurationGet", localVarResponse);
        }
  ...
  private HttpRequest.Builder multipleRingConfigurationDocumentsV2UsercollectionRingConfigurationGetRequestBuilder(@javax.annotation.Nullable String fields, @javax.annotation.Nullable String nextToken) throws ApiException {

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/v2/usercollection/ring_configuration";
   ...
   * @throws ApiException if fails to make API call
   */
  public PublicRingConfiguration singleRingConfigurationDocumentV2UsercollectionRingConfigurationDocumentIdGet(@javax.annotation.Nonnull String documentId) throws ApiException {
    ApiResponse<PublicRingConfiguration> localVarResponse = singleRingConfigurationDocumentV2UsercollectionRingConfigurationDocumentIdGetWithHttpInfo(documentId);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<PublicRingConfiguration> singleRingConfigurationDocumentV2UsercollectionRingConfigurationDocumentIdGetWithHttpInfo(@javax.annotation.Nonnull String documentId) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = singleRingConfigurationDocumentV2UsercollectionRingConfigurationDocumentIdGetRequestBuilder(documentId);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("singleRingConfigurationDocumentV2UsercollectionRingConfigurationDocumentIdGet", localVarResponse);
        }
        if (localVarResponse.body() == null) {
  ...
  private HttpRequest.Builder singleRingConfigurationDocumentV2UsercollectionRingConfigurationDocumentIdGetRequestBuilder(@javax.annotation.Nonnull String documentId) throws ApiException {
    // verify the required parameter 'documentId' is set
    if (documentId == null) {
      throw new ApiException(400, "Missing the required parameter 'documentId' when calling singleRingConfigurationDocumentV2UsercollectionRingConfigurationDocumentIdGet");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/v2/usercollection/ring_configuration/{document_id}"
