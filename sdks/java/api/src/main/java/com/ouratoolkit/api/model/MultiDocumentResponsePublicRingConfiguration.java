 ...
 */
@JsonPropertyOrder({
  MultiDocumentResponsePublicRingConfiguration.JSON_PROPERTY_DATA,
  MultiDocumentResponsePublicRingConfiguration.JSON_PROPERTY_NEXT_TOKEN
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.14.0")
public class MultiDocumentResponsePublicRingConfiguration {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nonnull
  private List<PublicRingConfiguration> data = new ArrayList<>();
  ...
  public MultiDocumentResponsePublicRingConfiguration data(@javax.annotation.Nonnull List<PublicRingConfiguration> data) {
    this.data = data;
    return this;
  }

  public MultiDocumentResponsePublicRingConfiguration addDataItem(PublicRingConfiguration dataItem) {
    if (this.data == null) {
  ...
  public List<PublicRingConfiguration> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@javax.annotation.Nonnull List<PublicRingConfiguration> data) {
    this.data = data;
  }


  public MultiDocumentResponsePublicRingConfiguration nextToken(@javax.annotation.Nullable String nextToken) {
  ...
  /**
   * Return true if this MultiDocumentResponse_PublicRingConfiguration_ object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    MultiDocumentResponsePublicRingConfiguration multiDocumentResponsePublicRingConfiguration = (MultiDocumentResponsePublicRingConfiguration) o;
    return Objects.equals(this.data, multiDocumentResponsePublicRingConfiguration.data) &&
        Objects.equals(this.nextToken, multiDocumentResponsePublicRingConfiguration.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class MultiDocumentResponsePublicRingConfiguration {\n");
