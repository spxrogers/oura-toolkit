...
import com.ouratoolkit.api.model.PublicRingBatteryLevelRow;
 ...
 */
@JsonPropertyOrder({
  TimeSeriesResponsePublicRingBatteryLevelRow.JSON_PROPERTY_DATA,
  TimeSeriesResponsePublicRingBatteryLevelRow.JSON_PROPERTY_NEXT_TOKEN
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.14.0")
public class TimeSeriesResponsePublicRingBatteryLevelRow {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nonnull
  private List<PublicRingBatteryLevelRow> data = new ArrayList<>();
  ...
  public TimeSeriesResponsePublicRingBatteryLevelRow data(@javax.annotation.Nonnull List<PublicRingBatteryLevelRow> data) {
    this.data = data;
    return this;
  }

  public TimeSeriesResponsePublicRingBatteryLevelRow addDataItem(PublicRingBatteryLevelRow dataItem) {
    if (this.data == null) {
  ...
  public List<PublicRingBatteryLevelRow> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@javax.annotation.Nonnull List<PublicRingBatteryLevelRow> data) {
    this.data = data;
  }


  public TimeSeriesResponsePublicRingBatteryLevelRow nextToken(@javax.annotation.Nullable String nextToken) {
  ...
  /**
   * Return true if this TimeSeriesResponse_PublicRingBatteryLevelRow_ object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TimeSeriesResponsePublicRingBatteryLevelRow timeSeriesResponsePublicRingBatteryLevelRow = (TimeSeriesResponsePublicRingBatteryLevelRow) o;
    return Objects.equals(this.data, timeSeriesResponsePublicRingBatteryLevelRow.data) &&
        equalsNullable(this.nextToken, timeSeriesResponsePublicRingBatteryLevelRow.nextToken);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(data, hashCodeNullable(nextToken));
  }
  ...
  public String toString() {
    ...
    sb.append("class TimeSeriesResponsePublicRingBatteryLevelRow {\n");
