...
public class SleepTimeRoutesApi {
  ...
  public SleepTimeRoutesApi() {
    this(Configuration.getDefaultApiClient());
  }

  public SleepTimeRoutesApi(ApiClient apiClient) {
   ...
   */
  public MultiDocumentResponsePublicSleepTime multipleSleepTimeDocumentsV2UsercollectionSleepTimeGet(@javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, @javax.annotation.Nullable String nextToken, @javax.annotation.Nullable String fields) throws ApiException {
    ApiResponse<MultiDocumentResponsePublicSleepTime> localVarResponse = multipleSleepTimeDocumentsV2UsercollectionSleepTimeGetWithHttpInfo(startDate, endDate, nextToken, fields);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<MultiDocumentResponsePublicSleepTime> multipleSleepTimeDocumentsV2UsercollectionSleepTimeGetWithHttpInfo(@javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, @javax.annotation.Nullable String nextToken, @javax.annotation.Nullable String fields) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = multipleSleepTimeDocumentsV2UsercollectionSleepTimeGetRequestBuilder(startDate, endDate, nextToken, fields);
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("multipleSleepTimeDocumentsV2UsercollectionSleepTimeGet", localVarResponse);
        }
  ...
  private HttpRequest.Builder multipleSleepTimeDocumentsV2UsercollectionSleepTimeGetRequestBuilder(@javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, @javax.annotation.Nullable String nextToken, @javax.annotation.Nullable String fields) throws ApiException {

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/v2/usercollection/sleep_time";
   ...
   * @throws ApiException if fails to make API call
   */
  public PublicSleepTime singleSleepTimeDocumentV2UsercollectionSleepTimeDocumentIdGet(@javax.annotation.Nonnull String documentId) throws ApiException {
    ApiResponse<PublicSleepTime> localVarResponse = singleSleepTimeDocumentV2UsercollectionSleepTimeDocumentIdGetWithHttpInfo(documentId);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<PublicSleepTime> singleSleepTimeDocumentV2UsercollectionSleepTimeDocumentIdGetWithHttpInfo(@javax.annotation.Nonnull String documentId) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = singleSleepTimeDocumentV2UsercollectionSleepTimeDocumentIdGetRequestBuilder(documentId);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("singleSleepTimeDocumentV2UsercollectionSleepTimeDocumentIdGet", localVarResponse);
        }
        if (localVarResponse.body() == null) {
  ...
  private HttpRequest.Builder singleSleepTimeDocumentV2UsercollectionSleepTimeDocumentIdGetRequestBuilder(@javax.annotation.Nonnull String documentId) throws ApiException {
    // verify the required parameter 'documentId' is set
    if (documentId == null) {
      throw new ApiException(400, "Missing the required parameter 'documentId' when calling singleSleepTimeDocumentV2UsercollectionSleepTimeDocumentIdGet");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/v2/usercollection/sleep_time/{document_id}"
