 ...
 */
@JsonPropertyOrder({
  MultiDocumentResponsePublicDailyStress.JSON_PROPERTY_DATA,
  MultiDocumentResponsePublicDailyStress.JSON_PROPERTY_NEXT_TOKEN
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.14.0")
public class MultiDocumentResponsePublicDailyStress {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nonnull
  private List<PublicDailyStress> data = new ArrayList<>();
  ...
  public MultiDocumentResponsePublicDailyStress data(@javax.annotation.Nonnull List<PublicDailyStress> data) {
    this.data = data;
    return this;
  }

  public MultiDocumentResponsePublicDailyStress addDataItem(PublicDailyStress dataItem) {
    if (this.data == null) {
  ...
  public List<PublicDailyStress> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@javax.annotation.Nonnull List<PublicDailyStress> data) {
    this.data = data;
  }


  public MultiDocumentResponsePublicDailyStress nextToken(@javax.annotation.Nullable String nextToken) {
  ...
  /**
   * Return true if this MultiDocumentResponse_PublicDailyStress_ object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    MultiDocumentResponsePublicDailyStress multiDocumentResponsePublicDailyStress = (MultiDocumentResponsePublicDailyStress) o;
    return Objects.equals(this.data, multiDocumentResponsePublicDailyStress.data) &&
        Objects.equals(this.nextToken, multiDocumentResponsePublicDailyStress.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class MultiDocumentResponsePublicDailyStress {\n");
