 ...
 */
@JsonPropertyOrder({
  TimeSeriesResponseDict.JSON_PROPERTY_DATA,
  TimeSeriesResponseDict.JSON_PROPERTY_NEXT_TOKEN
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.14.0")
public class TimeSeriesResponseDict {
  ...
  public TimeSeriesResponseDict data(@javax.annotation.Nonnull List<Map<String, Object>> data) {
    this.data = data;
    return this;
  }

  public TimeSeriesResponseDict addDataItem(Map<String, Object> dataItem) {
    if (this.data == null) {
  ...
  public TimeSeriesResponseDict nextToken(@javax.annotation.Nullable String nextToken) {
  ...
  /**
   * Return true if this TimeSeriesResponseDict object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TimeSeriesResponseDict timeSeriesResponseDict = (TimeSeriesResponseDict) o;
    return Objects.equals(this.data, timeSeriesResponseDict.data) &&
        equalsNullable(this.nextToken, timeSeriesResponseDict.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class TimeSeriesResponseDict {\n");
