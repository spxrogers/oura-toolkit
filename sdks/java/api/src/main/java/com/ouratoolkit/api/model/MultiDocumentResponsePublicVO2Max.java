 ...
 */
@JsonPropertyOrder({
  MultiDocumentResponsePublicVO2Max.JSON_PROPERTY_DATA,
  MultiDocumentResponsePublicVO2Max.JSON_PROPERTY_NEXT_TOKEN
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.14.0")
public class MultiDocumentResponsePublicVO2Max {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nonnull
  private List<PublicVO2Max> data = new ArrayList<>();
  ...
  public MultiDocumentResponsePublicVO2Max data(@javax.annotation.Nonnull List<PublicVO2Max> data) {
    this.data = data;
    return this;
  }

  public MultiDocumentResponsePublicVO2Max addDataItem(PublicVO2Max dataItem) {
    if (this.data == null) {
  ...
  public List<PublicVO2Max> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@javax.annotation.Nonnull List<PublicVO2Max> data) {
    this.data = data;
  }


  public MultiDocumentResponsePublicVO2Max nextToken(@javax.annotation.Nullable String nextToken) {
  ...
  /**
   * Return true if this MultiDocumentResponse_PublicVO2Max_ object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    MultiDocumentResponsePublicVO2Max multiDocumentResponsePublicVO2Max = (MultiDocumentResponsePublicVO2Max) o;
    return Objects.equals(this.data, multiDocumentResponsePublicVO2Max.data) &&
        Objects.equals(this.nextToken, multiDocumentResponsePublicVO2Max.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class MultiDocumentResponsePublicVO2Max {\n");
