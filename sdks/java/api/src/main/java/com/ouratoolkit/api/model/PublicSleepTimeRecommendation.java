...
public enum PublicSleepTimeRecommendation {
  ...
  PublicSleepTimeRecommendation(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static PublicSleepTimeRecommendation fromValue(String value) {
    for (PublicSleepTimeRecommendation b : PublicSleepTimeRecommendation.values()) {
