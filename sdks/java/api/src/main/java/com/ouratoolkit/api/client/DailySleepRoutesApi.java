...
public class DailySleepRoutesApi {
  ...
  public DailySleepRoutesApi() {
    this(Configuration.getDefaultApiClient());
  }

  public DailySleepRoutesApi(ApiClient apiClient) {
   ...
   */
  public MultiDocumentResponsePublicDailySleep multipleDailySleepDocumentsV2UsercollectionDailySleepGet(@javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, @javax.annotation.Nullable String nextToken, @javax.annotation.Nullable String fields) throws ApiException {
    ApiResponse<MultiDocumentResponsePublicDailySleep> localVarResponse = multipleDailySleepDocumentsV2UsercollectionDailySleepGetWithHttpInfo(startDate, endDate, nextToken, fields);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<MultiDocumentResponsePublicDailySleep> multipleDailySleepDocumentsV2UsercollectionDailySleepGetWithHttpInfo(@javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, @javax.annotation.Nullable String nextToken, @javax.annotation.Nullable String fields) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = multipleDailySleepDocumentsV2UsercollectionDailySleepGetRequestBuilder(startDate, endDate, nextToken, fields);
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("multipleDailySleepDocumentsV2UsercollectionDailySleepGet", localVarResponse);
        }
  ...
  private HttpRequest.Builder multipleDailySleepDocumentsV2UsercollectionDailySleepGetRequestBuilder(@javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, @javax.annotation.Nullable String nextToken, @javax.annotation.Nullable String fields) throws ApiException {

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/v2/usercollection/daily_sleep";
   ...
   * @throws ApiException if fails to make API call
   */
  public PublicDailySleep singleDailySleepDocumentV2UsercollectionDailySleepDocumentIdGet(@javax.annotation.Nonnull String documentId) throws ApiException {
    ApiResponse<PublicDailySleep> localVarResponse = singleDailySleepDocumentV2UsercollectionDailySleepDocumentIdGetWithHttpInfo(documentId);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<PublicDailySleep> singleDailySleepDocumentV2UsercollectionDailySleepDocumentIdGetWithHttpInfo(@javax.annotation.Nonnull String documentId) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = singleDailySleepDocumentV2UsercollectionDailySleepDocumentIdGetRequestBuilder(documentId);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("singleDailySleepDocumentV2UsercollectionDailySleepDocumentIdGet", localVarResponse);
        }
        if (localVarResponse.body() == null) {
  ...
  private HttpRequest.Builder singleDailySleepDocumentV2UsercollectionDailySleepDocumentIdGetRequestBuilder(@javax.annotation.Nonnull String documentId) throws ApiException {
    // verify the required parameter 'documentId' is set
    if (documentId == null) {
      throw new ApiException(400, "Missing the required parameter 'documentId' when calling singleDailySleepDocumentV2UsercollectionDailySleepDocumentIdGet");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/v2/usercollection/daily_sleep/{document_id}"
