...
import com.ouratoolkit.api.model.ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet;
...
public class HeartRateRoutesApi {
  ...
  public HeartRateRoutesApi() {
    this(Configuration.getDefaultApiClient());
  }

  public HeartRateRoutesApi(ApiClient apiClient) {
  ...
  public ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet multipleHeartrateDocumentsV2UsercollectionHeartrateGet(@javax.annotation.Nullable OffsetDateTime startDatetime, @javax.annotation.Nullable OffsetDateTime endDatetime, @javax.annotation.Nullable String nextToken, @javax.annotation.Nullable Boolean latest, @javax.annotation.Nullable String fields) throws ApiException {
    ApiResponse<ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet> localVarResponse = multipleHeartrateDocumentsV2UsercollectionHeartrateGetWithHttpInfo(startDatetime, endDatetime, nextToken, latest, fields);
   ...
   * @param latest If True, returns most recent sample. (optional)
   * @param fields Comma-separated list of fields to include in the response, in addition to the always returned fields. Defaults to all fields if not provided. (optional)
   * @return ApiResponse&lt;ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet&gt;
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet> multipleHeartrateDocumentsV2UsercollectionHeartrateGetWithHttpInfo(@javax.annotation.Nullable OffsetDateTime startDatetime, @javax.annotation.Nullable OffsetDateTime endDatetime, @javax.annotation.Nullable String nextToken, @javax.annotation.Nullable Boolean latest, @javax.annotation.Nullable String fields) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = multipleHeartrateDocumentsV2UsercollectionHeartrateGetRequestBuilder(startDatetime, endDatetime, nextToken, latest, fields);
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("multipleHeartrateDocumentsV2UsercollectionHeartrateGet", localVarResponse);
        }
        if (localVarResponse.body() == null) {
          return new ApiResponse<ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet>(
        ...
        return new ApiResponse<ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet>(
            localVarResponse.statusCode(),
            localVarResponse.headers().map(),
            responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet>() {})
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  private HttpRequest.Builder multipleHeartrateDocumentsV2UsercollectionHeartrateGetRequestBuilder(@javax.annotation.Nullable OffsetDateTime startDatetime, @javax.annotation.Nullable OffsetDateTime endDatetime, @javax.annotation.Nullable String nextToken, @javax.annotation.Nullable Boolean latest, @javax.annotation.Nullable String fields) throws ApiException {

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/v2/usercollection/heartrate";
