...
public class RestModePeriodRoutesApi {
  ...
  public RestModePeriodRoutesApi() {
    this(Configuration.getDefaultApiClient());
  }

  public RestModePeriodRoutesApi(ApiClient apiClient) {
   ...
   */
  public MultiDocumentResponsePublicRestModePeriod multipleRestModePeriodDocumentsV2UsercollectionRestModePeriodGet(@javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, @javax.annotation.Nullable String nextToken, @javax.annotation.Nullable String fields) throws ApiException {
    ApiResponse<MultiDocumentResponsePublicRestModePeriod> localVarResponse = multipleRestModePeriodDocumentsV2UsercollectionRestModePeriodGetWithHttpInfo(startDate, endDate, nextToken, fields);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<MultiDocumentResponsePublicRestModePeriod> multipleRestModePeriodDocumentsV2UsercollectionRestModePeriodGetWithHttpInfo(@javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, @javax.annotation.Nullable String nextToken, @javax.annotation.Nullable String fields) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = multipleRestModePeriodDocumentsV2UsercollectionRestModePeriodGetRequestBuilder(startDate, endDate, nextToken, fields);
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("multipleRestModePeriodDocumentsV2UsercollectionRestModePeriodGet", localVarResponse);
        }
  ...
  private HttpRequest.Builder multipleRestModePeriodDocumentsV2UsercollectionRestModePeriodGetRequestBuilder(@javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, @javax.annotation.Nullable String nextToken, @javax.annotation.Nullable String fields) throws ApiException {

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/v2/usercollection/rest_mode_period";
   ...
   * @throws ApiException if fails to make API call
   */
  public PublicRestModePeriod singleRestModePeriodDocumentV2UsercollectionRestModePeriodDocumentIdGet(@javax.annotation.Nonnull String documentId) throws ApiException {
    ApiResponse<PublicRestModePeriod> localVarResponse = singleRestModePeriodDocumentV2UsercollectionRestModePeriodDocumentIdGetWithHttpInfo(documentId);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<PublicRestModePeriod> singleRestModePeriodDocumentV2UsercollectionRestModePeriodDocumentIdGetWithHttpInfo(@javax.annotation.Nonnull String documentId) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = singleRestModePeriodDocumentV2UsercollectionRestModePeriodDocumentIdGetRequestBuilder(documentId);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("singleRestModePeriodDocumentV2UsercollectionRestModePeriodDocumentIdGet", localVarResponse);
        }
        if (localVarResponse.body() == null) {
  ...
  private HttpRequest.Builder singleRestModePeriodDocumentV2UsercollectionRestModePeriodDocumentIdGetRequestBuilder(@javax.annotation.Nonnull String documentId) throws ApiException {
    // verify the required parameter 'documentId' is set
    if (documentId == null) {
      throw new ApiException(400, "Missing the required parameter 'documentId' when calling singleRestModePeriodDocumentV2UsercollectionRestModePeriodDocumentIdGet");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/v2/usercollection/rest_mode_period/{document_id}"
