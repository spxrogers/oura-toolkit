...
public enum LongTermResilienceLevel {
  ...
  LongTermResilienceLevel(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static LongTermResilienceLevel fromValue(String value) {
    for (LongTermResilienceLevel b : LongTermResilienceLevel.values()) {
