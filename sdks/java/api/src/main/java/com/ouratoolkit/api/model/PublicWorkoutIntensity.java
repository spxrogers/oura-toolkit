...
public enum PublicWorkoutIntensity {
  ...
  PublicWorkoutIntensity(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static PublicWorkoutIntensity fromValue(String value) {
    for (PublicWorkoutIntensity b : PublicWorkoutIntensity.values()) {
