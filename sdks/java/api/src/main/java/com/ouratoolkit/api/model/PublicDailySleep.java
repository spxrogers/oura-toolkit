...
import com.ouratoolkit.api.model.PublicSleepContributors;
 ...
 */
@JsonPropertyOrder({
  PublicDailySleep.JSON_PROPERTY_ID,
  PublicDailySleep.JSON_PROPERTY_CONTRIBUTORS,
  PublicDailySleep.JSON_PROPERTY_DAY,
  PublicDailySleep.JSON_PROPERTY_SCORE,
  PublicDailySleep.JSON_PROPERTY_TIMESTAMP
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.14.0")
public class PublicDailySleep {
  ...
  @javax.annotation.Nonnull
  private PublicSleepContributors contributors;
  ...
  public PublicDailySleep id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public PublicDailySleep contributors(@javax.annotation.Nonnull PublicSleepContributors contributors) {
  ...
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public PublicSleepContributors getContributors() {
    return contributors;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CONTRIBUTORS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setContributors(@javax.annotation.Nonnull PublicSleepContributors contributors) {
    this.contributors = contributors;
  }


  public PublicDailySleep day(@javax.annotation.Nullable String day) {
    this.day = day;
    return this;
  }
  ...
  public PublicDailySleep score(@javax.annotation.Nullable Integer score) {
  ...
  public PublicDailySleep timestamp(@javax.annotation.Nullable String timestamp) {
  ...
  /**
   * Return true if this PublicDailySleep object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PublicDailySleep publicDailySleep = (PublicDailySleep) o;
    return Objects.equals(this.id, publicDailySleep.id) &&
        Objects.equals(this.contributors, publicDailySleep.contributors) &&
        Objects.equals(this.day, publicDailySleep.day) &&
        equalsNullable(this.score, publicDailySleep.score) &&
        Objects.equals(this.timestamp, publicDailySleep.timestamp);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, contributors, day, hashCodeNullable(score), timestamp);
  }
  ...
  public String toString() {
    ...
    sb.append("class PublicDailySleep {\n");
