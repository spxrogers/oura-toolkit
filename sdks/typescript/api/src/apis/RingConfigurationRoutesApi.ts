...
export interface MultipleRingConfigurationDocumentsV2UsercollectionRingConfigurationGetRequest {
    fields?: string | null;
    nextToken?: string | null;
}

export interface SingleRingConfigurationDocumentV2UsercollectionRingConfigurationDocumentIdGetRequest {
    documentId: string;
}
 ...
 * 
 */
export class RingConfigurationRoutesApi extends runtime.BaseAPI {

    /**
     * Multiple Ring Configuration Documents
     */
    async multipleRingConfigurationDocumentsV2UsercollectionRingConfigurationGetRaw(requestParameters: MultipleRingConfigurationDocumentsV2UsercollectionRingConfigurationGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MultiDocumentResponsePublicRingConfiguration>> {
        ...
        let urlPath = `/v2/usercollection/ring_configuration`;
     ...
     * Multiple Ring Configuration Documents
     */
    async multipleRingConfigurationDocumentsV2UsercollectionRingConfigurationGet(requestParameters: MultipleRingConfigurationDocumentsV2UsercollectionRingConfigurationGetRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MultiDocumentResponsePublicRingConfiguration> {
        const response = await this.multipleRingConfigurationDocumentsV2UsercollectionRingConfigurationGetRaw(requestParameters, initOverrides);
     ...
     */
    async singleRingConfigurationDocumentV2UsercollectionRingConfigurationDocumentIdGetRaw(requestParameters: SingleRingConfigurationDocumentV2UsercollectionRingConfigurationDocumentIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PublicRingConfiguration>> {
        if (requestParameters['documentId'] == null) {
            throw new runtime.RequiredError(
                'documentId',
                'Required parameter "documentId" was null or undefined when calling singleRingConfigurationDocumentV2UsercollectionRingConfigurationDocumentIdGet().'
            );
        }
        ...
        let urlPath = `/v2/usercollection/ring_configuration/{document_id}`;
     ...
     * Single Ring Configuration Document
     */
    async singleRingConfigurationDocumentV2UsercollectionRingConfigurationDocumentIdGet(requestParameters: SingleRingConfigurationDocumentV2UsercollectionRingConfigurationDocumentIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PublicRingConfiguration> {
        const response = await this.singleRingConfigurationDocumentV2UsercollectionRingConfigurationDocumentIdGetRaw(requestParameters, initOverrides);
        return await response.value();
    }
