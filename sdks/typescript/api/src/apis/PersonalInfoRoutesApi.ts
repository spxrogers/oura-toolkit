 ...
 * 
 */
export class PersonalInfoRoutesApi extends runtime.BaseAPI {

    /**
     * Single Personal Info Document
     */
    async singlePersonalInfoDocumentV2UsercollectionPersonalInfoGetRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PersonalInfoResponse>> {
        ...
        let urlPath = `/v2/usercollection/personal_info`;
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => PersonalInfoResponseFromJSON(jsonValue));
    }

    /**
     * Single Personal Info Document
     */
    async singlePersonalInfoDocumentV2UsercollectionPersonalInfoGet(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PersonalInfoResponse> {
        const response = await this.singlePersonalInfoDocumentV2UsercollectionPersonalInfoGetRaw(initOverrides);
