...
export interface MultipleSleepTimeDocumentsV2UsercollectionSleepTimeGetRequest {
    startDate?: Date;
    endDate?: Date;
...
export interface SingleSleepTimeDocumentV2UsercollectionSleepTimeDocumentIdGetRequest {
    documentId: string;
}
 ...
 * 
 */
export class SleepTimeRoutesApi extends runtime.BaseAPI {

    /**
     * Multiple Sleep Time Documents
     */
    async multipleSleepTimeDocumentsV2UsercollectionSleepTimeGetRaw(requestParameters: MultipleSleepTimeDocumentsV2UsercollectionSleepTimeGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MultiDocumentResponsePublicSleepTime>> {
        ...
        let urlPath = `/v2/usercollection/sleep_time`;
     ...
     * Multiple Sleep Time Documents
     */
    async multipleSleepTimeDocumentsV2UsercollectionSleepTimeGet(requestParameters: MultipleSleepTimeDocumentsV2UsercollectionSleepTimeGetRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MultiDocumentResponsePublicSleepTime> {
        const response = await this.multipleSleepTimeDocumentsV2UsercollectionSleepTimeGetRaw(requestParameters, initOverrides);
     ...
     */
    async singleSleepTimeDocumentV2UsercollectionSleepTimeDocumentIdGetRaw(requestParameters: SingleSleepTimeDocumentV2UsercollectionSleepTimeDocumentIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PublicSleepTime>> {
        if (requestParameters['documentId'] == null) {
            throw new runtime.RequiredError(
                'documentId',
                'Required parameter "documentId" was null or undefined when calling singleSleepTimeDocumentV2UsercollectionSleepTimeDocumentIdGet().'
            );
        }
        ...
        let urlPath = `/v2/usercollection/sleep_time/{document_id}`;
     ...
     * Single Sleep Time Document
     */
    async singleSleepTimeDocumentV2UsercollectionSleepTimeDocumentIdGet(requestParameters: SingleSleepTimeDocumentV2UsercollectionSleepTimeDocumentIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PublicSleepTime> {
        const response = await this.singleSleepTimeDocumentV2UsercollectionSleepTimeDocumentIdGetRaw(requestParameters, initOverrides);
        return await response.value();
    }
