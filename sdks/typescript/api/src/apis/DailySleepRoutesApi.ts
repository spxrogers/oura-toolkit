...
export interface MultipleDailySleepDocumentsV2UsercollectionDailySleepGetRequest {
    startDate?: Date;
    endDate?: Date;
...
export interface SingleDailySleepDocumentV2UsercollectionDailySleepDocumentIdGetRequest {
    documentId: string;
}
 ...
 * 
 */
export class DailySleepRoutesApi extends runtime.BaseAPI {

    /**
     * Multiple Daily Sleep Documents
     */
    async multipleDailySleepDocumentsV2UsercollectionDailySleepGetRaw(requestParameters: MultipleDailySleepDocumentsV2UsercollectionDailySleepGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MultiDocumentResponsePublicDailySleep>> {
        ...
        let urlPath = `/v2/usercollection/daily_sleep`;
     ...
     * Multiple Daily Sleep Documents
     */
    async multipleDailySleepDocumentsV2UsercollectionDailySleepGet(requestParameters: MultipleDailySleepDocumentsV2UsercollectionDailySleepGetRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MultiDocumentResponsePublicDailySleep> {
        const response = await this.multipleDailySleepDocumentsV2UsercollectionDailySleepGetRaw(requestParameters, initOverrides);
     ...
     */
    async singleDailySleepDocumentV2UsercollectionDailySleepDocumentIdGetRaw(requestParameters: SingleDailySleepDocumentV2UsercollectionDailySleepDocumentIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PublicDailySleep>> {
        if (requestParameters['documentId'] == null) {
            throw new runtime.RequiredError(
                'documentId',
                'Required parameter "documentId" was null or undefined when calling singleDailySleepDocumentV2UsercollectionDailySleepDocumentIdGet().'
            );
        }
        ...
        let urlPath = `/v2/usercollection/daily_sleep/{document_id}`;
     ...
     * Single Daily Sleep Document
     */
    async singleDailySleepDocumentV2UsercollectionDailySleepDocumentIdGet(requestParameters: SingleDailySleepDocumentV2UsercollectionDailySleepDocumentIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PublicDailySleep> {
        const response = await this.singleDailySleepDocumentV2UsercollectionDailySleepDocumentIdGetRaw(requestParameters, initOverrides);
        return await response.value();
    }
