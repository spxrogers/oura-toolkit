...
export interface MultipleDailyReadinessDocumentsV2UsercollectionDailyReadinessGetRequest {
    startDate?: Date;
    endDate?: Date;
...
export interface SingleDailyReadinessDocumentV2UsercollectionDailyReadinessDocumentIdGetRequest {
    documentId: string;
}
 ...
 * 
 */
export class DailyReadinessRoutesApi extends runtime.BaseAPI {

    /**
     * Multiple Daily Readiness Documents
     */
    async multipleDailyReadinessDocumentsV2UsercollectionDailyReadinessGetRaw(requestParameters: MultipleDailyReadinessDocumentsV2UsercollectionDailyReadinessGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MultiDocumentResponsePublicDailyReadiness>> {
        ...
        let urlPath = `/v2/usercollection/daily_readiness`;
     ...
     * Multiple Daily Readiness Documents
     */
    async multipleDailyReadinessDocumentsV2UsercollectionDailyReadinessGet(requestParameters: MultipleDailyReadinessDocumentsV2UsercollectionDailyReadinessGetRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MultiDocumentResponsePublicDailyReadiness> {
        const response = await this.multipleDailyReadinessDocumentsV2UsercollectionDailyReadinessGetRaw(requestParameters, initOverrides);
     ...
     */
    async singleDailyReadinessDocumentV2UsercollectionDailyReadinessDocumentIdGetRaw(requestParameters: SingleDailyReadinessDocumentV2UsercollectionDailyReadinessDocumentIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PublicDailyReadiness>> {
        if (requestParameters['documentId'] == null) {
            throw new runtime.RequiredError(
                'documentId',
                'Required parameter "documentId" was null or undefined when calling singleDailyReadinessDocumentV2UsercollectionDailyReadinessDocumentIdGet().'
            );
        }
        ...
        let urlPath = `/v2/usercollection/daily_readiness/{document_id}`;
     ...
     * Single Daily Readiness Document
     */
    async singleDailyReadinessDocumentV2UsercollectionDailyReadinessDocumentIdGet(requestParameters: SingleDailyReadinessDocumentV2UsercollectionDailyReadinessDocumentIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PublicDailyReadiness> {
        const response = await this.singleDailyReadinessDocumentV2UsercollectionDailyReadinessDocumentIdGetRaw(requestParameters, initOverrides);
        return await response.value();
    }
