...
export interface MultipleDailyCardiovascularAgeDocumentsV2UsercollectionDailyCardiovascularAgeGetRequest {
    startDate?: Date;
    endDate?: Date;
...
export interface SingleDailyCardiovascularAgeDocumentV2UsercollectionDailyCardiovascularAgeDocumentIdGetRequest {
    documentId: string;
}
 ...
 * 
 */
export class DailyCardiovascularAgeRoutesApi extends runtime.BaseAPI {

    /**
     * Multiple Daily Cardiovascular Age Documents
     */
    async multipleDailyCardiovascularAgeDocumentsV2UsercollectionDailyCardiovascularAgeGetRaw(requestParameters: MultipleDailyCardiovascularAgeDocumentsV2UsercollectionDailyCardiovascularAgeGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MultiDocumentResponsePublicDailyCardiovascularAge>> {
        ...
        let urlPath = `/v2/usercollection/daily_cardiovascular_age`;
     ...
     * Multiple Daily Cardiovascular Age Documents
     */
    async multipleDailyCardiovascularAgeDocumentsV2UsercollectionDailyCardiovascularAgeGet(requestParameters: MultipleDailyCardiovascularAgeDocumentsV2UsercollectionDailyCardiovascularAgeGetRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MultiDocumentResponsePublicDailyCardiovascularAge> {
        const response = await this.multipleDailyCardiovascularAgeDocumentsV2UsercollectionDailyCardiovascularAgeGetRaw(requestParameters, initOverrides);
     ...
     */
    async singleDailyCardiovascularAgeDocumentV2UsercollectionDailyCardiovascularAgeDocumentIdGetRaw(requestParameters: SingleDailyCardiovascularAgeDocumentV2UsercollectionDailyCardiovascularAgeDocumentIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PublicDailyCardiovascularAge>> {
        if (requestParameters['documentId'] == null) {
            throw new runtime.RequiredError(
                'documentId',
                'Required parameter "documentId" was null or undefined when calling singleDailyCardiovascularAgeDocumentV2UsercollectionDailyCardiovascularAgeDocumentIdGet().'
            );
        }
        ...
        let urlPath = `/v2/usercollection/daily_cardiovascular_age/{document_id}`;
     ...
     * Single Daily Cardiovascular Age Document
     */
    async singleDailyCardiovascularAgeDocumentV2UsercollectionDailyCardiovascularAgeDocumentIdGet(requestParameters: SingleDailyCardiovascularAgeDocumentV2UsercollectionDailyCardiovascularAgeDocumentIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PublicDailyCardiovascularAge> {
        const response = await this.singleDailyCardiovascularAgeDocumentV2UsercollectionDailyCardiovascularAgeDocumentIdGetRaw(requestParameters, initOverrides);
        return await response.value();
    }
