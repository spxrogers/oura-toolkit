...
export interface MultipleRestModePeriodDocumentsV2UsercollectionRestModePeriodGetRequest {
    startDate?: Date;
    endDate?: Date;
...
export interface SingleRestModePeriodDocumentV2UsercollectionRestModePeriodDocumentIdGetRequest {
    documentId: string;
}
 ...
 * 
 */
export class RestModePeriodRoutesApi extends runtime.BaseAPI {

    /**
     * Multiple Rest Mode Period Documents
     */
    async multipleRestModePeriodDocumentsV2UsercollectionRestModePeriodGetRaw(requestParameters: MultipleRestModePeriodDocumentsV2UsercollectionRestModePeriodGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MultiDocumentResponsePublicRestModePeriod>> {
        ...
        let urlPath = `/v2/usercollection/rest_mode_period`;
     ...
     * Multiple Rest Mode Period Documents
     */
    async multipleRestModePeriodDocumentsV2UsercollectionRestModePeriodGet(requestParameters: MultipleRestModePeriodDocumentsV2UsercollectionRestModePeriodGetRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MultiDocumentResponsePublicRestModePeriod> {
        const response = await this.multipleRestModePeriodDocumentsV2UsercollectionRestModePeriodGetRaw(requestParameters, initOverrides);
     ...
     */
    async singleRestModePeriodDocumentV2UsercollectionRestModePeriodDocumentIdGetRaw(requestParameters: SingleRestModePeriodDocumentV2UsercollectionRestModePeriodDocumentIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PublicRestModePeriod>> {
        if (requestParameters['documentId'] == null) {
            throw new runtime.RequiredError(
                'documentId',
                'Required parameter "documentId" was null or undefined when calling singleRestModePeriodDocumentV2UsercollectionRestModePeriodDocumentIdGet().'
            );
        }
        ...
        let urlPath = `/v2/usercollection/rest_mode_period/{document_id}`;
     ...
     * Single Rest Mode Period Document
     */
    async singleRestModePeriodDocumentV2UsercollectionRestModePeriodDocumentIdGet(requestParameters: SingleRestModePeriodDocumentV2UsercollectionRestModePeriodDocumentIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PublicRestModePeriod> {
        const response = await this.singleRestModePeriodDocumentV2UsercollectionRestModePeriodDocumentIdGetRaw(requestParameters, initOverrides);
        return await response.value();
    }
