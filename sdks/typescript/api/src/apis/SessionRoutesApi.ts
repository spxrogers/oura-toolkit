...
export interface MultipleSessionDocumentsV2UsercollectionSessionGetRequest {
    startDate?: Date;
    endDate?: Date;
...
export interface SingleSessionDocumentV2UsercollectionSessionDocumentIdGetRequest {
    documentId: string;
}
 ...
 * 
 */
export class SessionRoutesApi extends runtime.BaseAPI {

    /**
     * Multiple Session Documents
     */
    async multipleSessionDocumentsV2UsercollectionSessionGetRaw(requestParameters: MultipleSessionDocumentsV2UsercollectionSessionGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MultiDocumentResponsePublicSession>> {
        ...
        let urlPath = `/v2/usercollection/session`;
     ...
     * Multiple Session Documents
     */
    async multipleSessionDocumentsV2UsercollectionSessionGet(requestParameters: MultipleSessionDocumentsV2UsercollectionSessionGetRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MultiDocumentResponsePublicSession> {
        const response = await this.multipleSessionDocumentsV2UsercollectionSessionGetRaw(requestParameters, initOverrides);
     ...
     */
    async singleSessionDocumentV2UsercollectionSessionDocumentIdGetRaw(requestParameters: SingleSessionDocumentV2UsercollectionSessionDocumentIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PublicSession>> {
        if (requestParameters['documentId'] == null) {
            throw new runtime.RequiredError(
                'documentId',
                'Required parameter "documentId" was null or undefined when calling singleSessionDocumentV2UsercollectionSessionDocumentIdGet().'
            );
        }
        ...
        let urlPath = `/v2/usercollection/session/{document_id}`;
     ...
     * Single Session Document
     */
    async singleSessionDocumentV2UsercollectionSessionDocumentIdGet(requestParameters: SingleSessionDocumentV2UsercollectionSessionDocumentIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PublicSession> {
        const response = await this.singleSessionDocumentV2UsercollectionSessionDocumentIdGetRaw(requestParameters, initOverrides);
        return await response.value();
    }
