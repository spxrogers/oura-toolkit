...
export interface MultipleWorkoutDocumentsV2UsercollectionWorkoutGetRequest {
    startDate?: Date;
    endDate?: Date;
...
export interface SingleWorkoutDocumentV2UsercollectionWorkoutDocumentIdGetRequest {
    documentId: string;
}
 ...
 * 
 */
export class WorkoutRoutesApi extends runtime.BaseAPI {

    /**
     * Multiple Workout Documents
     */
    async multipleWorkoutDocumentsV2UsercollectionWorkoutGetRaw(requestParameters: MultipleWorkoutDocumentsV2UsercollectionWorkoutGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MultiDocumentResponsePublicWorkout>> {
        ...
        let urlPath = `/v2/usercollection/workout`;
     ...
     * Multiple Workout Documents
     */
    async multipleWorkoutDocumentsV2UsercollectionWorkoutGet(requestParameters: MultipleWorkoutDocumentsV2UsercollectionWorkoutGetRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MultiDocumentResponsePublicWorkout> {
        const response = await this.multipleWorkoutDocumentsV2UsercollectionWorkoutGetRaw(requestParameters, initOverrides);
     ...
     */
    async singleWorkoutDocumentV2UsercollectionWorkoutDocumentIdGetRaw(requestParameters: SingleWorkoutDocumentV2UsercollectionWorkoutDocumentIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PublicWorkout>> {
        if (requestParameters['documentId'] == null) {
            throw new runtime.RequiredError(
                'documentId',
                'Required parameter "documentId" was null or undefined when calling singleWorkoutDocumentV2UsercollectionWorkoutDocumentIdGet().'
            );
        }
        ...
        let urlPath = `/v2/usercollection/workout/{document_id}`;
     ...
     * Single Workout Document
     */
    async singleWorkoutDocumentV2UsercollectionWorkoutDocumentIdGet(requestParameters: SingleWorkoutDocumentV2UsercollectionWorkoutDocumentIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PublicWorkout> {
        const response = await this.singleWorkoutDocumentV2UsercollectionWorkoutDocumentIdGetRaw(requestParameters, initOverrides);
        return await response.value();
    }
