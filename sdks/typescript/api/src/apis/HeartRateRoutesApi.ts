...
import {
    ...
    ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGetFromJSON,
    ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGetToJSON,
} from '../models/index';

export interface MultipleHeartrateDocumentsV2UsercollectionHeartrateGetRequest {
 ...
 * 
 */
export class HeartRateRoutesApi extends runtime.BaseAPI {

    /**
     * Multiple Heartrate Documents
     */
    async multipleHeartrateDocumentsV2UsercollectionHeartrateGetRaw(requestParameters: MultipleHeartrateDocumentsV2UsercollectionHeartrateGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet>> {
        ...
        let urlPath = `/v2/usercollection/heartrate`;
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGetFromJSON(jsonValue));
    }

    /**
     * Multiple Heartrate Documents
     */
    async multipleHeartrateDocumentsV2UsercollectionHeartrateGet(requestParameters: MultipleHeartrateDocumentsV2UsercollectionHeartrateGetRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet> {
        const response = await this.multipleHeartrateDocumentsV2UsercollectionHeartrateGetRaw(requestParameters, initOverrides);
