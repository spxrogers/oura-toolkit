...
export interface MultipleSleepDocumentsV2UsercollectionSleepGetRequest {
    startDate?: Date;
    endDate?: Date;
...
export interface SingleSleepDocumentV2UsercollectionSleepDocumentIdGetRequest {
    documentId: string;
}
 ...
 * 
 */
export class SleepRoutesApi extends runtime.BaseAPI {

    /**
     * Multiple Sleep Documents
     */
    async multipleSleepDocumentsV2UsercollectionSleepGetRaw(requestParameters: MultipleSleepDocumentsV2UsercollectionSleepGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MultiDocumentResponsePublicModifiedSleepModel>> {
        ...
        let urlPath = `/v2/usercollection/sleep`;
     ...
     * Multiple Sleep Documents
     */
    async multipleSleepDocumentsV2UsercollectionSleepGet(requestParameters: MultipleSleepDocumentsV2UsercollectionSleepGetRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MultiDocumentResponsePublicModifiedSleepModel> {
        const response = await this.multipleSleepDocumentsV2UsercollectionSleepGetRaw(requestParameters, initOverrides);
     ...
     */
    async singleSleepDocumentV2UsercollectionSleepDocumentIdGetRaw(requestParameters: SingleSleepDocumentV2UsercollectionSleepDocumentIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PublicModifiedSleepModel>> {
        if (requestParameters['documentId'] == null) {
            throw new runtime.RequiredError(
                'documentId',
                'Required parameter "documentId" was null or undefined when calling singleSleepDocumentV2UsercollectionSleepDocumentIdGet().'
            );
        }
        ...
        let urlPath = `/v2/usercollection/sleep/{document_id}`;
     ...
     * Single Sleep Document
     */
    async singleSleepDocumentV2UsercollectionSleepDocumentIdGet(requestParameters: SingleSleepDocumentV2UsercollectionSleepDocumentIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PublicModifiedSleepModel> {
        const response = await this.singleSleepDocumentV2UsercollectionSleepDocumentIdGetRaw(requestParameters, initOverrides);
        return await response.value();
    }
