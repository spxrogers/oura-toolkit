...
export interface MultipleDailySpo2DocumentsV2UsercollectionDailySpo2GetRequest {
    startDate?: Date;
    endDate?: Date;
...
export interface SingleDailySpo2DocumentV2UsercollectionDailySpo2DocumentIdGetRequest {
    documentId: string;
}
 ...
 * 
 */
export class DailySpo2RoutesApi extends runtime.BaseAPI {

    /**
     * Multiple Daily Spo2 Documents
     */
    async multipleDailySpo2DocumentsV2UsercollectionDailySpo2GetRaw(requestParameters: MultipleDailySpo2DocumentsV2UsercollectionDailySpo2GetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MultiDocumentResponsePublicDailySpO2>> {
        ...
        let urlPath = `/v2/usercollection/daily_spo2`;
     ...
     * Multiple Daily Spo2 Documents
     */
    async multipleDailySpo2DocumentsV2UsercollectionDailySpo2Get(requestParameters: MultipleDailySpo2DocumentsV2UsercollectionDailySpo2GetRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MultiDocumentResponsePublicDailySpO2> {
        const response = await this.multipleDailySpo2DocumentsV2UsercollectionDailySpo2GetRaw(requestParameters, initOverrides);
     ...
     */
    async singleDailySpo2DocumentV2UsercollectionDailySpo2DocumentIdGetRaw(requestParameters: SingleDailySpo2DocumentV2UsercollectionDailySpo2DocumentIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PublicDailySpO2>> {
        if (requestParameters['documentId'] == null) {
            throw new runtime.RequiredError(
                'documentId',
                'Required parameter "documentId" was null or undefined when calling singleDailySpo2DocumentV2UsercollectionDailySpo2DocumentIdGet().'
            );
        }
        ...
        let urlPath = `/v2/usercollection/daily_spo2/{document_id}`;
     ...
     * Single Daily Spo2 Document
     */
    async singleDailySpo2DocumentV2UsercollectionDailySpo2DocumentIdGet(requestParameters: SingleDailySpo2DocumentV2UsercollectionDailySpo2DocumentIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PublicDailySpO2> {
        const response = await this.singleDailySpo2DocumentV2UsercollectionDailySpo2DocumentIdGetRaw(requestParameters, initOverrides);
        return await response.value();
    }
