...
export interface MultipleTagDocumentsV2UsercollectionTagGetRequest {
    startDate?: Date;
    endDate?: Date;
...
export interface SingleTagDocumentV2UsercollectionTagDocumentIdGetRequest {
    documentId: string;
}
 ...
 * 
 */
export class TagRoutesApi extends runtime.BaseAPI {

    /**
     * Multiple Tag Documents
     */
    async multipleTagDocumentsV2UsercollectionTagGetRaw(requestParameters: MultipleTagDocumentsV2UsercollectionTagGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MultiDocumentResponseTagModel>> {
        ...
        let urlPath = `/v2/usercollection/tag`;
     ...
     * Multiple Tag Documents
     */
    async multipleTagDocumentsV2UsercollectionTagGet(requestParameters: MultipleTagDocumentsV2UsercollectionTagGetRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MultiDocumentResponseTagModel> {
        const response = await this.multipleTagDocumentsV2UsercollectionTagGetRaw(requestParameters, initOverrides);
     ...
     * Single Tag Document
     */
    async singleTagDocumentV2UsercollectionTagDocumentIdGetRaw(requestParameters: SingleTagDocumentV2UsercollectionTagDocumentIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<TagModel>> {
        if (requestParameters['documentId'] == null) {
            throw new runtime.RequiredError(
                'documentId',
                'Required parameter "documentId" was null or undefined when calling singleTagDocumentV2UsercollectionTagDocumentIdGet().'
            );
        }
        ...
        let urlPath = `/v2/usercollection/tag/{document_id}`;
     ...
     * Single Tag Document
     */
    async singleTagDocumentV2UsercollectionTagDocumentIdGet(requestParameters: SingleTagDocumentV2UsercollectionTagDocumentIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<TagModel> {
        const response = await this.singleTagDocumentV2UsercollectionTagDocumentIdGetRaw(requestParameters, initOverrides);
        return await response.value();
    }
