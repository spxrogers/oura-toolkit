...
export interface MultipleDailyActivityDocumentsV2UsercollectionDailyActivityGetRequest {
    startDate?: Date;
    endDate?: Date;
...
export interface SingleDailyActivityDocumentV2UsercollectionDailyActivityDocumentIdGetRequest {
    documentId: string;
}
 ...
 * 
 */
export class DailyActivityRoutesApi extends runtime.BaseAPI {

    /**
     * Multiple Daily Activity Documents
     */
    async multipleDailyActivityDocumentsV2UsercollectionDailyActivityGetRaw(requestParameters: MultipleDailyActivityDocumentsV2UsercollectionDailyActivityGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MultiDocumentResponsePublicDailyActivity>> {
        ...
        let urlPath = `/v2/usercollection/daily_activity`;
     ...
     * Multiple Daily Activity Documents
     */
    async multipleDailyActivityDocumentsV2UsercollectionDailyActivityGet(requestParameters: MultipleDailyActivityDocumentsV2UsercollectionDailyActivityGetRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MultiDocumentResponsePublicDailyActivity> {
        const response = await this.multipleDailyActivityDocumentsV2UsercollectionDailyActivityGetRaw(requestParameters, initOverrides);
     ...
     */
    async singleDailyActivityDocumentV2UsercollectionDailyActivityDocumentIdGetRaw(requestParameters: SingleDailyActivityDocumentV2UsercollectionDailyActivityDocumentIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PublicDailyActivity>> {
        if (requestParameters['documentId'] == null) {
            throw new runtime.RequiredError(
                'documentId',
                'Required parameter "documentId" was null or undefined when calling singleDailyActivityDocumentV2UsercollectionDailyActivityDocumentIdGet().'
            );
        }
        ...
        let urlPath = `/v2/usercollection/daily_activity/{document_id}`;
     ...
     * Single Daily Activity Document
     */
    async singleDailyActivityDocumentV2UsercollectionDailyActivityDocumentIdGet(requestParameters: SingleDailyActivityDocumentV2UsercollectionDailyActivityDocumentIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PublicDailyActivity> {
        const response = await this.singleDailyActivityDocumentV2UsercollectionDailyActivityDocumentIdGetRaw(requestParameters, initOverrides);
        return await response.value();
    }
