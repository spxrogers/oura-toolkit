...
export interface MultipleDailyStressDocumentsV2UsercollectionDailyStressGetRequest {
    startDate?: Date;
    endDate?: Date;
...
export interface SingleDailyStressDocumentV2UsercollectionDailyStressDocumentIdGetRequest {
    documentId: string;
}
 ...
 * 
 */
export class DailyStressRoutesApi extends runtime.BaseAPI {

    /**
     * Multiple Daily Stress Documents
     */
    async multipleDailyStressDocumentsV2UsercollectionDailyStressGetRaw(requestParameters: MultipleDailyStressDocumentsV2UsercollectionDailyStressGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MultiDocumentResponsePublicDailyStress>> {
        ...
        let urlPath = `/v2/usercollection/daily_stress`;
     ...
     * Multiple Daily Stress Documents
     */
    async multipleDailyStressDocumentsV2UsercollectionDailyStressGet(requestParameters: MultipleDailyStressDocumentsV2UsercollectionDailyStressGetRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MultiDocumentResponsePublicDailyStress> {
        const response = await this.multipleDailyStressDocumentsV2UsercollectionDailyStressGetRaw(requestParameters, initOverrides);
     ...
     */
    async singleDailyStressDocumentV2UsercollectionDailyStressDocumentIdGetRaw(requestParameters: SingleDailyStressDocumentV2UsercollectionDailyStressDocumentIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PublicDailyStress>> {
        if (requestParameters['documentId'] == null) {
            throw new runtime.RequiredError(
                'documentId',
                'Required parameter "documentId" was null or undefined when calling singleDailyStressDocumentV2UsercollectionDailyStressDocumentIdGet().'
            );
        }
        ...
        let urlPath = `/v2/usercollection/daily_stress/{document_id}`;
     ...
     * Single Daily Stress Document
     */
    async singleDailyStressDocumentV2UsercollectionDailyStressDocumentIdGet(requestParameters: SingleDailyStressDocumentV2UsercollectionDailyStressDocumentIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PublicDailyStress> {
        const response = await this.singleDailyStressDocumentV2UsercollectionDailyStressDocumentIdGetRaw(requestParameters, initOverrides);
        return await response.value();
    }
