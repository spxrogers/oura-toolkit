...
export interface MultipleEnhancedTagDocumentsV2UsercollectionEnhancedTagGetRequest {
    startDate?: Date;
    endDate?: Date;
...
export interface SingleEnhancedTagDocumentV2UsercollectionEnhancedTagDocumentIdGetRequest {
    documentId: string;
}
 ...
 * 
 */
export class EnhancedTagRoutesApi extends runtime.BaseAPI {

    /**
     * Multiple Enhanced Tag Documents
     */
    async multipleEnhancedTagDocumentsV2UsercollectionEnhancedTagGetRaw(requestParameters: MultipleEnhancedTagDocumentsV2UsercollectionEnhancedTagGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MultiDocumentResponseEnhancedTagModel>> {
        ...
        let urlPath = `/v2/usercollection/enhanced_tag`;
     ...
     * Multiple Enhanced Tag Documents
     */
    async multipleEnhancedTagDocumentsV2UsercollectionEnhancedTagGet(requestParameters: MultipleEnhancedTagDocumentsV2UsercollectionEnhancedTagGetRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MultiDocumentResponseEnhancedTagModel> {
        const response = await this.multipleEnhancedTagDocumentsV2UsercollectionEnhancedTagGetRaw(requestParameters, initOverrides);
     ...
     */
    async singleEnhancedTagDocumentV2UsercollectionEnhancedTagDocumentIdGetRaw(requestParameters: SingleEnhancedTagDocumentV2UsercollectionEnhancedTagDocumentIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<EnhancedTagModel>> {
        if (requestParameters['documentId'] == null) {
            throw new runtime.RequiredError(
                'documentId',
                'Required parameter "documentId" was null or undefined when calling singleEnhancedTagDocumentV2UsercollectionEnhancedTagDocumentIdGet().'
            );
        }
        ...
        let urlPath = `/v2/usercollection/enhanced_tag/{document_id}`;
     ...
     * Single Enhanced Tag Document
     */
    async singleEnhancedTagDocumentV2UsercollectionEnhancedTagDocumentIdGet(requestParameters: SingleEnhancedTagDocumentV2UsercollectionEnhancedTagDocumentIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<EnhancedTagModel> {
        const response = await this.singleEnhancedTagDocumentV2UsercollectionEnhancedTagDocumentIdGetRaw(requestParameters, initOverrides);
        return await response.value();
    }
