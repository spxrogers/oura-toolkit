...
import {
    ...
    ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGetFromJSON,
    ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGetToJSON,
} from '../models/index';

export interface MultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGetRequest {
 ...
 * 
 */
export class RingBatteryLevelRoutesApi extends runtime.BaseAPI {

    /**
     * Multiple Ring Battery Level Documents
     */
    async multipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGetRaw(requestParameters: MultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet>> {
        ...
        let urlPath = `/v2/usercollection/ring_battery_level`;
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGetFromJSON(jsonValue));
    }

    /**
     * Multiple Ring Battery Level Documents
     */
    async multipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet(requestParameters: MultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGetRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet> {
        const response = await this.multipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGetRaw(requestParameters, initOverrides);
