...
export interface MultipleDailyResilienceDocumentsV2UsercollectionDailyResilienceGetRequest {
    startDate?: Date;
    endDate?: Date;
...
export interface SingleDailyResilienceDocumentV2UsercollectionDailyResilienceDocumentIdGetRequest {
    documentId: string;
}
 ...
 * 
 */
export class DailyResilienceRoutesApi extends runtime.BaseAPI {

    /**
     * Multiple Daily Resilience Documents
     */
    async multipleDailyResilienceDocumentsV2UsercollectionDailyResilienceGetRaw(requestParameters: MultipleDailyResilienceDocumentsV2UsercollectionDailyResilienceGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MultiDocumentResponseDailyResilienceModel>> {
        ...
        let urlPath = `/v2/usercollection/daily_resilience`;
     ...
     * Multiple Daily Resilience Documents
     */
    async multipleDailyResilienceDocumentsV2UsercollectionDailyResilienceGet(requestParameters: MultipleDailyResilienceDocumentsV2UsercollectionDailyResilienceGetRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MultiDocumentResponseDailyResilienceModel> {
        const response = await this.multipleDailyResilienceDocumentsV2UsercollectionDailyResilienceGetRaw(requestParameters, initOverrides);
     ...
     */
    async singleDailyResilienceDocumentV2UsercollectionDailyResilienceDocumentIdGetRaw(requestParameters: SingleDailyResilienceDocumentV2UsercollectionDailyResilienceDocumentIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DailyResilienceModel>> {
        if (requestParameters['documentId'] == null) {
            throw new runtime.RequiredError(
                'documentId',
                'Required parameter "documentId" was null or undefined when calling singleDailyResilienceDocumentV2UsercollectionDailyResilienceDocumentIdGet().'
            );
        }
        ...
        let urlPath = `/v2/usercollection/daily_resilience/{document_id}`;
     ...
     * Single Daily Resilience Document
     */
    async singleDailyResilienceDocumentV2UsercollectionDailyResilienceDocumentIdGet(requestParameters: SingleDailyResilienceDocumentV2UsercollectionDailyResilienceDocumentIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DailyResilienceModel> {
        const response = await this.singleDailyResilienceDocumentV2UsercollectionDailyResilienceDocumentIdGetRaw(requestParameters, initOverrides);
        return await response.value();
    }
