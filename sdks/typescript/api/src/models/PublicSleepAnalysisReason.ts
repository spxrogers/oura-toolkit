 ...
 * @export
 */
export const PublicSleepAnalysisReason = {
    ForegroundSleepAnalysis: 'foreground_sleep_analysis',
    BedtimeEdit: 'bedtime_edit',
    BackgroundSleepAnalysis: 'background_sleep_analysis',
    BackgroundCreatedForegroundUpdated: 'background_created_foreground_updated'
} as const;
export type PublicSleepAnalysisReason = typeof PublicSleepAnalysisReason[keyof typeof PublicSleepAnalysisReason];


export function instanceOfPublicSleepAnalysisReason(value: any): boolean {
    for (const key in PublicSleepAnalysisReason) {
        if (Object.prototype.hasOwnProperty.call(PublicSleepAnalysisReason, key)) {
            if (PublicSleepAnalysisReason[key as keyof typeof PublicSleepAnalysisReason] === value) {
                return true;
            }
        }
    }
...
export function PublicSleepAnalysisReasonFromJSON(json: any): PublicSleepAnalysisReason {
    return PublicSleepAnalysisReasonFromJSONTyped(json, false);
}

export function PublicSleepAnalysisReasonFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicSleepAnalysisReason {
    return json as PublicSleepAnalysisReason;
}

export function PublicSleepAnalysisReasonToJSON(value?: PublicSleepAnalysisReason | null): any {
    return value as any;
}

export function PublicSleepAnalysisReasonToJSONTyped(value: any, ignoreDiscriminator: boolean): PublicSleepAnalysisReason {
    return value as PublicSleepAnalysisReason;
}
