...
import type { PublicWorkout } from './PublicWorkout';
import {
    PublicWorkoutFromJSON,
    PublicWorkoutFromJSONTyped,
    PublicWorkoutToJSON,
    PublicWorkoutToJSONTyped,
} from './PublicWorkout';

/**
 * 
 * @export
 * @interface MultiDocumentResponsePublicWorkout
 */
export interface MultiDocumentResponsePublicWorkout {
    /**
     * 
     * @type {Array<PublicWorkout>}
     * @memberof MultiDocumentResponsePublicWorkout
     */
    data: Array<PublicWorkout>;
    /**
     * 
     * @type {string}
     * @memberof MultiDocumentResponsePublicWorkout
...
/**
 * Check if a given object implements the MultiDocumentResponsePublicWorkout interface.
 */
export function instanceOfMultiDocumentResponsePublicWorkout(value: object): value is MultiDocumentResponsePublicWorkout {
    if (!('data' in value) || value['data'] === undefined) return false;
    if (!('nextToken' in value) || value['nextToken'] === undefined) return false;
    return true;
}

export function MultiDocumentResponsePublicWorkoutFromJSON(json: any): MultiDocumentResponsePublicWorkout {
    return MultiDocumentResponsePublicWorkoutFromJSONTyped(json, false);
}

export function MultiDocumentResponsePublicWorkoutFromJSONTyped(json: any, ignoreDiscriminator: boolean): MultiDocumentResponsePublicWorkout {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(PublicWorkoutFromJSON)),
        'nextToken': json['next_token'],
    };
}

export function MultiDocumentResponsePublicWorkoutToJSON(json: any): MultiDocumentResponsePublicWorkout {
    return MultiDocumentResponsePublicWorkoutToJSONTyped(json, false);
}

export function MultiDocumentResponsePublicWorkoutToJSONTyped(value?: MultiDocumentResponsePublicWorkout | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ((value['data'] as Array<any>).map(PublicWorkoutToJSON)),
