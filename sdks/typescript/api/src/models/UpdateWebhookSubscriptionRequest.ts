...
import type { ExtApiV2DataType } from './ExtApiV2DataType';
import {
    ExtApiV2DataTypeFromJSON,
    ExtApiV2DataTypeFromJSONTyped,
    ExtApiV2DataTypeToJSON,
    ExtApiV2DataTypeToJSONTyped,
} from './ExtApiV2DataType';
import type { WebhookOperation } from './WebhookOperation';
import {
    WebhookOperationFromJSON,
    WebhookOperationFromJSONTyped,
    WebhookOperationToJSON,
    WebhookOperationToJSONTyped,
} from './WebhookOperation';
...
export interface UpdateWebhookSubscriptionRequest {
     ...
     * @memberof UpdateWebhookSubscriptionRequest
     */
    eventType?: WebhookOperation | null;
    /**
     * 
     * @type {ExtApiV2DataType}
     * @memberof UpdateWebhookSubscriptionRequest
     */
    dataType?: ExtApiV2DataType | null;
}



/**
 * Check if a given object implements the UpdateWebhookSubscriptionRequest interface.
 */
export function instanceOfUpdateWebhookSubscriptionRequest(value: object): value is UpdateWebhookSubscriptionRequest {
    if (!('verificationToken' in value) || value['verificationToken'] === undefined) return false;
    return true;
}

export function UpdateWebhookSubscriptionRequestFromJSON(json: any): UpdateWebhookSubscriptionRequest {
    return UpdateWebhookSubscriptionRequestFromJSONTyped(json, false);
}

export function UpdateWebhookSubscriptionRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateWebhookSubscriptionRequest {
    if (json == null) {
        return json;
    }
    return {
        ...
        'eventType': json['event_type'] == null ? undefined : WebhookOperationFromJSON(json['event_type']),
        'dataType': json['data_type'] == null ? undefined : ExtApiV2DataTypeFromJSON(json['data_type']),
    };
}

export function UpdateWebhookSubscriptionRequestToJSON(json: any): UpdateWebhookSubscriptionRequest {
    return UpdateWebhookSubscriptionRequestToJSONTyped(json, false);
}

export function UpdateWebhookSubscriptionRequestToJSONTyped(value?: UpdateWebhookSubscriptionRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'event_type': WebhookOperationToJSON(value['eventType']),
        'data_type': ExtApiV2DataTypeToJSON(value['dataType']),
    };
}
