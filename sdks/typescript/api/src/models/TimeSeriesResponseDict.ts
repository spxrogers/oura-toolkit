 ...
 * 
 * @export
 * @interface TimeSeriesResponseDict
 */
export interface TimeSeriesResponseDict {
    /**
     * 
     * @type {Array<{ [key: string]: any; }>}
     * @memberof TimeSeriesResponseDict
     */
...
/**
 * Check if a given object implements the TimeSeriesResponseDict interface.
 */
export function instanceOfTimeSeriesResponseDict(value: object): value is TimeSeriesResponseDict {
    if (!('data' in value) || value['data'] === undefined) return false;
    return true;
}

export function TimeSeriesResponseDictFromJSON(json: any): TimeSeriesResponseDict {
    return TimeSeriesResponseDictFromJSONTyped(json, false);
}

export function TimeSeriesResponseDictFromJSONTyped(json: any, ignoreDiscriminator: boolean): TimeSeriesResponseDict {
    if (json == null) {
        return json;
    }
    return {
...
export function TimeSeriesResponseDictToJSON(json: any): TimeSeriesResponseDict {
    return TimeSeriesResponseDictToJSONTyped(json, false);
}

export function TimeSeriesResponseDictToJSONTyped(value?: TimeSeriesResponseDict | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
