...
import type { PublicMomentType } from './PublicMomentType';
import {
    PublicMomentTypeFromJSON,
    PublicMomentTypeFromJSONTyped,
    PublicMomentTypeToJSON,
    PublicMomentTypeToJSONTyped,
} from './PublicMomentType';
...
import type { PublicMomentMood } from './PublicMomentMood';
import {
    PublicMomentMoodFromJSON,
    PublicMomentMoodFromJSONTyped,
    PublicMomentMoodToJSON,
    PublicMomentMoodToJSONTyped,
} from './PublicMomentMood';
...
export interface PublicSession {
     ...
     * @memberof PublicSession
     */
    heartRateVariability?: PublicSample | null;
    /**
     * 
     * @type {PublicMomentMood}
     * @memberof PublicSession
     */
...
/**
 * Check if a given object implements the PublicSession interface.
 */
export function instanceOfPublicSession(value: object): value is PublicSession {
...
export function PublicSessionFromJSON(json: any): PublicSession {
    return PublicSessionFromJSONTyped(json, false);
}

export function PublicSessionFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicSession {
    if (json == null) {
        return json;
    }
    return {
        ...
        'heartRateVariability': json['heart_rate_variability'] == null ? undefined : PublicSampleFromJSON(json['heart_rate_variability']),
        'mood': json['mood'] == null ? undefined : PublicMomentMoodFromJSON(json['mood']),
        'motionCount': json['motion_count'] == null ? undefined : PublicSampleFromJSON(json['motion_count']),
        'startDatetime': json['start_datetime'],
        'type': PublicMomentTypeFromJSON(json['type']),
    };
}

export function PublicSessionToJSON(json: any): PublicSession {
    return PublicSessionToJSONTyped(json, false);
}

export function PublicSessionToJSONTyped(value?: PublicSession | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'heart_rate_variability': PublicSampleToJSON(value['heartRateVariability']),
        'mood': PublicMomentMoodToJSON(value['mood']),
        'motion_count': PublicSampleToJSON(value['motionCount']),
        'start_datetime': value['startDatetime'],
        'type': PublicMomentTypeToJSON(value['type']),
    };
}
