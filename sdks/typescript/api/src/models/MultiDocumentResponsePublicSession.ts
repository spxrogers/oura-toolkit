...
import type { PublicSession } from './PublicSession';
import {
    PublicSessionFromJSON,
    PublicSessionFromJSONTyped,
    PublicSessionToJSON,
    PublicSessionToJSONTyped,
} from './PublicSession';

/**
 * 
 * @export
 * @interface MultiDocumentResponsePublicSession
 */
export interface MultiDocumentResponsePublicSession {
    /**
     * 
     * @type {Array<PublicSession>}
     * @memberof MultiDocumentResponsePublicSession
     */
    data: Array<PublicSession>;
    /**
     * 
     * @type {string}
     * @memberof MultiDocumentResponsePublicSession
...
/**
 * Check if a given object implements the MultiDocumentResponsePublicSession interface.
 */
export function instanceOfMultiDocumentResponsePublicSession(value: object): value is MultiDocumentResponsePublicSession {
    if (!('data' in value) || value['data'] === undefined) return false;
    if (!('nextToken' in value) || value['nextToken'] === undefined) return false;
    return true;
}

export function MultiDocumentResponsePublicSessionFromJSON(json: any): MultiDocumentResponsePublicSession {
    return MultiDocumentResponsePublicSessionFromJSONTyped(json, false);
}

export function MultiDocumentResponsePublicSessionFromJSONTyped(json: any, ignoreDiscriminator: boolean): MultiDocumentResponsePublicSession {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(PublicSessionFromJSON)),
        'nextToken': json['next_token'],
    };
}

export function MultiDocumentResponsePublicSessionToJSON(json: any): MultiDocumentResponsePublicSession {
    return MultiDocumentResponsePublicSessionToJSONTyped(json, false);
}

export function MultiDocumentResponsePublicSessionToJSONTyped(value?: MultiDocumentResponsePublicSession | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ((value['data'] as Array<any>).map(PublicSessionToJSON)),
