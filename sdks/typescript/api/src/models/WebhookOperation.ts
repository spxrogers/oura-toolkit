 ...
 * @export
 */
export const WebhookOperation = {
    Create: 'create',
    Update: 'update',
    Delete: 'delete'
} as const;
export type WebhookOperation = typeof WebhookOperation[keyof typeof WebhookOperation];


export function instanceOfWebhookOperation(value: any): boolean {
    for (const key in WebhookOperation) {
        if (Object.prototype.hasOwnProperty.call(WebhookOperation, key)) {
            if (WebhookOperation[key as keyof typeof WebhookOperation] === value) {
                return true;
            }
        }
    }
...
export function WebhookOperationFromJSON(json: any): WebhookOperation {
    return WebhookOperationFromJSONTyped(json, false);
}

export function WebhookOperationFromJSONTyped(json: any, ignoreDiscriminator: boolean): WebhookOperation {
    return json as WebhookOperation;
}

export function WebhookOperationToJSON(value?: WebhookOperation | null): any {
    return value as any;
}

export function WebhookOperationToJSONTyped(value: any, ignoreDiscriminator: boolean): WebhookOperation {
    return value as WebhookOperation;
}
