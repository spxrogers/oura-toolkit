 ...
 * 
 * @export
 * @interface MultiDocumentResponseTagModel
 */
export interface MultiDocumentResponseTagModel {
    /**
     * 
     * @type {Array<TagModel>}
     * @memberof MultiDocumentResponseTagModel
     */
    data: Array<TagModel>;
    /**
     * 
...
/**
 * Check if a given object implements the MultiDocumentResponseTagModel interface.
 */
export function instanceOfMultiDocumentResponseTagModel(value: object): value is MultiDocumentResponseTagModel {
    if (!('data' in value) || value['data'] === undefined) return false;
    if (!('nextToken' in value) || value['nextToken'] === undefined) return false;
    return true;
}

export function MultiDocumentResponseTagModelFromJSON(json: any): MultiDocumentResponseTagModel {
    return MultiDocumentResponseTagModelFromJSONTyped(json, false);
}

export function MultiDocumentResponseTagModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): MultiDocumentResponseTagModel {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(TagModelFromJSON)),
        'nextToken': json['next_token'],
    };
}

export function MultiDocumentResponseTagModelToJSON(json: any): MultiDocumentResponseTagModel {
    return MultiDocumentResponseTagModelToJSONTyped(json, false);
}

export function MultiDocumentResponseTagModelToJSONTyped(value?: MultiDocumentResponseTagModel | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ((value['data'] as Array<any>).map(TagModelToJSON)),
