 ...
 * @export
 */
export const PublicHeartRateSource = {
    Awake: 'awake',
    Workout: 'workout',
    Rest: 'rest',
    Sleep: 'sleep',
...
export type PublicHeartRateSource = typeof PublicHeartRateSource[keyof typeof PublicHeartRateSource];


export function instanceOfPublicHeartRateSource(value: any): boolean {
    for (const key in PublicHeartRateSource) {
        if (Object.prototype.hasOwnProperty.call(PublicHeartRateSource, key)) {
            if (PublicHeartRateSource[key as keyof typeof PublicHeartRateSource] === value) {
                return true;
            }
        }
    }
...
export function PublicHeartRateSourceFromJSON(json: any): PublicHeartRateSource {
    return PublicHeartRateSourceFromJSONTyped(json, false);
}

export function PublicHeartRateSourceFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicHeartRateSource {
    return json as PublicHeartRateSource;
}

export function PublicHeartRateSourceToJSON(value?: PublicHeartRateSource | null): any {
    return value as any;
}

export function PublicHeartRateSourceToJSONTyped(value: any, ignoreDiscriminator: boolean): PublicHeartRateSource {
    return value as PublicHeartRateSource;
}
