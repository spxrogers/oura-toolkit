...
export type PublicRingColor = typeof PublicRingColor[keyof typeof PublicRingColor];


export function instanceOfPublicRingColor(value: any): boolean {
    for (const key in PublicRingColor) {
        if (Object.prototype.hasOwnProperty.call(PublicRingColor, key)) {
            if (PublicRingColor[key as keyof typeof PublicRingColor] === value) {
                return true;
            }
        }
    }
...
export function PublicRingColorFromJSON(json: any): PublicRingColor {
    return PublicRingColorFromJSONTyped(json, false);
}

export function PublicRingColorFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicRingColor {
    return json as PublicRingColor;
}

export function PublicRingColorToJSON(value?: PublicRingColor | null): any {
    return value as any;
}

export function PublicRingColorToJSONTyped(value: any, ignoreDiscriminator: boolean): PublicRingColor {
    return value as PublicRingColor;
}
