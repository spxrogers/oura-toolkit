...
import type { PublicDailyReadiness } from './PublicDailyReadiness';
import {
    PublicDailyReadinessFromJSON,
    PublicDailyReadinessFromJSONTyped,
    PublicDailyReadinessToJSON,
    PublicDailyReadinessToJSONTyped,
} from './PublicDailyReadiness';

/**
 * 
 * @export
 * @interface MultiDocumentResponsePublicDailyReadiness
 */
export interface MultiDocumentResponsePublicDailyReadiness {
    /**
     * 
     * @type {Array<PublicDailyReadiness>}
     * @memberof MultiDocumentResponsePublicDailyReadiness
     */
    data: Array<PublicDailyReadiness>;
    /**
     * 
     * @type {string}
     * @memberof MultiDocumentResponsePublicDailyReadiness
...
/**
 * Check if a given object implements the MultiDocumentResponsePublicDailyReadiness interface.
 */
export function instanceOfMultiDocumentResponsePublicDailyReadiness(value: object): value is MultiDocumentResponsePublicDailyReadiness {
    if (!('data' in value) || value['data'] === undefined) return false;
    if (!('nextToken' in value) || value['nextToken'] === undefined) return false;
    return true;
}

export function MultiDocumentResponsePublicDailyReadinessFromJSON(json: any): MultiDocumentResponsePublicDailyReadiness {
    return MultiDocumentResponsePublicDailyReadinessFromJSONTyped(json, false);
}

export function MultiDocumentResponsePublicDailyReadinessFromJSONTyped(json: any, ignoreDiscriminator: boolean): MultiDocumentResponsePublicDailyReadiness {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(PublicDailyReadinessFromJSON)),
        'nextToken': json['next_token'],
    };
}

export function MultiDocumentResponsePublicDailyReadinessToJSON(json: any): MultiDocumentResponsePublicDailyReadiness {
    return MultiDocumentResponsePublicDailyReadinessToJSONTyped(json, false);
}

export function MultiDocumentResponsePublicDailyReadinessToJSONTyped(value?: MultiDocumentResponsePublicDailyReadiness | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ((value['data'] as Array<any>).map(PublicDailyReadinessToJSON)),
