...
export type PublicSleepType = typeof PublicSleepType[keyof typeof PublicSleepType];


export function instanceOfPublicSleepType(value: any): boolean {
    for (const key in PublicSleepType) {
        if (Object.prototype.hasOwnProperty.call(PublicSleepType, key)) {
            if (PublicSleepType[key as keyof typeof PublicSleepType] === value) {
                return true;
            }
        }
    }
...
export function PublicSleepTypeFromJSON(json: any): PublicSleepType {
    return PublicSleepTypeFromJSONTyped(json, false);
}

export function PublicSleepTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicSleepType {
    return json as PublicSleepType;
}

export function PublicSleepTypeToJSON(value?: PublicSleepType | null): any {
    return value as any;
}

export function PublicSleepTypeToJSONTyped(value: any, ignoreDiscriminator: boolean): PublicSleepType {
    return value as PublicSleepType;
}
