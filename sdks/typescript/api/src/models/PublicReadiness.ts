...
/**
 * Check if a given object implements the PublicReadiness interface.
 */
export function instanceOfPublicReadiness(value: object): value is PublicReadiness {
    if (!('contributors' in value) || value['contributors'] === undefined) return false;
    return true;
}

export function PublicReadinessFromJSON(json: any): PublicReadiness {
    return PublicReadinessFromJSONTyped(json, false);
}

export function PublicReadinessFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicReadiness {
    if (json == null) {
        return json;
    }
    return {
...
export function PublicReadinessToJSON(json: any): PublicReadiness {
    return PublicReadinessToJSONTyped(json, false);
}

export function PublicReadinessToJSONTyped(value?: PublicReadiness | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
