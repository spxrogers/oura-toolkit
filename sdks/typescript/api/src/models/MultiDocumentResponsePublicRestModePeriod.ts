...
import type { PublicRestModePeriod } from './PublicRestModePeriod';
import {
    PublicRestModePeriodFromJSON,
    PublicRestModePeriodFromJSONTyped,
    PublicRestModePeriodToJSON,
    PublicRestModePeriodToJSONTyped,
} from './PublicRestModePeriod';

/**
 * 
 * @export
 * @interface MultiDocumentResponsePublicRestModePeriod
 */
export interface MultiDocumentResponsePublicRestModePeriod {
    /**
     * 
     * @type {Array<PublicRestModePeriod>}
     * @memberof MultiDocumentResponsePublicRestModePeriod
     */
    data: Array<PublicRestModePeriod>;
    /**
     * 
     * @type {string}
     * @memberof MultiDocumentResponsePublicRestModePeriod
...
/**
 * Check if a given object implements the MultiDocumentResponsePublicRestModePeriod interface.
 */
export function instanceOfMultiDocumentResponsePublicRestModePeriod(value: object): value is MultiDocumentResponsePublicRestModePeriod {
    if (!('data' in value) || value['data'] === undefined) return false;
    if (!('nextToken' in value) || value['nextToken'] === undefined) return false;
    return true;
}

export function MultiDocumentResponsePublicRestModePeriodFromJSON(json: any): MultiDocumentResponsePublicRestModePeriod {
    return MultiDocumentResponsePublicRestModePeriodFromJSONTyped(json, false);
}

export function MultiDocumentResponsePublicRestModePeriodFromJSONTyped(json: any, ignoreDiscriminator: boolean): MultiDocumentResponsePublicRestModePeriod {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(PublicRestModePeriodFromJSON)),
        'nextToken': json['next_token'],
    };
}

export function MultiDocumentResponsePublicRestModePeriodToJSON(json: any): MultiDocumentResponsePublicRestModePeriod {
    return MultiDocumentResponsePublicRestModePeriodToJSONTyped(json, false);
}

export function MultiDocumentResponsePublicRestModePeriodToJSONTyped(value?: MultiDocumentResponsePublicRestModePeriod | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ((value['data'] as Array<any>).map(PublicRestModePeriodToJSON)),
