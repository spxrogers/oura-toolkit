...
import type { LongTermResilienceLevel } from './LongTermResilienceLevel';
import {
    LongTermResilienceLevelFromJSON,
    LongTermResilienceLevelFromJSONTyped,
    LongTermResilienceLevelToJSON,
    LongTermResilienceLevelToJSONTyped,
} from './LongTermResilienceLevel';
import type { ResilienceContributors } from './ResilienceContributors';
import {
    ResilienceContributorsFromJSON,
    ResilienceContributorsFromJSONTyped,
    ResilienceContributorsToJSON,
    ResilienceContributorsToJSONTyped,
} from './ResilienceContributors';

/**
 * 
 * @export
 * @interface DailyResilienceModel
 */
export interface DailyResilienceModel {
    /**
     * 
     * @type {string}
     * @memberof DailyResilienceModel
     */
    id: string;
    /**
...
/**
 * Check if a given object implements the DailyResilienceModel interface.
 */
export function instanceOfDailyResilienceModel(value: object): value is DailyResilienceModel {
...
export function DailyResilienceModelFromJSON(json: any): DailyResilienceModel {
    return DailyResilienceModelFromJSONTyped(json, false);
}

export function DailyResilienceModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): DailyResilienceModel {
    if (json == null) {
        return json;
    }
    return {
        ...
        'contributors': ResilienceContributorsFromJSON(json['contributors']),
        'level': LongTermResilienceLevelFromJSON(json['level']),
    };
}

export function DailyResilienceModelToJSON(json: any): DailyResilienceModel {
    return DailyResilienceModelToJSONTyped(json, false);
}

export function DailyResilienceModelToJSONTyped(value?: DailyResilienceModel | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'contributors': ResilienceContributorsToJSON(value['contributors']),
        'level': LongTermResilienceLevelToJSON(value['level']),
    };
}
