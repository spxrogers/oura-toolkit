...
import type { TimeSeriesResponsePublicHeartRateRow } from './TimeSeriesResponsePublicHeartRateRow';
import {
    TimeSeriesResponsePublicHeartRateRowFromJSON,
    TimeSeriesResponsePublicHeartRateRowFromJSONTyped,
    TimeSeriesResponsePublicHeartRateRowToJSON,
    TimeSeriesResponsePublicHeartRateRowToJSONTyped,
} from './TimeSeriesResponsePublicHeartRateRow';
 ...
 * 
 * @export
 * @interface ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet
 */
export interface ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet {
    /**
     * 
     * @type {Array<{ [key: string]: any; }>}
     * @memberof ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet
     */
...
/**
 * Check if a given object implements the ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet interface.
 */
export function instanceOfResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet(value: object): value is ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet {
    if (!('data' in value) || value['data'] === undefined) return false;
    return true;
}

export function ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGetFromJSON(json: any): ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet {
    return ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGetFromJSONTyped(json, false);
}

export function ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGetFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet {
    if (json == null) {
        return json;
    }
    return {
...
export function ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGetToJSON(json: any): ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet {
    return ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGetToJSONTyped(json, false);
}

export function ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGetToJSONTyped(value?: ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
