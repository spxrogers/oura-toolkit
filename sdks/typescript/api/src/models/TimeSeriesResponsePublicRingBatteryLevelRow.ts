...
import type { PublicRingBatteryLevelRow } from './PublicRingBatteryLevelRow';
import {
    PublicRingBatteryLevelRowFromJSON,
    PublicRingBatteryLevelRowFromJSONTyped,
    PublicRingBatteryLevelRowToJSON,
    PublicRingBatteryLevelRowToJSONTyped,
} from './PublicRingBatteryLevelRow';

/**
 * 
 * @export
 * @interface TimeSeriesResponsePublicRingBatteryLevelRow
 */
export interface TimeSeriesResponsePublicRingBatteryLevelRow {
    /**
     * 
     * @type {Array<PublicRingBatteryLevelRow>}
     * @memberof TimeSeriesResponsePublicRingBatteryLevelRow
     */
    data: Array<PublicRingBatteryLevelRow>;
    /**
     * 
     * @type {string}
     * @memberof TimeSeriesResponsePublicRingBatteryLevelRow
...
/**
 * Check if a given object implements the TimeSeriesResponsePublicRingBatteryLevelRow interface.
 */
export function instanceOfTimeSeriesResponsePublicRingBatteryLevelRow(value: object): value is TimeSeriesResponsePublicRingBatteryLevelRow {
    if (!('data' in value) || value['data'] === undefined) return false;
    return true;
}

export function TimeSeriesResponsePublicRingBatteryLevelRowFromJSON(json: any): TimeSeriesResponsePublicRingBatteryLevelRow {
    return TimeSeriesResponsePublicRingBatteryLevelRowFromJSONTyped(json, false);
}

export function TimeSeriesResponsePublicRingBatteryLevelRowFromJSONTyped(json: any, ignoreDiscriminator: boolean): TimeSeriesResponsePublicRingBatteryLevelRow {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(PublicRingBatteryLevelRowFromJSON)),
        'nextToken': json['next_token'] == null ? undefined : json['next_token'],
    };
}

export function TimeSeriesResponsePublicRingBatteryLevelRowToJSON(json: any): TimeSeriesResponsePublicRingBatteryLevelRow {
    return TimeSeriesResponsePublicRingBatteryLevelRowToJSONTyped(json, false);
}

export function TimeSeriesResponsePublicRingBatteryLevelRowToJSONTyped(value?: TimeSeriesResponsePublicRingBatteryLevelRow | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ((value['data'] as Array<any>).map(PublicRingBatteryLevelRowToJSON)),
