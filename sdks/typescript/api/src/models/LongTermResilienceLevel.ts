 ...
 * @export
 */
export const LongTermResilienceLevel = {
    Limited: 'limited',
    Adequate: 'adequate',
    Solid: 'solid',
    Strong: 'strong',
...
export type LongTermResilienceLevel = typeof LongTermResilienceLevel[keyof typeof LongTermResilienceLevel];


export function instanceOfLongTermResilienceLevel(value: any): boolean {
    for (const key in LongTermResilienceLevel) {
        if (Object.prototype.hasOwnProperty.call(LongTermResilienceLevel, key)) {
            if (LongTermResilienceLevel[key as keyof typeof LongTermResilienceLevel] === value) {
                return true;
            }
        }
    }
...
export function LongTermResilienceLevelFromJSON(json: any): LongTermResilienceLevel {
    return LongTermResilienceLevelFromJSONTyped(json, false);
}

export function LongTermResilienceLevelFromJSONTyped(json: any, ignoreDiscriminator: boolean): LongTermResilienceLevel {
    return json as LongTermResilienceLevel;
}

export function LongTermResilienceLevelToJSON(value?: LongTermResilienceLevel | null): any {
    return value as any;
}

export function LongTermResilienceLevelToJSONTyped(value: any, ignoreDiscriminator: boolean): LongTermResilienceLevel {
    return value as LongTermResilienceLevel;
}
