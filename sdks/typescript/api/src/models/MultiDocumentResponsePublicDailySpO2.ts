...
import type { PublicDailySpO2 } from './PublicDailySpO2';
import {
    PublicDailySpO2FromJSON,
    PublicDailySpO2FromJSONTyped,
    PublicDailySpO2ToJSON,
    PublicDailySpO2ToJSONTyped,
} from './PublicDailySpO2';

/**
 * 
 * @export
 * @interface MultiDocumentResponsePublicDailySpO2
 */
export interface MultiDocumentResponsePublicDailySpO2 {
    /**
     * 
     * @type {Array<PublicDailySpO2>}
     * @memberof MultiDocumentResponsePublicDailySpO2
     */
    data: Array<PublicDailySpO2>;
    /**
     * 
     * @type {string}
     * @memberof MultiDocumentResponsePublicDailySpO2
...
/**
 * Check if a given object implements the MultiDocumentResponsePublicDailySpO2 interface.
 */
export function instanceOfMultiDocumentResponsePublicDailySpO2(value: object): value is MultiDocumentResponsePublicDailySpO2 {
    if (!('data' in value) || value['data'] === undefined) return false;
    if (!('nextToken' in value) || value['nextToken'] === undefined) return false;
    return true;
}

export function MultiDocumentResponsePublicDailySpO2FromJSON(json: any): MultiDocumentResponsePublicDailySpO2 {
    return MultiDocumentResponsePublicDailySpO2FromJSONTyped(json, false);
}

export function MultiDocumentResponsePublicDailySpO2FromJSONTyped(json: any, ignoreDiscriminator: boolean): MultiDocumentResponsePublicDailySpO2 {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(PublicDailySpO2FromJSON)),
        'nextToken': json['next_token'],
    };
}

export function MultiDocumentResponsePublicDailySpO2ToJSON(json: any): MultiDocumentResponsePublicDailySpO2 {
    return MultiDocumentResponsePublicDailySpO2ToJSONTyped(json, false);
}

export function MultiDocumentResponsePublicDailySpO2ToJSONTyped(value?: MultiDocumentResponsePublicDailySpO2 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ((value['data'] as Array<any>).map(PublicDailySpO2ToJSON)),
