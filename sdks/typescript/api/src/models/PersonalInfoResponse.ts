 ...
 */
export function instanceOfPersonalInfoResponse(value: object): value is PersonalInfoResponse {
...
export function PersonalInfoResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PersonalInfoResponse {
    ...
    return {
        ...
        'biologicalSex': json['biological_sex'] == null ? undefined : json['biological_sex'],
        'email': json['email'] == null ? undefined : json['email'],
    };
}

export function PersonalInfoResponseToJSON(json: any): PersonalInfoResponse {
    return PersonalInfoResponseToJSONTyped(json, false);
}

export function PersonalInfoResponseToJSONTyped(value?: PersonalInfoResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
