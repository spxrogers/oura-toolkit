 ...
 * @export
 * @interface PublicDailyCardiovascularAge
 */
export interface PublicDailyCardiovascularAge {
    /**
     * Unique identifier of the object.
     * @type {string}
     * @memberof PublicDailyCardiovascularAge
     */
    id: string;
    /**
     * 
...
/**
 * Check if a given object implements the PublicDailyCardiovascularAge interface.
 */
export function instanceOfPublicDailyCardiovascularAge(value: object): value is PublicDailyCardiovascularAge {
    if (!('id' in value) || value['id'] === undefined) return false;
    if (!('day' in value) || value['day'] === undefined) return false;
    return true;
}

export function PublicDailyCardiovascularAgeFromJSON(json: any): PublicDailyCardiovascularAge {
    return PublicDailyCardiovascularAgeFromJSONTyped(json, false);
}

export function PublicDailyCardiovascularAgeFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicDailyCardiovascularAge {
    if (json == null) {
        return json;
    }
    return {
        ...
        'id': json['id'],
        'day': json['day'],
        'pulseWaveVelocity': json['pulse_wave_velocity'] == null ? undefined : json['pulse_wave_velocity'],
        'vascularAge': json['vascular_age'] == null ? undefined : json['vascular_age'],
    };
}

export function PublicDailyCardiovascularAgeToJSON(json: any): PublicDailyCardiovascularAge {
    return PublicDailyCardiovascularAgeToJSONTyped(json, false);
}

export function PublicDailyCardiovascularAgeToJSONTyped(value?: PublicDailyCardiovascularAge | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'id': value['id'],
        'day': value['day'],
        'pulse_wave_velocity': value['pulseWaveVelocity'],
        'vascular_age': value['vascularAge'],
    };
}
