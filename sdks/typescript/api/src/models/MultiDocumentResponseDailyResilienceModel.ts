...
import type { DailyResilienceModel } from './DailyResilienceModel';
import {
    DailyResilienceModelFromJSON,
    DailyResilienceModelFromJSONTyped,
    DailyResilienceModelToJSON,
    DailyResilienceModelToJSONTyped,
} from './DailyResilienceModel';

/**
 * 
 * @export
 * @interface MultiDocumentResponseDailyResilienceModel
 */
export interface MultiDocumentResponseDailyResilienceModel {
    /**
     * 
     * @type {Array<DailyResilienceModel>}
     * @memberof MultiDocumentResponseDailyResilienceModel
     */
    data: Array<DailyResilienceModel>;
    /**
     * 
     * @type {string}
     * @memberof MultiDocumentResponseDailyResilienceModel
...
/**
 * Check if a given object implements the MultiDocumentResponseDailyResilienceModel interface.
 */
export function instanceOfMultiDocumentResponseDailyResilienceModel(value: object): value is MultiDocumentResponseDailyResilienceModel {
    if (!('data' in value) || value['data'] === undefined) return false;
    if (!('nextToken' in value) || value['nextToken'] === undefined) return false;
    return true;
}

export function MultiDocumentResponseDailyResilienceModelFromJSON(json: any): MultiDocumentResponseDailyResilienceModel {
    return MultiDocumentResponseDailyResilienceModelFromJSONTyped(json, false);
}

export function MultiDocumentResponseDailyResilienceModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): MultiDocumentResponseDailyResilienceModel {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(DailyResilienceModelFromJSON)),
        'nextToken': json['next_token'],
    };
}

export function MultiDocumentResponseDailyResilienceModelToJSON(json: any): MultiDocumentResponseDailyResilienceModel {
    return MultiDocumentResponseDailyResilienceModelToJSONTyped(json, false);
}

export function MultiDocumentResponseDailyResilienceModelToJSONTyped(value?: MultiDocumentResponseDailyResilienceModel | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ((value['data'] as Array<any>).map(DailyResilienceModelToJSON)),
