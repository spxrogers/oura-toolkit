 ...
 * 
 * @export
 * @interface WebhookSubscriptionModel
 */
export interface WebhookSubscriptionModel {
    /**
     * 
     * @type {string}
     * @memberof WebhookSubscriptionModel
     */
    id: string;
    /**
     * 
...
/**
 * Check if a given object implements the WebhookSubscriptionModel interface.
 */
export function instanceOfWebhookSubscriptionModel(value: object): value is WebhookSubscriptionModel {
...
export function WebhookSubscriptionModelFromJSON(json: any): WebhookSubscriptionModel {
    return WebhookSubscriptionModelFromJSONTyped(json, false);
}

export function WebhookSubscriptionModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): WebhookSubscriptionModel {
    if (json == null) {
        return json;
    }
    return {
...
export function WebhookSubscriptionModelToJSON(json: any): WebhookSubscriptionModel {
    return WebhookSubscriptionModelToJSONTyped(json, false);
}

export function WebhookSubscriptionModelToJSONTyped(value?: WebhookSubscriptionModel | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
