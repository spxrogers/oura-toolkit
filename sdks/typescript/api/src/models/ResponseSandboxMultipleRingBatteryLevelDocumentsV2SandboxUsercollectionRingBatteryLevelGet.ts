...
import type { TimeSeriesResponsePublicRingBatteryLevelRow } from './TimeSeriesResponsePublicRingBatteryLevelRow';
import {
    TimeSeriesResponsePublicRingBatteryLevelRowFromJSON,
    TimeSeriesResponsePublicRingBatteryLevelRowFromJSONTyped,
    TimeSeriesResponsePublicRingBatteryLevelRowToJSON,
    TimeSeriesResponsePublicRingBatteryLevelRowToJSONTyped,
} from './TimeSeriesResponsePublicRingBatteryLevelRow';
import type { TimeSeriesResponseDict } from './TimeSeriesResponseDict';
import {
    TimeSeriesResponseDictFromJSON,
    TimeSeriesResponseDictFromJSONTyped,
    TimeSeriesResponseDictToJSON,
    TimeSeriesResponseDictToJSONTyped,
} from './TimeSeriesResponseDict';

/**
 * 
 * @export
 * @interface ResponseSandboxMultipleRingBatteryLevelDocumentsV2SandboxUsercollectionRingBatteryLevelGet
 */
export interface ResponseSandboxMultipleRingBatteryLevelDocumentsV2SandboxUsercollectionRingBatteryLevelGet {
    /**
     * 
     * @type {Array<{ [key: string]: any; }>}
     * @memberof ResponseSandboxMultipleRingBatteryLevelDocumentsV2SandboxUsercollectionRingBatteryLevelGet
     */
...
/**
 * Check if a given object implements the ResponseSandboxMultipleRingBatteryLevelDocumentsV2SandboxUsercollectionRingBatteryLevelGet interface.
 */
export function instanceOfResponseSandboxMultipleRingBatteryLevelDocumentsV2SandboxUsercollectionRingBatteryLevelGet(value: object): value is ResponseSandboxMultipleRingBatteryLevelDocumentsV2SandboxUsercollectionRingBatteryLevelGet {
    if (!('data' in value) || value['data'] === undefined) return false;
    return true;
}

export function ResponseSandboxMultipleRingBatteryLevelDocumentsV2SandboxUsercollectionRingBatteryLevelGetFromJSON(json: any): ResponseSandboxMultipleRingBatteryLevelDocumentsV2SandboxUsercollectionRingBatteryLevelGet {
    return ResponseSandboxMultipleRingBatteryLevelDocumentsV2SandboxUsercollectionRingBatteryLevelGetFromJSONTyped(json, false);
}

export function ResponseSandboxMultipleRingBatteryLevelDocumentsV2SandboxUsercollectionRingBatteryLevelGetFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResponseSandboxMultipleRingBatteryLevelDocumentsV2SandboxUsercollectionRingBatteryLevelGet {
    if (json == null) {
        return json;
    }
    return {
...
export function ResponseSandboxMultipleRingBatteryLevelDocumentsV2SandboxUsercollectionRingBatteryLevelGetToJSON(json: any): ResponseSandboxMultipleRingBatteryLevelDocumentsV2SandboxUsercollectionRingBatteryLevelGet {
    return ResponseSandboxMultipleRingBatteryLevelDocumentsV2SandboxUsercollectionRingBatteryLevelGetToJSONTyped(json, false);
}

export function ResponseSandboxMultipleRingBatteryLevelDocumentsV2SandboxUsercollectionRingBatteryLevelGetToJSONTyped(value?: ResponseSandboxMultipleRingBatteryLevelDocumentsV2SandboxUsercollectionRingBatteryLevelGet | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
