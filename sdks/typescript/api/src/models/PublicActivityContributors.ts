 ...
 * @export
 * @interface PublicActivityContributors
 */
export interface PublicActivityContributors {
    /**
     * 
     * @type {number}
     * @memberof PublicActivityContributors
     */
    meetDailyTargets?: number | null;
    /**
     * 
     * @type {number}
     * @memberof PublicActivityContributors
     */
    moveEveryHour?: number | null;
    /**
     * 
     * @type {number}
     * @memberof PublicActivityContributors
...
/**
 * Check if a given object implements the PublicActivityContributors interface.
 */
export function instanceOfPublicActivityContributors(value: object): value is PublicActivityContributors {
    return true;
}

export function PublicActivityContributorsFromJSON(json: any): PublicActivityContributors {
    return PublicActivityContributorsFromJSONTyped(json, false);
}

export function PublicActivityContributorsFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicActivityContributors {
    if (json == null) {
        return json;
    }
    return {
        
        'meetDailyTargets': json['meet_daily_targets'] == null ? undefined : json['meet_daily_targets'],
        'moveEveryHour': json['move_every_hour'] == null ? undefined : json['move_every_hour'],
        'recoveryTime': json['recovery_time'] == null ? undefined : json['recovery_time'],
        'stayActive': json['stay_active'] == null ? undefined : json['stay_active'],
        'trainingFrequency': json['training_frequency'] == null ? undefined : json['training_frequency'],
        'trainingVolume': json['training_volume'] == null ? undefined : json['training_volume'],
    };
}

export function PublicActivityContributorsToJSON(json: any): PublicActivityContributors {
    return PublicActivityContributorsToJSONTyped(json, false);
}

export function PublicActivityContributorsToJSONTyped(value?: PublicActivityContributors | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'meet_daily_targets': value['meetDailyTargets'],
        'move_every_hour': value['moveEveryHour'],
        'recovery_time': value['recoveryTime'],
        'stay_active': value['stayActive'],
        'training_frequency': value['trainingFrequency'],
        'training_volume': value['trainingVolume'],
    };
}
