 ...
 * @export
 */
export const PublicRingHardwareType = {
    Gen1: 'gen1',
    Gen2: 'gen2',
    Gen2m: 'gen2m',
    Gen3: 'gen3',
...
export type PublicRingHardwareType = typeof PublicRingHardwareType[keyof typeof PublicRingHardwareType];


export function instanceOfPublicRingHardwareType(value: any): boolean {
    for (const key in PublicRingHardwareType) {
        if (Object.prototype.hasOwnProperty.call(PublicRingHardwareType, key)) {
            if (PublicRingHardwareType[key as keyof typeof PublicRingHardwareType] === value) {
                return true;
            }
        }
    }
...
export function PublicRingHardwareTypeFromJSON(json: any): PublicRingHardwareType {
    return PublicRingHardwareTypeFromJSONTyped(json, false);
}

export function PublicRingHardwareTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicRingHardwareType {
    return json as PublicRingHardwareType;
}

export function PublicRingHardwareTypeToJSON(value?: PublicRingHardwareType | null): any {
    return value as any;
}

export function PublicRingHardwareTypeToJSONTyped(value: any, ignoreDiscriminator: boolean): PublicRingHardwareType {
    return value as PublicRingHardwareType;
}
