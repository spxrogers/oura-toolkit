 ...
 * 
 * @export
 * @interface ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet
 */
export interface ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet {
    /**
     * 
     * @type {Array<{ [key: string]: any; }>}
     * @memberof ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet
     */
...
/**
 * Check if a given object implements the ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet interface.
 */
export function instanceOfResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet(value: object): value is ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet {
    if (!('data' in value) || value['data'] === undefined) return false;
    return true;
}

export function ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGetFromJSON(json: any): ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet {
    return ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGetFromJSONTyped(json, false);
}

export function ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGetFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet {
    if (json == null) {
        return json;
    }
    return {
...
export function ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGetToJSON(json: any): ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet {
    return ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGetToJSONTyped(json, false);
}

export function ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGetToJSONTyped(value?: ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
