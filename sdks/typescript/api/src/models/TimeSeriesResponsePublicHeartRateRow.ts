...
import type { PublicHeartRateRow } from './PublicHeartRateRow';
import {
    PublicHeartRateRowFromJSON,
    PublicHeartRateRowFromJSONTyped,
    PublicHeartRateRowToJSON,
    PublicHeartRateRowToJSONTyped,
} from './PublicHeartRateRow';

/**
 * 
 * @export
 * @interface TimeSeriesResponsePublicHeartRateRow
 */
export interface TimeSeriesResponsePublicHeartRateRow {
    /**
     * 
     * @type {Array<PublicHeartRateRow>}
     * @memberof TimeSeriesResponsePublicHeartRateRow
     */
    data: Array<PublicHeartRateRow>;
    /**
     * 
     * @type {string}
     * @memberof TimeSeriesResponsePublicHeartRateRow
...
/**
 * Check if a given object implements the TimeSeriesResponsePublicHeartRateRow interface.
 */
export function instanceOfTimeSeriesResponsePublicHeartRateRow(value: object): value is TimeSeriesResponsePublicHeartRateRow {
    if (!('data' in value) || value['data'] === undefined) return false;
    return true;
}

export function TimeSeriesResponsePublicHeartRateRowFromJSON(json: any): TimeSeriesResponsePublicHeartRateRow {
    return TimeSeriesResponsePublicHeartRateRowFromJSONTyped(json, false);
}

export function TimeSeriesResponsePublicHeartRateRowFromJSONTyped(json: any, ignoreDiscriminator: boolean): TimeSeriesResponsePublicHeartRateRow {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(PublicHeartRateRowFromJSON)),
        'nextToken': json['next_token'] == null ? undefined : json['next_token'],
    };
}

export function TimeSeriesResponsePublicHeartRateRowToJSON(json: any): TimeSeriesResponsePublicHeartRateRow {
    return TimeSeriesResponsePublicHeartRateRowToJSONTyped(json, false);
}

export function TimeSeriesResponsePublicHeartRateRowToJSONTyped(value?: TimeSeriesResponsePublicHeartRateRow | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ((value['data'] as Array<any>).map(PublicHeartRateRowToJSON)),
