...
import type { PublicSleepContributors } from './PublicSleepContributors';
import {
    PublicSleepContributorsFromJSON,
    PublicSleepContributorsFromJSONTyped,
    PublicSleepContributorsToJSON,
    PublicSleepContributorsToJSONTyped,
} from './PublicSleepContributors';

/**
 * Public object defining daily sleep.
 * @export
 * @interface PublicDailySleep
 */
export interface PublicDailySleep {
    /**
     * Unique identifier of the object.
     * @type {string}
     * @memberof PublicDailySleep
     */
    id: string;
    /**
     * Contributors for the daily sleep score.
     * @type {PublicSleepContributors}
     * @memberof PublicDailySleep
     */
...
/**
 * Check if a given object implements the PublicDailySleep interface.
 */
export function instanceOfPublicDailySleep(value: object): value is PublicDailySleep {
...
export function PublicDailySleepFromJSON(json: any): PublicDailySleep {
    return PublicDailySleepFromJSONTyped(json, false);
}

export function PublicDailySleepFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicDailySleep {
    if (json == null) {
        return json;
    }
    return {
        ...
        'id': json['id'],
        'contributors': PublicSleepContributorsFromJSON(json['contributors']),
        'day': json['day'],
...
export function PublicDailySleepToJSON(json: any): PublicDailySleep {
    return PublicDailySleepToJSONTyped(json, false);
}

export function PublicDailySleepToJSONTyped(value?: PublicDailySleep | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'id': value['id'],
        'contributors': PublicSleepContributorsToJSON(value['contributors']),
        'day': value['day'],
        'score': value['score'],
