 ...
 * @export
 */
export const PublicSleepTimeRecommendation = {
...
export type PublicSleepTimeRecommendation = typeof PublicSleepTimeRecommendation[keyof typeof PublicSleepTimeRecommendation];


export function instanceOfPublicSleepTimeRecommendation(value: any): boolean {
    for (const key in PublicSleepTimeRecommendation) {
        if (Object.prototype.hasOwnProperty.call(PublicSleepTimeRecommendation, key)) {
            if (PublicSleepTimeRecommendation[key as keyof typeof PublicSleepTimeRecommendation] === value) {
                return true;
            }
        }
    }
...
export function PublicSleepTimeRecommendationFromJSON(json: any): PublicSleepTimeRecommendation {
    return PublicSleepTimeRecommendationFromJSONTyped(json, false);
}

export function PublicSleepTimeRecommendationFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicSleepTimeRecommendation {
    return json as PublicSleepTimeRecommendation;
}

export function PublicSleepTimeRecommendationToJSON(value?: PublicSleepTimeRecommendation | null): any {
    return value as any;
}

export function PublicSleepTimeRecommendationToJSONTyped(value: any, ignoreDiscriminator: boolean): PublicSleepTimeRecommendation {
    return value as PublicSleepTimeRecommendation;
}
