...
export type PublicMomentType = typeof PublicMomentType[keyof typeof PublicMomentType];


export function instanceOfPublicMomentType(value: any): boolean {
    for (const key in PublicMomentType) {
        if (Object.prototype.hasOwnProperty.call(PublicMomentType, key)) {
            if (PublicMomentType[key as keyof typeof PublicMomentType] === value) {
                return true;
            }
        }
    }
...
export function PublicMomentTypeFromJSON(json: any): PublicMomentType {
    return PublicMomentTypeFromJSONTyped(json, false);
}

export function PublicMomentTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicMomentType {
    return json as PublicMomentType;
}

export function PublicMomentTypeToJSON(value?: PublicMomentType | null): any {
    return value as any;
}

export function PublicMomentTypeToJSONTyped(value: any, ignoreDiscriminator: boolean): PublicMomentType {
    return value as PublicMomentType;
}
