 ...
 * @export
 */
export const PublicDailyStressSummary = {
    Restored: 'restored',
    Normal: 'normal',
    Stressful: 'stressful'
} as const;
export type PublicDailyStressSummary = typeof PublicDailyStressSummary[keyof typeof PublicDailyStressSummary];


export function instanceOfPublicDailyStressSummary(value: any): boolean {
    for (const key in PublicDailyStressSummary) {
        if (Object.prototype.hasOwnProperty.call(PublicDailyStressSummary, key)) {
            if (PublicDailyStressSummary[key as keyof typeof PublicDailyStressSummary] === value) {
                return true;
            }
        }
    }
...
export function PublicDailyStressSummaryFromJSON(json: any): PublicDailyStressSummary {
    return PublicDailyStressSummaryFromJSONTyped(json, false);
}

export function PublicDailyStressSummaryFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicDailyStressSummary {
    return json as PublicDailyStressSummary;
}

export function PublicDailyStressSummaryToJSON(value?: PublicDailyStressSummary | null): any {
    return value as any;
}

export function PublicDailyStressSummaryToJSONTyped(value: any, ignoreDiscriminator: boolean): PublicDailyStressSummary {
    return value as PublicDailyStressSummary;
}
