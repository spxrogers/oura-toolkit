...
import type { PublicDailyActivity } from './PublicDailyActivity';
import {
    PublicDailyActivityFromJSON,
    PublicDailyActivityFromJSONTyped,
    PublicDailyActivityToJSON,
    PublicDailyActivityToJSONTyped,
} from './PublicDailyActivity';

/**
 * 
 * @export
 * @interface MultiDocumentResponsePublicDailyActivity
 */
export interface MultiDocumentResponsePublicDailyActivity {
    /**
     * 
     * @type {Array<PublicDailyActivity>}
     * @memberof MultiDocumentResponsePublicDailyActivity
     */
    data: Array<PublicDailyActivity>;
    /**
     * 
     * @type {string}
     * @memberof MultiDocumentResponsePublicDailyActivity
...
/**
 * Check if a given object implements the MultiDocumentResponsePublicDailyActivity interface.
 */
export function instanceOfMultiDocumentResponsePublicDailyActivity(value: object): value is MultiDocumentResponsePublicDailyActivity {
    if (!('data' in value) || value['data'] === undefined) return false;
    if (!('nextToken' in value) || value['nextToken'] === undefined) return false;
    return true;
}

export function MultiDocumentResponsePublicDailyActivityFromJSON(json: any): MultiDocumentResponsePublicDailyActivity {
    return MultiDocumentResponsePublicDailyActivityFromJSONTyped(json, false);
}

export function MultiDocumentResponsePublicDailyActivityFromJSONTyped(json: any, ignoreDiscriminator: boolean): MultiDocumentResponsePublicDailyActivity {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(PublicDailyActivityFromJSON)),
        'nextToken': json['next_token'],
    };
}

export function MultiDocumentResponsePublicDailyActivityToJSON(json: any): MultiDocumentResponsePublicDailyActivity {
    return MultiDocumentResponsePublicDailyActivityToJSONTyped(json, false);
}

export function MultiDocumentResponsePublicDailyActivityToJSONTyped(value?: MultiDocumentResponsePublicDailyActivity | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ((value['data'] as Array<any>).map(PublicDailyActivityToJSON)),
