...
export type ExtApiV2DataType = typeof ExtApiV2DataType[keyof typeof ExtApiV2DataType];


export function instanceOfExtApiV2DataType(value: any): boolean {
    for (const key in ExtApiV2DataType) {
        if (Object.prototype.hasOwnProperty.call(ExtApiV2DataType, key)) {
            if (ExtApiV2DataType[key as keyof typeof ExtApiV2DataType] === value) {
                return true;
            }
        }
    }
...
export function ExtApiV2DataTypeFromJSON(json: any): ExtApiV2DataType {
    return ExtApiV2DataTypeFromJSONTyped(json, false);
}

export function ExtApiV2DataTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ExtApiV2DataType {
    return json as ExtApiV2DataType;
}

export function ExtApiV2DataTypeToJSON(value?: ExtApiV2DataType | null): any {
    return value as any;
}

export function ExtApiV2DataTypeToJSONTyped(value: any, ignoreDiscriminator: boolean): ExtApiV2DataType {
    return value as ExtApiV2DataType;
}
