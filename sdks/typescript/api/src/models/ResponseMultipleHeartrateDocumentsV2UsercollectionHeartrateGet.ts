 ...
 * 
 * @export
 * @interface ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet
 */
export interface ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet {
    /**
     * 
     * @type {Array<{ [key: string]: any; }>}
     * @memberof ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet
     */
...
/**
 * Check if a given object implements the ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet interface.
 */
export function instanceOfResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet(value: object): value is ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet {
    if (!('data' in value) || value['data'] === undefined) return false;
    return true;
}

export function ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGetFromJSON(json: any): ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet {
    return ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGetFromJSONTyped(json, false);
}

export function ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGetFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet {
    if (json == null) {
        return json;
    }
    return {
...
export function ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGetToJSON(json: any): ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet {
    return ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGetToJSONTyped(json, false);
}

export function ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGetToJSONTyped(value?: ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
