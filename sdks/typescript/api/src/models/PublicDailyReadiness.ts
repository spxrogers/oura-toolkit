...
import type { PublicReadinessContributors } from './PublicReadinessContributors';
import {
    PublicReadinessContributorsFromJSON,
    PublicReadinessContributorsFromJSONTyped,
    PublicReadinessContributorsToJSON,
    PublicReadinessContributorsToJSONTyped,
} from './PublicReadinessContributors';

/**
 * Public object defining daily readiness.
 * @export
 * @interface PublicDailyReadiness
 */
export interface PublicDailyReadiness {
    /**
     * Unique identifier of the object.
     * @type {string}
     * @memberof PublicDailyReadiness
     */
    id: string;
    /**
     * Contributors of the daily readiness score.
     * @type {PublicReadinessContributors}
     * @memberof PublicDailyReadiness
     */
...
/**
 * Check if a given object implements the PublicDailyReadiness interface.
 */
export function instanceOfPublicDailyReadiness(value: object): value is PublicDailyReadiness {
...
export function PublicDailyReadinessFromJSON(json: any): PublicDailyReadiness {
    return PublicDailyReadinessFromJSONTyped(json, false);
}

export function PublicDailyReadinessFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicDailyReadiness {
    if (json == null) {
        return json;
    }
    return {
        ...
        'id': json['id'],
        'contributors': PublicReadinessContributorsFromJSON(json['contributors']),
        'day': json['day'],
        'score': json['score'] == null ? undefined : json['score'],
        'temperatureDeviation': json['temperature_deviation'] == null ? undefined : json['temperature_deviation'],
        'temperatureTrendDeviation': json['temperature_trend_deviation'] == null ? undefined : json['temperature_trend_deviation'],
        'timestamp': json['timestamp'],
    };
}

export function PublicDailyReadinessToJSON(json: any): PublicDailyReadiness {
    return PublicDailyReadinessToJSONTyped(json, false);
}

export function PublicDailyReadinessToJSONTyped(value?: PublicDailyReadiness | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'id': value['id'],
        'contributors': PublicReadinessContributorsToJSON(value['contributors']),
        'day': value['day'],
        'score': value['score'],
        'temperature_deviation': value['temperatureDeviation'],
        'temperature_trend_deviation': value['temperatureTrendDeviation'],
