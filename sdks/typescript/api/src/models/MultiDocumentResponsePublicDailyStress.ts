...
import type { PublicDailyStress } from './PublicDailyStress';
import {
    PublicDailyStressFromJSON,
    PublicDailyStressFromJSONTyped,
    PublicDailyStressToJSON,
    PublicDailyStressToJSONTyped,
} from './PublicDailyStress';

/**
 * 
 * @export
 * @interface MultiDocumentResponsePublicDailyStress
 */
export interface MultiDocumentResponsePublicDailyStress {
    /**
     * 
     * @type {Array<PublicDailyStress>}
     * @memberof MultiDocumentResponsePublicDailyStress
     */
    data: Array<PublicDailyStress>;
    /**
     * 
     * @type {string}
     * @memberof MultiDocumentResponsePublicDailyStress
...
/**
 * Check if a given object implements the MultiDocumentResponsePublicDailyStress interface.
 */
export function instanceOfMultiDocumentResponsePublicDailyStress(value: object): value is MultiDocumentResponsePublicDailyStress {
    if (!('data' in value) || value['data'] === undefined) return false;
    if (!('nextToken' in value) || value['nextToken'] === undefined) return false;
    return true;
}

export function MultiDocumentResponsePublicDailyStressFromJSON(json: any): MultiDocumentResponsePublicDailyStress {
    return MultiDocumentResponsePublicDailyStressFromJSONTyped(json, false);
}

export function MultiDocumentResponsePublicDailyStressFromJSONTyped(json: any, ignoreDiscriminator: boolean): MultiDocumentResponsePublicDailyStress {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(PublicDailyStressFromJSON)),
        'nextToken': json['next_token'],
    };
}

export function MultiDocumentResponsePublicDailyStressToJSON(json: any): MultiDocumentResponsePublicDailyStress {
    return MultiDocumentResponsePublicDailyStressToJSONTyped(json, false);
}

export function MultiDocumentResponsePublicDailyStressToJSONTyped(value?: MultiDocumentResponsePublicDailyStress | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ((value['data'] as Array<any>).map(PublicDailyStressToJSON)),
