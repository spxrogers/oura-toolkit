...
import type { EnhancedTagModel } from './EnhancedTagModel';
import {
    EnhancedTagModelFromJSON,
    EnhancedTagModelFromJSONTyped,
    EnhancedTagModelToJSON,
    EnhancedTagModelToJSONTyped,
} from './EnhancedTagModel';

/**
 * 
 * @export
 * @interface MultiDocumentResponseEnhancedTagModel
 */
export interface MultiDocumentResponseEnhancedTagModel {
    /**
     * 
     * @type {Array<EnhancedTagModel>}
     * @memberof MultiDocumentResponseEnhancedTagModel
     */
    data: Array<EnhancedTagModel>;
    /**
     * 
     * @type {string}
     * @memberof MultiDocumentResponseEnhancedTagModel
...
/**
 * Check if a given object implements the MultiDocumentResponseEnhancedTagModel interface.
 */
export function instanceOfMultiDocumentResponseEnhancedTagModel(value: object): value is MultiDocumentResponseEnhancedTagModel {
    if (!('data' in value) || value['data'] === undefined) return false;
    if (!('nextToken' in value) || value['nextToken'] === undefined) return false;
    return true;
}

export function MultiDocumentResponseEnhancedTagModelFromJSON(json: any): MultiDocumentResponseEnhancedTagModel {
    return MultiDocumentResponseEnhancedTagModelFromJSONTyped(json, false);
}

export function MultiDocumentResponseEnhancedTagModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): MultiDocumentResponseEnhancedTagModel {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(EnhancedTagModelFromJSON)),
        'nextToken': json['next_token'],
    };
}

export function MultiDocumentResponseEnhancedTagModelToJSON(json: any): MultiDocumentResponseEnhancedTagModel {
    return MultiDocumentResponseEnhancedTagModelToJSONTyped(json, false);
}

export function MultiDocumentResponseEnhancedTagModelToJSONTyped(value?: MultiDocumentResponseEnhancedTagModel | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ((value['data'] as Array<any>).map(EnhancedTagModelToJSON)),
