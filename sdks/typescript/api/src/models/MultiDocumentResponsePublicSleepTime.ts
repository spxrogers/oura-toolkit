...
import type { PublicSleepTime } from './PublicSleepTime';
import {
    PublicSleepTimeFromJSON,
    PublicSleepTimeFromJSONTyped,
    PublicSleepTimeToJSON,
    PublicSleepTimeToJSONTyped,
} from './PublicSleepTime';

/**
 * 
 * @export
 * @interface MultiDocumentResponsePublicSleepTime
 */
export interface MultiDocumentResponsePublicSleepTime {
    /**
     * 
     * @type {Array<PublicSleepTime>}
     * @memberof MultiDocumentResponsePublicSleepTime
     */
    data: Array<PublicSleepTime>;
    /**
     * 
     * @type {string}
     * @memberof MultiDocumentResponsePublicSleepTime
...
/**
 * Check if a given object implements the MultiDocumentResponsePublicSleepTime interface.
 */
export function instanceOfMultiDocumentResponsePublicSleepTime(value: object): value is MultiDocumentResponsePublicSleepTime {
    if (!('data' in value) || value['data'] === undefined) return false;
    if (!('nextToken' in value) || value['nextToken'] === undefined) return false;
    return true;
}

export function MultiDocumentResponsePublicSleepTimeFromJSON(json: any): MultiDocumentResponsePublicSleepTime {
    return MultiDocumentResponsePublicSleepTimeFromJSONTyped(json, false);
}

export function MultiDocumentResponsePublicSleepTimeFromJSONTyped(json: any, ignoreDiscriminator: boolean): MultiDocumentResponsePublicSleepTime {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(PublicSleepTimeFromJSON)),
        'nextToken': json['next_token'],
    };
}

export function MultiDocumentResponsePublicSleepTimeToJSON(json: any): MultiDocumentResponsePublicSleepTime {
    return MultiDocumentResponsePublicSleepTimeToJSONTyped(json, false);
}

export function MultiDocumentResponsePublicSleepTimeToJSONTyped(value?: MultiDocumentResponsePublicSleepTime | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ((value['data'] as Array<any>).map(PublicSleepTimeToJSON)),
