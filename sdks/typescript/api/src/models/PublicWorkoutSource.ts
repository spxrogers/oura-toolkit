 ...
 * @export
 */
export const PublicWorkoutSource = {
    Manual: 'manual',
...
export function instanceOfPublicWorkoutSource(value: any): boolean {
    for (const key in PublicWorkoutSource) {
        if (Object.prototype.hasOwnProperty.call(PublicWorkoutSource, key)) {
            if (PublicWorkoutSource[key as keyof typeof PublicWorkoutSource] === value) {
                return true;
            }
        }
    }
...
export function PublicWorkoutSourceFromJSON(json: any): PublicWorkoutSource {
    return PublicWorkoutSourceFromJSONTyped(json, false);
}

export function PublicWorkoutSourceFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicWorkoutSource {
    return json as PublicWorkoutSource;
}

export function PublicWorkoutSourceToJSON(value?: PublicWorkoutSource | null): any {
    return value as any;
}

export function PublicWorkoutSourceToJSONTyped(value: any, ignoreDiscriminator: boolean): PublicWorkoutSource {
    return value as PublicWorkoutSource;
}
