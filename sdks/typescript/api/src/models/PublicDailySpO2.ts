...
import type { PublicSpo2AggregatedValues } from './PublicSpo2AggregatedValues';
import {
    PublicSpo2AggregatedValuesFromJSON,
    PublicSpo2AggregatedValuesFromJSONTyped,
    PublicSpo2AggregatedValuesToJSON,
    PublicSpo2AggregatedValuesToJSONTyped,
} from './PublicSpo2AggregatedValues';

/**
 * Daily SpO2 (Oxygen saturation).
 * @export
 * @interface PublicDailySpO2
 */
export interface PublicDailySpO2 {
    /**
     * Unique identifier of the object.
     * @type {string}
     * @memberof PublicDailySpO2
     */
    id: string;
    /**
     * 
    ...
    /**
     * 
     * @type {PublicSpo2AggregatedValues}
     * @memberof PublicDailySpO2
     */
    spo2Percentage?: PublicSpo2AggregatedValues | null;
}

/**
 * Check if a given object implements the PublicDailySpO2 interface.
 */
export function instanceOfPublicDailySpO2(value: object): value is PublicDailySpO2 {
    if (!('id' in value) || value['id'] === undefined) return false;
    if (!('day' in value) || value['day'] === undefined) return false;
    return true;
}

export function PublicDailySpO2FromJSON(json: any): PublicDailySpO2 {
    return PublicDailySpO2FromJSONTyped(json, false);
}

export function PublicDailySpO2FromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicDailySpO2 {
    if (json == null) {
        return json;
    }
    return {
        ...
        'id': json['id'],
        'breathingDisturbanceIndex': json['breathing_disturbance_index'] == null ? undefined : json['breathing_disturbance_index'],
        'day': json['day'],
        'spo2Percentage': json['spo2_percentage'] == null ? undefined : PublicSpo2AggregatedValuesFromJSON(json['spo2_percentage']),
    };
}

export function PublicDailySpO2ToJSON(json: any): PublicDailySpO2 {
    return PublicDailySpO2ToJSONTyped(json, false);
}

export function PublicDailySpO2ToJSONTyped(value?: PublicDailySpO2 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'id': value['id'],
        'breathing_disturbance_index': value['breathingDisturbanceIndex'],
        'day': value['day'],
        'spo2_percentage': PublicSpo2AggregatedValuesToJSON(value['spo2Percentage']),
    };
}
