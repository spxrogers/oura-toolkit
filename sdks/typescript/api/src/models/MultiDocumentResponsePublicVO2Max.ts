...
import type { PublicVO2Max } from './PublicVO2Max';
import {
    PublicVO2MaxFromJSON,
    PublicVO2MaxFromJSONTyped,
    PublicVO2MaxToJSON,
    PublicVO2MaxToJSONTyped,
} from './PublicVO2Max';

/**
 * 
 * @export
 * @interface MultiDocumentResponsePublicVO2Max
 */
export interface MultiDocumentResponsePublicVO2Max {
    /**
     * 
     * @type {Array<PublicVO2Max>}
     * @memberof MultiDocumentResponsePublicVO2Max
     */
    data: Array<PublicVO2Max>;
    /**
     * 
     * @type {string}
     * @memberof MultiDocumentResponsePublicVO2Max
...
/**
 * Check if a given object implements the MultiDocumentResponsePublicVO2Max interface.
 */
export function instanceOfMultiDocumentResponsePublicVO2Max(value: object): value is MultiDocumentResponsePublicVO2Max {
    if (!('data' in value) || value['data'] === undefined) return false;
    if (!('nextToken' in value) || value['nextToken'] === undefined) return false;
    return true;
}

export function MultiDocumentResponsePublicVO2MaxFromJSON(json: any): MultiDocumentResponsePublicVO2Max {
    return MultiDocumentResponsePublicVO2MaxFromJSONTyped(json, false);
}

export function MultiDocumentResponsePublicVO2MaxFromJSONTyped(json: any, ignoreDiscriminator: boolean): MultiDocumentResponsePublicVO2Max {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(PublicVO2MaxFromJSON)),
        'nextToken': json['next_token'],
    };
}

export function MultiDocumentResponsePublicVO2MaxToJSON(json: any): MultiDocumentResponsePublicVO2Max {
    return MultiDocumentResponsePublicVO2MaxToJSONTyped(json, false);
}

export function MultiDocumentResponsePublicVO2MaxToJSONTyped(value?: MultiDocumentResponsePublicVO2Max | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ((value['data'] as Array<any>).map(PublicVO2MaxToJSON)),
