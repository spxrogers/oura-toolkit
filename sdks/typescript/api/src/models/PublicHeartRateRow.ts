...
import type { PublicHeartRateSource } from './PublicHeartRateSource';
import {
    PublicHeartRateSourceFromJSON,
    PublicHeartRateSourceFromJSONTyped,
    PublicHeartRateSourceToJSON,
    PublicHeartRateSourceToJSONTyped,
} from './PublicHeartRateSource';

/**
 * Heart rate sample
 * @export
 * @interface PublicHeartRateRow
 */
export interface PublicHeartRateRow {
    /**
     * 
     * @type {string}
     * @memberof PublicHeartRateRow
     */
...
/**
 * Check if a given object implements the PublicHeartRateRow interface.
 */
export function instanceOfPublicHeartRateRow(value: object): value is PublicHeartRateRow {
    if (!('timestamp' in value) || value['timestamp'] === undefined) return false;
    if (!('timestampUnix' in value) || value['timestampUnix'] === undefined) return false;
    if (!('bpm' in value) || value['bpm'] === undefined) return false;
    if (!('source' in value) || value['source'] === undefined) return false;
    return true;
}

export function PublicHeartRateRowFromJSON(json: any): PublicHeartRateRow {
    return PublicHeartRateRowFromJSONTyped(json, false);
}

export function PublicHeartRateRowFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicHeartRateRow {
    if (json == null) {
        return json;
    }
    return {
        ...
        'timestampUnix': json['timestamp_unix'],
        'bpm': json['bpm'],
        'source': PublicHeartRateSourceFromJSON(json['source']),
    };
}

export function PublicHeartRateRowToJSON(json: any): PublicHeartRateRow {
    return PublicHeartRateRowToJSONTyped(json, false);
}

export function PublicHeartRateRowToJSONTyped(value?: PublicHeartRateRow | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'bpm': value['bpm'],
        'source': PublicHeartRateSourceToJSON(value['source']),
    };
}
