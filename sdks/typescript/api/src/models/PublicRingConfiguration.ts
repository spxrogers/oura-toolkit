...
import type { PublicRingColor } from './PublicRingColor';
import {
    PublicRingColorFromJSON,
    PublicRingColorFromJSONTyped,
    PublicRingColorToJSON,
    PublicRingColorToJSONTyped,
} from './PublicRingColor';
import type { PublicRingDesign } from './PublicRingDesign';
import {
    PublicRingDesignFromJSON,
    PublicRingDesignFromJSONTyped,
    PublicRingDesignToJSON,
    PublicRingDesignToJSONTyped,
} from './PublicRingDesign';
import type { PublicRingHardwareType } from './PublicRingHardwareType';
import {
    PublicRingHardwareTypeFromJSON,
    PublicRingHardwareTypeFromJSONTyped,
    PublicRingHardwareTypeToJSON,
    PublicRingHardwareTypeToJSONTyped,
} from './PublicRingHardwareType';

/**
 * Ring configuration.
 * @export
 * @interface PublicRingConfiguration
 */
export interface PublicRingConfiguration {
    /**
     * Unique identifier of the object.
     * @type {string}
     * @memberof PublicRingConfiguration
     */
    id: string;
    /**
     * 
     * @type {PublicRingColor}
     * @memberof PublicRingConfiguration
     */
    color?: PublicRingColor | null;
    /**
     * 
     * @type {PublicRingDesign}
     * @memberof PublicRingConfiguration
     */
    ...
    /**
     * 
     * @type {PublicRingHardwareType}
     * @memberof PublicRingConfiguration
     */
    hardwareType?: PublicRingHardwareType | null;
    /**
     * 
     * @type {string}
     * @memberof PublicRingConfiguration
...
/**
 * Check if a given object implements the PublicRingConfiguration interface.
 */
export function instanceOfPublicRingConfiguration(value: object): value is PublicRingConfiguration {
    if (!('id' in value) || value['id'] === undefined) return false;
    return true;
}

export function PublicRingConfigurationFromJSON(json: any): PublicRingConfiguration {
    return PublicRingConfigurationFromJSONTyped(json, false);
}

export function PublicRingConfigurationFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicRingConfiguration {
    if (json == null) {
        return json;
    }
    return {
        ...
        'id': json['id'],
        'color': json['color'] == null ? undefined : PublicRingColorFromJSON(json['color']),
        'design': json['design'] == null ? undefined : PublicRingDesignFromJSON(json['design']),
        'firmwareVersion': json['firmware_version'] == null ? undefined : json['firmware_version'],
        'hardwareType': json['hardware_type'] == null ? undefined : PublicRingHardwareTypeFromJSON(json['hardware_type']),
        'setUpAt': json['set_up_at'] == null ? undefined : json['set_up_at'],
        'size': json['size'] == null ? undefined : json['size'],
    };
}

export function PublicRingConfigurationToJSON(json: any): PublicRingConfiguration {
    return PublicRingConfigurationToJSONTyped(json, false);
}

export function PublicRingConfigurationToJSONTyped(value?: PublicRingConfiguration | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'id': value['id'],
        'color': PublicRingColorToJSON(value['color']),
        'design': PublicRingDesignToJSON(value['design']),
        'firmware_version': value['firmwareVersion'],
        'hardware_type': PublicRingHardwareTypeToJSON(value['hardwareType']),
        'set_up_at': value['setUpAt'],
        'size': value['size'],
    };
}
