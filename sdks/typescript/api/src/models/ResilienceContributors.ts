...
/**
 * Check if a given object implements the ResilienceContributors interface.
 */
export function instanceOfResilienceContributors(value: object): value is ResilienceContributors {
    if (!('sleepRecovery' in value) || value['sleepRecovery'] === undefined) return false;
    if (!('daytimeRecovery' in value) || value['daytimeRecovery'] === undefined) return false;
    if (!('stress' in value) || value['stress'] === undefined) return false;
    return true;
}

export function ResilienceContributorsFromJSON(json: any): ResilienceContributors {
    return ResilienceContributorsFromJSONTyped(json, false);
}

export function ResilienceContributorsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResilienceContributors {
    if (json == null) {
        return json;
    }
    return {
        
        'sleepRecovery': json['sleep_recovery'],
        'daytimeRecovery': json['daytime_recovery'],
        'stress': json['stress'],
    };
}

export function ResilienceContributorsToJSON(json: any): ResilienceContributors {
    return ResilienceContributorsToJSONTyped(json, false);
}

export function ResilienceContributorsToJSONTyped(value?: ResilienceContributors | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'sleep_recovery': value['sleepRecovery'],
        'daytime_recovery': value['daytimeRecovery'],
        'stress': value['stress'],
    };
}
