 ...
 * @export
 * @interface PublicSpo2AggregatedValues
 */
export interface PublicSpo2AggregatedValues {
    /**
     * Average of spo2.
     * @type {number}
     * @memberof PublicSpo2AggregatedValues
     */
    average: number;
}

/**
 * Check if a given object implements the PublicSpo2AggregatedValues interface.
 */
export function instanceOfPublicSpo2AggregatedValues(value: object): value is PublicSpo2AggregatedValues {
    if (!('average' in value) || value['average'] === undefined) return false;
    return true;
}

export function PublicSpo2AggregatedValuesFromJSON(json: any): PublicSpo2AggregatedValues {
    return PublicSpo2AggregatedValuesFromJSONTyped(json, false);
}

export function PublicSpo2AggregatedValuesFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicSpo2AggregatedValues {
    if (json == null) {
        return json;
    }
    return {
...
export function PublicSpo2AggregatedValuesToJSON(json: any): PublicSpo2AggregatedValues {
    return PublicSpo2AggregatedValuesToJSONTyped(json, false);
}

export function PublicSpo2AggregatedValuesToJSONTyped(value?: PublicSpo2AggregatedValues | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
