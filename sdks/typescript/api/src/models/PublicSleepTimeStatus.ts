 ...
 * @export
 */
export const PublicSleepTimeStatus = {
...
export type PublicSleepTimeStatus = typeof PublicSleepTimeStatus[keyof typeof PublicSleepTimeStatus];


export function instanceOfPublicSleepTimeStatus(value: any): boolean {
    for (const key in PublicSleepTimeStatus) {
        if (Object.prototype.hasOwnProperty.call(PublicSleepTimeStatus, key)) {
            if (PublicSleepTimeStatus[key as keyof typeof PublicSleepTimeStatus] === value) {
                return true;
            }
        }
    }
...
export function PublicSleepTimeStatusFromJSON(json: any): PublicSleepTimeStatus {
    return PublicSleepTimeStatusFromJSONTyped(json, false);
}

export function PublicSleepTimeStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicSleepTimeStatus {
    return json as PublicSleepTimeStatus;
}

export function PublicSleepTimeStatusToJSON(value?: PublicSleepTimeStatus | null): any {
    return value as any;
}

export function PublicSleepTimeStatusToJSONTyped(value: any, ignoreDiscriminator: boolean): PublicSleepTimeStatus {
    return value as PublicSleepTimeStatus;
}
