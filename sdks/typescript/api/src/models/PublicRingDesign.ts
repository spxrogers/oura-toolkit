...
export type PublicRingDesign = typeof PublicRingDesign[keyof typeof PublicRingDesign];


export function instanceOfPublicRingDesign(value: any): boolean {
    for (const key in PublicRingDesign) {
        if (Object.prototype.hasOwnProperty.call(PublicRingDesign, key)) {
            if (PublicRingDesign[key as keyof typeof PublicRingDesign] === value) {
                return true;
            }
        }
    }
...
export function PublicRingDesignFromJSON(json: any): PublicRingDesign {
    return PublicRingDesignFromJSONTyped(json, false);
}

export function PublicRingDesignFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicRingDesign {
    return json as PublicRingDesign;
}

export function PublicRingDesignToJSON(value?: PublicRingDesign | null): any {
    return value as any;
}

export function PublicRingDesignToJSONTyped(value: any, ignoreDiscriminator: boolean): PublicRingDesign {
    return value as PublicRingDesign;
}
