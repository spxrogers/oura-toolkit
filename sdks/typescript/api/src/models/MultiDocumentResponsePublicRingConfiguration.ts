...
import type { PublicRingConfiguration } from './PublicRingConfiguration';
import {
    PublicRingConfigurationFromJSON,
    PublicRingConfigurationFromJSONTyped,
    PublicRingConfigurationToJSON,
    PublicRingConfigurationToJSONTyped,
} from './PublicRingConfiguration';

/**
 * 
 * @export
 * @interface MultiDocumentResponsePublicRingConfiguration
 */
export interface MultiDocumentResponsePublicRingConfiguration {
    /**
     * 
     * @type {Array<PublicRingConfiguration>}
     * @memberof MultiDocumentResponsePublicRingConfiguration
     */
    data: Array<PublicRingConfiguration>;
    /**
     * 
     * @type {string}
     * @memberof MultiDocumentResponsePublicRingConfiguration
...
/**
 * Check if a given object implements the MultiDocumentResponsePublicRingConfiguration interface.
 */
export function instanceOfMultiDocumentResponsePublicRingConfiguration(value: object): value is MultiDocumentResponsePublicRingConfiguration {
    if (!('data' in value) || value['data'] === undefined) return false;
    if (!('nextToken' in value) || value['nextToken'] === undefined) return false;
    return true;
}

export function MultiDocumentResponsePublicRingConfigurationFromJSON(json: any): MultiDocumentResponsePublicRingConfiguration {
    return MultiDocumentResponsePublicRingConfigurationFromJSONTyped(json, false);
}

export function MultiDocumentResponsePublicRingConfigurationFromJSONTyped(json: any, ignoreDiscriminator: boolean): MultiDocumentResponsePublicRingConfiguration {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(PublicRingConfigurationFromJSON)),
        'nextToken': json['next_token'],
    };
}

export function MultiDocumentResponsePublicRingConfigurationToJSON(json: any): MultiDocumentResponsePublicRingConfiguration {
    return MultiDocumentResponsePublicRingConfigurationToJSONTyped(json, false);
}

export function MultiDocumentResponsePublicRingConfigurationToJSONTyped(value?: MultiDocumentResponsePublicRingConfiguration | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ((value['data'] as Array<any>).map(PublicRingConfigurationToJSON)),
