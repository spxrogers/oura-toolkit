...
import type { PublicDailyCardiovascularAge } from './PublicDailyCardiovascularAge';
import {
    PublicDailyCardiovascularAgeFromJSON,
    PublicDailyCardiovascularAgeFromJSONTyped,
    PublicDailyCardiovascularAgeToJSON,
    PublicDailyCardiovascularAgeToJSONTyped,
} from './PublicDailyCardiovascularAge';

/**
 * 
 * @export
 * @interface MultiDocumentResponsePublicDailyCardiovascularAge
 */
export interface MultiDocumentResponsePublicDailyCardiovascularAge {
    /**
     * 
     * @type {Array<PublicDailyCardiovascularAge>}
     * @memberof MultiDocumentResponsePublicDailyCardiovascularAge
     */
    data: Array<PublicDailyCardiovascularAge>;
    /**
     * 
     * @type {string}
     * @memberof MultiDocumentResponsePublicDailyCardiovascularAge
...
/**
 * Check if a given object implements the MultiDocumentResponsePublicDailyCardiovascularAge interface.
 */
export function instanceOfMultiDocumentResponsePublicDailyCardiovascularAge(value: object): value is MultiDocumentResponsePublicDailyCardiovascularAge {
    if (!('data' in value) || value['data'] === undefined) return false;
    if (!('nextToken' in value) || value['nextToken'] === undefined) return false;
    return true;
}

export function MultiDocumentResponsePublicDailyCardiovascularAgeFromJSON(json: any): MultiDocumentResponsePublicDailyCardiovascularAge {
    return MultiDocumentResponsePublicDailyCardiovascularAgeFromJSONTyped(json, false);
}

export function MultiDocumentResponsePublicDailyCardiovascularAgeFromJSONTyped(json: any, ignoreDiscriminator: boolean): MultiDocumentResponsePublicDailyCardiovascularAge {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(PublicDailyCardiovascularAgeFromJSON)),
        'nextToken': json['next_token'],
    };
}

export function MultiDocumentResponsePublicDailyCardiovascularAgeToJSON(json: any): MultiDocumentResponsePublicDailyCardiovascularAge {
    return MultiDocumentResponsePublicDailyCardiovascularAgeToJSONTyped(json, false);
}

export function MultiDocumentResponsePublicDailyCardiovascularAgeToJSONTyped(value?: MultiDocumentResponsePublicDailyCardiovascularAge | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ((value['data'] as Array<any>).map(PublicDailyCardiovascularAgeToJSON)),
