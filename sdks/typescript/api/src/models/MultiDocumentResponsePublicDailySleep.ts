...
import type { PublicDailySleep } from './PublicDailySleep';
import {
    PublicDailySleepFromJSON,
    PublicDailySleepFromJSONTyped,
    PublicDailySleepToJSON,
    PublicDailySleepToJSONTyped,
} from './PublicDailySleep';

/**
 * 
 * @export
 * @interface MultiDocumentResponsePublicDailySleep
 */
export interface MultiDocumentResponsePublicDailySleep {
    /**
     * 
     * @type {Array<PublicDailySleep>}
     * @memberof MultiDocumentResponsePublicDailySleep
     */
    data: Array<PublicDailySleep>;
    /**
     * 
     * @type {string}
     * @memberof MultiDocumentResponsePublicDailySleep
...
/**
 * Check if a given object implements the MultiDocumentResponsePublicDailySleep interface.
 */
export function instanceOfMultiDocumentResponsePublicDailySleep(value: object): value is MultiDocumentResponsePublicDailySleep {
    if (!('data' in value) || value['data'] === undefined) return false;
    if (!('nextToken' in value) || value['nextToken'] === undefined) return false;
    return true;
}

export function MultiDocumentResponsePublicDailySleepFromJSON(json: any): MultiDocumentResponsePublicDailySleep {
    return MultiDocumentResponsePublicDailySleepFromJSONTyped(json, false);
}

export function MultiDocumentResponsePublicDailySleepFromJSONTyped(json: any, ignoreDiscriminator: boolean): MultiDocumentResponsePublicDailySleep {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(PublicDailySleepFromJSON)),
        'nextToken': json['next_token'],
    };
}

export function MultiDocumentResponsePublicDailySleepToJSON(json: any): MultiDocumentResponsePublicDailySleep {
    return MultiDocumentResponsePublicDailySleepToJSONTyped(json, false);
}

export function MultiDocumentResponsePublicDailySleepToJSONTyped(value?: MultiDocumentResponsePublicDailySleep | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ((value['data'] as Array<any>).map(PublicDailySleepToJSON)),
