...
import type { PublicModifiedSleepModel } from './PublicModifiedSleepModel';
import {
    PublicModifiedSleepModelFromJSON,
    PublicModifiedSleepModelFromJSONTyped,
    PublicModifiedSleepModelToJSON,
    PublicModifiedSleepModelToJSONTyped,
} from './PublicModifiedSleepModel';

/**
 * 
 * @export
 * @interface MultiDocumentResponsePublicModifiedSleepModel
 */
export interface MultiDocumentResponsePublicModifiedSleepModel {
    /**
     * 
     * @type {Array<PublicModifiedSleepModel>}
     * @memberof MultiDocumentResponsePublicModifiedSleepModel
     */
    data: Array<PublicModifiedSleepModel>;
    /**
     * 
     * @type {string}
     * @memberof MultiDocumentResponsePublicModifiedSleepModel
...
/**
 * Check if a given object implements the MultiDocumentResponsePublicModifiedSleepModel interface.
 */
export function instanceOfMultiDocumentResponsePublicModifiedSleepModel(value: object): value is MultiDocumentResponsePublicModifiedSleepModel {
    if (!('data' in value) || value['data'] === undefined) return false;
    if (!('nextToken' in value) || value['nextToken'] === undefined) return false;
    return true;
}

export function MultiDocumentResponsePublicModifiedSleepModelFromJSON(json: any): MultiDocumentResponsePublicModifiedSleepModel {
    return MultiDocumentResponsePublicModifiedSleepModelFromJSONTyped(json, false);
}

export function MultiDocumentResponsePublicModifiedSleepModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): MultiDocumentResponsePublicModifiedSleepModel {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(PublicModifiedSleepModelFromJSON)),
        'nextToken': json['next_token'],
    };
}

export function MultiDocumentResponsePublicModifiedSleepModelToJSON(json: any): MultiDocumentResponsePublicModifiedSleepModel {
    return MultiDocumentResponsePublicModifiedSleepModelToJSONTyped(json, false);
}

export function MultiDocumentResponsePublicModifiedSleepModelToJSONTyped(value?: MultiDocumentResponsePublicModifiedSleepModel | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ((value['data'] as Array<any>).map(PublicModifiedSleepModelToJSON)),
