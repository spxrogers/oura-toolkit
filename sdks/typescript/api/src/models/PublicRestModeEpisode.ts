...
/**
 * Check if a given object implements the PublicRestModeEpisode interface.
 */
export function instanceOfPublicRestModeEpisode(value: object): value is PublicRestModeEpisode {
    if (!('tags' in value) || value['tags'] === undefined) return false;
    if (!('timestamp' in value) || value['timestamp'] === undefined) return false;
    return true;
}

export function PublicRestModeEpisodeFromJSON(json: any): PublicRestModeEpisode {
    return PublicRestModeEpisodeFromJSONTyped(json, false);
}

export function PublicRestModeEpisodeFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicRestModeEpisode {
    if (json == null) {
        return json;
    }
    return {
...
export function PublicRestModeEpisodeToJSON(json: any): PublicRestModeEpisode {
    return PublicRestModeEpisodeToJSONTyped(json, false);
}

export function PublicRestModeEpisodeToJSONTyped(value?: PublicRestModeEpisode | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
