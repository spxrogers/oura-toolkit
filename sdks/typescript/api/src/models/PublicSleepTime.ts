...
import type { PublicSleepTimeWindow } from './PublicSleepTimeWindow';
import {
    PublicSleepTimeWindowFromJSON,
    PublicSleepTimeWindowFromJSONTyped,
    PublicSleepTimeWindowToJSON,
    PublicSleepTimeWindowToJSONTyped,
} from './PublicSleepTimeWindow';
import type { PublicSleepTimeStatus } from './PublicSleepTimeStatus';
import {
    PublicSleepTimeStatusFromJSON,
    PublicSleepTimeStatusFromJSONTyped,
    PublicSleepTimeStatusToJSON,
    PublicSleepTimeStatusToJSONTyped,
} from './PublicSleepTimeStatus';
import type { PublicSleepTimeRecommendation } from './PublicSleepTimeRecommendation';
import {
    PublicSleepTimeRecommendationFromJSON,
    PublicSleepTimeRecommendationFromJSONTyped,
    PublicSleepTimeRecommendationToJSON,
    PublicSleepTimeRecommendationToJSONTyped,
} from './PublicSleepTimeRecommendation';

/**
 * Suggested bedtime for the user.
 * @export
 * @interface PublicSleepTime
 */
export interface PublicSleepTime {
    /**
     * Unique identifier of the object.
     * @type {string}
     * @memberof PublicSleepTime
     */
    id: string;
    /**
     * 
    ...
    /**
     * 
     * @type {PublicSleepTimeWindow}
     * @memberof PublicSleepTime
     */
    optimalBedtime?: PublicSleepTimeWindow | null;
    /**
     * 
     * @type {PublicSleepTimeRecommendation}
     * @memberof PublicSleepTime
     */
    recommendation?: PublicSleepTimeRecommendation | null;
    /**
     * 
     * @type {PublicSleepTimeStatus}
     * @memberof PublicSleepTime
     */
...
/**
 * Check if a given object implements the PublicSleepTime interface.
 */
export function instanceOfPublicSleepTime(value: object): value is PublicSleepTime {
    if (!('id' in value) || value['id'] === undefined) return false;
    if (!('day' in value) || value['day'] === undefined) return false;
    return true;
}

export function PublicSleepTimeFromJSON(json: any): PublicSleepTime {
    return PublicSleepTimeFromJSONTyped(json, false);
}

export function PublicSleepTimeFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicSleepTime {
    if (json == null) {
        return json;
    }
    return {
        ...
        'id': json['id'],
        'day': json['day'],
        'optimalBedtime': json['optimal_bedtime'] == null ? undefined : PublicSleepTimeWindowFromJSON(json['optimal_bedtime']),
        'recommendation': json['recommendation'] == null ? undefined : PublicSleepTimeRecommendationFromJSON(json['recommendation']),
        'status': json['status'] == null ? undefined : PublicSleepTimeStatusFromJSON(json['status']),
    };
}

export function PublicSleepTimeToJSON(json: any): PublicSleepTime {
    return PublicSleepTimeToJSONTyped(json, false);
}

export function PublicSleepTimeToJSONTyped(value?: PublicSleepTime | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'id': value['id'],
        'day': value['day'],
        'optimal_bedtime': PublicSleepTimeWindowToJSON(value['optimalBedtime']),
        'recommendation': PublicSleepTimeRecommendationToJSON(value['recommendation']),
        'status': PublicSleepTimeStatusToJSON(value['status']),
    };
}
