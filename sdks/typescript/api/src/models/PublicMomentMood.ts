...
export type PublicMomentMood = typeof PublicMomentMood[keyof typeof PublicMomentMood];


export function instanceOfPublicMomentMood(value: any): boolean {
    for (const key in PublicMomentMood) {
        if (Object.prototype.hasOwnProperty.call(PublicMomentMood, key)) {
            if (PublicMomentMood[key as keyof typeof PublicMomentMood] === value) {
                return true;
            }
        }
    }
...
export function PublicMomentMoodFromJSON(json: any): PublicMomentMood {
    return PublicMomentMoodFromJSONTyped(json, false);
}

export function PublicMomentMoodFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicMomentMood {
    return json as PublicMomentMood;
}

export function PublicMomentMoodToJSON(value?: PublicMomentMood | null): any {
    return value as any;
}

export function PublicMomentMoodToJSONTyped(value: any, ignoreDiscriminator: boolean): PublicMomentMood {
    return value as PublicMomentMood;
}
