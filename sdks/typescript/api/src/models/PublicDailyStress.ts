...
import type { PublicDailyStressSummary } from './PublicDailyStressSummary';
import {
    PublicDailyStressSummaryFromJSON,
    PublicDailyStressSummaryFromJSONTyped,
    PublicDailyStressSummaryToJSON,
    PublicDailyStressSummaryToJSONTyped,
} from './PublicDailyStressSummary';

/**
 * Daily stress.
 * @export
 * @interface PublicDailyStress
 */
export interface PublicDailyStress {
    /**
     * Unique identifier of the object.
     * @type {string}
     * @memberof PublicDailyStress
     */
    id: string;
    /**
     * 
    ...
    /**
     * 
     * @type {PublicDailyStressSummary}
     * @memberof PublicDailyStress
     */
    daySummary?: PublicDailyStressSummary | null;
    /**
     * 
     * @type {number}
     * @memberof PublicDailyStress
...
/**
 * Check if a given object implements the PublicDailyStress interface.
 */
export function instanceOfPublicDailyStress(value: object): value is PublicDailyStress {
    if (!('id' in value) || value['id'] === undefined) return false;
    if (!('day' in value) || value['day'] === undefined) return false;
    return true;
}

export function PublicDailyStressFromJSON(json: any): PublicDailyStress {
    return PublicDailyStressFromJSONTyped(json, false);
}

export function PublicDailyStressFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicDailyStress {
    if (json == null) {
        return json;
    }
    return {
        ...
        'id': json['id'],
        'day': json['day'],
        'daySummary': json['day_summary'] == null ? undefined : PublicDailyStressSummaryFromJSON(json['day_summary']),
        'recoveryHigh': json['recovery_high'] == null ? undefined : json['recovery_high'],
        'stressHigh': json['stress_high'] == null ? undefined : json['stress_high'],
    };
}

export function PublicDailyStressToJSON(json: any): PublicDailyStress {
    return PublicDailyStressToJSONTyped(json, false);
}

export function PublicDailyStressToJSONTyped(value?: PublicDailyStress | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'id': value['id'],
        'day': value['day'],
        'day_summary': PublicDailyStressSummaryToJSON(value['daySummary']),
        'recovery_high': value['recoveryHigh'],
        'stress_high': value['stressHigh'],
    };
}
