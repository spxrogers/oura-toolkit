 ...
 * @export
 */
export const PublicWorkoutIntensity = {
    Easy: 'easy',
    Moderate: 'moderate',
    Hard: 'hard'
} as const;
export type PublicWorkoutIntensity = typeof PublicWorkoutIntensity[keyof typeof PublicWorkoutIntensity];


export function instanceOfPublicWorkoutIntensity(value: any): boolean {
    for (const key in PublicWorkoutIntensity) {
        if (Object.prototype.hasOwnProperty.call(PublicWorkoutIntensity, key)) {
            if (PublicWorkoutIntensity[key as keyof typeof PublicWorkoutIntensity] === value) {
                return true;
            }
        }
    }
...
export function PublicWorkoutIntensityFromJSON(json: any): PublicWorkoutIntensity {
    return PublicWorkoutIntensityFromJSONTyped(json, false);
}

export function PublicWorkoutIntensityFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicWorkoutIntensity {
    return json as PublicWorkoutIntensity;
}

export function PublicWorkoutIntensityToJSON(value?: PublicWorkoutIntensity | null): any {
    return value as any;
}

export function PublicWorkoutIntensityToJSONTyped(value: any, ignoreDiscriminator: boolean): PublicWorkoutIntensity {
    return value as PublicWorkoutIntensity;
}
