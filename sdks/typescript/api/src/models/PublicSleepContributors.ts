 ...
 * @export
 * @interface PublicSleepContributors
 */
export interface PublicSleepContributors {
    /**
     * 
     * @type {number}
     * @memberof PublicSleepContributors
     */
...
/**
 * Check if a given object implements the PublicSleepContributors interface.
 */
export function instanceOfPublicSleepContributors(value: object): value is PublicSleepContributors {
    return true;
}

export function PublicSleepContributorsFromJSON(json: any): PublicSleepContributors {
    return PublicSleepContributorsFromJSONTyped(json, false);
}

export function PublicSleepContributorsFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicSleepContributors {
    if (json == null) {
        return json;
    }
    return {
        
        'deepSleep': json['deep_sleep'] == null ? undefined : json['deep_sleep'],
        'efficiency': json['efficiency'] == null ? undefined : json['efficiency'],
        'latency': json['latency'] == null ? undefined : json['latency'],
        'remSleep': json['rem_sleep'] == null ? undefined : json['rem_sleep'],
        'restfulness': json['restfulness'] == null ? undefined : json['restfulness'],
        'timing': json['timing'] == null ? undefined : json['timing'],
        'totalSleep': json['total_sleep'] == null ? undefined : json['total_sleep'],
    };
}

export function PublicSleepContributorsToJSON(json: any): PublicSleepContributors {
    return PublicSleepContributorsToJSONTyped(json, false);
}

export function PublicSleepContributorsToJSONTyped(value?: PublicSleepContributors | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'deep_sleep': value['deepSleep'],
        'efficiency': value['efficiency'],
        'latency': value['latency'],
        'rem_sleep': value['remSleep'],
        'restfulness': value['restfulness'],
        'timing': value['timing'],
        'total_sleep': value['totalSleep'],
    };
}
