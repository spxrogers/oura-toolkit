...
/**
 * Check if a given object implements the PublicSleepTimeWindow interface.
 */
export function instanceOfPublicSleepTimeWindow(value: object): value is PublicSleepTimeWindow {
    if (!('dayTz' in value) || value['dayTz'] === undefined) return false;
...
export function PublicSleepTimeWindowFromJSON(json: any): PublicSleepTimeWindow {
    return PublicSleepTimeWindowFromJSONTyped(json, false);
}

export function PublicSleepTimeWindowFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicSleepTimeWindow {
    if (json == null) {
        return json;
    }
    return {
...
export function PublicSleepTimeWindowToJSON(json: any): PublicSleepTimeWindow {
    return PublicSleepTimeWindowToJSONTyped(json, false);
}

export function PublicSleepTimeWindowToJSONTyped(value?: PublicSleepTimeWindow | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
