 ...
 * @export
 * @interface EnhancedTagModel
 */
export interface EnhancedTagModel {
    /**
     * 
     * @type {string}
     * @memberof EnhancedTagModel
     */
    id: string;
    /**
     * 
...
/**
 * Check if a given object implements the EnhancedTagModel interface.
 */
export function instanceOfEnhancedTagModel(value: object): value is EnhancedTagModel {
...
export function EnhancedTagModelFromJSON(json: any): EnhancedTagModel {
    return EnhancedTagModelFromJSONTyped(json, false);
}

export function EnhancedTagModelFromJSONTyped(json: any, ignoreDiscriminator: boolean): EnhancedTagModel {
    if (json == null) {
        return json;
    }
    return {
        ...
        'id': json['id'],
        'tagTypeCode': json['tag_type_code'] == null ? undefined : json['tag_type_code'],
        'startTime': json['start_time'],
        'endTime': json['end_time'] == null ? undefined : json['end_time'],
        'startDay': (new Date(json['start_day'])),
        'endDay': json['end_day'] == null ? undefined : (new Date(json['end_day'])),
        'comment': json['comment'] == null ? undefined : json['comment'],
        'customName': json['custom_name'] == null ? undefined : json['custom_name'],
    };
}

export function EnhancedTagModelToJSON(json: any): EnhancedTagModel {
    return EnhancedTagModelToJSONTyped(json, false);
}

export function EnhancedTagModelToJSONTyped(value?: EnhancedTagModel | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'id': value['id'],
        'tag_type_code': value['tagTypeCode'],
        'start_time': value['startTime'],
        'end_time': value['endTime'],
        'start_day': ((value['startDay']).toISOString().substring(0,10)),
        'end_day': value['endDay'] === null ? null : ((value['endDay'] as any)?.toISOString().substring(0,10)),
