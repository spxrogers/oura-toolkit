 ...
 * @export
 */
export const PublicSleepAlgorithmVersion = {
    V1: 'v1',
    V2: 'v2'
} as const;
export type PublicSleepAlgorithmVersion = typeof PublicSleepAlgorithmVersion[keyof typeof PublicSleepAlgorithmVersion];


export function instanceOfPublicSleepAlgorithmVersion(value: any): boolean {
    for (const key in PublicSleepAlgorithmVersion) {
        if (Object.prototype.hasOwnProperty.call(PublicSleepAlgorithmVersion, key)) {
            if (PublicSleepAlgorithmVersion[key as keyof typeof PublicSleepAlgorithmVersion] === value) {
                return true;
            }
        }
    }
...
export function PublicSleepAlgorithmVersionFromJSON(json: any): PublicSleepAlgorithmVersion {
    return PublicSleepAlgorithmVersionFromJSONTyped(json, false);
}

export function PublicSleepAlgorithmVersionFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicSleepAlgorithmVersion {
    return json as PublicSleepAlgorithmVersion;
}

export function PublicSleepAlgorithmVersionToJSON(value?: PublicSleepAlgorithmVersion | null): any {
    return value as any;
}

export function PublicSleepAlgorithmVersionToJSONTyped(value: any, ignoreDiscriminator: boolean): PublicSleepAlgorithmVersion {
    return value as PublicSleepAlgorithmVersion;
}
