 ...
 * VO2Max estimate.
 * @export
 * @interface PublicVO2Max
 */
export interface PublicVO2Max {
    /**
     * Unique identifier of the object.
     * @type {string}
     * @memberof PublicVO2Max
     */
    id: string;
    /**
     * 
...
/**
 * Check if a given object implements the PublicVO2Max interface.
 */
export function instanceOfPublicVO2Max(value: object): value is PublicVO2Max {
    if (!('id' in value) || value['id'] === undefined) return false;
    if (!('day' in value) || value['day'] === undefined) return false;
    if (!('timestamp' in value) || value['timestamp'] === undefined) return false;
    if (!('vo2Max' in value) || value['vo2Max'] === undefined) return false;
    return true;
}

export function PublicVO2MaxFromJSON(json: any): PublicVO2Max {
    return PublicVO2MaxFromJSONTyped(json, false);
}

export function PublicVO2MaxFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicVO2Max {
    if (json == null) {
        return json;
    }
    return {
...
export function PublicVO2MaxToJSON(json: any): PublicVO2Max {
    return PublicVO2MaxToJSONTyped(json, false);
}

export function PublicVO2MaxToJSONTyped(value?: PublicVO2Max | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
