 ...
 * @export
 * @interface PublicRingBatteryLevelRow
 */
export interface PublicRingBatteryLevelRow {
    /**
     * 
     * @type {string}
     * @memberof PublicRingBatteryLevelRow
     */
...
/**
 * Check if a given object implements the PublicRingBatteryLevelRow interface.
 */
export function instanceOfPublicRingBatteryLevelRow(value: object): value is PublicRingBatteryLevelRow {
...
export function PublicRingBatteryLevelRowFromJSON(json: any): PublicRingBatteryLevelRow {
    return PublicRingBatteryLevelRowFromJSONTyped(json, false);
}

export function PublicRingBatteryLevelRowFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicRingBatteryLevelRow {
    if (json == null) {
        return json;
    }
    return {
        ...
        'charging': json['charging'] == null ? undefined : json['charging'],
        'inCharger': json['in_charger'] == null ? undefined : json['in_charger'],
        'level': json['level'],
    };
}

export function PublicRingBatteryLevelRowToJSON(json: any): PublicRingBatteryLevelRow {
    return PublicRingBatteryLevelRowToJSONTyped(json, false);
}

export function PublicRingBatteryLevelRowToJSONTyped(value?: PublicRingBatteryLevelRow | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
