...
```
nuget pack -Build -OutputDirectory out OuraToolkit.Api.csproj
```
...
namespace Example
{
    public class Example
    {
        public static void Main()
        {
            ...
            var startDate = DateOnly.Parse("2013-10-20");  // DateOnly? |  (optional) 
            var endDate = DateOnly.Parse("2013-10-20");  // DateOnly? |  (optional) 
