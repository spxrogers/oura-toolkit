...
namespace OuraToolkit.Api.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/0.2.2/csharp");
        ...
        public Configuration(
            ...
            string basePath = "https://api.ouraring.com") : this()
        {
        ...
        {
            string report = "C# SDK (OuraToolkit.Api) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 2.0\n";
            report += "    SDK Package Version: 0.2.2\n";
