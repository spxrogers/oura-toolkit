...
namespace OuraToolkit.Api.Api
{
    ...
    /// </summary>
    public interface IDailyCardiovascularAgeRoutesApiSync : IApiAccessor
    {
        ...
        PublicDailyCardiovascularAge SingleDailyCardiovascularAgeDocumentV2UsercollectionDailyCardiovascularAgeDocumentIdGet(string documentId);
        ...
        ApiResponse<PublicDailyCardiovascularAge> SingleDailyCardiovascularAgeDocumentV2UsercollectionDailyCardiovascularAgeDocumentIdGetWithHttpInfo(string documentId);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IDailyCardiovascularAgeRoutesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<PublicDailyCardiovascularAge> SingleDailyCardiovascularAgeDocumentV2UsercollectionDailyCardiovascularAgeDocumentIdGetAsync(string documentId, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<PublicDailyCardiovascularAge>> SingleDailyCardiovascularAgeDocumentV2UsercollectionDailyCardiovascularAgeDocumentIdGetWithHttpInfoAsync(string documentId, System.Threading.CancellationToken cancellationToken = default);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IDailyCardiovascularAgeRoutesApi : IDailyCardiovascularAgeRoutesApiSync, IDailyCardiovascularAgeRoutesApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class DailyCardiovascularAgeRoutesApi : IDisposable, IDailyCardiovascularAgeRoutesApi
    {
        private OuraToolkit.Api.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="DailyCardiovascularAgeRoutesApi"/> class.
        /// **IMPORTANT** This will also create an instance of HttpClient, which is less than ideal.
        /// It's better to reuse the <see href="https://docs.microsoft.com/en-us/dotnet/architecture/microservices/implement-resilient-applications/use-httpclientfactory-to-implement-resilient-http-requests#issues-with-the-original-httpclient-class-available-in-net">HttpClient and HttpClientHandler</see>.
        /// </summary>
        /// <returns></returns>
        public DailyCardiovascularAgeRoutesApi() : this((string)null)
        {
        }
        ...
        /// <returns></returns>
        public DailyCardiovascularAgeRoutesApi(string basePath)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DailyCardiovascularAgeRoutesApi"/> class using Configuration object.
        /// **IMPORTANT** This will also create an instance of HttpClient, which is less than ideal.
        /// It's better to reuse the <see href="https://docs.microsoft.com/en-us/dotnet/architecture/microservices/implement-resilient-applications/use-httpclientfactory-to-implement-resilient-http-requests#issues-with-the-original-httpclient-class-available-in-net">HttpClient and HttpClientHandler</see>.
        /// </summary>
        ...
        /// <returns></returns>
        public DailyCardiovascularAgeRoutesApi(OuraToolkit.Api.Client.Configuration configuration)
        {
        ...
        /// </remarks>
        public DailyCardiovascularAgeRoutesApi(HttpClient client, HttpClientHandler handler = null) : this(client, (string)null, handler)
        {
        }
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public DailyCardiovascularAgeRoutesApi(HttpClient client, string basePath, HttpClientHandler handler = null)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public DailyCardiovascularAgeRoutesApi(HttpClient client, OuraToolkit.Api.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public DailyCardiovascularAgeRoutesApi(OuraToolkit.Api.Client.ISynchronousClient client, OuraToolkit.Api.Client.IAsynchronousClient asyncClient, OuraToolkit.Api.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        public OuraToolkit.Api.Client.ApiResponse<MultiDocumentResponsePublicDailyCardiovascularAge> MultipleDailyCardiovascularAgeDocumentsV2UsercollectionDailyCardiovascularAgeGetWithHttpInfo(DateOnly? startDate = default, DateOnly? endDate = default, string? nextToken = default, string? fields = default)
        {
            ...
            var localVarResponse = this.Client.Get<MultiDocumentResponsePublicDailyCardiovascularAge>("/v2/usercollection/daily_cardiovascular_age", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("MultipleDailyCardiovascularAgeDocumentsV2UsercollectionDailyCardiovascularAgeGet", localVarResponse);
        ...
        public async System.Threading.Tasks.Task<OuraToolkit.Api.Client.ApiResponse<MultiDocumentResponsePublicDailyCardiovascularAge>> MultipleDailyCardiovascularAgeDocumentsV2UsercollectionDailyCardiovascularAgeGetWithHttpInfoAsync(DateOnly? startDate = default, DateOnly? endDate = default, string? nextToken = default, string? fields = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<MultiDocumentResponsePublicDailyCardiovascularAge>("/v2/usercollection/daily_cardiovascular_age", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="documentId"></param>
        /// <returns>PublicDailyCardiovascularAge</returns>
        public PublicDailyCardiovascularAge SingleDailyCardiovascularAgeDocumentV2UsercollectionDailyCardiovascularAgeDocumentIdGet(string documentId)
        {
            OuraToolkit.Api.Client.ApiResponse<PublicDailyCardiovascularAge> localVarResponse = SingleDailyCardiovascularAgeDocumentV2UsercollectionDailyCardiovascularAgeDocumentIdGetWithHttpInfo(documentId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="documentId"></param>
        /// <returns>ApiResponse of PublicDailyCardiovascularAge</returns>
        public OuraToolkit.Api.Client.ApiResponse<PublicDailyCardiovascularAge> SingleDailyCardiovascularAgeDocumentV2UsercollectionDailyCardiovascularAgeDocumentIdGetWithHttpInfo(string documentId)
        {
            // verify the required parameter 'documentId' is set
            if (documentId == null)
                throw new OuraToolkit.Api.Client.ApiException(400, "Missing required parameter 'documentId' when calling DailyCardiovascularAgeRoutesApi->SingleDailyCardiovascularAgeDocumentV2UsercollectionDailyCardiovascularAgeDocumentIdGet");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<PublicDailyCardiovascularAge>("/v2/usercollection/daily_cardiovascular_age/{document_id}", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("SingleDailyCardiovascularAgeDocumentV2UsercollectionDailyCardiovascularAgeDocumentIdGet", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of PublicDailyCardiovascularAge</returns>
        public async System.Threading.Tasks.Task<PublicDailyCardiovascularAge> SingleDailyCardiovascularAgeDocumentV2UsercollectionDailyCardiovascularAgeDocumentIdGetAsync(string documentId, System.Threading.CancellationToken cancellationToken = default)
        {
            OuraToolkit.Api.Client.ApiResponse<PublicDailyCardiovascularAge> localVarResponse = await SingleDailyCardiovascularAgeDocumentV2UsercollectionDailyCardiovascularAgeDocumentIdGetWithHttpInfoAsync(documentId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PublicDailyCardiovascularAge)</returns>
        public async System.Threading.Tasks.Task<OuraToolkit.Api.Client.ApiResponse<PublicDailyCardiovascularAge>> SingleDailyCardiovascularAgeDocumentV2UsercollectionDailyCardiovascularAgeDocumentIdGetWithHttpInfoAsync(string documentId, System.Threading.CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'documentId' is set
            if (documentId == null)
                throw new OuraToolkit.Api.Client.ApiException(400, "Missing required parameter 'documentId' when calling DailyCardiovascularAgeRoutesApi->SingleDailyCardiovascularAgeDocumentV2UsercollectionDailyCardiovascularAgeDocumentIdGet");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<PublicDailyCardiovascularAge>("/v2/usercollection/daily_cardiovascular_age/{document_id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
