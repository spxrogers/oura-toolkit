...
namespace OuraToolkit.Api.Api
{
    ...
    /// </summary>
    public interface IDailyReadinessRoutesApiSync : IApiAccessor
    {
        ...
        MultiDocumentResponsePublicDailyReadiness MultipleDailyReadinessDocumentsV2UsercollectionDailyReadinessGet(DateOnly? startDate = default, DateOnly? endDate = default, string? nextToken = default, string? fields = default);
        ...
        ApiResponse<MultiDocumentResponsePublicDailyReadiness> MultipleDailyReadinessDocumentsV2UsercollectionDailyReadinessGetWithHttpInfo(DateOnly? startDate = default, DateOnly? endDate = default, string? nextToken = default, string? fields = default);
        /// <summary>
        ...
        PublicDailyReadiness SingleDailyReadinessDocumentV2UsercollectionDailyReadinessDocumentIdGet(string documentId);
        ...
        ApiResponse<PublicDailyReadiness> SingleDailyReadinessDocumentV2UsercollectionDailyReadinessDocumentIdGetWithHttpInfo(string documentId);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IDailyReadinessRoutesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<MultiDocumentResponsePublicDailyReadiness> MultipleDailyReadinessDocumentsV2UsercollectionDailyReadinessGetAsync(DateOnly? startDate = default, DateOnly? endDate = default, string? nextToken = default, string? fields = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<MultiDocumentResponsePublicDailyReadiness>> MultipleDailyReadinessDocumentsV2UsercollectionDailyReadinessGetWithHttpInfoAsync(DateOnly? startDate = default, DateOnly? endDate = default, string? nextToken = default, string? fields = default, System.Threading.CancellationToken cancellationToken = default);
        /// <summary>
        /// Single Daily Readiness Document
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<PublicDailyReadiness> SingleDailyReadinessDocumentV2UsercollectionDailyReadinessDocumentIdGetAsync(string documentId, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<PublicDailyReadiness>> SingleDailyReadinessDocumentV2UsercollectionDailyReadinessDocumentIdGetWithHttpInfoAsync(string documentId, System.Threading.CancellationToken cancellationToken = default);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IDailyReadinessRoutesApi : IDailyReadinessRoutesApiSync, IDailyReadinessRoutesApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class DailyReadinessRoutesApi : IDisposable, IDailyReadinessRoutesApi
    {
        private OuraToolkit.Api.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="DailyReadinessRoutesApi"/> class.
        /// **IMPORTANT** This will also create an instance of HttpClient, which is less than ideal.
        /// It's better to reuse the <see href="https://docs.microsoft.com/en-us/dotnet/architecture/microservices/implement-resilient-applications/use-httpclientfactory-to-implement-resilient-http-requests#issues-with-the-original-httpclient-class-available-in-net">HttpClient and HttpClientHandler</see>.
        /// </summary>
        /// <returns></returns>
        public DailyReadinessRoutesApi() : this((string)null)
        {
        }
        ...
        /// <returns></returns>
        public DailyReadinessRoutesApi(string basePath)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DailyReadinessRoutesApi"/> class using Configuration object.
        /// **IMPORTANT** This will also create an instance of HttpClient, which is less than ideal.
        /// It's better to reuse the <see href="https://docs.microsoft.com/en-us/dotnet/architecture/microservices/implement-resilient-applications/use-httpclientfactory-to-implement-resilient-http-requests#issues-with-the-original-httpclient-class-available-in-net">HttpClient and HttpClientHandler</see>.
        /// </summary>
        ...
        /// <returns></returns>
        public DailyReadinessRoutesApi(OuraToolkit.Api.Client.Configuration configuration)
        {
        ...
        /// </remarks>
        public DailyReadinessRoutesApi(HttpClient client, HttpClientHandler handler = null) : this(client, (string)null, handler)
        {
        }
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public DailyReadinessRoutesApi(HttpClient client, string basePath, HttpClientHandler handler = null)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public DailyReadinessRoutesApi(HttpClient client, OuraToolkit.Api.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public DailyReadinessRoutesApi(OuraToolkit.Api.Client.ISynchronousClient client, OuraToolkit.Api.Client.IAsynchronousClient asyncClient, OuraToolkit.Api.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <param name="fields">Comma-separated list of fields to include in the response, in addition to the always returned fields. Defaults to all fields if not provided. (optional)</param>
        /// <returns>MultiDocumentResponsePublicDailyReadiness</returns>
        public MultiDocumentResponsePublicDailyReadiness MultipleDailyReadinessDocumentsV2UsercollectionDailyReadinessGet(DateOnly? startDate = default, DateOnly? endDate = default, string? nextToken = default, string? fields = default)
        {
            OuraToolkit.Api.Client.ApiResponse<MultiDocumentResponsePublicDailyReadiness> localVarResponse = MultipleDailyReadinessDocumentsV2UsercollectionDailyReadinessGetWithHttpInfo(startDate, endDate, nextToken, fields);
        ...
        /// <param name="fields">Comma-separated list of fields to include in the response, in addition to the always returned fields. Defaults to all fields if not provided. (optional)</param>
        /// <returns>ApiResponse of MultiDocumentResponsePublicDailyReadiness</returns>
        public OuraToolkit.Api.Client.ApiResponse<MultiDocumentResponsePublicDailyReadiness> MultipleDailyReadinessDocumentsV2UsercollectionDailyReadinessGetWithHttpInfo(DateOnly? startDate = default, DateOnly? endDate = default, string? nextToken = default, string? fields = default)
        {
            ...
            var localVarResponse = this.Client.Get<MultiDocumentResponsePublicDailyReadiness>("/v2/usercollection/daily_readiness", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("MultipleDailyReadinessDocumentsV2UsercollectionDailyReadinessGet", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of MultiDocumentResponsePublicDailyReadiness</returns>
        public async System.Threading.Tasks.Task<MultiDocumentResponsePublicDailyReadiness> MultipleDailyReadinessDocumentsV2UsercollectionDailyReadinessGetAsync(DateOnly? startDate = default, DateOnly? endDate = default, string? nextToken = default, string? fields = default, System.Threading.CancellationToken cancellationToken = default)
        {
            OuraToolkit.Api.Client.ApiResponse<MultiDocumentResponsePublicDailyReadiness> localVarResponse = await MultipleDailyReadinessDocumentsV2UsercollectionDailyReadinessGetWithHttpInfoAsync(startDate, endDate, nextToken, fields, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (MultiDocumentResponsePublicDailyReadiness)</returns>
        public async System.Threading.Tasks.Task<OuraToolkit.Api.Client.ApiResponse<MultiDocumentResponsePublicDailyReadiness>> MultipleDailyReadinessDocumentsV2UsercollectionDailyReadinessGetWithHttpInfoAsync(DateOnly? startDate = default, DateOnly? endDate = default, string? nextToken = default, string? fields = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<MultiDocumentResponsePublicDailyReadiness>("/v2/usercollection/daily_readiness", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="documentId"></param>
        /// <returns>PublicDailyReadiness</returns>
        public PublicDailyReadiness SingleDailyReadinessDocumentV2UsercollectionDailyReadinessDocumentIdGet(string documentId)
        {
            OuraToolkit.Api.Client.ApiResponse<PublicDailyReadiness> localVarResponse = SingleDailyReadinessDocumentV2UsercollectionDailyReadinessDocumentIdGetWithHttpInfo(documentId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="documentId"></param>
        /// <returns>ApiResponse of PublicDailyReadiness</returns>
        public OuraToolkit.Api.Client.ApiResponse<PublicDailyReadiness> SingleDailyReadinessDocumentV2UsercollectionDailyReadinessDocumentIdGetWithHttpInfo(string documentId)
        {
            // verify the required parameter 'documentId' is set
            if (documentId == null)
                throw new OuraToolkit.Api.Client.ApiException(400, "Missing required parameter 'documentId' when calling DailyReadinessRoutesApi->SingleDailyReadinessDocumentV2UsercollectionDailyReadinessDocumentIdGet");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<PublicDailyReadiness>("/v2/usercollection/daily_readiness/{document_id}", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("SingleDailyReadinessDocumentV2UsercollectionDailyReadinessDocumentIdGet", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of PublicDailyReadiness</returns>
        public async System.Threading.Tasks.Task<PublicDailyReadiness> SingleDailyReadinessDocumentV2UsercollectionDailyReadinessDocumentIdGetAsync(string documentId, System.Threading.CancellationToken cancellationToken = default)
        {
            OuraToolkit.Api.Client.ApiResponse<PublicDailyReadiness> localVarResponse = await SingleDailyReadinessDocumentV2UsercollectionDailyReadinessDocumentIdGetWithHttpInfoAsync(documentId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PublicDailyReadiness)</returns>
        public async System.Threading.Tasks.Task<OuraToolkit.Api.Client.ApiResponse<PublicDailyReadiness>> SingleDailyReadinessDocumentV2UsercollectionDailyReadinessDocumentIdGetWithHttpInfoAsync(string documentId, System.Threading.CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'documentId' is set
            if (documentId == null)
                throw new OuraToolkit.Api.Client.ApiException(400, "Missing required parameter 'documentId' when calling DailyReadinessRoutesApi->SingleDailyReadinessDocumentV2UsercollectionDailyReadinessDocumentIdGet");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<PublicDailyReadiness>("/v2/usercollection/daily_readiness/{document_id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
