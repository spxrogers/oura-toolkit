...
namespace OuraToolkit.Api.Api
{
    ...
    /// </summary>
    public interface ITagRoutesApiSync : IApiAccessor
    {
        ...
        MultiDocumentResponseTagModel MultipleTagDocumentsV2UsercollectionTagGet(DateTime? startDate = default, DateTime? endDate = default, string? nextToken = default, string? fields = default);
        ...
        ApiResponse<MultiDocumentResponseTagModel> MultipleTagDocumentsV2UsercollectionTagGetWithHttpInfo(DateTime? startDate = default, DateTime? endDate = default, string? nextToken = default, string? fields = default);
        /// <summary>
        /// Single Tag Document
        /// </summary>
        /// <exception cref="OuraToolkit.Api.Client.ApiException">Thrown when fails to make API call</exception>
        ...
        TagModel SingleTagDocumentV2UsercollectionTagDocumentIdGet(string documentId);
        ...
        ApiResponse<TagModel> SingleTagDocumentV2UsercollectionTagDocumentIdGetWithHttpInfo(string documentId);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ITagRoutesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<MultiDocumentResponseTagModel> MultipleTagDocumentsV2UsercollectionTagGetAsync(DateTime? startDate = default, DateTime? endDate = default, string? nextToken = default, string? fields = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<MultiDocumentResponseTagModel>> MultipleTagDocumentsV2UsercollectionTagGetWithHttpInfoAsync(DateTime? startDate = default, DateTime? endDate = default, string? nextToken = default, string? fields = default, System.Threading.CancellationToken cancellationToken = default);
        /// <summary>
        /// Single Tag Document
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<TagModel> SingleTagDocumentV2UsercollectionTagDocumentIdGetAsync(string documentId, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<TagModel>> SingleTagDocumentV2UsercollectionTagDocumentIdGetWithHttpInfoAsync(string documentId, System.Threading.CancellationToken cancellationToken = default);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ITagRoutesApi : ITagRoutesApiSync, ITagRoutesApiAsync
    {
    ...
    public partial class TagRoutesApi : IDisposable, ITagRoutesApi
    {
        ...
        /// <returns></returns>
        public TagRoutesApi(string basePath)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TagRoutesApi"/> class using Configuration object.
        /// **IMPORTANT** This will also create an instance of HttpClient, which is less than ideal.
        /// It's better to reuse the <see href="https://docs.microsoft.com/en-us/dotnet/architecture/microservices/implement-resilient-applications/use-httpclientfactory-to-implement-resilient-http-requests#issues-with-the-original-httpclient-class-available-in-net">HttpClient and HttpClientHandler</see>.
        /// </summary>
        ...
        /// <returns></returns>
        public TagRoutesApi(OuraToolkit.Api.Client.Configuration configuration)
        {
        ...
        /// </remarks>
        public TagRoutesApi(HttpClient client, HttpClientHandler handler = null) : this(client, (string)null, handler)
        {
        }
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public TagRoutesApi(HttpClient client, string basePath, HttpClientHandler handler = null)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public TagRoutesApi(HttpClient client, OuraToolkit.Api.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public TagRoutesApi(OuraToolkit.Api.Client.ISynchronousClient client, OuraToolkit.Api.Client.IAsynchronousClient asyncClient, OuraToolkit.Api.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <param name="fields">N/A. This route does not support field selection yet, all fields will be returned. (optional)</param>
        /// <returns>MultiDocumentResponseTagModel</returns>
        public MultiDocumentResponseTagModel MultipleTagDocumentsV2UsercollectionTagGet(DateTime? startDate = default, DateTime? endDate = default, string? nextToken = default, string? fields = default)
        {
            OuraToolkit.Api.Client.ApiResponse<MultiDocumentResponseTagModel> localVarResponse = MultipleTagDocumentsV2UsercollectionTagGetWithHttpInfo(startDate, endDate, nextToken, fields);
        ...
        /// <param name="fields">N/A. This route does not support field selection yet, all fields will be returned. (optional)</param>
        /// <returns>ApiResponse of MultiDocumentResponseTagModel</returns>
        public OuraToolkit.Api.Client.ApiResponse<MultiDocumentResponseTagModel> MultipleTagDocumentsV2UsercollectionTagGetWithHttpInfo(DateTime? startDate = default, DateTime? endDate = default, string? nextToken = default, string? fields = default)
        {
            ...
            var localVarResponse = this.Client.Get<MultiDocumentResponseTagModel>("/v2/usercollection/tag", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("MultipleTagDocumentsV2UsercollectionTagGet", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of MultiDocumentResponseTagModel</returns>
        public async System.Threading.Tasks.Task<MultiDocumentResponseTagModel> MultipleTagDocumentsV2UsercollectionTagGetAsync(DateTime? startDate = default, DateTime? endDate = default, string? nextToken = default, string? fields = default, System.Threading.CancellationToken cancellationToken = default)
        {
            OuraToolkit.Api.Client.ApiResponse<MultiDocumentResponseTagModel> localVarResponse = await MultipleTagDocumentsV2UsercollectionTagGetWithHttpInfoAsync(startDate, endDate, nextToken, fields, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (MultiDocumentResponseTagModel)</returns>
        public async System.Threading.Tasks.Task<OuraToolkit.Api.Client.ApiResponse<MultiDocumentResponseTagModel>> MultipleTagDocumentsV2UsercollectionTagGetWithHttpInfoAsync(DateTime? startDate = default, DateTime? endDate = default, string? nextToken = default, string? fields = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<MultiDocumentResponseTagModel>("/v2/usercollection/tag", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="documentId"></param>
        /// <returns>TagModel</returns>
        public TagModel SingleTagDocumentV2UsercollectionTagDocumentIdGet(string documentId)
        {
            OuraToolkit.Api.Client.ApiResponse<TagModel> localVarResponse = SingleTagDocumentV2UsercollectionTagDocumentIdGetWithHttpInfo(documentId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="documentId"></param>
        /// <returns>ApiResponse of TagModel</returns>
        public OuraToolkit.Api.Client.ApiResponse<TagModel> SingleTagDocumentV2UsercollectionTagDocumentIdGetWithHttpInfo(string documentId)
        {
            // verify the required parameter 'documentId' is set
            if (documentId == null)
                throw new OuraToolkit.Api.Client.ApiException(400, "Missing required parameter 'documentId' when calling TagRoutesApi->SingleTagDocumentV2UsercollectionTagDocumentIdGet");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<TagModel>("/v2/usercollection/tag/{document_id}", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("SingleTagDocumentV2UsercollectionTagDocumentIdGet", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of TagModel</returns>
        public async System.Threading.Tasks.Task<TagModel> SingleTagDocumentV2UsercollectionTagDocumentIdGetAsync(string documentId, System.Threading.CancellationToken cancellationToken = default)
        {
            OuraToolkit.Api.Client.ApiResponse<TagModel> localVarResponse = await SingleTagDocumentV2UsercollectionTagDocumentIdGetWithHttpInfoAsync(documentId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (TagModel)</returns>
        public async System.Threading.Tasks.Task<OuraToolkit.Api.Client.ApiResponse<TagModel>> SingleTagDocumentV2UsercollectionTagDocumentIdGetWithHttpInfoAsync(string documentId, System.Threading.CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'documentId' is set
            if (documentId == null)
                throw new OuraToolkit.Api.Client.ApiException(400, "Missing required parameter 'documentId' when calling TagRoutesApi->SingleTagDocumentV2UsercollectionTagDocumentIdGet");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<TagModel>("/v2/usercollection/tag/{document_id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
