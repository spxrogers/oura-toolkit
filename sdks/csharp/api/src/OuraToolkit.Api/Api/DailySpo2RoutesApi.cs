...
namespace OuraToolkit.Api.Api
{
    ...
    /// </summary>
    public interface IDailySpo2RoutesApiSync : IApiAccessor
    {
        ...
        PublicDailySpO2 SingleDailySpo2DocumentV2UsercollectionDailySpo2DocumentIdGet(string documentId);
        ...
        ApiResponse<PublicDailySpO2> SingleDailySpo2DocumentV2UsercollectionDailySpo2DocumentIdGetWithHttpInfo(string documentId);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IDailySpo2RoutesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<PublicDailySpO2> SingleDailySpo2DocumentV2UsercollectionDailySpo2DocumentIdGetAsync(string documentId, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<PublicDailySpO2>> SingleDailySpo2DocumentV2UsercollectionDailySpo2DocumentIdGetWithHttpInfoAsync(string documentId, System.Threading.CancellationToken cancellationToken = default);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IDailySpo2RoutesApi : IDailySpo2RoutesApiSync, IDailySpo2RoutesApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class DailySpo2RoutesApi : IDisposable, IDailySpo2RoutesApi
    {
        private OuraToolkit.Api.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="DailySpo2RoutesApi"/> class.
        /// **IMPORTANT** This will also create an instance of HttpClient, which is less than ideal.
        /// It's better to reuse the <see href="https://docs.microsoft.com/en-us/dotnet/architecture/microservices/implement-resilient-applications/use-httpclientfactory-to-implement-resilient-http-requests#issues-with-the-original-httpclient-class-available-in-net">HttpClient and HttpClientHandler</see>.
        /// </summary>
        /// <returns></returns>
        public DailySpo2RoutesApi() : this((string)null)
        {
        }
        ...
        /// <returns></returns>
        public DailySpo2RoutesApi(string basePath)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DailySpo2RoutesApi"/> class using Configuration object.
        /// **IMPORTANT** This will also create an instance of HttpClient, which is less than ideal.
        /// It's better to reuse the <see href="https://docs.microsoft.com/en-us/dotnet/architecture/microservices/implement-resilient-applications/use-httpclientfactory-to-implement-resilient-http-requests#issues-with-the-original-httpclient-class-available-in-net">HttpClient and HttpClientHandler</see>.
        /// </summary>
        ...
        /// <returns></returns>
        public DailySpo2RoutesApi(OuraToolkit.Api.Client.Configuration configuration)
        {
        ...
        /// </remarks>
        public DailySpo2RoutesApi(HttpClient client, HttpClientHandler handler = null) : this(client, (string)null, handler)
        {
        }
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public DailySpo2RoutesApi(HttpClient client, string basePath, HttpClientHandler handler = null)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public DailySpo2RoutesApi(HttpClient client, OuraToolkit.Api.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public DailySpo2RoutesApi(OuraToolkit.Api.Client.ISynchronousClient client, OuraToolkit.Api.Client.IAsynchronousClient asyncClient, OuraToolkit.Api.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        public OuraToolkit.Api.Client.ApiResponse<MultiDocumentResponsePublicDailySpO2> MultipleDailySpo2DocumentsV2UsercollectionDailySpo2GetWithHttpInfo(DateOnly? startDate = default, DateOnly? endDate = default, string? nextToken = default, string? fields = default)
        {
            ...
            var localVarResponse = this.Client.Get<MultiDocumentResponsePublicDailySpO2>("/v2/usercollection/daily_spo2", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("MultipleDailySpo2DocumentsV2UsercollectionDailySpo2Get", localVarResponse);
        ...
        public async System.Threading.Tasks.Task<OuraToolkit.Api.Client.ApiResponse<MultiDocumentResponsePublicDailySpO2>> MultipleDailySpo2DocumentsV2UsercollectionDailySpo2GetWithHttpInfoAsync(DateOnly? startDate = default, DateOnly? endDate = default, string? nextToken = default, string? fields = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<MultiDocumentResponsePublicDailySpO2>("/v2/usercollection/daily_spo2", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="documentId"></param>
        /// <returns>PublicDailySpO2</returns>
        public PublicDailySpO2 SingleDailySpo2DocumentV2UsercollectionDailySpo2DocumentIdGet(string documentId)
        {
            OuraToolkit.Api.Client.ApiResponse<PublicDailySpO2> localVarResponse = SingleDailySpo2DocumentV2UsercollectionDailySpo2DocumentIdGetWithHttpInfo(documentId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="documentId"></param>
        /// <returns>ApiResponse of PublicDailySpO2</returns>
        public OuraToolkit.Api.Client.ApiResponse<PublicDailySpO2> SingleDailySpo2DocumentV2UsercollectionDailySpo2DocumentIdGetWithHttpInfo(string documentId)
        {
            // verify the required parameter 'documentId' is set
            if (documentId == null)
                throw new OuraToolkit.Api.Client.ApiException(400, "Missing required parameter 'documentId' when calling DailySpo2RoutesApi->SingleDailySpo2DocumentV2UsercollectionDailySpo2DocumentIdGet");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<PublicDailySpO2>("/v2/usercollection/daily_spo2/{document_id}", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("SingleDailySpo2DocumentV2UsercollectionDailySpo2DocumentIdGet", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of PublicDailySpO2</returns>
        public async System.Threading.Tasks.Task<PublicDailySpO2> SingleDailySpo2DocumentV2UsercollectionDailySpo2DocumentIdGetAsync(string documentId, System.Threading.CancellationToken cancellationToken = default)
        {
            OuraToolkit.Api.Client.ApiResponse<PublicDailySpO2> localVarResponse = await SingleDailySpo2DocumentV2UsercollectionDailySpo2DocumentIdGetWithHttpInfoAsync(documentId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PublicDailySpO2)</returns>
        public async System.Threading.Tasks.Task<OuraToolkit.Api.Client.ApiResponse<PublicDailySpO2>> SingleDailySpo2DocumentV2UsercollectionDailySpo2DocumentIdGetWithHttpInfoAsync(string documentId, System.Threading.CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'documentId' is set
            if (documentId == null)
                throw new OuraToolkit.Api.Client.ApiException(400, "Missing required parameter 'documentId' when calling DailySpo2RoutesApi->SingleDailySpo2DocumentV2UsercollectionDailySpo2DocumentIdGet");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<PublicDailySpO2>("/v2/usercollection/daily_spo2/{document_id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
