...
namespace OuraToolkit.Api.Api
{
    ...
    /// </summary>
    public interface IRestModePeriodRoutesApiSync : IApiAccessor
    {
        ...
        PublicRestModePeriod SingleRestModePeriodDocumentV2UsercollectionRestModePeriodDocumentIdGet(string documentId);
        ...
        ApiResponse<PublicRestModePeriod> SingleRestModePeriodDocumentV2UsercollectionRestModePeriodDocumentIdGetWithHttpInfo(string documentId);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IRestModePeriodRoutesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<PublicRestModePeriod> SingleRestModePeriodDocumentV2UsercollectionRestModePeriodDocumentIdGetAsync(string documentId, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<PublicRestModePeriod>> SingleRestModePeriodDocumentV2UsercollectionRestModePeriodDocumentIdGetWithHttpInfoAsync(string documentId, System.Threading.CancellationToken cancellationToken = default);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IRestModePeriodRoutesApi : IRestModePeriodRoutesApiSync, IRestModePeriodRoutesApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class RestModePeriodRoutesApi : IDisposable, IRestModePeriodRoutesApi
    {
        private OuraToolkit.Api.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="RestModePeriodRoutesApi"/> class.
        /// **IMPORTANT** This will also create an instance of HttpClient, which is less than ideal.
        /// It's better to reuse the <see href="https://docs.microsoft.com/en-us/dotnet/architecture/microservices/implement-resilient-applications/use-httpclientfactory-to-implement-resilient-http-requests#issues-with-the-original-httpclient-class-available-in-net">HttpClient and HttpClientHandler</see>.
        /// </summary>
        /// <returns></returns>
        public RestModePeriodRoutesApi() : this((string)null)
        {
        }
        ...
        /// <returns></returns>
        public RestModePeriodRoutesApi(string basePath)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RestModePeriodRoutesApi"/> class using Configuration object.
        /// **IMPORTANT** This will also create an instance of HttpClient, which is less than ideal.
        /// It's better to reuse the <see href="https://docs.microsoft.com/en-us/dotnet/architecture/microservices/implement-resilient-applications/use-httpclientfactory-to-implement-resilient-http-requests#issues-with-the-original-httpclient-class-available-in-net">HttpClient and HttpClientHandler</see>.
        /// </summary>
        ...
        /// <returns></returns>
        public RestModePeriodRoutesApi(OuraToolkit.Api.Client.Configuration configuration)
        {
        ...
        /// </remarks>
        public RestModePeriodRoutesApi(HttpClient client, HttpClientHandler handler = null) : this(client, (string)null, handler)
        {
        }
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public RestModePeriodRoutesApi(HttpClient client, string basePath, HttpClientHandler handler = null)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public RestModePeriodRoutesApi(HttpClient client, OuraToolkit.Api.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public RestModePeriodRoutesApi(OuraToolkit.Api.Client.ISynchronousClient client, OuraToolkit.Api.Client.IAsynchronousClient asyncClient, OuraToolkit.Api.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        public OuraToolkit.Api.Client.ApiResponse<MultiDocumentResponsePublicRestModePeriod> MultipleRestModePeriodDocumentsV2UsercollectionRestModePeriodGetWithHttpInfo(DateOnly? startDate = default, DateOnly? endDate = default, string? nextToken = default, string? fields = default)
        {
            ...
            var localVarResponse = this.Client.Get<MultiDocumentResponsePublicRestModePeriod>("/v2/usercollection/rest_mode_period", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("MultipleRestModePeriodDocumentsV2UsercollectionRestModePeriodGet", localVarResponse);
        ...
        public async System.Threading.Tasks.Task<OuraToolkit.Api.Client.ApiResponse<MultiDocumentResponsePublicRestModePeriod>> MultipleRestModePeriodDocumentsV2UsercollectionRestModePeriodGetWithHttpInfoAsync(DateOnly? startDate = default, DateOnly? endDate = default, string? nextToken = default, string? fields = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<MultiDocumentResponsePublicRestModePeriod>("/v2/usercollection/rest_mode_period", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="documentId"></param>
        /// <returns>PublicRestModePeriod</returns>
        public PublicRestModePeriod SingleRestModePeriodDocumentV2UsercollectionRestModePeriodDocumentIdGet(string documentId)
        {
            OuraToolkit.Api.Client.ApiResponse<PublicRestModePeriod> localVarResponse = SingleRestModePeriodDocumentV2UsercollectionRestModePeriodDocumentIdGetWithHttpInfo(documentId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="documentId"></param>
        /// <returns>ApiResponse of PublicRestModePeriod</returns>
        public OuraToolkit.Api.Client.ApiResponse<PublicRestModePeriod> SingleRestModePeriodDocumentV2UsercollectionRestModePeriodDocumentIdGetWithHttpInfo(string documentId)
        {
            // verify the required parameter 'documentId' is set
            if (documentId == null)
                throw new OuraToolkit.Api.Client.ApiException(400, "Missing required parameter 'documentId' when calling RestModePeriodRoutesApi->SingleRestModePeriodDocumentV2UsercollectionRestModePeriodDocumentIdGet");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<PublicRestModePeriod>("/v2/usercollection/rest_mode_period/{document_id}", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("SingleRestModePeriodDocumentV2UsercollectionRestModePeriodDocumentIdGet", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of PublicRestModePeriod</returns>
        public async System.Threading.Tasks.Task<PublicRestModePeriod> SingleRestModePeriodDocumentV2UsercollectionRestModePeriodDocumentIdGetAsync(string documentId, System.Threading.CancellationToken cancellationToken = default)
        {
            OuraToolkit.Api.Client.ApiResponse<PublicRestModePeriod> localVarResponse = await SingleRestModePeriodDocumentV2UsercollectionRestModePeriodDocumentIdGetWithHttpInfoAsync(documentId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PublicRestModePeriod)</returns>
        public async System.Threading.Tasks.Task<OuraToolkit.Api.Client.ApiResponse<PublicRestModePeriod>> SingleRestModePeriodDocumentV2UsercollectionRestModePeriodDocumentIdGetWithHttpInfoAsync(string documentId, System.Threading.CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'documentId' is set
            if (documentId == null)
                throw new OuraToolkit.Api.Client.ApiException(400, "Missing required parameter 'documentId' when calling RestModePeriodRoutesApi->SingleRestModePeriodDocumentV2UsercollectionRestModePeriodDocumentIdGet");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<PublicRestModePeriod>("/v2/usercollection/rest_mode_period/{document_id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
