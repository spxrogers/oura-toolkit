...
namespace OuraToolkit.Api.Api
{
    ...
    /// </summary>
    public interface IDailySleepRoutesApiSync : IApiAccessor
    {
        ...
        MultiDocumentResponsePublicDailySleep MultipleDailySleepDocumentsV2UsercollectionDailySleepGet(DateTime? startDate = default, DateTime? endDate = default, string? nextToken = default, string? fields = default);
        ...
        ApiResponse<MultiDocumentResponsePublicDailySleep> MultipleDailySleepDocumentsV2UsercollectionDailySleepGetWithHttpInfo(DateTime? startDate = default, DateTime? endDate = default, string? nextToken = default, string? fields = default);
        /// <summary>
        ...
        PublicDailySleep SingleDailySleepDocumentV2UsercollectionDailySleepDocumentIdGet(string documentId);
        ...
        ApiResponse<PublicDailySleep> SingleDailySleepDocumentV2UsercollectionDailySleepDocumentIdGetWithHttpInfo(string documentId);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IDailySleepRoutesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<MultiDocumentResponsePublicDailySleep> MultipleDailySleepDocumentsV2UsercollectionDailySleepGetAsync(DateTime? startDate = default, DateTime? endDate = default, string? nextToken = default, string? fields = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<PublicDailySleep> SingleDailySleepDocumentV2UsercollectionDailySleepDocumentIdGetAsync(string documentId, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<PublicDailySleep>> SingleDailySleepDocumentV2UsercollectionDailySleepDocumentIdGetWithHttpInfoAsync(string documentId, System.Threading.CancellationToken cancellationToken = default);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IDailySleepRoutesApi : IDailySleepRoutesApiSync, IDailySleepRoutesApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class DailySleepRoutesApi : IDisposable, IDailySleepRoutesApi
    {
        private OuraToolkit.Api.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="DailySleepRoutesApi"/> class.
        /// **IMPORTANT** This will also create an instance of HttpClient, which is less than ideal.
        /// It's better to reuse the <see href="https://docs.microsoft.com/en-us/dotnet/architecture/microservices/implement-resilient-applications/use-httpclientfactory-to-implement-resilient-http-requests#issues-with-the-original-httpclient-class-available-in-net">HttpClient and HttpClientHandler</see>.
        /// </summary>
        /// <returns></returns>
        public DailySleepRoutesApi() : this((string)null)
        {
        }
        ...
        /// <returns></returns>
        public DailySleepRoutesApi(string basePath)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DailySleepRoutesApi"/> class using Configuration object.
        /// **IMPORTANT** This will also create an instance of HttpClient, which is less than ideal.
        /// It's better to reuse the <see href="https://docs.microsoft.com/en-us/dotnet/architecture/microservices/implement-resilient-applications/use-httpclientfactory-to-implement-resilient-http-requests#issues-with-the-original-httpclient-class-available-in-net">HttpClient and HttpClientHandler</see>.
        /// </summary>
        ...
        /// <returns></returns>
        public DailySleepRoutesApi(OuraToolkit.Api.Client.Configuration configuration)
        {
        ...
        /// </remarks>
        public DailySleepRoutesApi(HttpClient client, HttpClientHandler handler = null) : this(client, (string)null, handler)
        {
        }
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public DailySleepRoutesApi(HttpClient client, string basePath, HttpClientHandler handler = null)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public DailySleepRoutesApi(HttpClient client, OuraToolkit.Api.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public DailySleepRoutesApi(OuraToolkit.Api.Client.ISynchronousClient client, OuraToolkit.Api.Client.IAsynchronousClient asyncClient, OuraToolkit.Api.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <param name="fields">Comma-separated list of fields to include in the response, in addition to the always returned fields. Defaults to all fields if not provided. (optional)</param>
        /// <returns>MultiDocumentResponsePublicDailySleep</returns>
        public MultiDocumentResponsePublicDailySleep MultipleDailySleepDocumentsV2UsercollectionDailySleepGet(DateTime? startDate = default, DateTime? endDate = default, string? nextToken = default, string? fields = default)
        {
            OuraToolkit.Api.Client.ApiResponse<MultiDocumentResponsePublicDailySleep> localVarResponse = MultipleDailySleepDocumentsV2UsercollectionDailySleepGetWithHttpInfo(startDate, endDate, nextToken, fields);
        ...
        /// <param name="fields">Comma-separated list of fields to include in the response, in addition to the always returned fields. Defaults to all fields if not provided. (optional)</param>
        /// <returns>ApiResponse of MultiDocumentResponsePublicDailySleep</returns>
        public OuraToolkit.Api.Client.ApiResponse<MultiDocumentResponsePublicDailySleep> MultipleDailySleepDocumentsV2UsercollectionDailySleepGetWithHttpInfo(DateTime? startDate = default, DateTime? endDate = default, string? nextToken = default, string? fields = default)
        {
            ...
            var localVarResponse = this.Client.Get<MultiDocumentResponsePublicDailySleep>("/v2/usercollection/daily_sleep", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("MultipleDailySleepDocumentsV2UsercollectionDailySleepGet", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of MultiDocumentResponsePublicDailySleep</returns>
        public async System.Threading.Tasks.Task<MultiDocumentResponsePublicDailySleep> MultipleDailySleepDocumentsV2UsercollectionDailySleepGetAsync(DateTime? startDate = default, DateTime? endDate = default, string? nextToken = default, string? fields = default, System.Threading.CancellationToken cancellationToken = default)
        {
            OuraToolkit.Api.Client.ApiResponse<MultiDocumentResponsePublicDailySleep> localVarResponse = await MultipleDailySleepDocumentsV2UsercollectionDailySleepGetWithHttpInfoAsync(startDate, endDate, nextToken, fields, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (MultiDocumentResponsePublicDailySleep)</returns>
        public async System.Threading.Tasks.Task<OuraToolkit.Api.Client.ApiResponse<MultiDocumentResponsePublicDailySleep>> MultipleDailySleepDocumentsV2UsercollectionDailySleepGetWithHttpInfoAsync(DateTime? startDate = default, DateTime? endDate = default, string? nextToken = default, string? fields = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<MultiDocumentResponsePublicDailySleep>("/v2/usercollection/daily_sleep", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="documentId"></param>
        /// <returns>PublicDailySleep</returns>
        public PublicDailySleep SingleDailySleepDocumentV2UsercollectionDailySleepDocumentIdGet(string documentId)
        {
            OuraToolkit.Api.Client.ApiResponse<PublicDailySleep> localVarResponse = SingleDailySleepDocumentV2UsercollectionDailySleepDocumentIdGetWithHttpInfo(documentId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="documentId"></param>
        /// <returns>ApiResponse of PublicDailySleep</returns>
        public OuraToolkit.Api.Client.ApiResponse<PublicDailySleep> SingleDailySleepDocumentV2UsercollectionDailySleepDocumentIdGetWithHttpInfo(string documentId)
        {
            // verify the required parameter 'documentId' is set
            if (documentId == null)
                throw new OuraToolkit.Api.Client.ApiException(400, "Missing required parameter 'documentId' when calling DailySleepRoutesApi->SingleDailySleepDocumentV2UsercollectionDailySleepDocumentIdGet");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<PublicDailySleep>("/v2/usercollection/daily_sleep/{document_id}", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("SingleDailySleepDocumentV2UsercollectionDailySleepDocumentIdGet", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of PublicDailySleep</returns>
        public async System.Threading.Tasks.Task<PublicDailySleep> SingleDailySleepDocumentV2UsercollectionDailySleepDocumentIdGetAsync(string documentId, System.Threading.CancellationToken cancellationToken = default)
        {
            OuraToolkit.Api.Client.ApiResponse<PublicDailySleep> localVarResponse = await SingleDailySleepDocumentV2UsercollectionDailySleepDocumentIdGetWithHttpInfoAsync(documentId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PublicDailySleep)</returns>
        public async System.Threading.Tasks.Task<OuraToolkit.Api.Client.ApiResponse<PublicDailySleep>> SingleDailySleepDocumentV2UsercollectionDailySleepDocumentIdGetWithHttpInfoAsync(string documentId, System.Threading.CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'documentId' is set
            if (documentId == null)
                throw new OuraToolkit.Api.Client.ApiException(400, "Missing required parameter 'documentId' when calling DailySleepRoutesApi->SingleDailySleepDocumentV2UsercollectionDailySleepDocumentIdGet");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<PublicDailySleep>("/v2/usercollection/daily_sleep/{document_id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
