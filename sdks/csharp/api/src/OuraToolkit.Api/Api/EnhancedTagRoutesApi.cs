...
namespace OuraToolkit.Api.Api
{
    ...
    /// </summary>
    public interface IEnhancedTagRoutesApiSync : IApiAccessor
    {
        ...
        EnhancedTagModel SingleEnhancedTagDocumentV2UsercollectionEnhancedTagDocumentIdGet(string documentId);
        ...
        ApiResponse<EnhancedTagModel> SingleEnhancedTagDocumentV2UsercollectionEnhancedTagDocumentIdGetWithHttpInfo(string documentId);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IEnhancedTagRoutesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<EnhancedTagModel> SingleEnhancedTagDocumentV2UsercollectionEnhancedTagDocumentIdGetAsync(string documentId, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<EnhancedTagModel>> SingleEnhancedTagDocumentV2UsercollectionEnhancedTagDocumentIdGetWithHttpInfoAsync(string documentId, System.Threading.CancellationToken cancellationToken = default);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IEnhancedTagRoutesApi : IEnhancedTagRoutesApiSync, IEnhancedTagRoutesApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class EnhancedTagRoutesApi : IDisposable, IEnhancedTagRoutesApi
    {
        private OuraToolkit.Api.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="EnhancedTagRoutesApi"/> class.
        /// **IMPORTANT** This will also create an instance of HttpClient, which is less than ideal.
        /// It's better to reuse the <see href="https://docs.microsoft.com/en-us/dotnet/architecture/microservices/implement-resilient-applications/use-httpclientfactory-to-implement-resilient-http-requests#issues-with-the-original-httpclient-class-available-in-net">HttpClient and HttpClientHandler</see>.
        /// </summary>
        /// <returns></returns>
        public EnhancedTagRoutesApi() : this((string)null)
        {
        }
        ...
        /// <returns></returns>
        public EnhancedTagRoutesApi(string basePath)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EnhancedTagRoutesApi"/> class using Configuration object.
        /// **IMPORTANT** This will also create an instance of HttpClient, which is less than ideal.
        /// It's better to reuse the <see href="https://docs.microsoft.com/en-us/dotnet/architecture/microservices/implement-resilient-applications/use-httpclientfactory-to-implement-resilient-http-requests#issues-with-the-original-httpclient-class-available-in-net">HttpClient and HttpClientHandler</see>.
        /// </summary>
        ...
        /// <returns></returns>
        public EnhancedTagRoutesApi(OuraToolkit.Api.Client.Configuration configuration)
        {
        ...
        /// </remarks>
        public EnhancedTagRoutesApi(HttpClient client, HttpClientHandler handler = null) : this(client, (string)null, handler)
        {
        }
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public EnhancedTagRoutesApi(HttpClient client, string basePath, HttpClientHandler handler = null)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public EnhancedTagRoutesApi(HttpClient client, OuraToolkit.Api.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public EnhancedTagRoutesApi(OuraToolkit.Api.Client.ISynchronousClient client, OuraToolkit.Api.Client.IAsynchronousClient asyncClient, OuraToolkit.Api.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        public OuraToolkit.Api.Client.ApiResponse<MultiDocumentResponseEnhancedTagModel> MultipleEnhancedTagDocumentsV2UsercollectionEnhancedTagGetWithHttpInfo(DateTime? startDate = default, DateTime? endDate = default, string? nextToken = default, string? fields = default)
        {
            ...
            var localVarResponse = this.Client.Get<MultiDocumentResponseEnhancedTagModel>("/v2/usercollection/enhanced_tag", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("MultipleEnhancedTagDocumentsV2UsercollectionEnhancedTagGet", localVarResponse);
        ...
        public async System.Threading.Tasks.Task<OuraToolkit.Api.Client.ApiResponse<MultiDocumentResponseEnhancedTagModel>> MultipleEnhancedTagDocumentsV2UsercollectionEnhancedTagGetWithHttpInfoAsync(DateTime? startDate = default, DateTime? endDate = default, string? nextToken = default, string? fields = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<MultiDocumentResponseEnhancedTagModel>("/v2/usercollection/enhanced_tag", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="documentId"></param>
        /// <returns>EnhancedTagModel</returns>
        public EnhancedTagModel SingleEnhancedTagDocumentV2UsercollectionEnhancedTagDocumentIdGet(string documentId)
        {
            OuraToolkit.Api.Client.ApiResponse<EnhancedTagModel> localVarResponse = SingleEnhancedTagDocumentV2UsercollectionEnhancedTagDocumentIdGetWithHttpInfo(documentId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="documentId"></param>
        /// <returns>ApiResponse of EnhancedTagModel</returns>
        public OuraToolkit.Api.Client.ApiResponse<EnhancedTagModel> SingleEnhancedTagDocumentV2UsercollectionEnhancedTagDocumentIdGetWithHttpInfo(string documentId)
        {
            // verify the required parameter 'documentId' is set
            if (documentId == null)
                throw new OuraToolkit.Api.Client.ApiException(400, "Missing required parameter 'documentId' when calling EnhancedTagRoutesApi->SingleEnhancedTagDocumentV2UsercollectionEnhancedTagDocumentIdGet");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<EnhancedTagModel>("/v2/usercollection/enhanced_tag/{document_id}", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("SingleEnhancedTagDocumentV2UsercollectionEnhancedTagDocumentIdGet", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of EnhancedTagModel</returns>
        public async System.Threading.Tasks.Task<EnhancedTagModel> SingleEnhancedTagDocumentV2UsercollectionEnhancedTagDocumentIdGetAsync(string documentId, System.Threading.CancellationToken cancellationToken = default)
        {
            OuraToolkit.Api.Client.ApiResponse<EnhancedTagModel> localVarResponse = await SingleEnhancedTagDocumentV2UsercollectionEnhancedTagDocumentIdGetWithHttpInfoAsync(documentId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (EnhancedTagModel)</returns>
        public async System.Threading.Tasks.Task<OuraToolkit.Api.Client.ApiResponse<EnhancedTagModel>> SingleEnhancedTagDocumentV2UsercollectionEnhancedTagDocumentIdGetWithHttpInfoAsync(string documentId, System.Threading.CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'documentId' is set
            if (documentId == null)
                throw new OuraToolkit.Api.Client.ApiException(400, "Missing required parameter 'documentId' when calling EnhancedTagRoutesApi->SingleEnhancedTagDocumentV2UsercollectionEnhancedTagDocumentIdGet");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<EnhancedTagModel>("/v2/usercollection/enhanced_tag/{document_id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
