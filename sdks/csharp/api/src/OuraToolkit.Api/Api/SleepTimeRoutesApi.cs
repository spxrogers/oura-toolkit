...
namespace OuraToolkit.Api.Api
{
    ...
    /// </summary>
    public interface ISleepTimeRoutesApiSync : IApiAccessor
    {
        ...
        MultiDocumentResponsePublicSleepTime MultipleSleepTimeDocumentsV2UsercollectionSleepTimeGet(DateTime? startDate = default, DateTime? endDate = default, string? nextToken = default, string? fields = default);
        ...
        ApiResponse<MultiDocumentResponsePublicSleepTime> MultipleSleepTimeDocumentsV2UsercollectionSleepTimeGetWithHttpInfo(DateTime? startDate = default, DateTime? endDate = default, string? nextToken = default, string? fields = default);
        /// <summary>
        ...
        PublicSleepTime SingleSleepTimeDocumentV2UsercollectionSleepTimeDocumentIdGet(string documentId);
        ...
        ApiResponse<PublicSleepTime> SingleSleepTimeDocumentV2UsercollectionSleepTimeDocumentIdGetWithHttpInfo(string documentId);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ISleepTimeRoutesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<MultiDocumentResponsePublicSleepTime> MultipleSleepTimeDocumentsV2UsercollectionSleepTimeGetAsync(DateTime? startDate = default, DateTime? endDate = default, string? nextToken = default, string? fields = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<MultiDocumentResponsePublicSleepTime>> MultipleSleepTimeDocumentsV2UsercollectionSleepTimeGetWithHttpInfoAsync(DateTime? startDate = default, DateTime? endDate = default, string? nextToken = default, string? fields = default, System.Threading.CancellationToken cancellationToken = default);
        /// <summary>
        /// Single Sleep Time Document
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<PublicSleepTime> SingleSleepTimeDocumentV2UsercollectionSleepTimeDocumentIdGetAsync(string documentId, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<PublicSleepTime>> SingleSleepTimeDocumentV2UsercollectionSleepTimeDocumentIdGetWithHttpInfoAsync(string documentId, System.Threading.CancellationToken cancellationToken = default);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ISleepTimeRoutesApi : ISleepTimeRoutesApiSync, ISleepTimeRoutesApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class SleepTimeRoutesApi : IDisposable, ISleepTimeRoutesApi
    {
        private OuraToolkit.Api.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="SleepTimeRoutesApi"/> class.
        /// **IMPORTANT** This will also create an instance of HttpClient, which is less than ideal.
        /// It's better to reuse the <see href="https://docs.microsoft.com/en-us/dotnet/architecture/microservices/implement-resilient-applications/use-httpclientfactory-to-implement-resilient-http-requests#issues-with-the-original-httpclient-class-available-in-net">HttpClient and HttpClientHandler</see>.
        /// </summary>
        /// <returns></returns>
        public SleepTimeRoutesApi() : this((string)null)
        {
        }
        ...
        /// <returns></returns>
        public SleepTimeRoutesApi(string basePath)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SleepTimeRoutesApi"/> class using Configuration object.
        /// **IMPORTANT** This will also create an instance of HttpClient, which is less than ideal.
        /// It's better to reuse the <see href="https://docs.microsoft.com/en-us/dotnet/architecture/microservices/implement-resilient-applications/use-httpclientfactory-to-implement-resilient-http-requests#issues-with-the-original-httpclient-class-available-in-net">HttpClient and HttpClientHandler</see>.
        /// </summary>
        ...
        /// <returns></returns>
        public SleepTimeRoutesApi(OuraToolkit.Api.Client.Configuration configuration)
        {
        ...
        /// </remarks>
        public SleepTimeRoutesApi(HttpClient client, HttpClientHandler handler = null) : this(client, (string)null, handler)
        {
        }
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public SleepTimeRoutesApi(HttpClient client, string basePath, HttpClientHandler handler = null)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public SleepTimeRoutesApi(HttpClient client, OuraToolkit.Api.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public SleepTimeRoutesApi(OuraToolkit.Api.Client.ISynchronousClient client, OuraToolkit.Api.Client.IAsynchronousClient asyncClient, OuraToolkit.Api.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <param name="fields">Comma-separated list of fields to include in the response, in addition to the always returned fields. Defaults to all fields if not provided. (optional)</param>
        /// <returns>MultiDocumentResponsePublicSleepTime</returns>
        public MultiDocumentResponsePublicSleepTime MultipleSleepTimeDocumentsV2UsercollectionSleepTimeGet(DateTime? startDate = default, DateTime? endDate = default, string? nextToken = default, string? fields = default)
        {
            OuraToolkit.Api.Client.ApiResponse<MultiDocumentResponsePublicSleepTime> localVarResponse = MultipleSleepTimeDocumentsV2UsercollectionSleepTimeGetWithHttpInfo(startDate, endDate, nextToken, fields);
        ...
        /// <param name="fields">Comma-separated list of fields to include in the response, in addition to the always returned fields. Defaults to all fields if not provided. (optional)</param>
        /// <returns>ApiResponse of MultiDocumentResponsePublicSleepTime</returns>
        public OuraToolkit.Api.Client.ApiResponse<MultiDocumentResponsePublicSleepTime> MultipleSleepTimeDocumentsV2UsercollectionSleepTimeGetWithHttpInfo(DateTime? startDate = default, DateTime? endDate = default, string? nextToken = default, string? fields = default)
        {
            ...
            var localVarResponse = this.Client.Get<MultiDocumentResponsePublicSleepTime>("/v2/usercollection/sleep_time", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("MultipleSleepTimeDocumentsV2UsercollectionSleepTimeGet", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of MultiDocumentResponsePublicSleepTime</returns>
        public async System.Threading.Tasks.Task<MultiDocumentResponsePublicSleepTime> MultipleSleepTimeDocumentsV2UsercollectionSleepTimeGetAsync(DateTime? startDate = default, DateTime? endDate = default, string? nextToken = default, string? fields = default, System.Threading.CancellationToken cancellationToken = default)
        {
            OuraToolkit.Api.Client.ApiResponse<MultiDocumentResponsePublicSleepTime> localVarResponse = await MultipleSleepTimeDocumentsV2UsercollectionSleepTimeGetWithHttpInfoAsync(startDate, endDate, nextToken, fields, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<OuraToolkit.Api.Client.ApiResponse<MultiDocumentResponsePublicSleepTime>> MultipleSleepTimeDocumentsV2UsercollectionSleepTimeGetWithHttpInfoAsync(DateTime? startDate = default, DateTime? endDate = default, string? nextToken = default, string? fields = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<MultiDocumentResponsePublicSleepTime>("/v2/usercollection/sleep_time", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="documentId"></param>
        /// <returns>PublicSleepTime</returns>
        public PublicSleepTime SingleSleepTimeDocumentV2UsercollectionSleepTimeDocumentIdGet(string documentId)
        {
            OuraToolkit.Api.Client.ApiResponse<PublicSleepTime> localVarResponse = SingleSleepTimeDocumentV2UsercollectionSleepTimeDocumentIdGetWithHttpInfo(documentId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="documentId"></param>
        /// <returns>ApiResponse of PublicSleepTime</returns>
        public OuraToolkit.Api.Client.ApiResponse<PublicSleepTime> SingleSleepTimeDocumentV2UsercollectionSleepTimeDocumentIdGetWithHttpInfo(string documentId)
        {
            // verify the required parameter 'documentId' is set
            if (documentId == null)
                throw new OuraToolkit.Api.Client.ApiException(400, "Missing required parameter 'documentId' when calling SleepTimeRoutesApi->SingleSleepTimeDocumentV2UsercollectionSleepTimeDocumentIdGet");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<PublicSleepTime>("/v2/usercollection/sleep_time/{document_id}", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("SingleSleepTimeDocumentV2UsercollectionSleepTimeDocumentIdGet", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of PublicSleepTime</returns>
        public async System.Threading.Tasks.Task<PublicSleepTime> SingleSleepTimeDocumentV2UsercollectionSleepTimeDocumentIdGetAsync(string documentId, System.Threading.CancellationToken cancellationToken = default)
        {
            OuraToolkit.Api.Client.ApiResponse<PublicSleepTime> localVarResponse = await SingleSleepTimeDocumentV2UsercollectionSleepTimeDocumentIdGetWithHttpInfoAsync(documentId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PublicSleepTime)</returns>
        public async System.Threading.Tasks.Task<OuraToolkit.Api.Client.ApiResponse<PublicSleepTime>> SingleSleepTimeDocumentV2UsercollectionSleepTimeDocumentIdGetWithHttpInfoAsync(string documentId, System.Threading.CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'documentId' is set
            if (documentId == null)
                throw new OuraToolkit.Api.Client.ApiException(400, "Missing required parameter 'documentId' when calling SleepTimeRoutesApi->SingleSleepTimeDocumentV2UsercollectionSleepTimeDocumentIdGet");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<PublicSleepTime>("/v2/usercollection/sleep_time/{document_id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
