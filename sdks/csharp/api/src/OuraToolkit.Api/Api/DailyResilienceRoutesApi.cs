...
namespace OuraToolkit.Api.Api
{
    ...
    /// </summary>
    public interface IDailyResilienceRoutesApiSync : IApiAccessor
    {
        ...
        DailyResilienceModel SingleDailyResilienceDocumentV2UsercollectionDailyResilienceDocumentIdGet(string documentId);
        ...
        ApiResponse<DailyResilienceModel> SingleDailyResilienceDocumentV2UsercollectionDailyResilienceDocumentIdGetWithHttpInfo(string documentId);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IDailyResilienceRoutesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<DailyResilienceModel> SingleDailyResilienceDocumentV2UsercollectionDailyResilienceDocumentIdGetAsync(string documentId, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<DailyResilienceModel>> SingleDailyResilienceDocumentV2UsercollectionDailyResilienceDocumentIdGetWithHttpInfoAsync(string documentId, System.Threading.CancellationToken cancellationToken = default);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IDailyResilienceRoutesApi : IDailyResilienceRoutesApiSync, IDailyResilienceRoutesApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class DailyResilienceRoutesApi : IDisposable, IDailyResilienceRoutesApi
    {
        private OuraToolkit.Api.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="DailyResilienceRoutesApi"/> class.
        /// **IMPORTANT** This will also create an instance of HttpClient, which is less than ideal.
        /// It's better to reuse the <see href="https://docs.microsoft.com/en-us/dotnet/architecture/microservices/implement-resilient-applications/use-httpclientfactory-to-implement-resilient-http-requests#issues-with-the-original-httpclient-class-available-in-net">HttpClient and HttpClientHandler</see>.
        /// </summary>
        /// <returns></returns>
        public DailyResilienceRoutesApi() : this((string)null)
        {
        }
        ...
        /// <returns></returns>
        public DailyResilienceRoutesApi(string basePath)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DailyResilienceRoutesApi"/> class using Configuration object.
        /// **IMPORTANT** This will also create an instance of HttpClient, which is less than ideal.
        /// It's better to reuse the <see href="https://docs.microsoft.com/en-us/dotnet/architecture/microservices/implement-resilient-applications/use-httpclientfactory-to-implement-resilient-http-requests#issues-with-the-original-httpclient-class-available-in-net">HttpClient and HttpClientHandler</see>.
        /// </summary>
        ...
        /// <returns></returns>
        public DailyResilienceRoutesApi(OuraToolkit.Api.Client.Configuration configuration)
        {
        ...
        /// </remarks>
        public DailyResilienceRoutesApi(HttpClient client, HttpClientHandler handler = null) : this(client, (string)null, handler)
        {
        }
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public DailyResilienceRoutesApi(HttpClient client, string basePath, HttpClientHandler handler = null)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public DailyResilienceRoutesApi(HttpClient client, OuraToolkit.Api.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public DailyResilienceRoutesApi(OuraToolkit.Api.Client.ISynchronousClient client, OuraToolkit.Api.Client.IAsynchronousClient asyncClient, OuraToolkit.Api.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        public OuraToolkit.Api.Client.ApiResponse<MultiDocumentResponseDailyResilienceModel> MultipleDailyResilienceDocumentsV2UsercollectionDailyResilienceGetWithHttpInfo(DateTime? startDate = default, DateTime? endDate = default, string? nextToken = default, string? fields = default)
        {
            ...
            var localVarResponse = this.Client.Get<MultiDocumentResponseDailyResilienceModel>("/v2/usercollection/daily_resilience", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("MultipleDailyResilienceDocumentsV2UsercollectionDailyResilienceGet", localVarResponse);
        ...
        public async System.Threading.Tasks.Task<OuraToolkit.Api.Client.ApiResponse<MultiDocumentResponseDailyResilienceModel>> MultipleDailyResilienceDocumentsV2UsercollectionDailyResilienceGetWithHttpInfoAsync(DateTime? startDate = default, DateTime? endDate = default, string? nextToken = default, string? fields = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<MultiDocumentResponseDailyResilienceModel>("/v2/usercollection/daily_resilience", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="documentId"></param>
        /// <returns>DailyResilienceModel</returns>
        public DailyResilienceModel SingleDailyResilienceDocumentV2UsercollectionDailyResilienceDocumentIdGet(string documentId)
        {
            OuraToolkit.Api.Client.ApiResponse<DailyResilienceModel> localVarResponse = SingleDailyResilienceDocumentV2UsercollectionDailyResilienceDocumentIdGetWithHttpInfo(documentId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="documentId"></param>
        /// <returns>ApiResponse of DailyResilienceModel</returns>
        public OuraToolkit.Api.Client.ApiResponse<DailyResilienceModel> SingleDailyResilienceDocumentV2UsercollectionDailyResilienceDocumentIdGetWithHttpInfo(string documentId)
        {
            // verify the required parameter 'documentId' is set
            if (documentId == null)
                throw new OuraToolkit.Api.Client.ApiException(400, "Missing required parameter 'documentId' when calling DailyResilienceRoutesApi->SingleDailyResilienceDocumentV2UsercollectionDailyResilienceDocumentIdGet");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<DailyResilienceModel>("/v2/usercollection/daily_resilience/{document_id}", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("SingleDailyResilienceDocumentV2UsercollectionDailyResilienceDocumentIdGet", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of DailyResilienceModel</returns>
        public async System.Threading.Tasks.Task<DailyResilienceModel> SingleDailyResilienceDocumentV2UsercollectionDailyResilienceDocumentIdGetAsync(string documentId, System.Threading.CancellationToken cancellationToken = default)
        {
            OuraToolkit.Api.Client.ApiResponse<DailyResilienceModel> localVarResponse = await SingleDailyResilienceDocumentV2UsercollectionDailyResilienceDocumentIdGetWithHttpInfoAsync(documentId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DailyResilienceModel)</returns>
        public async System.Threading.Tasks.Task<OuraToolkit.Api.Client.ApiResponse<DailyResilienceModel>> SingleDailyResilienceDocumentV2UsercollectionDailyResilienceDocumentIdGetWithHttpInfoAsync(string documentId, System.Threading.CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'documentId' is set
            if (documentId == null)
                throw new OuraToolkit.Api.Client.ApiException(400, "Missing required parameter 'documentId' when calling DailyResilienceRoutesApi->SingleDailyResilienceDocumentV2UsercollectionDailyResilienceDocumentIdGet");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<DailyResilienceModel>("/v2/usercollection/daily_resilience/{document_id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
