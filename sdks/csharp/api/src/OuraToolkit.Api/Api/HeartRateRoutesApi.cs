...
namespace OuraToolkit.Api.Api
{
    ...
    /// </summary>
    public interface IHeartRateRoutesApiSync : IApiAccessor
    {
        ...
        /// <returns>ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet</returns>
        ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet MultipleHeartrateDocumentsV2UsercollectionHeartrateGet(DateTime? startDatetime = default, DateTime? endDatetime = default, string? nextToken = default, bool? latest = default, string? fields = default);
        ...
        /// <param name="latest">If True, returns most recent sample. (optional)</param>
        /// <param name="fields">Comma-separated list of fields to include in the response, in addition to the always returned fields. Defaults to all fields if not provided. (optional)</param>
        /// <returns>ApiResponse of ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet</returns>
        ApiResponse<ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet> MultipleHeartrateDocumentsV2UsercollectionHeartrateGetWithHttpInfo(DateTime? startDatetime = default, DateTime? endDatetime = default, string? nextToken = default, bool? latest = default, string? fields = default);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IHeartRateRoutesApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet</returns>
        System.Threading.Tasks.Task<ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet> MultipleHeartrateDocumentsV2UsercollectionHeartrateGetAsync(DateTime? startDatetime = default, DateTime? endDatetime = default, string? nextToken = default, bool? latest = default, string? fields = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="fields">Comma-separated list of fields to include in the response, in addition to the always returned fields. Defaults to all fields if not provided. (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet)</returns>
        System.Threading.Tasks.Task<ApiResponse<ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet>> MultipleHeartrateDocumentsV2UsercollectionHeartrateGetWithHttpInfoAsync(DateTime? startDatetime = default, DateTime? endDatetime = default, string? nextToken = default, bool? latest = default, string? fields = default, System.Threading.CancellationToken cancellationToken = default);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IHeartRateRoutesApi : IHeartRateRoutesApiSync, IHeartRateRoutesApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class HeartRateRoutesApi : IDisposable, IHeartRateRoutesApi
    {
        private OuraToolkit.Api.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="HeartRateRoutesApi"/> class.
        /// **IMPORTANT** This will also create an instance of HttpClient, which is less than ideal.
        /// It's better to reuse the <see href="https://docs.microsoft.com/en-us/dotnet/architecture/microservices/implement-resilient-applications/use-httpclientfactory-to-implement-resilient-http-requests#issues-with-the-original-httpclient-class-available-in-net">HttpClient and HttpClientHandler</see>.
        /// </summary>
        /// <returns></returns>
        public HeartRateRoutesApi() : this((string)null)
        {
        }
        ...
        /// <returns></returns>
        public HeartRateRoutesApi(string basePath)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HeartRateRoutesApi"/> class using Configuration object.
        /// **IMPORTANT** This will also create an instance of HttpClient, which is less than ideal.
        /// It's better to reuse the <see href="https://docs.microsoft.com/en-us/dotnet/architecture/microservices/implement-resilient-applications/use-httpclientfactory-to-implement-resilient-http-requests#issues-with-the-original-httpclient-class-available-in-net">HttpClient and HttpClientHandler</see>.
        /// </summary>
        ...
        /// <returns></returns>
        public HeartRateRoutesApi(OuraToolkit.Api.Client.Configuration configuration)
        {
        ...
        /// </remarks>
        public HeartRateRoutesApi(HttpClient client, HttpClientHandler handler = null) : this(client, (string)null, handler)
        {
        }
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public HeartRateRoutesApi(HttpClient client, string basePath, HttpClientHandler handler = null)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public HeartRateRoutesApi(HttpClient client, OuraToolkit.Api.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public HeartRateRoutesApi(OuraToolkit.Api.Client.ISynchronousClient client, OuraToolkit.Api.Client.IAsynchronousClient asyncClient, OuraToolkit.Api.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <param name="fields">Comma-separated list of fields to include in the response, in addition to the always returned fields. Defaults to all fields if not provided. (optional)</param>
        /// <returns>ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet</returns>
        public ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet MultipleHeartrateDocumentsV2UsercollectionHeartrateGet(DateTime? startDatetime = default, DateTime? endDatetime = default, string? nextToken = default, bool? latest = default, string? fields = default)
        {
            OuraToolkit.Api.Client.ApiResponse<ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet> localVarResponse = MultipleHeartrateDocumentsV2UsercollectionHeartrateGetWithHttpInfo(startDatetime, endDatetime, nextToken, latest, fields);
        ...
        /// <param name="fields">Comma-separated list of fields to include in the response, in addition to the always returned fields. Defaults to all fields if not provided. (optional)</param>
        /// <returns>ApiResponse of ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet</returns>
        public OuraToolkit.Api.Client.ApiResponse<ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet> MultipleHeartrateDocumentsV2UsercollectionHeartrateGetWithHttpInfo(DateTime? startDatetime = default, DateTime? endDatetime = default, string? nextToken = default, bool? latest = default, string? fields = default)
        {
            ...
            var localVarResponse = this.Client.Get<ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet>("/v2/usercollection/heartrate", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("MultipleHeartrateDocumentsV2UsercollectionHeartrateGet", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet</returns>
        public async System.Threading.Tasks.Task<ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet> MultipleHeartrateDocumentsV2UsercollectionHeartrateGetAsync(DateTime? startDatetime = default, DateTime? endDatetime = default, string? nextToken = default, bool? latest = default, string? fields = default, System.Threading.CancellationToken cancellationToken = default)
        {
            OuraToolkit.Api.Client.ApiResponse<ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet> localVarResponse = await MultipleHeartrateDocumentsV2UsercollectionHeartrateGetWithHttpInfoAsync(startDatetime, endDatetime, nextToken, latest, fields, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet)</returns>
        public async System.Threading.Tasks.Task<OuraToolkit.Api.Client.ApiResponse<ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet>> MultipleHeartrateDocumentsV2UsercollectionHeartrateGetWithHttpInfoAsync(DateTime? startDatetime = default, DateTime? endDatetime = default, string? nextToken = default, bool? latest = default, string? fields = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet>("/v2/usercollection/heartrate", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
