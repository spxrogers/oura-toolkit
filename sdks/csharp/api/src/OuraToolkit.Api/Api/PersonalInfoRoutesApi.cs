...
namespace OuraToolkit.Api.Api
{
    ...
    /// </summary>
    public interface IPersonalInfoRoutesApiSync : IApiAccessor
    {
        ...
        /// <returns>PersonalInfoResponse</returns>
        ...
        /// </remarks>
        /// <exception cref="OuraToolkit.Api.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of PersonalInfoResponse</returns>
        ApiResponse<PersonalInfoResponse> SinglePersonalInfoDocumentV2UsercollectionPersonalInfoGetWithHttpInfo();
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IPersonalInfoRoutesApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of PersonalInfoResponse</returns>
        System.Threading.Tasks.Task<PersonalInfoResponse> SinglePersonalInfoDocumentV2UsercollectionPersonalInfoGetAsync(System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <exception cref="OuraToolkit.Api.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PersonalInfoResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<PersonalInfoResponse>> SinglePersonalInfoDocumentV2UsercollectionPersonalInfoGetWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IPersonalInfoRoutesApi : IPersonalInfoRoutesApiSync, IPersonalInfoRoutesApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class PersonalInfoRoutesApi : IDisposable, IPersonalInfoRoutesApi
    {
        private OuraToolkit.Api.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="PersonalInfoRoutesApi"/> class.
        /// **IMPORTANT** This will also create an instance of HttpClient, which is less than ideal.
        /// It's better to reuse the <see href="https://docs.microsoft.com/en-us/dotnet/architecture/microservices/implement-resilient-applications/use-httpclientfactory-to-implement-resilient-http-requests#issues-with-the-original-httpclient-class-available-in-net">HttpClient and HttpClientHandler</see>.
        /// </summary>
        /// <returns></returns>
        public PersonalInfoRoutesApi() : this((string)null)
        {
        }
        ...
        /// <returns></returns>
        public PersonalInfoRoutesApi(string basePath)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PersonalInfoRoutesApi"/> class using Configuration object.
        /// **IMPORTANT** This will also create an instance of HttpClient, which is less than ideal.
        /// It's better to reuse the <see href="https://docs.microsoft.com/en-us/dotnet/architecture/microservices/implement-resilient-applications/use-httpclientfactory-to-implement-resilient-http-requests#issues-with-the-original-httpclient-class-available-in-net">HttpClient and HttpClientHandler</see>.
        /// </summary>
        ...
        /// <returns></returns>
        public PersonalInfoRoutesApi(OuraToolkit.Api.Client.Configuration configuration)
        {
        ...
        /// </remarks>
        public PersonalInfoRoutesApi(HttpClient client, HttpClientHandler handler = null) : this(client, (string)null, handler)
        {
        }
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public PersonalInfoRoutesApi(HttpClient client, string basePath, HttpClientHandler handler = null)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public PersonalInfoRoutesApi(HttpClient client, OuraToolkit.Api.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public PersonalInfoRoutesApi(OuraToolkit.Api.Client.ISynchronousClient client, OuraToolkit.Api.Client.IAsynchronousClient asyncClient, OuraToolkit.Api.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="OuraToolkit.Api.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>PersonalInfoResponse</returns>
        public PersonalInfoResponse SinglePersonalInfoDocumentV2UsercollectionPersonalInfoGet()
        {
            OuraToolkit.Api.Client.ApiResponse<PersonalInfoResponse> localVarResponse = SinglePersonalInfoDocumentV2UsercollectionPersonalInfoGetWithHttpInfo();
        ...
        /// <exception cref="OuraToolkit.Api.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of PersonalInfoResponse</returns>
        public OuraToolkit.Api.Client.ApiResponse<PersonalInfoResponse> SinglePersonalInfoDocumentV2UsercollectionPersonalInfoGetWithHttpInfo()
        {
            ...
            var localVarResponse = this.Client.Get<PersonalInfoResponse>("/v2/usercollection/personal_info", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("SinglePersonalInfoDocumentV2UsercollectionPersonalInfoGet", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of PersonalInfoResponse</returns>
        public async System.Threading.Tasks.Task<PersonalInfoResponse> SinglePersonalInfoDocumentV2UsercollectionPersonalInfoGetAsync(System.Threading.CancellationToken cancellationToken = default)
        {
            OuraToolkit.Api.Client.ApiResponse<PersonalInfoResponse> localVarResponse = await SinglePersonalInfoDocumentV2UsercollectionPersonalInfoGetWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PersonalInfoResponse)</returns>
        public async System.Threading.Tasks.Task<OuraToolkit.Api.Client.ApiResponse<PersonalInfoResponse>> SinglePersonalInfoDocumentV2UsercollectionPersonalInfoGetWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<PersonalInfoResponse>("/v2/usercollection/personal_info", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
