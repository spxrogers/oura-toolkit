...
namespace OuraToolkit.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PublicRestModePeriod")]
    public partial class PublicRestModePeriod : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicRestModePeriod" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PublicRestModePeriod() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicRestModePeriod" /> class.
        /// </summary>
        ...
        /// <param name="episodes">Collection of episodes during rest mode, consisting of tags. (required).</param>
        /// <param name="startDay">startDay (required).</param>
        /// <param name="startTime">startTime.</param>
        public PublicRestModePeriod(string id = default, string endDay = default, string endTime = default, List<PublicRestModeEpisode> episodes = default, string startDay = default, string startTime = default)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for PublicRestModePeriod and cannot be null");
            }
            this.Id = id;
            // to ensure "episodes" is required (not null)
            if (episodes == null)
            {
                throw new ArgumentNullException("episodes is a required property for PublicRestModePeriod and cannot be null");
            }
            this.Episodes = episodes;
            // to ensure "startDay" is required (not null)
            if (startDay == null)
            {
                throw new ArgumentNullException("startDay is a required property for PublicRestModePeriod and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Collection of episodes during rest mode, consisting of tags.</value>
        [DataMember(Name = "episodes", IsRequired = true, EmitDefaultValue = true)]
        public List<PublicRestModeEpisode> Episodes { get; set; }
