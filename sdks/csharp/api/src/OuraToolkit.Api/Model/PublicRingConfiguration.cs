...
namespace OuraToolkit.Api.Model
{
    ...
    /// Ring configuration.
    /// </summary>
    [DataContract(Name = "PublicRingConfiguration")]
    public partial class PublicRingConfiguration : IValidatableObject
    {
        ...
        public PublicRingColor? Color { get; set; }

        /// <summary>
        /// Gets or Sets Design
        /// </summary>
        [DataMember(Name = "design", EmitDefaultValue = true)]
        public PublicRingDesign? Design { get; set; }

        /// <summary>
        /// Gets or Sets HardwareType
        /// </summary>
        [DataMember(Name = "hardware_type", EmitDefaultValue = true)]
        public PublicRingHardwareType? HardwareType { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicRingConfiguration" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PublicRingConfiguration() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicRingConfiguration" /> class.
        /// </summary>
        ...
        /// <param name="setUpAt">setUpAt.</param>
        /// <param name="size">size.</param>
        public PublicRingConfiguration(string id = default, PublicRingColor? color = default, PublicRingDesign? design = default, string firmwareVersion = default, PublicRingHardwareType? hardwareType = default, string setUpAt = default, int? size = default)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for PublicRingConfiguration and cannot be null");
            }
            this.Id = id;
            this.Color = color;
            this.Design = design;
        ...
        /// </summary>
        [DataMember(Name = "firmware_version", EmitDefaultValue = true)]
        public string FirmwareVersion { get; set; }

        /// <summary>
        /// Gets or Sets SetUpAt
        /// </summary>
        [DataMember(Name = "set_up_at", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SetUpAt: ").Append(SetUpAt).Append("\n");
