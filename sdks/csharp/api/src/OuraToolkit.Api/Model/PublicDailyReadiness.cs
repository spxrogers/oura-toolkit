...
namespace OuraToolkit.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PublicDailyReadiness")]
    public partial class PublicDailyReadiness : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicDailyReadiness" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PublicDailyReadiness() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicDailyReadiness" /> class.
        /// </summary>
        /// <param name="id">Unique identifier of the object. (required).</param>
        /// <param name="contributors">Contributors of the daily readiness score. (required).</param>
        /// <param name="day">day (required).</param>
        /// <param name="score">score.</param>
        /// <param name="temperatureDeviation">temperatureDeviation.</param>
        /// <param name="temperatureTrendDeviation">temperatureTrendDeviation.</param>
        /// <param name="timestamp">timestamp (required).</param>
        public PublicDailyReadiness(string id = default, PublicReadinessContributors contributors = default, string day = default, int? score = default, decimal? temperatureDeviation = default, decimal? temperatureTrendDeviation = default, string timestamp = default)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for PublicDailyReadiness and cannot be null");
            }
            this.Id = id;
            // to ensure "contributors" is required (not null)
            if (contributors == null)
            {
                throw new ArgumentNullException("contributors is a required property for PublicDailyReadiness and cannot be null");
            }
            this.Contributors = contributors;
            // to ensure "day" is required (not null)
            if (day == null)
            {
                throw new ArgumentNullException("day is a required property for PublicDailyReadiness and cannot be null");
            }
            this.Day = day;
            // to ensure "timestamp" is required (not null)
            if (timestamp == null)
            {
                throw new ArgumentNullException("timestamp is a required property for PublicDailyReadiness and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Contributors of the daily readiness score.</value>
        [DataMember(Name = "contributors", IsRequired = true, EmitDefaultValue = true)]
        public PublicReadinessContributors Contributors { get; set; }
        ...
        /// <summary>
        /// Gets or Sets TemperatureDeviation
        /// </summary>
        [DataMember(Name = "temperature_deviation", EmitDefaultValue = true)]
        public decimal? TemperatureDeviation { get; set; }

        /// <summary>
        /// Gets or Sets TemperatureTrendDeviation
        /// </summary>
        [DataMember(Name = "temperature_trend_deviation", EmitDefaultValue = true)]
        public decimal? TemperatureTrendDeviation { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  TemperatureDeviation: ").Append(TemperatureDeviation).Append("\n");
            sb.Append("  TemperatureTrendDeviation: ").Append(TemperatureTrendDeviation).Append("\n");
