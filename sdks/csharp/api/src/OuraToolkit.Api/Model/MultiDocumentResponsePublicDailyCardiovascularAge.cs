...
namespace OuraToolkit.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MultiDocumentResponse_PublicDailyCardiovascularAge_")]
    public partial class MultiDocumentResponsePublicDailyCardiovascularAge : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiDocumentResponsePublicDailyCardiovascularAge" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MultiDocumentResponsePublicDailyCardiovascularAge() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiDocumentResponsePublicDailyCardiovascularAge" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        /// <param name="nextToken">nextToken (required).</param>
        public MultiDocumentResponsePublicDailyCardiovascularAge(List<PublicDailyCardiovascularAge> data = default, string nextToken = default)
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for MultiDocumentResponsePublicDailyCardiovascularAge and cannot be null");
            }
            this.Data = data;
            // to ensure "nextToken" is required (not null)
            if (nextToken == null)
            {
                throw new ArgumentNullException("nextToken is a required property for MultiDocumentResponsePublicDailyCardiovascularAge and cannot be null");
            }
        ...
        public List<PublicDailyCardiovascularAge> Data { get; set; }

        /// <summary>
        /// Gets or Sets NextToken
        /// </summary>
        [DataMember(Name = "next_token", IsRequired = true, EmitDefaultValue = true)]
