...
namespace OuraToolkit.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PublicDailyCardiovascularAge")]
    public partial class PublicDailyCardiovascularAge : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicDailyCardiovascularAge" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PublicDailyCardiovascularAge() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicDailyCardiovascularAge" /> class.
        /// </summary>
        /// <param name="id">Unique identifier of the object. (required).</param>
        /// <param name="day">day (required).</param>
        /// <param name="pulseWaveVelocity">pulseWaveVelocity.</param>
        /// <param name="vascularAge">vascularAge.</param>
        public PublicDailyCardiovascularAge(string id = default, string day = default, decimal? pulseWaveVelocity = default, int? vascularAge = default)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for PublicDailyCardiovascularAge and cannot be null");
            }
            this.Id = id;
            // to ensure "day" is required (not null)
            if (day == null)
            {
                throw new ArgumentNullException("day is a required property for PublicDailyCardiovascularAge and cannot be null");
            }
            this.Day = day;
        ...
        /// <summary>
        /// Gets or Sets PulseWaveVelocity
        /// </summary>
        [DataMember(Name = "pulse_wave_velocity", EmitDefaultValue = true)]
        public decimal? PulseWaveVelocity { get; set; }

        /// <summary>
        /// Gets or Sets VascularAge
        /// </summary>
        [DataMember(Name = "vascular_age", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PulseWaveVelocity: ").Append(PulseWaveVelocity).Append("\n");
            sb.Append("  VascularAge: ").Append(VascularAge).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
