...
namespace OuraToolkit.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PublicActivityContributors")]
    public partial class PublicActivityContributors : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicActivityContributors" /> class.
        /// </summary>
        /// <param name="meetDailyTargets">meetDailyTargets.</param>
        /// <param name="moveEveryHour">moveEveryHour.</param>
        /// <param name="recoveryTime">recoveryTime.</param>
        /// <param name="stayActive">stayActive.</param>
        /// <param name="trainingFrequency">trainingFrequency.</param>
        /// <param name="trainingVolume">trainingVolume.</param>
        public PublicActivityContributors(int? meetDailyTargets = default, int? moveEveryHour = default, int? recoveryTime = default, int? stayActive = default, int? trainingFrequency = default, int? trainingVolume = default)
        {
        ...
        /// <summary>
        /// Gets or Sets MeetDailyTargets
        /// </summary>
        [DataMember(Name = "meet_daily_targets", EmitDefaultValue = true)]
        public int? MeetDailyTargets { get; set; }

        /// <summary>
        /// Gets or Sets MoveEveryHour
        /// </summary>
        [DataMember(Name = "move_every_hour", EmitDefaultValue = true)]
        public int? MoveEveryHour { get; set; }

        /// <summary>
        /// Gets or Sets RecoveryTime
        /// </summary>
        [DataMember(Name = "recovery_time", EmitDefaultValue = true)]
        public int? RecoveryTime { get; set; }

        /// <summary>
        /// Gets or Sets StayActive
        /// </summary>
        [DataMember(Name = "stay_active", EmitDefaultValue = true)]
        public int? StayActive { get; set; }

        /// <summary>
        /// Gets or Sets TrainingFrequency
        /// </summary>
        [DataMember(Name = "training_frequency", EmitDefaultValue = true)]
        public int? TrainingFrequency { get; set; }

        /// <summary>
        /// Gets or Sets TrainingVolume
        /// </summary>
        [DataMember(Name = "training_volume", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  MeetDailyTargets: ").Append(MeetDailyTargets).Append("\n");
            sb.Append("  MoveEveryHour: ").Append(MoveEveryHour).Append("\n");
            sb.Append("  RecoveryTime: ").Append(RecoveryTime).Append("\n");
            sb.Append("  StayActive: ").Append(StayActive).Append("\n");
            sb.Append("  TrainingFrequency: ").Append(TrainingFrequency).Append("\n");
            sb.Append("  TrainingVolume: ").Append(TrainingVolume).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
