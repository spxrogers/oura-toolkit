...
namespace OuraToolkit.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TimeSeriesResponseDict")]
    public partial class TimeSeriesResponseDict : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TimeSeriesResponseDict" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TimeSeriesResponseDict() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TimeSeriesResponseDict" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        /// <param name="nextToken">nextToken.</param>
        public TimeSeriesResponseDict(List<Dictionary<string, Object>> data = default, string nextToken = default)
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for TimeSeriesResponseDict and cannot be null");
            }
            this.Data = data;
