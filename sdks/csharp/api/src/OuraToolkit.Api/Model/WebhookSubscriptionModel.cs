...
namespace OuraToolkit.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WebhookSubscriptionModel")]
    public partial class WebhookSubscriptionModel : IValidatableObject
    {
        ...
        protected WebhookSubscriptionModel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookSubscriptionModel" /> class.
        /// </summary>
        ...
        public WebhookSubscriptionModel(string id = default, string callbackUrl = default, WebhookOperation eventType = default, ExtApiV2DataType dataType = default, DateTime expirationTime = default)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for WebhookSubscriptionModel and cannot be null");
            }
            this.Id = id;
            // to ensure "callbackUrl" is required (not null)
            if (callbackUrl == null)
            {
                throw new ArgumentNullException("callbackUrl is a required property for WebhookSubscriptionModel and cannot be null");
            }
