...
namespace OuraToolkit.Api.Model
{
    ...
    public enum ExtApiV2DataType
    {
        ...
        /// <summary>
        /// Enum EnhancedTag for value: enhanced_tag
        /// </summary>
        [EnumMember(Value = "enhanced_tag")]
        EnhancedTag = 2,
        ...
        /// <summary>
        /// Enum DailySleep for value: daily_sleep
        /// </summary>
        [EnumMember(Value = "daily_sleep")]
        DailySleep = 6,

        /// <summary>
        /// Enum DailyReadiness for value: daily_readiness
        /// </summary>
        [EnumMember(Value = "daily_readiness")]
        DailyReadiness = 7,

        /// <summary>
        /// Enum DailyActivity for value: daily_activity
        /// </summary>
        [EnumMember(Value = "daily_activity")]
        DailyActivity = 8,

        /// <summary>
        /// Enum DailySpo2 for value: daily_spo2
        /// </summary>
        [EnumMember(Value = "daily_spo2")]
        DailySpo2 = 9,

        /// <summary>
        /// Enum SleepTime for value: sleep_time
        /// </summary>
        [EnumMember(Value = "sleep_time")]
        SleepTime = 10,

        /// <summary>
        /// Enum RestModePeriod for value: rest_mode_period
        /// </summary>
        [EnumMember(Value = "rest_mode_period")]
        RestModePeriod = 11,

        /// <summary>
        /// Enum RingConfiguration for value: ring_configuration
        /// </summary>
        [EnumMember(Value = "ring_configuration")]
        RingConfiguration = 12,

        /// <summary>
        /// Enum DailyStress for value: daily_stress
        /// </summary>
        [EnumMember(Value = "daily_stress")]
        DailyStress = 13,

        /// <summary>
        /// Enum DailyCardiovascularAge for value: daily_cardiovascular_age
        /// </summary>
        [EnumMember(Value = "daily_cardiovascular_age")]
        DailyCardiovascularAge = 14,

        /// <summary>
        /// Enum DailyResilience for value: daily_resilience
        /// </summary>
        [EnumMember(Value = "daily_resilience")]
        DailyResilience = 15,

        /// <summary>
        /// Enum Vo2Max for value: vo2_max
        /// </summary>
        [EnumMember(Value = "vo2_max")]
        Vo2Max = 16,
