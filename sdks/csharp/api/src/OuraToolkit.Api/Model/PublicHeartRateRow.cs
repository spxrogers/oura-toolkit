...
namespace OuraToolkit.Api.Model
{
    ...
    /// Heart rate sample
    /// </summary>
    [DataContract(Name = "PublicHeartRateRow")]
    public partial class PublicHeartRateRow : IValidatableObject
    {

        /// <summary>
        /// Source of the sample.
        /// </summary>
        /// <value>Source of the sample.</value>
        [DataMember(Name = "source", IsRequired = true, EmitDefaultValue = true)]
        public PublicHeartRateSource Source { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicHeartRateRow" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PublicHeartRateRow() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicHeartRateRow" /> class.
        /// </summary>
        /// <param name="timestamp">timestamp (required).</param>
        /// <param name="timestampUnix">Timestamp of the discrete sample as unix time in milliseconds. (required).</param>
        /// <param name="bpm">Heart rate as beats per minute. (required).</param>
        /// <param name="source">Source of the sample. (required).</param>
        public PublicHeartRateRow(string timestamp = default, int timestampUnix = default, int bpm = default, PublicHeartRateSource source = default)
        {
            // to ensure "timestamp" is required (not null)
            if (timestamp == null)
            {
                throw new ArgumentNullException("timestamp is a required property for PublicHeartRateRow and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Heart rate as beats per minute.</value>
        [DataMember(Name = "bpm", IsRequired = true, EmitDefaultValue = true)]
