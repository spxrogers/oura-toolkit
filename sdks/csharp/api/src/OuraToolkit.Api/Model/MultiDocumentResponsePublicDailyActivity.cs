...
namespace OuraToolkit.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MultiDocumentResponse_PublicDailyActivity_")]
    public partial class MultiDocumentResponsePublicDailyActivity : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiDocumentResponsePublicDailyActivity" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MultiDocumentResponsePublicDailyActivity() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiDocumentResponsePublicDailyActivity" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        /// <param name="nextToken">nextToken (required).</param>
        public MultiDocumentResponsePublicDailyActivity(List<PublicDailyActivity> data = default, string nextToken = default)
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for MultiDocumentResponsePublicDailyActivity and cannot be null");
            }
            this.Data = data;
            // to ensure "nextToken" is required (not null)
            if (nextToken == null)
            {
                throw new ArgumentNullException("nextToken is a required property for MultiDocumentResponsePublicDailyActivity and cannot be null");
            }
        ...
        public List<PublicDailyActivity> Data { get; set; }
