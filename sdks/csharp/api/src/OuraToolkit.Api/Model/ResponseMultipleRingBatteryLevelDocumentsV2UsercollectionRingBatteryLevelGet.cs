...
namespace OuraToolkit.Api.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGetJsonConverter))]
    [DataContract(Name = "Response_Multiple_Ring_Battery_Level_Documents_V2_Usercollection_Ring_Battery_Level_Get")]
    public partial class ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet : AbstractOpenAPISchema, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet" /> class
        ...
        public ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet(TimeSeriesResponsePublicRingBatteryLevelRow actualInstance)
        {
            IsNullable = false;
            SchemaType= "anyOf";
        ...
        public ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet(TimeSeriesResponseDict actualInstance)
        {
            IsNullable = false;
            SchemaType= "anyOf";
            ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet {\n");
        ...
        {
            return JsonConvert.SerializeObject(ActualInstance, ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet</returns>
        public static ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet FromJson(string jsonString)
        {
            ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet newResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet;
            }

            try
            {
                newResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet = new ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet(JsonConvert.DeserializeObject<TimeSeriesResponseDict>(jsonString, ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet.SerializerSettings));
            ...
            try
            {
                newResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet = new ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet(JsonConvert.DeserializeObject<TimeSeriesResponsePublicRingBatteryLevelRow>(jsonString, ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet.SerializerSettings));
                // deserialization is considered successful at this point if no exception has been thrown.
                return newResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet;
            }
            catch (Exception exception)
    ...
    /// <summary>
    /// Custom JSON converter for ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet
    /// </summary>
    public class ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGetJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            switch(reader.TokenType) 
            {
                case JsonToken.StartObject:
                    return ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet.FromJson(JObject.Load(reader).ToString(Formatting.None));
                case JsonToken.StartArray:
                    return ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet.FromJson(JArray.Load(reader).ToString(Formatting.None));
                default:
                    return null;
            }
        }
