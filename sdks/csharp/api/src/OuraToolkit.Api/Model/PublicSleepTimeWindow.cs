...
namespace OuraToolkit.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PublicSleepTimeWindow")]
    public partial class PublicSleepTimeWindow : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicSleepTimeWindow" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PublicSleepTimeWindow() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicSleepTimeWindow" /> class.
        /// </summary>
        /// <param name="dayTz">Timezone offset in second from GMT of the day (required).</param>
        /// <param name="endOffset">End offset from midnight in second (required).</param>
        /// <param name="startOffset">Start offset from midnight in second (required).</param>
        public PublicSleepTimeWindow(int dayTz = default, int endOffset = default, int startOffset = default)
        {
            this.DayTz = dayTz;
        ...
        /// </summary>
        /// <value>Timezone offset in second from GMT of the day</value>
        [DataMember(Name = "day_tz", IsRequired = true, EmitDefaultValue = true)]
        public int DayTz { get; set; }

        /// <summary>
        /// End offset from midnight in second
        /// </summary>
        /// <value>End offset from midnight in second</value>
        [DataMember(Name = "end_offset", IsRequired = true, EmitDefaultValue = true)]
        public int EndOffset { get; set; }

        /// <summary>
        /// Start offset from midnight in second
        /// </summary>
        /// <value>Start offset from midnight in second</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DayTz: ").Append(DayTz).Append("\n");
