...
namespace OuraToolkit.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MultiDocumentResponse_DailyResilienceModel_")]
    public partial class MultiDocumentResponseDailyResilienceModel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiDocumentResponseDailyResilienceModel" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MultiDocumentResponseDailyResilienceModel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiDocumentResponseDailyResilienceModel" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        /// <param name="nextToken">nextToken (required).</param>
        public MultiDocumentResponseDailyResilienceModel(List<DailyResilienceModel> data = default, string nextToken = default)
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for MultiDocumentResponseDailyResilienceModel and cannot be null");
            }
            this.Data = data;
            // to ensure "nextToken" is required (not null)
            if (nextToken == null)
            {
                throw new ArgumentNullException("nextToken is a required property for MultiDocumentResponseDailyResilienceModel and cannot be null");
            }
        ...
        public List<DailyResilienceModel> Data { get; set; }
