...
namespace OuraToolkit.Api.Model
{
    ...
    /// </summary>
    /// <value>Possible ring colors.</value>
    [JsonConverter(typeof(StringEnumConverter))]
    public enum PublicRingColor
    {
        /// <summary>
        /// Enum BrushedSilver for value: brushed_silver
        /// </summary>
        [EnumMember(Value = "brushed_silver")]
        BrushedSilver = 1,

        /// <summary>
        /// Enum GlossyBlack for value: glossy_black
        /// </summary>
        [EnumMember(Value = "glossy_black")]
        GlossyBlack = 2,

        /// <summary>
        /// Enum GlossyGold for value: glossy_gold
        /// </summary>
        [EnumMember(Value = "glossy_gold")]
        GlossyGold = 3,

        /// <summary>
        /// Enum GlossyWhite for value: glossy_white
        /// </summary>
        [EnumMember(Value = "glossy_white")]
        GlossyWhite = 4,

        /// <summary>
        /// Enum Gucci for value: gucci
        /// </summary>
        [EnumMember(Value = "gucci")]
        Gucci = 5,

        /// <summary>
        /// Enum MattGold for value: matt_gold
        /// </summary>
        [EnumMember(Value = "matt_gold")]
        MattGold = 6,

        /// <summary>
        /// Enum Rose for value: rose
        /// </summary>
        ...
        /// <summary>
        /// Enum StealthBlack for value: stealth_black
        /// </summary>
        [EnumMember(Value = "stealth_black")]
        StealthBlack = 9,

        /// <summary>
        /// Enum Titanium for value: titanium
        /// </summary>
        [EnumMember(Value = "titanium")]
        Titanium = 10,

        /// <summary>
        /// Enum TitaniumAndGold for value: titanium_and_gold
        /// </summary>
        [EnumMember(Value = "titanium_and_gold")]
        TitaniumAndGold = 11,
        ...
        /// <summary>
        /// Enum Petal for value: petal
        /// </summary>
        [EnumMember(Value = "petal")]
        Petal = 13,
        ...
        /// <summary>
        /// Enum Tide for value: tide
        /// </summary>
        [EnumMember(Value = "tide")]
        Tide = 15,

        /// <summary>
        /// Enum DeepRose for value: deep_rose
        /// </summary>
        [EnumMember(Value = "deep_rose")]
        DeepRose = 16
    }
