...
namespace OuraToolkit.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MultiDocumentResponse_TagModel_")]
    public partial class MultiDocumentResponseTagModel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiDocumentResponseTagModel" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MultiDocumentResponseTagModel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiDocumentResponseTagModel" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        /// <param name="nextToken">nextToken (required).</param>
        public MultiDocumentResponseTagModel(List<TagModel> data = default, string nextToken = default)
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for MultiDocumentResponseTagModel and cannot be null");
            }
            this.Data = data;
            // to ensure "nextToken" is required (not null)
            if (nextToken == null)
            {
                throw new ArgumentNullException("nextToken is a required property for MultiDocumentResponseTagModel and cannot be null");
            }
