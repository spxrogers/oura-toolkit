...
namespace OuraToolkit.Api.Model
{
    ...
    /// </summary>
    /// <value>Possible sleep period types. &#39;deleted&#39; &#x3D; deleted sleep by user. &#39;sleep&#39; &#x3D; user confirmed sleep / nap, min 15 minutes, max 3 hours, contributes to daily scores &#39;late_nap&#39; &#x3D; user confirmed sleep / nap, min 15 minutes, ended after sleep day change (6 pm), contributes to next days daily scores &#39;long_sleep&#39; &#x3D; sleep that is long enough (&gt;3h) to automatically contribute to daily scores &#39;rest&#39; &#x3D; Falsely detected sleep / nap, rejected in confirm prompt by user</value>
    ...
    public enum PublicSleepType
    {
        ...
        /// <summary>
        /// Enum LongSleep for value: long_sleep
        /// </summary>
        [EnumMember(Value = "long_sleep")]
        LongSleep = 3,

        /// <summary>
        /// Enum LateNap for value: late_nap
        /// </summary>
        [EnumMember(Value = "late_nap")]
        LateNap = 4,
