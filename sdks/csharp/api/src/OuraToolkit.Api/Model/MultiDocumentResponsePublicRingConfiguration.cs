...
namespace OuraToolkit.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MultiDocumentResponse_PublicRingConfiguration_")]
    public partial class MultiDocumentResponsePublicRingConfiguration : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiDocumentResponsePublicRingConfiguration" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MultiDocumentResponsePublicRingConfiguration() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiDocumentResponsePublicRingConfiguration" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        /// <param name="nextToken">nextToken (required).</param>
        public MultiDocumentResponsePublicRingConfiguration(List<PublicRingConfiguration> data = default, string nextToken = default)
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for MultiDocumentResponsePublicRingConfiguration and cannot be null");
            }
            this.Data = data;
            // to ensure "nextToken" is required (not null)
            if (nextToken == null)
            {
                throw new ArgumentNullException("nextToken is a required property for MultiDocumentResponsePublicRingConfiguration and cannot be null");
            }
        ...
        public List<PublicRingConfiguration> Data { get; set; }
