...
namespace OuraToolkit.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PublicReadiness")]
    public partial class PublicReadiness : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicReadiness" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PublicReadiness() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicReadiness" /> class.
        /// </summary>
        /// <param name="contributors">Contributors of the readiness score. (required).</param>
        ...
        public PublicReadiness(PublicReadinessContributors contributors = default, int? score = default, decimal? temperatureDeviation = default, decimal? temperatureTrendDeviation = default)
        {
            // to ensure "contributors" is required (not null)
            if (contributors == null)
            {
                throw new ArgumentNullException("contributors is a required property for PublicReadiness and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Contributors of the readiness score.</value>
