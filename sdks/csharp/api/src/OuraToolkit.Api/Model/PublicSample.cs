...
namespace OuraToolkit.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PublicSample")]
    public partial class PublicSample : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicSample" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PublicSample() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicSample" /> class.
        /// </summary>
        /// <param name="interval">Interval in seconds between the sampled items. (required).</param>
        /// <param name="items">items (required).</param>
        /// <param name="timestamp">timestamp (required).</param>
        public PublicSample(decimal interval = default, List<decimal?> items = default, string timestamp = default)
        {
            this.Interval = interval;
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new ArgumentNullException("items is a required property for PublicSample and cannot be null");
            }
            this.Items = items;
            // to ensure "timestamp" is required (not null)
            if (timestamp == null)
            {
                throw new ArgumentNullException("timestamp is a required property for PublicSample and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Interval in seconds between the sampled items.</value>
