...
namespace OuraToolkit.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DailyResilienceModel")]
    public partial class DailyResilienceModel : IValidatableObject
    {

        /// <summary>
        /// Resilience level.
        /// </summary>
        /// <value>Resilience level.</value>
        [DataMember(Name = "level", IsRequired = true, EmitDefaultValue = true)]
        public LongTermResilienceLevel Level { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="DailyResilienceModel" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DailyResilienceModel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DailyResilienceModel" /> class.
        /// </summary>
        ...
        public DailyResilienceModel(string id = default, DateOnly day = default, ResilienceContributors contributors = default, LongTermResilienceLevel level = default)
        {
            ...
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for DailyResilienceModel and cannot be null");
            }
            this.Id = id;
            this.Day = day;
            ...
            {
                throw new ArgumentNullException("contributors is a required property for DailyResilienceModel and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Contributors to the resilience score.</value>
        [DataMember(Name = "contributors", IsRequired = true, EmitDefaultValue = true)]
        public ResilienceContributors Contributors { get; set; }
