...
namespace OuraToolkit.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PublicRestModeEpisode")]
    public partial class PublicRestModeEpisode : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicRestModeEpisode" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PublicRestModeEpisode() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicRestModeEpisode" /> class.
        /// </summary>
        /// <param name="tags">Tags selected for the episode. (required).</param>
        /// <param name="timestamp">timestamp (required).</param>
        public PublicRestModeEpisode(List<string> tags = default, string timestamp = default)
        {
            // to ensure "tags" is required (not null)
            if (tags == null)
            {
                throw new ArgumentNullException("tags is a required property for PublicRestModeEpisode and cannot be null");
            }
            this.Tags = tags;
            // to ensure "timestamp" is required (not null)
            if (timestamp == null)
            {
                throw new ArgumentNullException("timestamp is a required property for PublicRestModeEpisode and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Tags selected for the episode.</value>
