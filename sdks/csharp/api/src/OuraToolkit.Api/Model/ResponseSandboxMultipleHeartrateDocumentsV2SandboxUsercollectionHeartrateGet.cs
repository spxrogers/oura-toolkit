...
namespace OuraToolkit.Api.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGetJsonConverter))]
    [DataContract(Name = "Response_Sandbox___Multiple_Heartrate_Documents_V2_Sandbox_Usercollection_Heartrate_Get")]
    public partial class ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet : AbstractOpenAPISchema, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet" /> class
        ...
        public ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet(TimeSeriesResponsePublicHeartRateRow actualInstance)
        {
            IsNullable = false;
            SchemaType= "anyOf";
        ...
        public ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet(TimeSeriesResponseDict actualInstance)
        {
            IsNullable = false;
            SchemaType= "anyOf";
            ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet {\n");
        ...
        {
            return JsonConvert.SerializeObject(ActualInstance, ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet</returns>
        public static ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet FromJson(string jsonString)
        {
            ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet newResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet;
            }

            try
            {
                newResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet = new ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet(JsonConvert.DeserializeObject<TimeSeriesResponseDict>(jsonString, ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet.SerializerSettings));
            ...
            try
            {
                newResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet = new ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet(JsonConvert.DeserializeObject<TimeSeriesResponsePublicHeartRateRow>(jsonString, ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet.SerializerSettings));
                // deserialization is considered successful at this point if no exception has been thrown.
                return newResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet;
            }
            catch (Exception exception)
    ...
    /// <summary>
    /// Custom JSON converter for ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet
    /// </summary>
    public class ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGetJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            switch(reader.TokenType) 
            {
                case JsonToken.StartObject:
                    return ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet.FromJson(JObject.Load(reader).ToString(Formatting.None));
                case JsonToken.StartArray:
                    return ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet.FromJson(JArray.Load(reader).ToString(Formatting.None));
                default:
                    return null;
            }
        }
