...
namespace OuraToolkit.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MultiDocumentResponse_PublicDailySleep_")]
    public partial class MultiDocumentResponsePublicDailySleep : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiDocumentResponsePublicDailySleep" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MultiDocumentResponsePublicDailySleep() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiDocumentResponsePublicDailySleep" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        /// <param name="nextToken">nextToken (required).</param>
        public MultiDocumentResponsePublicDailySleep(List<PublicDailySleep> data = default, string nextToken = default)
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for MultiDocumentResponsePublicDailySleep and cannot be null");
            }
            this.Data = data;
            // to ensure "nextToken" is required (not null)
            if (nextToken == null)
            {
                throw new ArgumentNullException("nextToken is a required property for MultiDocumentResponsePublicDailySleep and cannot be null");
            }
        ...
        public List<PublicDailySleep> Data { get; set; }
