...
namespace OuraToolkit.Api.Model
{
    ...
    /// VO2Max estimate.
    /// </summary>
    [DataContract(Name = "PublicVO2Max")]
    public partial class PublicVO2Max : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicVO2Max" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PublicVO2Max() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicVO2Max" /> class.
        /// </summary>
        ...
        /// <param name="vo2Max">VO2 max value. (required).</param>
        public PublicVO2Max(string id = default, string day = default, string timestamp = default, int vo2Max = default)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for PublicVO2Max and cannot be null");
            }
            this.Id = id;
            // to ensure "day" is required (not null)
            if (day == null)
            {
                throw new ArgumentNullException("day is a required property for PublicVO2Max and cannot be null");
            }
            this.Day = day;
            // to ensure "timestamp" is required (not null)
            if (timestamp == null)
            {
                throw new ArgumentNullException("timestamp is a required property for PublicVO2Max and cannot be null");
            }
        ...
        /// VO2 max value.
        /// </summary>
        /// <value>VO2 max value.</value>
        [DataMember(Name = "vo2_max", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Vo2Max: ").Append(Vo2Max).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
