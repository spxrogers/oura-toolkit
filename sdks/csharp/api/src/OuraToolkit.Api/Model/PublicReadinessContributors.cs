...
namespace OuraToolkit.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PublicReadinessContributors")]
    public partial class PublicReadinessContributors : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicReadinessContributors" /> class.
        /// </summary>
        /// <param name="activityBalance">activityBalance.</param>
        /// <param name="bodyTemperature">bodyTemperature.</param>
        /// <param name="hrvBalance">hrvBalance.</param>
        /// <param name="previousDayActivity">previousDayActivity.</param>
        /// <param name="previousNight">previousNight.</param>
        /// <param name="recoveryIndex">recoveryIndex.</param>
        /// <param name="restingHeartRate">restingHeartRate.</param>
        /// <param name="sleepBalance">sleepBalance.</param>
        /// <param name="sleepRegularity">sleepRegularity.</param>
        public PublicReadinessContributors(int? activityBalance = default, int? bodyTemperature = default, int? hrvBalance = default, int? previousDayActivity = default, int? previousNight = default, int? recoveryIndex = default, int? restingHeartRate = default, int? sleepBalance = default, int? sleepRegularity = default)
        {
        ...
        /// <summary>
        /// Gets or Sets ActivityBalance
        /// </summary>
        [DataMember(Name = "activity_balance", EmitDefaultValue = true)]
        public int? ActivityBalance { get; set; }

        /// <summary>
        /// Gets or Sets BodyTemperature
        /// </summary>
        [DataMember(Name = "body_temperature", EmitDefaultValue = true)]
        public int? BodyTemperature { get; set; }

        /// <summary>
        /// Gets or Sets HrvBalance
        /// </summary>
        [DataMember(Name = "hrv_balance", EmitDefaultValue = true)]
        public int? HrvBalance { get; set; }

        /// <summary>
        /// Gets or Sets PreviousDayActivity
        /// </summary>
        [DataMember(Name = "previous_day_activity", EmitDefaultValue = true)]
        public int? PreviousDayActivity { get; set; }

        /// <summary>
        /// Gets or Sets PreviousNight
        /// </summary>
        [DataMember(Name = "previous_night", EmitDefaultValue = true)]
        public int? PreviousNight { get; set; }

        /// <summary>
        /// Gets or Sets RecoveryIndex
        /// </summary>
        [DataMember(Name = "recovery_index", EmitDefaultValue = true)]
        public int? RecoveryIndex { get; set; }

        /// <summary>
        /// Gets or Sets RestingHeartRate
        /// </summary>
        [DataMember(Name = "resting_heart_rate", EmitDefaultValue = true)]
        public int? RestingHeartRate { get; set; }

        /// <summary>
        /// Gets or Sets SleepBalance
        /// </summary>
        [DataMember(Name = "sleep_balance", EmitDefaultValue = true)]
        public int? SleepBalance { get; set; }

        /// <summary>
        /// Gets or Sets SleepRegularity
        /// </summary>
        [DataMember(Name = "sleep_regularity", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ActivityBalance: ").Append(ActivityBalance).Append("\n");
            sb.Append("  BodyTemperature: ").Append(BodyTemperature).Append("\n");
            sb.Append("  HrvBalance: ").Append(HrvBalance).Append("\n");
            sb.Append("  PreviousDayActivity: ").Append(PreviousDayActivity).Append("\n");
            sb.Append("  PreviousNight: ").Append(PreviousNight).Append("\n");
            sb.Append("  RecoveryIndex: ").Append(RecoveryIndex).Append("\n");
            sb.Append("  RestingHeartRate: ").Append(RestingHeartRate).Append("\n");
            sb.Append("  SleepBalance: ").Append(SleepBalance).Append("\n");
            sb.Append("  SleepRegularity: ").Append(SleepRegularity).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
