...
namespace OuraToolkit.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PublicRingBatteryLevelRow")]
    public partial class PublicRingBatteryLevelRow : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicRingBatteryLevelRow" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PublicRingBatteryLevelRow() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicRingBatteryLevelRow" /> class.
        /// </summary>
        /// <param name="timestamp">timestamp (required).</param>
        /// <param name="timestampUnix">Timestamp of the discrete sample as unix time in milliseconds. (required).</param>
        /// <param name="charging">charging.</param>
        /// <param name="inCharger">inCharger.</param>
        /// <param name="level">Ring battery level percentage. These values are within [0, 100]. (required).</param>
        public PublicRingBatteryLevelRow(string timestamp = default, int timestampUnix = default, bool? charging = default, bool? inCharger = default, int level = default)
        {
            // to ensure "timestamp" is required (not null)
            if (timestamp == null)
            {
                throw new ArgumentNullException("timestamp is a required property for PublicRingBatteryLevelRow and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Timestamp of the discrete sample as unix time in milliseconds.</value>
        [DataMember(Name = "timestamp_unix", IsRequired = true, EmitDefaultValue = true)]
        public int TimestampUnix { get; set; }

        /// <summary>
        /// Gets or Sets Charging
        /// </summary>
        [DataMember(Name = "charging", EmitDefaultValue = true)]
        public bool? Charging { get; set; }

        /// <summary>
        /// Gets or Sets InCharger
        /// </summary>
        [DataMember(Name = "in_charger", EmitDefaultValue = true)]
        public bool? InCharger { get; set; }

        /// <summary>
        /// Ring battery level percentage. These values are within [0, 100].
        /// </summary>
        /// <value>Ring battery level percentage. These values are within [0, 100].</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  InCharger: ").Append(InCharger).Append("\n");
