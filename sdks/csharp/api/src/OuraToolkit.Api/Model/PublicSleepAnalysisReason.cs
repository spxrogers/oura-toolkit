...
namespace OuraToolkit.Api.Model
{
    ...
    /// </summary>
    /// <value>Possible sleep analysis reasons.</value>
    [JsonConverter(typeof(StringEnumConverter))]
    public enum PublicSleepAnalysisReason
    {
        /// <summary>
        /// Enum ForegroundSleepAnalysis for value: foreground_sleep_analysis
        /// </summary>
        [EnumMember(Value = "foreground_sleep_analysis")]
        ForegroundSleepAnalysis = 1,

        /// <summary>
        /// Enum BedtimeEdit for value: bedtime_edit
        /// </summary>
        [EnumMember(Value = "bedtime_edit")]
        BedtimeEdit = 2,

        /// <summary>
        /// Enum BackgroundSleepAnalysis for value: background_sleep_analysis
        /// </summary>
        [EnumMember(Value = "background_sleep_analysis")]
        BackgroundSleepAnalysis = 3,

        /// <summary>
        /// Enum BackgroundCreatedForegroundUpdated for value: background_created_foreground_updated
        /// </summary>
        [EnumMember(Value = "background_created_foreground_updated")]
        BackgroundCreatedForegroundUpdated = 4
    }
