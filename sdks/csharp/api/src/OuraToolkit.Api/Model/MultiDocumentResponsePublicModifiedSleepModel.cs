...
namespace OuraToolkit.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MultiDocumentResponse_PublicModifiedSleepModel_")]
    public partial class MultiDocumentResponsePublicModifiedSleepModel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiDocumentResponsePublicModifiedSleepModel" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MultiDocumentResponsePublicModifiedSleepModel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiDocumentResponsePublicModifiedSleepModel" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        /// <param name="nextToken">nextToken (required).</param>
        public MultiDocumentResponsePublicModifiedSleepModel(List<PublicModifiedSleepModel> data = default, string nextToken = default)
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for MultiDocumentResponsePublicModifiedSleepModel and cannot be null");
            }
            this.Data = data;
            // to ensure "nextToken" is required (not null)
            if (nextToken == null)
            {
                throw new ArgumentNullException("nextToken is a required property for MultiDocumentResponsePublicModifiedSleepModel and cannot be null");
            }
        ...
        public List<PublicModifiedSleepModel> Data { get; set; }
