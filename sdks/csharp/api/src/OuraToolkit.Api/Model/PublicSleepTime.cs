...
namespace OuraToolkit.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PublicSleepTime")]
    public partial class PublicSleepTime : IValidatableObject
    {
        ...
        public PublicSleepTimeRecommendation? Recommendation { get; set; }

        /// <summary>
        /// Gets or Sets Status
        /// </summary>
        [DataMember(Name = "status", EmitDefaultValue = true)]
        public PublicSleepTimeStatus? Status { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicSleepTime" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PublicSleepTime() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicSleepTime" /> class.
        /// </summary>
        /// <param name="id">Unique identifier of the object. (required).</param>
        /// <param name="day">day (required).</param>
        /// <param name="optimalBedtime">optimalBedtime.</param>
        /// <param name="recommendation">recommendation.</param>
        /// <param name="status">status.</param>
        public PublicSleepTime(string id = default, string day = default, PublicSleepTimeWindow optimalBedtime = default, PublicSleepTimeRecommendation? recommendation = default, PublicSleepTimeStatus? status = default)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for PublicSleepTime and cannot be null");
            }
            this.Id = id;
            // to ensure "day" is required (not null)
            if (day == null)
            {
                throw new ArgumentNullException("day is a required property for PublicSleepTime and cannot be null");
            }
            this.Day = day;
        ...
        /// <summary>
        /// Gets or Sets OptimalBedtime
        /// </summary>
        [DataMember(Name = "optimal_bedtime", EmitDefaultValue = true)]
        public PublicSleepTimeWindow OptimalBedtime { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  OptimalBedtime: ").Append(OptimalBedtime).Append("\n");
