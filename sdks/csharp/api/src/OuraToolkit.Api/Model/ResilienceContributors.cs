...
namespace OuraToolkit.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResilienceContributors")]
    public partial class ResilienceContributors : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResilienceContributors" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResilienceContributors() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResilienceContributors" /> class.
        /// </summary>
        /// <param name="sleepRecovery">Sleep recovery contributor to the resilience score. Range: [0, 100] (required).</param>
        /// <param name="daytimeRecovery">Daytime recovery contributor to the resilience score. Range: [0, 100] (required).</param>
        /// <param name="stress">Stress contributor to the resilience score. Range: [0, 100] (required).</param>
        public ResilienceContributors(decimal sleepRecovery = default, decimal daytimeRecovery = default, decimal stress = default)
        {
        ...
        /// </summary>
        /// <value>Sleep recovery contributor to the resilience score. Range: [0, 100]</value>
        [DataMember(Name = "sleep_recovery", IsRequired = true, EmitDefaultValue = true)]
        public decimal SleepRecovery { get; set; }

        /// <summary>
        /// Daytime recovery contributor to the resilience score. Range: [0, 100]
        /// </summary>
        /// <value>Daytime recovery contributor to the resilience score. Range: [0, 100]</value>
        [DataMember(Name = "daytime_recovery", IsRequired = true, EmitDefaultValue = true)]
        public decimal DaytimeRecovery { get; set; }

        /// <summary>
        /// Stress contributor to the resilience score. Range: [0, 100]
        /// </summary>
        /// <value>Stress contributor to the resilience score. Range: [0, 100]</value>
        [DataMember(Name = "stress", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SleepRecovery: ").Append(SleepRecovery).Append("\n");
            sb.Append("  DaytimeRecovery: ").Append(DaytimeRecovery).Append("\n");
