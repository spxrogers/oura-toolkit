...
namespace OuraToolkit.Api.Model
{
    ...
    /// </summary>
    /// <value>Possible public SleepTime recommendation.</value>
    [JsonConverter(typeof(StringEnumConverter))]
    public enum PublicSleepTimeRecommendation
    {
        /// <summary>
        /// Enum ImproveEfficiency for value: improve_efficiency
        /// </summary>
        [EnumMember(Value = "improve_efficiency")]
        ImproveEfficiency = 1,

        /// <summary>
        /// Enum EarlierBedtime for value: earlier_bedtime
        /// </summary>
        [EnumMember(Value = "earlier_bedtime")]
        EarlierBedtime = 2,

        /// <summary>
        /// Enum LaterBedtime for value: later_bedtime
        /// </summary>
        [EnumMember(Value = "later_bedtime")]
        LaterBedtime = 3,

        /// <summary>
        /// Enum EarlierWakeUpTime for value: earlier_wake_up_time
        /// </summary>
        [EnumMember(Value = "earlier_wake_up_time")]
        EarlierWakeUpTime = 4,

        /// <summary>
        /// Enum LaterWakeUpTime for value: later_wake_up_time
        /// </summary>
        [EnumMember(Value = "later_wake_up_time")]
        LaterWakeUpTime = 5,

        /// <summary>
        /// Enum FollowOptimalBedtime for value: follow_optimal_bedtime
        /// </summary>
        [EnumMember(Value = "follow_optimal_bedtime")]
        FollowOptimalBedtime = 6
    }
