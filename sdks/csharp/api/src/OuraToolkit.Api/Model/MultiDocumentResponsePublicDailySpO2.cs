...
namespace OuraToolkit.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MultiDocumentResponse_PublicDailySpO2_")]
    public partial class MultiDocumentResponsePublicDailySpO2 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiDocumentResponsePublicDailySpO2" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MultiDocumentResponsePublicDailySpO2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiDocumentResponsePublicDailySpO2" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        /// <param name="nextToken">nextToken (required).</param>
        public MultiDocumentResponsePublicDailySpO2(List<PublicDailySpO2> data = default, string nextToken = default)
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for MultiDocumentResponsePublicDailySpO2 and cannot be null");
            }
            this.Data = data;
            // to ensure "nextToken" is required (not null)
            if (nextToken == null)
            {
                throw new ArgumentNullException("nextToken is a required property for MultiDocumentResponsePublicDailySpO2 and cannot be null");
            }
        ...
        public List<PublicDailySpO2> Data { get; set; }
