...
namespace OuraToolkit.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PublicDailySpO2")]
    public partial class PublicDailySpO2 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicDailySpO2" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PublicDailySpO2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicDailySpO2" /> class.
        /// </summary>
        /// <param name="id">Unique identifier of the object. (required).</param>
        /// <param name="breathingDisturbanceIndex">breathingDisturbanceIndex.</param>
        /// <param name="day">day (required).</param>
        /// <param name="spo2Percentage">spo2Percentage.</param>
        public PublicDailySpO2(string id = default, int? breathingDisturbanceIndex = default, string day = default, PublicSpo2AggregatedValues spo2Percentage = default)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for PublicDailySpO2 and cannot be null");
            }
            this.Id = id;
            // to ensure "day" is required (not null)
            if (day == null)
            {
                throw new ArgumentNullException("day is a required property for PublicDailySpO2 and cannot be null");
            }
            this.Day = day;
        ...
        /// <summary>
        /// Gets or Sets BreathingDisturbanceIndex
        /// </summary>
        [DataMember(Name = "breathing_disturbance_index", EmitDefaultValue = true)]
        ...
        /// <summary>
        /// Gets or Sets Spo2Percentage
        /// </summary>
        [DataMember(Name = "spo2_percentage", EmitDefaultValue = true)]
        public PublicSpo2AggregatedValues Spo2Percentage { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  BreathingDisturbanceIndex: ").Append(BreathingDisturbanceIndex).Append("\n");
