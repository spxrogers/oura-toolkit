...
namespace OuraToolkit.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PersonalInfoResponse")]
    public partial class PersonalInfoResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PersonalInfoResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PersonalInfoResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PersonalInfoResponse" /> class.
        /// </summary>
        ...
        /// <param name="biologicalSex">biologicalSex.</param>
        /// <param name="email">email.</param>
        public PersonalInfoResponse(string id = default, int? age = default, decimal? weight = default, decimal? height = default, string biologicalSex = default, string email = default)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for PersonalInfoResponse and cannot be null");
            }
            this.Id = id;
            this.Age = age;
            this.Weight = weight;
        ...
        /// <summary>
        /// Gets or Sets BiologicalSex
        /// </summary>
        [DataMember(Name = "biological_sex", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  BiologicalSex: ").Append(BiologicalSex).Append("\n");
