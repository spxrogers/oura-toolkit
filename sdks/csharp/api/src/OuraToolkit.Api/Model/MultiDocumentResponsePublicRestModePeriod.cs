...
namespace OuraToolkit.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MultiDocumentResponse_PublicRestModePeriod_")]
    public partial class MultiDocumentResponsePublicRestModePeriod : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiDocumentResponsePublicRestModePeriod" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MultiDocumentResponsePublicRestModePeriod() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiDocumentResponsePublicRestModePeriod" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        /// <param name="nextToken">nextToken (required).</param>
        public MultiDocumentResponsePublicRestModePeriod(List<PublicRestModePeriod> data = default, string nextToken = default)
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for MultiDocumentResponsePublicRestModePeriod and cannot be null");
            }
            this.Data = data;
            // to ensure "nextToken" is required (not null)
            if (nextToken == null)
            {
                throw new ArgumentNullException("nextToken is a required property for MultiDocumentResponsePublicRestModePeriod and cannot be null");
            }
        ...
        public List<PublicRestModePeriod> Data { get; set; }
