...
namespace OuraToolkit.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateWebhookSubscriptionRequest")]
    public partial class UpdateWebhookSubscriptionRequest : IValidatableObject
    {
        ...
        protected UpdateWebhookSubscriptionRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateWebhookSubscriptionRequest" /> class.
        /// </summary>
        ...
        public UpdateWebhookSubscriptionRequest(string verificationToken = default, string callbackUrl = default, WebhookOperation? eventType = default, ExtApiV2DataType? dataType = default)
        {
            // to ensure "verificationToken" is required (not null)
            if (verificationToken == null)
            {
                throw new ArgumentNullException("verificationToken is a required property for UpdateWebhookSubscriptionRequest and cannot be null");
            }
