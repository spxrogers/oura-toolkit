...
namespace OuraToolkit.Api.Model
{
    ...
    /// Daily stress.
    /// </summary>
    [DataContract(Name = "PublicDailyStress")]
    public partial class PublicDailyStress : IValidatableObject
    {

        /// <summary>
        /// Gets or Sets DaySummary
        /// </summary>
        [DataMember(Name = "day_summary", EmitDefaultValue = true)]
        public PublicDailyStressSummary? DaySummary { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicDailyStress" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PublicDailyStress() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicDailyStress" /> class.
        /// </summary>
        /// <param name="id">Unique identifier of the object. (required).</param>
        /// <param name="day">day (required).</param>
        /// <param name="daySummary">daySummary.</param>
        /// <param name="recoveryHigh">recoveryHigh.</param>
        /// <param name="stressHigh">stressHigh.</param>
        public PublicDailyStress(string id = default, string day = default, PublicDailyStressSummary? daySummary = default, int? recoveryHigh = default, int? stressHigh = default)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for PublicDailyStress and cannot be null");
            }
            this.Id = id;
            // to ensure "day" is required (not null)
            if (day == null)
            {
                throw new ArgumentNullException("day is a required property for PublicDailyStress and cannot be null");
            }
            this.Day = day;
        ...
        /// <summary>
        /// Gets or Sets RecoveryHigh
        /// </summary>
        [DataMember(Name = "recovery_high", EmitDefaultValue = true)]
        public int? RecoveryHigh { get; set; }

        /// <summary>
        /// Gets or Sets StressHigh
        /// </summary>
        [DataMember(Name = "stress_high", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DaySummary: ").Append(DaySummary).Append("\n");
            sb.Append("  RecoveryHigh: ").Append(RecoveryHigh).Append("\n");
            sb.Append("  StressHigh: ").Append(StressHigh).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
