...
namespace OuraToolkit.Api.Model
{
    ...
    /// </summary>
    /// <value>Possible public SleepTime status.</value>
    [JsonConverter(typeof(StringEnumConverter))]
    public enum PublicSleepTimeStatus
    {
        /// <summary>
        /// Enum NotEnoughNights for value: not_enough_nights
        /// </summary>
        [EnumMember(Value = "not_enough_nights")]
        NotEnoughNights = 1,

        /// <summary>
        /// Enum NotEnoughRecentNights for value: not_enough_recent_nights
        /// </summary>
        [EnumMember(Value = "not_enough_recent_nights")]
        NotEnoughRecentNights = 2,

        /// <summary>
        /// Enum BadSleepQuality for value: bad_sleep_quality
        /// </summary>
        [EnumMember(Value = "bad_sleep_quality")]
        BadSleepQuality = 3,

        /// <summary>
        /// Enum OnlyRecommendedFound for value: only_recommended_found
        /// </summary>
        [EnumMember(Value = "only_recommended_found")]
        OnlyRecommendedFound = 4,

        /// <summary>
        /// Enum OptimalFound for value: optimal_found
        /// </summary>
        [EnumMember(Value = "optimal_found")]
        OptimalFound = 5
    }
