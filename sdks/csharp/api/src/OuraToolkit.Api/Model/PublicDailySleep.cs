...
namespace OuraToolkit.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PublicDailySleep")]
    public partial class PublicDailySleep : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicDailySleep" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PublicDailySleep() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicDailySleep" /> class.
        /// </summary>
        /// <param name="id">Unique identifier of the object. (required).</param>
        /// <param name="contributors">Contributors for the daily sleep score. (required).</param>
        /// <param name="day">day (required).</param>
        /// <param name="score">score.</param>
        /// <param name="timestamp">timestamp (required).</param>
        public PublicDailySleep(string id = default, PublicSleepContributors contributors = default, string day = default, int? score = default, string timestamp = default)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for PublicDailySleep and cannot be null");
            }
            this.Id = id;
            // to ensure "contributors" is required (not null)
            if (contributors == null)
            {
                throw new ArgumentNullException("contributors is a required property for PublicDailySleep and cannot be null");
            }
            this.Contributors = contributors;
            // to ensure "day" is required (not null)
            if (day == null)
            {
                throw new ArgumentNullException("day is a required property for PublicDailySleep and cannot be null");
            }
            this.Day = day;
            // to ensure "timestamp" is required (not null)
            if (timestamp == null)
            {
                throw new ArgumentNullException("timestamp is a required property for PublicDailySleep and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Contributors for the daily sleep score.</value>
        [DataMember(Name = "contributors", IsRequired = true, EmitDefaultValue = true)]
        public PublicSleepContributors Contributors { get; set; }
