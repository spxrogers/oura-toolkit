...
namespace OuraToolkit.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MultiDocumentResponse_EnhancedTagModel_")]
    public partial class MultiDocumentResponseEnhancedTagModel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiDocumentResponseEnhancedTagModel" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MultiDocumentResponseEnhancedTagModel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiDocumentResponseEnhancedTagModel" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        /// <param name="nextToken">nextToken (required).</param>
        public MultiDocumentResponseEnhancedTagModel(List<EnhancedTagModel> data = default, string nextToken = default)
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for MultiDocumentResponseEnhancedTagModel and cannot be null");
            }
            this.Data = data;
            // to ensure "nextToken" is required (not null)
            if (nextToken == null)
            {
                throw new ArgumentNullException("nextToken is a required property for MultiDocumentResponseEnhancedTagModel and cannot be null");
            }
        ...
        public List<EnhancedTagModel> Data { get; set; }
