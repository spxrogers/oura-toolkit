...
namespace OuraToolkit.Api.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(ResponseSandboxMultipleRingBatteryLevelDocumentsV2SandboxUsercollectionRingBatteryLevelGetJsonConverter))]
    [DataContract(Name = "Response_Sandbox___Multiple_Ring_Battery_Level_Documents_V2_Sandbox_Usercollection_Ring_Battery_Level_Get")]
    public partial class ResponseSandboxMultipleRingBatteryLevelDocumentsV2SandboxUsercollectionRingBatteryLevelGet : AbstractOpenAPISchema, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseSandboxMultipleRingBatteryLevelDocumentsV2SandboxUsercollectionRingBatteryLevelGet" /> class
        /// with the <see cref="TimeSeriesResponsePublicRingBatteryLevelRow" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of TimeSeriesResponsePublicRingBatteryLevelRow.</param>
        public ResponseSandboxMultipleRingBatteryLevelDocumentsV2SandboxUsercollectionRingBatteryLevelGet(TimeSeriesResponsePublicRingBatteryLevelRow actualInstance)
        {
            IsNullable = false;
            SchemaType= "anyOf";
        ...
        public ResponseSandboxMultipleRingBatteryLevelDocumentsV2SandboxUsercollectionRingBatteryLevelGet(TimeSeriesResponseDict actualInstance)
        {
            IsNullable = false;
            SchemaType= "anyOf";
            ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                ...
                else if (value.GetType() == typeof(TimeSeriesResponsePublicRingBatteryLevelRow))
                {
                    _actualInstance = value;
                }
                else
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: TimeSeriesResponseDict, TimeSeriesResponsePublicRingBatteryLevelRow");
                }
            }
        }
        ...
        /// </summary>
        /// <returns>An instance of TimeSeriesResponsePublicRingBatteryLevelRow</returns>
        public TimeSeriesResponsePublicRingBatteryLevelRow GetTimeSeriesResponsePublicRingBatteryLevelRow()
        {
            return (TimeSeriesResponsePublicRingBatteryLevelRow)ActualInstance;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResponseSandboxMultipleRingBatteryLevelDocumentsV2SandboxUsercollectionRingBatteryLevelGet {\n");
        ...
        {
            return JsonConvert.SerializeObject(ActualInstance, ResponseSandboxMultipleRingBatteryLevelDocumentsV2SandboxUsercollectionRingBatteryLevelGet.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of ResponseSandboxMultipleRingBatteryLevelDocumentsV2SandboxUsercollectionRingBatteryLevelGet
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of ResponseSandboxMultipleRingBatteryLevelDocumentsV2SandboxUsercollectionRingBatteryLevelGet</returns>
        public static ResponseSandboxMultipleRingBatteryLevelDocumentsV2SandboxUsercollectionRingBatteryLevelGet FromJson(string jsonString)
        {
            ResponseSandboxMultipleRingBatteryLevelDocumentsV2SandboxUsercollectionRingBatteryLevelGet newResponseSandboxMultipleRingBatteryLevelDocumentsV2SandboxUsercollectionRingBatteryLevelGet = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newResponseSandboxMultipleRingBatteryLevelDocumentsV2SandboxUsercollectionRingBatteryLevelGet;
            }

            try
            {
                newResponseSandboxMultipleRingBatteryLevelDocumentsV2SandboxUsercollectionRingBatteryLevelGet = new ResponseSandboxMultipleRingBatteryLevelDocumentsV2SandboxUsercollectionRingBatteryLevelGet(JsonConvert.DeserializeObject<TimeSeriesResponseDict>(jsonString, ResponseSandboxMultipleRingBatteryLevelDocumentsV2SandboxUsercollectionRingBatteryLevelGet.SerializerSettings));
            ...
            try
            {
                newResponseSandboxMultipleRingBatteryLevelDocumentsV2SandboxUsercollectionRingBatteryLevelGet = new ResponseSandboxMultipleRingBatteryLevelDocumentsV2SandboxUsercollectionRingBatteryLevelGet(JsonConvert.DeserializeObject<TimeSeriesResponsePublicRingBatteryLevelRow>(jsonString, ResponseSandboxMultipleRingBatteryLevelDocumentsV2SandboxUsercollectionRingBatteryLevelGet.SerializerSettings));
                // deserialization is considered successful at this point if no exception has been thrown.
                return newResponseSandboxMultipleRingBatteryLevelDocumentsV2SandboxUsercollectionRingBatteryLevelGet;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into TimeSeriesResponsePublicRingBatteryLevelRow: {1}", jsonString, exception.ToString()));
            }
    ...
    /// <summary>
    /// Custom JSON converter for ResponseSandboxMultipleRingBatteryLevelDocumentsV2SandboxUsercollectionRingBatteryLevelGet
    /// </summary>
    public class ResponseSandboxMultipleRingBatteryLevelDocumentsV2SandboxUsercollectionRingBatteryLevelGetJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(ResponseSandboxMultipleRingBatteryLevelDocumentsV2SandboxUsercollectionRingBatteryLevelGet).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            switch(reader.TokenType) 
            {
                case JsonToken.StartObject:
                    return ResponseSandboxMultipleRingBatteryLevelDocumentsV2SandboxUsercollectionRingBatteryLevelGet.FromJson(JObject.Load(reader).ToString(Formatting.None));
                case JsonToken.StartArray:
                    return ResponseSandboxMultipleRingBatteryLevelDocumentsV2SandboxUsercollectionRingBatteryLevelGet.FromJson(JArray.Load(reader).ToString(Formatting.None));
                default:
                    return null;
            }
        }
