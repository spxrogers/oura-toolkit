...
namespace OuraToolkit.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MultiDocumentResponse_PublicDailyReadiness_")]
    public partial class MultiDocumentResponsePublicDailyReadiness : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiDocumentResponsePublicDailyReadiness" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MultiDocumentResponsePublicDailyReadiness() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiDocumentResponsePublicDailyReadiness" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        /// <param name="nextToken">nextToken (required).</param>
        public MultiDocumentResponsePublicDailyReadiness(List<PublicDailyReadiness> data = default, string nextToken = default)
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for MultiDocumentResponsePublicDailyReadiness and cannot be null");
            }
            this.Data = data;
            // to ensure "nextToken" is required (not null)
            if (nextToken == null)
            {
                throw new ArgumentNullException("nextToken is a required property for MultiDocumentResponsePublicDailyReadiness and cannot be null");
            }
        ...
        public List<PublicDailyReadiness> Data { get; set; }
