...
namespace OuraToolkit.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TimeSeriesResponse_PublicRingBatteryLevelRow_")]
    public partial class TimeSeriesResponsePublicRingBatteryLevelRow : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TimeSeriesResponsePublicRingBatteryLevelRow" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TimeSeriesResponsePublicRingBatteryLevelRow() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TimeSeriesResponsePublicRingBatteryLevelRow" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        /// <param name="nextToken">nextToken.</param>
        public TimeSeriesResponsePublicRingBatteryLevelRow(List<PublicRingBatteryLevelRow> data = default, string nextToken = default)
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for TimeSeriesResponsePublicRingBatteryLevelRow and cannot be null");
            }
            this.Data = data;
        ...
        public List<PublicRingBatteryLevelRow> Data { get; set; }
