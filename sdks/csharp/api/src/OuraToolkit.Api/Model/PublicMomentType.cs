...
namespace OuraToolkit.Api.Model
{
    ...
    /// </summary>
    /// <value>Possible Moment types.</value>
    [JsonConverter(typeof(StringEnumConverter))]
    public enum PublicMomentType
    {
        /// <summary>
        /// Enum Breathing for value: breathing
        /// </summary>
        [EnumMember(Value = "breathing")]
        Breathing = 1,

        /// <summary>
        /// Enum Meditation for value: meditation
        /// </summary>
        ...
        /// <summary>
        /// Enum Relaxation for value: relaxation
        /// </summary>
        [EnumMember(Value = "relaxation")]
        Relaxation = 4,
        ...
        /// <summary>
        /// Enum BodyStatus for value: body_status
        /// </summary>
        [EnumMember(Value = "body_status")]
        BodyStatus = 6
    }
