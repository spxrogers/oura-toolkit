...
namespace OuraToolkit.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TimeSeriesResponse_PublicHeartRateRow_")]
    public partial class TimeSeriesResponsePublicHeartRateRow : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TimeSeriesResponsePublicHeartRateRow" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TimeSeriesResponsePublicHeartRateRow() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TimeSeriesResponsePublicHeartRateRow" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        /// <param name="nextToken">nextToken.</param>
        public TimeSeriesResponsePublicHeartRateRow(List<PublicHeartRateRow> data = default, string nextToken = default)
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for TimeSeriesResponsePublicHeartRateRow and cannot be null");
            }
            this.Data = data;
        ...
        public List<PublicHeartRateRow> Data { get; set; }
