...
class PublicSleepTimeWindow(BaseModel):
    """
    Object defining sleep time window
    """ # noqa: E501
    day_tz: StrictInt = Field(description="Timezone offset in second from GMT of the day")
    end_offset: StrictInt = Field(description="End offset from midnight in second")
    start_offset: StrictInt = Field(description="Start offset from midnight in second")
    __properties: ClassVar[List[str]] = ["day_tz", "end_offset", "start_offset"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublicSleepTimeWindow from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublicSleepTimeWindow from a dict"""
        if obj is None:
            return None
