...
class PublicDailySpO2(BaseModel):
    """
    ...
    breathing_disturbance_index: Optional[StrictInt] = None
    day: Optional[StrictStr]
    spo2_percentage: Optional[PublicSpo2AggregatedValues] = None
    __properties: ClassVar[List[str]] = ["id", "breathing_disturbance_index", "day", "spo2_percentage"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublicDailySpO2 from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of spo2_percentage
        if self.spo2_percentage:
            _dict['spo2_percentage'] = self.spo2_percentage.to_dict()
        # set to None if breathing_disturbance_index (nullable) is None
        # and model_fields_set contains the field
        if self.breathing_disturbance_index is None and "breathing_disturbance_index" in self.model_fields_set:
            _dict['breathing_disturbance_index'] = None
        ...
        # set to None if spo2_percentage (nullable) is None
        # and model_fields_set contains the field
        if self.spo2_percentage is None and "spo2_percentage" in self.model_fields_set:
            _dict['spo2_percentage'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublicDailySpO2 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "breathing_disturbance_index": obj.get("breathing_disturbance_index"),
            "day": obj.get("day"),
            "spo2_percentage": PublicSpo2AggregatedValues.from_dict(obj["spo2_percentage"]) if obj.get("spo2_percentage") is not None else None
        })
        return _obj
