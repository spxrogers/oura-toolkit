...
class MultiDocumentResponsePublicVO2Max(BaseModel):
    """
    MultiDocumentResponsePublicVO2Max
    """ # noqa: E501
    data: List[PublicVO2Max]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MultiDocumentResponsePublicVO2Max from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MultiDocumentResponsePublicVO2Max from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": [PublicVO2Max.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
