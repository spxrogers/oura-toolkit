...
class TagModel(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr
    day: date = Field(description="Day that the note belongs to.")
    text: Optional[StrictStr]
    timestamp: Optional[StrictStr]
    tags: List[StrictStr] = Field(description="Selected tags for the tag.")
    __properties: ClassVar[List[str]] = ["id", "day", "text", "timestamp", "tags"]
