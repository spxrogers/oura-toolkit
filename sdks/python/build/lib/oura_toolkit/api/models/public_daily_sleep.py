...
class PublicDailySleep(BaseModel):
    """
    ...
    contributors: PublicSleepContributors = Field(description="Contributors for the daily sleep score.")
    day: Optional[StrictStr]
    score: Optional[StrictInt] = None
    timestamp: Optional[StrictStr]
    __properties: ClassVar[List[str]] = ["id", "contributors", "day", "score", "timestamp"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublicDailySleep from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublicDailySleep from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "contributors": PublicSleepContributors.from_dict(obj["contributors"]) if obj.get("contributors") is not None else None,
            "day": obj.get("day"),
            "score": obj.get("score"),
