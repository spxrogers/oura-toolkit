...
class PublicHeartRateRow(BaseModel):
    """
    Heart rate sample
    """ # noqa: E501
    ...
    bpm: StrictInt = Field(description="Heart rate as beats per minute.")
    source: PublicHeartRateSource = Field(description="Source of the sample.")
    __properties: ClassVar[List[str]] = ["timestamp", "timestamp_unix", "bpm", "source"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublicHeartRateRow from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublicHeartRateRow from a dict"""
        if obj is None:
            return None
