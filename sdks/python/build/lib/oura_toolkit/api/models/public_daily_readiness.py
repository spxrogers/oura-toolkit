...
class PublicDailyReadiness(BaseModel):
    """
    ...
    contributors: PublicReadinessContributors = Field(description="Contributors of the daily readiness score.")
    day: Optional[StrictStr]
    score: Optional[StrictInt] = None
    temperature_deviation: Optional[Union[StrictFloat, StrictInt]] = None
    temperature_trend_deviation: Optional[Union[StrictFloat, StrictInt]] = None
    timestamp: Optional[StrictStr]
    __properties: ClassVar[List[str]] = ["id", "contributors", "day", "score", "temperature_deviation", "temperature_trend_deviation", "timestamp"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublicDailyReadiness from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if temperature_deviation (nullable) is None
        # and model_fields_set contains the field
        if self.temperature_deviation is None and "temperature_deviation" in self.model_fields_set:
            _dict['temperature_deviation'] = None

        # set to None if temperature_trend_deviation (nullable) is None
        # and model_fields_set contains the field
        if self.temperature_trend_deviation is None and "temperature_trend_deviation" in self.model_fields_set:
            _dict['temperature_trend_deviation'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublicDailyReadiness from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "contributors": PublicReadinessContributors.from_dict(obj["contributors"]) if obj.get("contributors") is not None else None,
            "day": obj.get("day"),
            "score": obj.get("score"),
            "temperature_deviation": obj.get("temperature_deviation"),
            "temperature_trend_deviation": obj.get("temperature_trend_deviation"),
