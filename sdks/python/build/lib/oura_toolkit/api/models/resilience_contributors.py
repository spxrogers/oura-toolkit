...
class ResilienceContributors(BaseModel):
    ...
    """ # noqa: E501
    sleep_recovery: Union[StrictFloat, StrictInt] = Field(description="Sleep recovery contributor to the resilience score. Range: [0, 100]")
    daytime_recovery: Union[StrictFloat, StrictInt] = Field(description="Daytime recovery contributor to the resilience score. Range: [0, 100]")
    stress: Union[StrictFloat, StrictInt] = Field(description="Stress contributor to the resilience score. Range: [0, 100]")
    __properties: ClassVar[List[str]] = ["sleep_recovery", "daytime_recovery", "stress"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResilienceContributors from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResilienceContributors from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "sleep_recovery": obj.get("sleep_recovery"),
            "daytime_recovery": obj.get("daytime_recovery"),
