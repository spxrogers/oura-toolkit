...
class PublicSession(BaseModel):
    ...
    end_datetime: Optional[StrictStr]
    heart_rate: Optional[PublicSample] = None
    heart_rate_variability: Optional[PublicSample] = None
    mood: Optional[PublicMomentMood] = None
    motion_count: Optional[PublicSample] = None
    start_datetime: Optional[StrictStr]
    type: PublicMomentType = Field(description="Type of the Moment.")
    __properties: ClassVar[List[str]] = ["id", "day", "end_datetime", "heart_rate", "heart_rate_variability", "mood", "motion_count", "start_datetime", "type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublicSession from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of heart_rate_variability
        if self.heart_rate_variability:
            _dict['heart_rate_variability'] = self.heart_rate_variability.to_dict()
        # override the default output from pydantic by calling `to_dict()` of motion_count
        if self.motion_count:
            _dict['motion_count'] = self.motion_count.to_dict()
        ...
        # set to None if heart_rate_variability (nullable) is None
        # and model_fields_set contains the field
        if self.heart_rate_variability is None and "heart_rate_variability" in self.model_fields_set:
            _dict['heart_rate_variability'] = None
        ...
        # set to None if motion_count (nullable) is None
        # and model_fields_set contains the field
        if self.motion_count is None and "motion_count" in self.model_fields_set:
            _dict['motion_count'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublicSession from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "heart_rate_variability": PublicSample.from_dict(obj["heart_rate_variability"]) if obj.get("heart_rate_variability") is not None else None,
            "mood": obj.get("mood"),
            "motion_count": PublicSample.from_dict(obj["motion_count"]) if obj.get("motion_count") is not None else None,
