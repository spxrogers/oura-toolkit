...
class PublicSpo2AggregatedValues(BaseModel):
    """
    Object defining public spo2 aggregated values.
    """ # noqa: E501
    average: Union[StrictFloat, StrictInt] = Field(description="Average of spo2.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublicSpo2AggregatedValues from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublicSpo2AggregatedValues from a dict"""
        if obj is None:
            return None
