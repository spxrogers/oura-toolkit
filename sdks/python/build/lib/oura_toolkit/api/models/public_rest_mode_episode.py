...
class PublicRestModeEpisode(BaseModel):
    """
    Object defining a public Rest Mode episode.
    """ # noqa: E501
    tags: List[StrictStr] = Field(description="Tags selected for the episode.")
    timestamp: Optional[StrictStr]
    __properties: ClassVar[List[str]] = ["tags", "timestamp"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublicRestModeEpisode from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublicRestModeEpisode from a dict"""
        if obj is None:
            return None
