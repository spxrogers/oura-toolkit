...
class WebhookSubscriptionModel(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "callback_url", "event_type", "data_type", "expiration_time"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebhookSubscriptionModel from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebhookSubscriptionModel from a dict"""
        if obj is None:
            return None
