...
class PublicDailyStress(BaseModel):
    """
    Daily stress.
    """ # noqa: E501
    id: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Unique identifier of the object.")
    day: Optional[StrictStr]
    day_summary: Optional[PublicDailyStressSummary] = None
    recovery_high: Optional[StrictInt] = None
    stress_high: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["id", "day", "day_summary", "recovery_high", "stress_high"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublicDailyStress from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if day_summary (nullable) is None
        # and model_fields_set contains the field
        if self.day_summary is None and "day_summary" in self.model_fields_set:
            _dict['day_summary'] = None

        # set to None if recovery_high (nullable) is None
        # and model_fields_set contains the field
        if self.recovery_high is None and "recovery_high" in self.model_fields_set:
            _dict['recovery_high'] = None

        # set to None if stress_high (nullable) is None
        # and model_fields_set contains the field
        if self.stress_high is None and "stress_high" in self.model_fields_set:
            _dict['stress_high'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublicDailyStress from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "day": obj.get("day"),
            "day_summary": obj.get("day_summary"),
            "recovery_high": obj.get("recovery_high"),
            "stress_high": obj.get("stress_high")
        })
        return _obj
