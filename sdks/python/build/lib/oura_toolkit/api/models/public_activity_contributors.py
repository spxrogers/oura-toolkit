...
class PublicActivityContributors(BaseModel):
    """
    Object defining activity score contributors.
    """ # noqa: E501
    meet_daily_targets: Optional[StrictInt] = None
    move_every_hour: Optional[StrictInt] = None
    recovery_time: Optional[StrictInt] = None
    stay_active: Optional[StrictInt] = None
    training_frequency: Optional[StrictInt] = None
    training_volume: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["meet_daily_targets", "move_every_hour", "recovery_time", "stay_active", "training_frequency", "training_volume"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublicActivityContributors from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if meet_daily_targets (nullable) is None
        # and model_fields_set contains the field
        if self.meet_daily_targets is None and "meet_daily_targets" in self.model_fields_set:
            _dict['meet_daily_targets'] = None

        # set to None if move_every_hour (nullable) is None
        # and model_fields_set contains the field
        if self.move_every_hour is None and "move_every_hour" in self.model_fields_set:
            _dict['move_every_hour'] = None

        # set to None if recovery_time (nullable) is None
        # and model_fields_set contains the field
        if self.recovery_time is None and "recovery_time" in self.model_fields_set:
            _dict['recovery_time'] = None

        # set to None if stay_active (nullable) is None
        # and model_fields_set contains the field
        if self.stay_active is None and "stay_active" in self.model_fields_set:
            _dict['stay_active'] = None

        # set to None if training_frequency (nullable) is None
        # and model_fields_set contains the field
        if self.training_frequency is None and "training_frequency" in self.model_fields_set:
            _dict['training_frequency'] = None

        # set to None if training_volume (nullable) is None
        # and model_fields_set contains the field
        if self.training_volume is None and "training_volume" in self.model_fields_set:
            _dict['training_volume'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublicActivityContributors from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "meet_daily_targets": obj.get("meet_daily_targets"),
            "move_every_hour": obj.get("move_every_hour"),
            "recovery_time": obj.get("recovery_time"),
            "stay_active": obj.get("stay_active"),
            "training_frequency": obj.get("training_frequency"),
            "training_volume": obj.get("training_volume")
        })
        return _obj
