...
class PublicDailyCardiovascularAge(BaseModel):
    """
    ...
    pulse_wave_velocity: Optional[Union[StrictFloat, StrictInt]] = None
    vascular_age: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["id", "day", "pulse_wave_velocity", "vascular_age"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublicDailyCardiovascularAge from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if pulse_wave_velocity (nullable) is None
        # and model_fields_set contains the field
        if self.pulse_wave_velocity is None and "pulse_wave_velocity" in self.model_fields_set:
            _dict['pulse_wave_velocity'] = None

        # set to None if vascular_age (nullable) is None
        # and model_fields_set contains the field
        if self.vascular_age is None and "vascular_age" in self.model_fields_set:
            _dict['vascular_age'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublicDailyCardiovascularAge from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "day": obj.get("day"),
            "pulse_wave_velocity": obj.get("pulse_wave_velocity"),
            "vascular_age": obj.get("vascular_age")
        })
        return _obj
