...
from oura_toolkit.api.api_client import ApiClient, RequestSerialized
from oura_toolkit.api.api_response import ApiResponse
from oura_toolkit.api.rest import RESTResponseType


class DailyCardiovascularAgeRoutesApi:
    ...
    def multiple_daily_cardiovascular_age_documents_v2_usercollection_daily_cardiovascular_age_get(
        ...
        fields: Annotated[Optional[StrictStr], Field(description="Comma-separated list of fields to include in the response, in addition to the always returned fields. Defaults to all fields if not provided.")] = None,
        ...
        :param next_token:
        :type next_token: str
        :param fields: Comma-separated list of fields to include in the response, in addition to the always returned fields. Defaults to all fields if not provided.
        :type fields: str
        ...
        _param = self._multiple_daily_cardiovascular_age_documents_v2_usercollection_daily_cardiovascular_age_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "MultiDocumentResponsePublicDailyCardiovascularAge",
            '400': None,
            '401': None,
            '403': None,
            '429': None,
    ...
    @validate_call
    def multiple_daily_cardiovascular_age_documents_v2_usercollection_daily_cardiovascular_age_get_with_http_info(
        self,
        start_date: Optional[date] = None,
        end_date: Optional[date] = None,
        next_token: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[MultiDocumentResponsePublicDailyCardiovascularAge]:
        """Multiple Daily Cardiovascular Age Documents
    ...
    @validate_call
    def multiple_daily_cardiovascular_age_documents_v2_usercollection_daily_cardiovascular_age_get_without_preload_content(
        self,
        start_date: Optional[date] = None,
        end_date: Optional[date] = None,
        next_token: Optional[StrictStr] = None,
    ...
    def _multiple_daily_cardiovascular_age_documents_v2_usercollection_daily_cardiovascular_age_get_serialize(
        self,
        start_date,
        end_date,
        next_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/usercollection/daily_cardiovascular_age',
    ...
    def single_daily_cardiovascular_age_document_v2_usercollection_daily_cardiovascular_age_document_id_get(
        ...
        _param = self._single_daily_cardiovascular_age_document_v2_usercollection_daily_cardiovascular_age_document_id_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PublicDailyCardiovascularAge",
            '404': None,
            '400': None,
            '401': None,
            '403': None,
    ...
    @validate_call
    def single_daily_cardiovascular_age_document_v2_usercollection_daily_cardiovascular_age_document_id_get_with_http_info(
        self,
        document_id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PublicDailyCardiovascularAge]:
        """Single Daily Cardiovascular Age Document
    ...
    @validate_call
    def single_daily_cardiovascular_age_document_v2_usercollection_daily_cardiovascular_age_document_id_get_without_preload_content(
        self,
        document_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _single_daily_cardiovascular_age_document_v2_usercollection_daily_cardiovascular_age_document_id_get_serialize(
        self,
        document_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/usercollection/daily_cardiovascular_age/{document_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
