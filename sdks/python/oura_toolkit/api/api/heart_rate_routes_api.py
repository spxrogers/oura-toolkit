...
class HeartRateRoutesApi:
    ...
    @validate_call
    def multiple_heartrate_documents_v2_usercollection_heartrate_get(
        self,
        ...
        _param = self._multiple_heartrate_documents_v2_usercollection_heartrate_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet",
            '400': None,
            '401': None,
            '403': None,
            '429': None,
    ...
    @validate_call
    def multiple_heartrate_documents_v2_usercollection_heartrate_get_with_http_info(
        self,
        start_datetime: Optional[datetime] = None,
        end_datetime: Optional[datetime] = None,
        next_token: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet]:
        """Multiple Heartrate Documents
    ...
    @validate_call
    def multiple_heartrate_documents_v2_usercollection_heartrate_get_without_preload_content(
        self,
        start_datetime: Optional[datetime] = None,
        end_datetime: Optional[datetime] = None,
        next_token: Optional[StrictStr] = None,
    ...
    def _multiple_heartrate_documents_v2_usercollection_heartrate_get_serialize(
        self,
        start_datetime,
        end_datetime,
        next_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/usercollection/heartrate',
