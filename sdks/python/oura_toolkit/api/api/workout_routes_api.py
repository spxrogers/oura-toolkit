...
class WorkoutRoutesApi:
    ...
    @validate_call
    def multiple_workout_documents_v2_usercollection_workout_get(
        self,
        ...
        _param = self._multiple_workout_documents_v2_usercollection_workout_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "MultiDocumentResponsePublicWorkout",
            '400': None,
            '401': None,
            '403': None,
            '429': None,
    ...
    @validate_call
    def multiple_workout_documents_v2_usercollection_workout_get_with_http_info(
        self,
        start_date: Optional[date] = None,
        end_date: Optional[date] = None,
        next_token: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[MultiDocumentResponsePublicWorkout]:
        """Multiple Workout Documents
    ...
    @validate_call
    def multiple_workout_documents_v2_usercollection_workout_get_without_preload_content(
        self,
        start_date: Optional[date] = None,
        end_date: Optional[date] = None,
        next_token: Optional[StrictStr] = None,
    ...
    def _multiple_workout_documents_v2_usercollection_workout_get_serialize(
        self,
        start_date,
        end_date,
        next_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/usercollection/workout',
    ...
    @validate_call
    def single_workout_document_v2_usercollection_workout_document_id_get(
        self,
        ...
        _param = self._single_workout_document_v2_usercollection_workout_document_id_get_serialize(
    ...
    @validate_call
    def single_workout_document_v2_usercollection_workout_document_id_get_with_http_info(
        self,
        document_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def single_workout_document_v2_usercollection_workout_document_id_get_without_preload_content(
        self,
        document_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _single_workout_document_v2_usercollection_workout_document_id_get_serialize(
        self,
        document_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/usercollection/workout/{document_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
