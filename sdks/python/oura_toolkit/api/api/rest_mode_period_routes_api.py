...
class RestModePeriodRoutesApi:
    ...
    @validate_call
    def multiple_rest_mode_period_documents_v2_usercollection_rest_mode_period_get(
        self,
        ...
        _param = self._multiple_rest_mode_period_documents_v2_usercollection_rest_mode_period_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "MultiDocumentResponsePublicRestModePeriod",
            '400': None,
            '401': None,
            '403': None,
            '429': None,
    ...
    @validate_call
    def multiple_rest_mode_period_documents_v2_usercollection_rest_mode_period_get_with_http_info(
        self,
        start_date: Optional[date] = None,
        end_date: Optional[date] = None,
        next_token: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[MultiDocumentResponsePublicRestModePeriod]:
        """Multiple Rest Mode Period Documents
    ...
    @validate_call
    def multiple_rest_mode_period_documents_v2_usercollection_rest_mode_period_get_without_preload_content(
        self,
        start_date: Optional[date] = None,
        end_date: Optional[date] = None,
        next_token: Optional[StrictStr] = None,
    ...
    def _multiple_rest_mode_period_documents_v2_usercollection_rest_mode_period_get_serialize(
        self,
        start_date,
        end_date,
        next_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/usercollection/rest_mode_period',
    ...
    def single_rest_mode_period_document_v2_usercollection_rest_mode_period_document_id_get(
        ...
        _param = self._single_rest_mode_period_document_v2_usercollection_rest_mode_period_document_id_get_serialize(
    ...
    @validate_call
    def single_rest_mode_period_document_v2_usercollection_rest_mode_period_document_id_get_with_http_info(
        self,
        document_id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PublicRestModePeriod]:
        """Single Rest Mode Period Document
    ...
    @validate_call
    def single_rest_mode_period_document_v2_usercollection_rest_mode_period_document_id_get_without_preload_content(
        self,
        document_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _single_rest_mode_period_document_v2_usercollection_rest_mode_period_document_id_get_serialize(
        self,
        document_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/usercollection/rest_mode_period/{document_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
