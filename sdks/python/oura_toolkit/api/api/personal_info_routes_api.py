...
class PersonalInfoRoutesApi:
    ...
    @validate_call
    def single_personal_info_document_v2_usercollection_personal_info_get(
        self,
        ...
        _param = self._single_personal_info_document_v2_usercollection_personal_info_get_serialize(
    ...
    @validate_call
    def single_personal_info_document_v2_usercollection_personal_info_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def single_personal_info_document_v2_usercollection_personal_info_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _single_personal_info_document_v2_usercollection_personal_info_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/usercollection/personal_info',
