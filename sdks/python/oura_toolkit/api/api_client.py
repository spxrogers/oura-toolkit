...
from oura_toolkit.api.api_response import ApiResponse, T as ApiResponseT
import oura_toolkit.api.models
from oura_toolkit.api import rest
from oura_toolkit.api.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(oura_toolkit.api.models, klass)
