...
AuthSettings = TypedDict(
    "AuthSettings",
    {
        ...
        "ClientIdAuth": APIKeyAuthSetting,
        "ClientSecretAuth": APIKeyAuthSetting,
    },
    total=False,
)
...
conf = oura_toolkit.api.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://api.ouraring.com" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("oura_toolkit.api")
    ...
    def auth_settings(self)-> AuthSettings:
        ...
        if 'ClientIdAuth' in self.api_key:
            auth['ClientIdAuth'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'x-client-id',
        ...
        if 'ClientSecretAuth' in self.api_key:
