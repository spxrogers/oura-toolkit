...
class DailyResilienceModel(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr
    day: date = Field(description="Day when the resilience record was recorded.")
    contributors: ResilienceContributors = Field(description="Contributors to the resilience score.")
    level: LongTermResilienceLevel = Field(description="Resilience level.")
    __properties: ClassVar[List[str]] = ["id", "day", "contributors", "level"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DailyResilienceModel from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DailyResilienceModel from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "day": obj.get("day"),
            "contributors": ResilienceContributors.from_dict(obj["contributors"]) if obj.get("contributors") is not None else None,
            "level": obj.get("level")
        })
        return _obj
