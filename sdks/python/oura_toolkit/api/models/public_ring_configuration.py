...
class PublicRingConfiguration(BaseModel):
    """
    Ring configuration.
    """ # noqa: E501
    id: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Unique identifier of the object.")
    color: Optional[PublicRingColor] = None
    design: Optional[PublicRingDesign] = None
    firmware_version: Optional[StrictStr] = None
    hardware_type: Optional[PublicRingHardwareType] = None
    set_up_at: Optional[StrictStr] = None
    size: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["id", "color", "design", "firmware_version", "hardware_type", "set_up_at", "size"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublicRingConfiguration from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if design (nullable) is None
        # and model_fields_set contains the field
        if self.design is None and "design" in self.model_fields_set:
            _dict['design'] = None
        ...
        # set to None if hardware_type (nullable) is None
        # and model_fields_set contains the field
        if self.hardware_type is None and "hardware_type" in self.model_fields_set:
            _dict['hardware_type'] = None

        # set to None if set_up_at (nullable) is None
        # and model_fields_set contains the field
        if self.set_up_at is None and "set_up_at" in self.model_fields_set:
            _dict['set_up_at'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublicRingConfiguration from a dict"""
        if obj is None:
            return None
