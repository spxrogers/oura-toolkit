...
class PublicWorkout(BaseModel):
    ...
    activity: StrictStr = Field(description="Type of the workout activity.")
    calories: Optional[Union[StrictFloat, StrictInt]] = None
    day: Optional[StrictStr]
    distance: Optional[Union[StrictFloat, StrictInt]] = None
    end_datetime: Optional[StrictStr]
    intensity: PublicWorkoutIntensity = Field(description="Intensity of the workout.")
    label: Optional[StrictStr] = None
    source: PublicWorkoutSource = Field(description="Possible workout sources.")
    start_datetime: Optional[StrictStr]
    __properties: ClassVar[List[str]] = ["id", "activity", "calories", "day", "distance", "end_datetime", "intensity", "label", "source", "start_datetime"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublicWorkout from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublicWorkout from a dict"""
        if obj is None:
            return None
