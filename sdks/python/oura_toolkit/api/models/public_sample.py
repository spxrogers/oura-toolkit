...
class PublicSample(BaseModel):
    ...
    """ # noqa: E501
    interval: Union[StrictFloat, StrictInt] = Field(description="Interval in seconds between the sampled items.")
    items: List[Optional[Union[StrictFloat, StrictInt]]]
    timestamp: Optional[StrictStr]
    __properties: ClassVar[List[str]] = ["interval", "items", "timestamp"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublicSample from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublicSample from a dict"""
        if obj is None:
            return None
