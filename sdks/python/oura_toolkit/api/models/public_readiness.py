...
class PublicReadiness(BaseModel):
    ...
    """ # noqa: E501
    contributors: PublicReadinessContributors = Field(description="Contributors of the readiness score.")
    ...
    __properties: ClassVar[List[str]] = ["contributors", "score", "temperature_deviation", "temperature_trend_deviation"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublicReadiness from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublicReadiness from a dict"""
        if obj is None:
            return None
