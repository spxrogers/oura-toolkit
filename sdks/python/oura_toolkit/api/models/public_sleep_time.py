...
class PublicSleepTime(BaseModel):
    """
    ...
    optimal_bedtime: Optional[PublicSleepTimeWindow] = None
    recommendation: Optional[PublicSleepTimeRecommendation] = None
    status: Optional[PublicSleepTimeStatus] = None
    __properties: ClassVar[List[str]] = ["id", "day", "optimal_bedtime", "recommendation", "status"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublicSleepTime from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of optimal_bedtime
        if self.optimal_bedtime:
            _dict['optimal_bedtime'] = self.optimal_bedtime.to_dict()
        # set to None if day (nullable) is None
        # and model_fields_set contains the field
        if self.day is None and "day" in self.model_fields_set:
            _dict['day'] = None

        # set to None if optimal_bedtime (nullable) is None
        # and model_fields_set contains the field
        if self.optimal_bedtime is None and "optimal_bedtime" in self.model_fields_set:
            _dict['optimal_bedtime'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublicSleepTime from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "day": obj.get("day"),
            "optimal_bedtime": PublicSleepTimeWindow.from_dict(obj["optimal_bedtime"]) if obj.get("optimal_bedtime") is not None else None,
