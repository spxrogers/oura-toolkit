...
class PublicVO2Max(BaseModel):
    ...
    vo2_max: StrictInt = Field(description="VO2 max value.")
    __properties: ClassVar[List[str]] = ["id", "day", "timestamp", "vo2_max"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublicVO2Max from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublicVO2Max from a dict"""
        if obj is None:
            return None
