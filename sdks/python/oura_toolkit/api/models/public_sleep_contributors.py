...
class PublicSleepContributors(BaseModel):
    """
    Object defining sleep score contributors.
    """ # noqa: E501
    deep_sleep: Optional[StrictInt] = None
    efficiency: Optional[StrictInt] = None
    latency: Optional[StrictInt] = None
    rem_sleep: Optional[StrictInt] = None
    restfulness: Optional[StrictInt] = None
    timing: Optional[StrictInt] = None
    total_sleep: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["deep_sleep", "efficiency", "latency", "rem_sleep", "restfulness", "timing", "total_sleep"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublicSleepContributors from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if deep_sleep (nullable) is None
        # and model_fields_set contains the field
        if self.deep_sleep is None and "deep_sleep" in self.model_fields_set:
            _dict['deep_sleep'] = None
        ...
        # set to None if rem_sleep (nullable) is None
        # and model_fields_set contains the field
        if self.rem_sleep is None and "rem_sleep" in self.model_fields_set:
            _dict['rem_sleep'] = None

        # set to None if restfulness (nullable) is None
        # and model_fields_set contains the field
        if self.restfulness is None and "restfulness" in self.model_fields_set:
            _dict['restfulness'] = None
        ...
        # set to None if total_sleep (nullable) is None
        # and model_fields_set contains the field
        if self.total_sleep is None and "total_sleep" in self.model_fields_set:
            _dict['total_sleep'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublicSleepContributors from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "deep_sleep": obj.get("deep_sleep"),
            "efficiency": obj.get("efficiency"),
            "latency": obj.get("latency"),
            "rem_sleep": obj.get("rem_sleep"),
            "restfulness": obj.get("restfulness"),
            "timing": obj.get("timing"),
            "total_sleep": obj.get("total_sleep")
        })
        return _obj
