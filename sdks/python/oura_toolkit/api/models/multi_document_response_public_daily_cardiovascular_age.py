...
class MultiDocumentResponsePublicDailyCardiovascularAge(BaseModel):
    """
    MultiDocumentResponsePublicDailyCardiovascularAge
    """ # noqa: E501
    data: List[PublicDailyCardiovascularAge]
    next_token: Optional[StrictStr]
    __properties: ClassVar[List[str]] = ["data", "next_token"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MultiDocumentResponsePublicDailyCardiovascularAge from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MultiDocumentResponsePublicDailyCardiovascularAge from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": [PublicDailyCardiovascularAge.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
