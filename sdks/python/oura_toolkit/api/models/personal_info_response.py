...
class PersonalInfoResponse(BaseModel):
    ...
    biological_sex: Optional[StrictStr] = None
    email: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "age", "weight", "height", "biological_sex", "email"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PersonalInfoResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if biological_sex (nullable) is None
        # and model_fields_set contains the field
        if self.biological_sex is None and "biological_sex" in self.model_fields_set:
            _dict['biological_sex'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PersonalInfoResponse from a dict"""
        if obj is None:
            return None
