...
// RestModePeriodRoutesAPIService RestModePeriodRoutesAPI service
type RestModePeriodRoutesAPIService service

type ApiMultipleRestModePeriodDocumentsV2UsercollectionRestModePeriodGetRequest struct {
	ctx context.Context
	ApiService *RestModePeriodRoutesAPIService
	startDate *string
	endDate *string
	nextToken *string
	fields *string
...
func (r ApiMultipleRestModePeriodDocumentsV2UsercollectionRestModePeriodGetRequest) StartDate(startDate string) ApiMultipleRestModePeriodDocumentsV2UsercollectionRestModePeriodGetRequest {
	r.startDate = &startDate
	return r
}

func (r ApiMultipleRestModePeriodDocumentsV2UsercollectionRestModePeriodGetRequest) EndDate(endDate string) ApiMultipleRestModePeriodDocumentsV2UsercollectionRestModePeriodGetRequest {
	r.endDate = &endDate
	return r
}

func (r ApiMultipleRestModePeriodDocumentsV2UsercollectionRestModePeriodGetRequest) NextToken(nextToken string) ApiMultipleRestModePeriodDocumentsV2UsercollectionRestModePeriodGetRequest {
...
func (r ApiMultipleRestModePeriodDocumentsV2UsercollectionRestModePeriodGetRequest) Fields(fields string) ApiMultipleRestModePeriodDocumentsV2UsercollectionRestModePeriodGetRequest {
	r.fields = &fields
	return r
}

func (r ApiMultipleRestModePeriodDocumentsV2UsercollectionRestModePeriodGetRequest) Execute() (*MultiDocumentResponsePublicRestModePeriod, *http.Response, error) {
	return r.ApiService.MultipleRestModePeriodDocumentsV2UsercollectionRestModePeriodGetExecute(r)
}

/*
MultipleRestModePeriodDocumentsV2UsercollectionRestModePeriodGet Multiple Rest Mode Period Documents

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiMultipleRestModePeriodDocumentsV2UsercollectionRestModePeriodGetRequest
*/
func (a *RestModePeriodRoutesAPIService) MultipleRestModePeriodDocumentsV2UsercollectionRestModePeriodGet(ctx context.Context) ApiMultipleRestModePeriodDocumentsV2UsercollectionRestModePeriodGetRequest {
	return ApiMultipleRestModePeriodDocumentsV2UsercollectionRestModePeriodGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *RestModePeriodRoutesAPIService) MultipleRestModePeriodDocumentsV2UsercollectionRestModePeriodGetExecute(r ApiMultipleRestModePeriodDocumentsV2UsercollectionRestModePeriodGetRequest) (*MultiDocumentResponsePublicRestModePeriod, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RestModePeriodRoutesAPIService.MultipleRestModePeriodDocumentsV2UsercollectionRestModePeriodGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/usercollection/rest_mode_period"
...
type ApiSingleRestModePeriodDocumentV2UsercollectionRestModePeriodDocumentIdGetRequest struct {
	ctx context.Context
	ApiService *RestModePeriodRoutesAPIService
	documentId string
}

func (r ApiSingleRestModePeriodDocumentV2UsercollectionRestModePeriodDocumentIdGetRequest) Execute() (*PublicRestModePeriod, *http.Response, error) {
	return r.ApiService.SingleRestModePeriodDocumentV2UsercollectionRestModePeriodDocumentIdGetExecute(r)
}

/*
SingleRestModePeriodDocumentV2UsercollectionRestModePeriodDocumentIdGet Single Rest Mode Period Document

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param documentId
 @return ApiSingleRestModePeriodDocumentV2UsercollectionRestModePeriodDocumentIdGetRequest
*/
func (a *RestModePeriodRoutesAPIService) SingleRestModePeriodDocumentV2UsercollectionRestModePeriodDocumentIdGet(ctx context.Context, documentId string) ApiSingleRestModePeriodDocumentV2UsercollectionRestModePeriodDocumentIdGetRequest {
	return ApiSingleRestModePeriodDocumentV2UsercollectionRestModePeriodDocumentIdGetRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *RestModePeriodRoutesAPIService) SingleRestModePeriodDocumentV2UsercollectionRestModePeriodDocumentIdGetExecute(r ApiSingleRestModePeriodDocumentV2UsercollectionRestModePeriodDocumentIdGetRequest) (*PublicRestModePeriod, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RestModePeriodRoutesAPIService.SingleRestModePeriodDocumentV2UsercollectionRestModePeriodDocumentIdGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/usercollection/rest_mode_period/{document_id}"
