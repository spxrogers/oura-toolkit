...
func (r ApiMultipleDailyActivityDocumentsV2UsercollectionDailyActivityGetRequest) StartDate(startDate string) ApiMultipleDailyActivityDocumentsV2UsercollectionDailyActivityGetRequest {
	r.startDate = &startDate
	return r
}

func (r ApiMultipleDailyActivityDocumentsV2UsercollectionDailyActivityGetRequest) EndDate(endDate string) ApiMultipleDailyActivityDocumentsV2UsercollectionDailyActivityGetRequest {
	r.endDate = &endDate
	return r
}
...
func (r ApiMultipleDailyActivityDocumentsV2UsercollectionDailyActivityGetRequest) Fields(fields string) ApiMultipleDailyActivityDocumentsV2UsercollectionDailyActivityGetRequest {
	r.fields = &fields
	return r
}

func (r ApiMultipleDailyActivityDocumentsV2UsercollectionDailyActivityGetRequest) Execute() (*MultiDocumentResponsePublicDailyActivity, *http.Response, error) {
...
func (a *DailyActivityRoutesAPIService) MultipleDailyActivityDocumentsV2UsercollectionDailyActivityGetExecute(r ApiMultipleDailyActivityDocumentsV2UsercollectionDailyActivityGetRequest) (*MultiDocumentResponsePublicDailyActivity, *http.Response, error) {
	var (
...
func (r ApiSingleDailyActivityDocumentV2UsercollectionDailyActivityDocumentIdGetRequest) Execute() (*PublicDailyActivity, *http.Response, error) {
...
func (a *DailyActivityRoutesAPIService) SingleDailyActivityDocumentV2UsercollectionDailyActivityDocumentIdGetExecute(r ApiSingleDailyActivityDocumentV2UsercollectionDailyActivityDocumentIdGetRequest) (*PublicDailyActivity, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
