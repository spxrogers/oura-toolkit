...
func (r ApiMultipleDailyStressDocumentsV2UsercollectionDailyStressGetRequest) StartDate(startDate string) ApiMultipleDailyStressDocumentsV2UsercollectionDailyStressGetRequest {
	r.startDate = &startDate
	return r
}

func (r ApiMultipleDailyStressDocumentsV2UsercollectionDailyStressGetRequest) EndDate(endDate string) ApiMultipleDailyStressDocumentsV2UsercollectionDailyStressGetRequest {
	r.endDate = &endDate
	return r
}
...
func (r ApiMultipleDailyStressDocumentsV2UsercollectionDailyStressGetRequest) Fields(fields string) ApiMultipleDailyStressDocumentsV2UsercollectionDailyStressGetRequest {
	r.fields = &fields
	return r
}

func (r ApiMultipleDailyStressDocumentsV2UsercollectionDailyStressGetRequest) Execute() (*MultiDocumentResponsePublicDailyStress, *http.Response, error) {
...
func (a *DailyStressRoutesAPIService) MultipleDailyStressDocumentsV2UsercollectionDailyStressGetExecute(r ApiMultipleDailyStressDocumentsV2UsercollectionDailyStressGetRequest) (*MultiDocumentResponsePublicDailyStress, *http.Response, error) {
	var (
...
func (r ApiSingleDailyStressDocumentV2UsercollectionDailyStressDocumentIdGetRequest) Execute() (*PublicDailyStress, *http.Response, error) {
...
func (a *DailyStressRoutesAPIService) SingleDailyStressDocumentV2UsercollectionDailyStressDocumentIdGetExecute(r ApiSingleDailyStressDocumentV2UsercollectionDailyStressDocumentIdGetRequest) (*PublicDailyStress, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
