...
// checks if the MultiDocumentResponseDailyResilienceModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MultiDocumentResponseDailyResilienceModel{}

// MultiDocumentResponseDailyResilienceModel struct for MultiDocumentResponseDailyResilienceModel
...
type _MultiDocumentResponseDailyResilienceModel MultiDocumentResponseDailyResilienceModel
...
func NewMultiDocumentResponseDailyResilienceModel(data []DailyResilienceModel, nextToken NullableString) *MultiDocumentResponseDailyResilienceModel {
	this := MultiDocumentResponseDailyResilienceModel{}
	this.Data = data
...
func (o MultiDocumentResponseDailyResilienceModel) MarshalJSON() ([]byte, error) {
...
func (o MultiDocumentResponseDailyResilienceModel) ToMap() (map[string]interface{}, error) {
...
func (o *MultiDocumentResponseDailyResilienceModel) UnmarshalJSON(data []byte) (err error) {
	...
	varMultiDocumentResponseDailyResilienceModel := _MultiDocumentResponseDailyResilienceModel{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMultiDocumentResponseDailyResilienceModel)

	if err != nil {
		return err
	}

	*o = MultiDocumentResponseDailyResilienceModel(varMultiDocumentResponseDailyResilienceModel)

	return err
}

type NullableMultiDocumentResponseDailyResilienceModel struct {
	value *MultiDocumentResponseDailyResilienceModel
	isSet bool
}

func (v NullableMultiDocumentResponseDailyResilienceModel) Get() *MultiDocumentResponseDailyResilienceModel {
	return v.value
}

func (v *NullableMultiDocumentResponseDailyResilienceModel) Set(val *MultiDocumentResponseDailyResilienceModel) {
	v.value = val
	v.isSet = true
}

func (v NullableMultiDocumentResponseDailyResilienceModel) IsSet() bool {
	return v.isSet
}

func (v *NullableMultiDocumentResponseDailyResilienceModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMultiDocumentResponseDailyResilienceModel(val *MultiDocumentResponseDailyResilienceModel) *NullableMultiDocumentResponseDailyResilienceModel {
	return &NullableMultiDocumentResponseDailyResilienceModel{value: val, isSet: true}
}

func (v NullableMultiDocumentResponseDailyResilienceModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMultiDocumentResponseDailyResilienceModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
