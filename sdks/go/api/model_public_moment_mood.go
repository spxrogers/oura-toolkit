...
// PublicMomentMood Possible Moment moods.
type PublicMomentMood string

// List of PublicMomentMood
const (
	PUBLICMOMENTMOOD_BAD PublicMomentMood = "bad"
	PUBLICMOMENTMOOD_WORSE PublicMomentMood = "worse"
	PUBLICMOMENTMOOD_SAME PublicMomentMood = "same"
	PUBLICMOMENTMOOD_GOOD PublicMomentMood = "good"
	PUBLICMOMENTMOOD_GREAT PublicMomentMood = "great"
)

// All allowed values of PublicMomentMood enum
var AllowedPublicMomentMoodEnumValues = []PublicMomentMood{
	"bad",
	"worse",
	"same",
	"good",
...
func (v *PublicMomentMood) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := PublicMomentMood(value)
	for _, existing := range AllowedPublicMomentMoodEnumValues {
	...
	return fmt.Errorf("%+v is not a valid PublicMomentMood", value)
}

// NewPublicMomentMoodFromValue returns a pointer to a valid PublicMomentMood
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewPublicMomentMoodFromValue(v string) (*PublicMomentMood, error) {
	ev := PublicMomentMood(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for PublicMomentMood: valid values are %v", v, AllowedPublicMomentMoodEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v PublicMomentMood) IsValid() bool {
	for _, existing := range AllowedPublicMomentMoodEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to PublicMomentMood value
func (v PublicMomentMood) Ptr() *PublicMomentMood {
	return &v
}

type NullablePublicMomentMood struct {
	value *PublicMomentMood
	isSet bool
}

func (v NullablePublicMomentMood) Get() *PublicMomentMood {
	return v.value
}

func (v *NullablePublicMomentMood) Set(val *PublicMomentMood) {
	v.value = val
	v.isSet = true
}

func (v NullablePublicMomentMood) IsSet() bool {
	return v.isSet
}

func (v *NullablePublicMomentMood) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePublicMomentMood(val *PublicMomentMood) *NullablePublicMomentMood {
	return &NullablePublicMomentMood{value: val, isSet: true}
}

func (v NullablePublicMomentMood) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePublicMomentMood) UnmarshalJSON(src []byte) error {
	v.isSet = true
