...
func (r ApiMultipleSleepDocumentsV2UsercollectionSleepGetRequest) StartDate(startDate string) ApiMultipleSleepDocumentsV2UsercollectionSleepGetRequest {
	r.startDate = &startDate
	return r
}

func (r ApiMultipleSleepDocumentsV2UsercollectionSleepGetRequest) EndDate(endDate string) ApiMultipleSleepDocumentsV2UsercollectionSleepGetRequest {
	r.endDate = &endDate
	return r
}
...
func (r ApiMultipleSleepDocumentsV2UsercollectionSleepGetRequest) Fields(fields string) ApiMultipleSleepDocumentsV2UsercollectionSleepGetRequest {
	r.fields = &fields
	return r
}

func (r ApiMultipleSleepDocumentsV2UsercollectionSleepGetRequest) Execute() (*MultiDocumentResponsePublicModifiedSleepModel, *http.Response, error) {
...
func (a *SleepRoutesAPIService) MultipleSleepDocumentsV2UsercollectionSleepGetExecute(r ApiMultipleSleepDocumentsV2UsercollectionSleepGetRequest) (*MultiDocumentResponsePublicModifiedSleepModel, *http.Response, error) {
	var (
...
func (r ApiSingleSleepDocumentV2UsercollectionSleepDocumentIdGetRequest) Execute() (*PublicModifiedSleepModel, *http.Response, error) {
...
func (a *SleepRoutesAPIService) SingleSleepDocumentV2UsercollectionSleepDocumentIdGetExecute(r ApiSingleSleepDocumentV2UsercollectionSleepDocumentIdGetRequest) (*PublicModifiedSleepModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
