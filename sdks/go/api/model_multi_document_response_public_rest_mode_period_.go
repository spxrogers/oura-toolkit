...
// checks if the MultiDocumentResponsePublicRestModePeriod type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MultiDocumentResponsePublicRestModePeriod{}

// MultiDocumentResponsePublicRestModePeriod struct for MultiDocumentResponsePublicRestModePeriod
type MultiDocumentResponsePublicRestModePeriod struct {
	Data []PublicRestModePeriod `json:"data"`
	NextToken NullableString `json:"next_token"`
}

type _MultiDocumentResponsePublicRestModePeriod MultiDocumentResponsePublicRestModePeriod

// NewMultiDocumentResponsePublicRestModePeriod instantiates a new MultiDocumentResponsePublicRestModePeriod object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewMultiDocumentResponsePublicRestModePeriod(data []PublicRestModePeriod, nextToken NullableString) *MultiDocumentResponsePublicRestModePeriod {
	this := MultiDocumentResponsePublicRestModePeriod{}
	this.Data = data
	this.NextToken = nextToken
	return &this
}

// NewMultiDocumentResponsePublicRestModePeriodWithDefaults instantiates a new MultiDocumentResponsePublicRestModePeriod object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewMultiDocumentResponsePublicRestModePeriodWithDefaults() *MultiDocumentResponsePublicRestModePeriod {
	this := MultiDocumentResponsePublicRestModePeriod{}
	return &this
}

// GetData returns the Data field value
func (o *MultiDocumentResponsePublicRestModePeriod) GetData() []PublicRestModePeriod {
	if o == nil {
		var ret []PublicRestModePeriod
		return ret
	}
...
func (o *MultiDocumentResponsePublicRestModePeriod) GetDataOk() ([]PublicRestModePeriod, bool) {
	if o == nil {
		return nil, false
	}
	return o.Data, true
...
func (o *MultiDocumentResponsePublicRestModePeriod) SetData(v []PublicRestModePeriod) {
	o.Data = v
}

// GetNextToken returns the NextToken field value
// If the value is explicit nil, the zero value for string will be returned
func (o *MultiDocumentResponsePublicRestModePeriod) GetNextToken() string {
...
func (o *MultiDocumentResponsePublicRestModePeriod) GetNextTokenOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *MultiDocumentResponsePublicRestModePeriod) SetNextToken(v string) {
	o.NextToken.Set(&v)
}

func (o MultiDocumentResponsePublicRestModePeriod) MarshalJSON() ([]byte, error) {
...
func (o MultiDocumentResponsePublicRestModePeriod) ToMap() (map[string]interface{}, error) {
...
func (o *MultiDocumentResponsePublicRestModePeriod) UnmarshalJSON(data []byte) (err error) {
	...
	varMultiDocumentResponsePublicRestModePeriod := _MultiDocumentResponsePublicRestModePeriod{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMultiDocumentResponsePublicRestModePeriod)

	if err != nil {
		return err
	}

	*o = MultiDocumentResponsePublicRestModePeriod(varMultiDocumentResponsePublicRestModePeriod)

	return err
}

type NullableMultiDocumentResponsePublicRestModePeriod struct {
	value *MultiDocumentResponsePublicRestModePeriod
	isSet bool
}

func (v NullableMultiDocumentResponsePublicRestModePeriod) Get() *MultiDocumentResponsePublicRestModePeriod {
	return v.value
}

func (v *NullableMultiDocumentResponsePublicRestModePeriod) Set(val *MultiDocumentResponsePublicRestModePeriod) {
	v.value = val
	v.isSet = true
}

func (v NullableMultiDocumentResponsePublicRestModePeriod) IsSet() bool {
	return v.isSet
}

func (v *NullableMultiDocumentResponsePublicRestModePeriod) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMultiDocumentResponsePublicRestModePeriod(val *MultiDocumentResponsePublicRestModePeriod) *NullableMultiDocumentResponsePublicRestModePeriod {
	return &NullableMultiDocumentResponsePublicRestModePeriod{value: val, isSet: true}
}

func (v NullableMultiDocumentResponsePublicRestModePeriod) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMultiDocumentResponsePublicRestModePeriod) UnmarshalJSON(src []byte) error {
	v.isSet = true
