...
// checks if the MultiDocumentResponsePublicSession type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MultiDocumentResponsePublicSession{}

// MultiDocumentResponsePublicSession struct for MultiDocumentResponsePublicSession
type MultiDocumentResponsePublicSession struct {
	Data []PublicSession `json:"data"`
	NextToken NullableString `json:"next_token"`
}

type _MultiDocumentResponsePublicSession MultiDocumentResponsePublicSession

// NewMultiDocumentResponsePublicSession instantiates a new MultiDocumentResponsePublicSession object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewMultiDocumentResponsePublicSession(data []PublicSession, nextToken NullableString) *MultiDocumentResponsePublicSession {
	this := MultiDocumentResponsePublicSession{}
	this.Data = data
	this.NextToken = nextToken
	return &this
}

// NewMultiDocumentResponsePublicSessionWithDefaults instantiates a new MultiDocumentResponsePublicSession object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewMultiDocumentResponsePublicSessionWithDefaults() *MultiDocumentResponsePublicSession {
	this := MultiDocumentResponsePublicSession{}
	return &this
}

// GetData returns the Data field value
func (o *MultiDocumentResponsePublicSession) GetData() []PublicSession {
	if o == nil {
		var ret []PublicSession
		return ret
	}
...
func (o *MultiDocumentResponsePublicSession) GetDataOk() ([]PublicSession, bool) {
	if o == nil {
		return nil, false
	}
	return o.Data, true
...
func (o *MultiDocumentResponsePublicSession) SetData(v []PublicSession) {
	o.Data = v
}

// GetNextToken returns the NextToken field value
// If the value is explicit nil, the zero value for string will be returned
func (o *MultiDocumentResponsePublicSession) GetNextToken() string {
...
func (o *MultiDocumentResponsePublicSession) GetNextTokenOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *MultiDocumentResponsePublicSession) SetNextToken(v string) {
	o.NextToken.Set(&v)
}

func (o MultiDocumentResponsePublicSession) MarshalJSON() ([]byte, error) {
...
func (o MultiDocumentResponsePublicSession) ToMap() (map[string]interface{}, error) {
...
func (o *MultiDocumentResponsePublicSession) UnmarshalJSON(data []byte) (err error) {
	...
	varMultiDocumentResponsePublicSession := _MultiDocumentResponsePublicSession{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMultiDocumentResponsePublicSession)

	if err != nil {
		return err
	}

	*o = MultiDocumentResponsePublicSession(varMultiDocumentResponsePublicSession)

	return err
}

type NullableMultiDocumentResponsePublicSession struct {
	value *MultiDocumentResponsePublicSession
	isSet bool
}

func (v NullableMultiDocumentResponsePublicSession) Get() *MultiDocumentResponsePublicSession {
	return v.value
}

func (v *NullableMultiDocumentResponsePublicSession) Set(val *MultiDocumentResponsePublicSession) {
	v.value = val
	v.isSet = true
}

func (v NullableMultiDocumentResponsePublicSession) IsSet() bool {
	return v.isSet
}

func (v *NullableMultiDocumentResponsePublicSession) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMultiDocumentResponsePublicSession(val *MultiDocumentResponsePublicSession) *NullableMultiDocumentResponsePublicSession {
	return &NullableMultiDocumentResponsePublicSession{value: val, isSet: true}
}

func (v NullableMultiDocumentResponsePublicSession) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMultiDocumentResponsePublicSession) UnmarshalJSON(src []byte) error {
	v.isSet = true
