...
// checks if the MultiDocumentResponsePublicDailyStress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MultiDocumentResponsePublicDailyStress{}

// MultiDocumentResponsePublicDailyStress struct for MultiDocumentResponsePublicDailyStress
type MultiDocumentResponsePublicDailyStress struct {
	Data []PublicDailyStress `json:"data"`
	NextToken NullableString `json:"next_token"`
}

type _MultiDocumentResponsePublicDailyStress MultiDocumentResponsePublicDailyStress

// NewMultiDocumentResponsePublicDailyStress instantiates a new MultiDocumentResponsePublicDailyStress object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewMultiDocumentResponsePublicDailyStress(data []PublicDailyStress, nextToken NullableString) *MultiDocumentResponsePublicDailyStress {
	this := MultiDocumentResponsePublicDailyStress{}
	this.Data = data
	this.NextToken = nextToken
	return &this
}

// NewMultiDocumentResponsePublicDailyStressWithDefaults instantiates a new MultiDocumentResponsePublicDailyStress object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewMultiDocumentResponsePublicDailyStressWithDefaults() *MultiDocumentResponsePublicDailyStress {
	this := MultiDocumentResponsePublicDailyStress{}
	return &this
}

// GetData returns the Data field value
func (o *MultiDocumentResponsePublicDailyStress) GetData() []PublicDailyStress {
	if o == nil {
		var ret []PublicDailyStress
		return ret
	}
...
func (o *MultiDocumentResponsePublicDailyStress) GetDataOk() ([]PublicDailyStress, bool) {
	if o == nil {
		return nil, false
	}
	return o.Data, true
...
func (o *MultiDocumentResponsePublicDailyStress) SetData(v []PublicDailyStress) {
	o.Data = v
}

// GetNextToken returns the NextToken field value
// If the value is explicit nil, the zero value for string will be returned
func (o *MultiDocumentResponsePublicDailyStress) GetNextToken() string {
...
func (o *MultiDocumentResponsePublicDailyStress) GetNextTokenOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *MultiDocumentResponsePublicDailyStress) SetNextToken(v string) {
	o.NextToken.Set(&v)
}

func (o MultiDocumentResponsePublicDailyStress) MarshalJSON() ([]byte, error) {
...
func (o MultiDocumentResponsePublicDailyStress) ToMap() (map[string]interface{}, error) {
...
func (o *MultiDocumentResponsePublicDailyStress) UnmarshalJSON(data []byte) (err error) {
	...
	varMultiDocumentResponsePublicDailyStress := _MultiDocumentResponsePublicDailyStress{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMultiDocumentResponsePublicDailyStress)

	if err != nil {
		return err
	}

	*o = MultiDocumentResponsePublicDailyStress(varMultiDocumentResponsePublicDailyStress)

	return err
}

type NullableMultiDocumentResponsePublicDailyStress struct {
	value *MultiDocumentResponsePublicDailyStress
	isSet bool
}

func (v NullableMultiDocumentResponsePublicDailyStress) Get() *MultiDocumentResponsePublicDailyStress {
	return v.value
}

func (v *NullableMultiDocumentResponsePublicDailyStress) Set(val *MultiDocumentResponsePublicDailyStress) {
	v.value = val
	v.isSet = true
}

func (v NullableMultiDocumentResponsePublicDailyStress) IsSet() bool {
	return v.isSet
}

func (v *NullableMultiDocumentResponsePublicDailyStress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMultiDocumentResponsePublicDailyStress(val *MultiDocumentResponsePublicDailyStress) *NullableMultiDocumentResponsePublicDailyStress {
	return &NullableMultiDocumentResponsePublicDailyStress{value: val, isSet: true}
}

func (v NullableMultiDocumentResponsePublicDailyStress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMultiDocumentResponsePublicDailyStress) UnmarshalJSON(src []byte) error {
	v.isSet = true
