...
// checks if the MultiDocumentResponsePublicDailyCardiovascularAge type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MultiDocumentResponsePublicDailyCardiovascularAge{}

// MultiDocumentResponsePublicDailyCardiovascularAge struct for MultiDocumentResponsePublicDailyCardiovascularAge
type MultiDocumentResponsePublicDailyCardiovascularAge struct {
	Data []PublicDailyCardiovascularAge `json:"data"`
	NextToken NullableString `json:"next_token"`
}

type _MultiDocumentResponsePublicDailyCardiovascularAge MultiDocumentResponsePublicDailyCardiovascularAge

// NewMultiDocumentResponsePublicDailyCardiovascularAge instantiates a new MultiDocumentResponsePublicDailyCardiovascularAge object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewMultiDocumentResponsePublicDailyCardiovascularAge(data []PublicDailyCardiovascularAge, nextToken NullableString) *MultiDocumentResponsePublicDailyCardiovascularAge {
	this := MultiDocumentResponsePublicDailyCardiovascularAge{}
	this.Data = data
	this.NextToken = nextToken
	return &this
}

// NewMultiDocumentResponsePublicDailyCardiovascularAgeWithDefaults instantiates a new MultiDocumentResponsePublicDailyCardiovascularAge object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewMultiDocumentResponsePublicDailyCardiovascularAgeWithDefaults() *MultiDocumentResponsePublicDailyCardiovascularAge {
	this := MultiDocumentResponsePublicDailyCardiovascularAge{}
	return &this
}

// GetData returns the Data field value
func (o *MultiDocumentResponsePublicDailyCardiovascularAge) GetData() []PublicDailyCardiovascularAge {
	if o == nil {
		var ret []PublicDailyCardiovascularAge
		return ret
	}
...
func (o *MultiDocumentResponsePublicDailyCardiovascularAge) GetDataOk() ([]PublicDailyCardiovascularAge, bool) {
	if o == nil {
		return nil, false
	}
	return o.Data, true
...
func (o *MultiDocumentResponsePublicDailyCardiovascularAge) SetData(v []PublicDailyCardiovascularAge) {
	o.Data = v
}

// GetNextToken returns the NextToken field value
// If the value is explicit nil, the zero value for string will be returned
func (o *MultiDocumentResponsePublicDailyCardiovascularAge) GetNextToken() string {
...
func (o *MultiDocumentResponsePublicDailyCardiovascularAge) GetNextTokenOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *MultiDocumentResponsePublicDailyCardiovascularAge) SetNextToken(v string) {
	o.NextToken.Set(&v)
}

func (o MultiDocumentResponsePublicDailyCardiovascularAge) MarshalJSON() ([]byte, error) {
...
func (o MultiDocumentResponsePublicDailyCardiovascularAge) ToMap() (map[string]interface{}, error) {
...
func (o *MultiDocumentResponsePublicDailyCardiovascularAge) UnmarshalJSON(data []byte) (err error) {
	...
	varMultiDocumentResponsePublicDailyCardiovascularAge := _MultiDocumentResponsePublicDailyCardiovascularAge{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMultiDocumentResponsePublicDailyCardiovascularAge)

	if err != nil {
		return err
	}

	*o = MultiDocumentResponsePublicDailyCardiovascularAge(varMultiDocumentResponsePublicDailyCardiovascularAge)

	return err
}

type NullableMultiDocumentResponsePublicDailyCardiovascularAge struct {
	value *MultiDocumentResponsePublicDailyCardiovascularAge
	isSet bool
}

func (v NullableMultiDocumentResponsePublicDailyCardiovascularAge) Get() *MultiDocumentResponsePublicDailyCardiovascularAge {
	return v.value
}

func (v *NullableMultiDocumentResponsePublicDailyCardiovascularAge) Set(val *MultiDocumentResponsePublicDailyCardiovascularAge) {
	v.value = val
	v.isSet = true
}

func (v NullableMultiDocumentResponsePublicDailyCardiovascularAge) IsSet() bool {
	return v.isSet
}

func (v *NullableMultiDocumentResponsePublicDailyCardiovascularAge) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMultiDocumentResponsePublicDailyCardiovascularAge(val *MultiDocumentResponsePublicDailyCardiovascularAge) *NullableMultiDocumentResponsePublicDailyCardiovascularAge {
	return &NullableMultiDocumentResponsePublicDailyCardiovascularAge{value: val, isSet: true}
}

func (v NullableMultiDocumentResponsePublicDailyCardiovascularAge) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMultiDocumentResponsePublicDailyCardiovascularAge) UnmarshalJSON(src []byte) error {
	v.isSet = true
