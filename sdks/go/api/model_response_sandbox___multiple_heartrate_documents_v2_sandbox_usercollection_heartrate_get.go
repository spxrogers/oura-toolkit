...
// ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet struct for ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet
type ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet struct {
	TimeSeriesResponseDict *TimeSeriesResponseDict
	TimeSeriesResponsePublicHeartRateRow *TimeSeriesResponsePublicHeartRateRow
}

// Unmarshal JSON data into any of the pointers in the struct
func (dst *ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet) UnmarshalJSON(data []byte) error {
	var err error
	...
	// try to unmarshal JSON data into TimeSeriesResponsePublicHeartRateRow
	err = json.Unmarshal(data, &dst.TimeSeriesResponsePublicHeartRateRow);
	if err == nil {
		jsonTimeSeriesResponsePublicHeartRateRow, _ := json.Marshal(dst.TimeSeriesResponsePublicHeartRateRow)
		if string(jsonTimeSeriesResponsePublicHeartRateRow) == "{}" { // empty struct
			dst.TimeSeriesResponsePublicHeartRateRow = nil
		} else {
			return nil // data stored in dst.TimeSeriesResponsePublicHeartRateRow, return on the first match
		}
	} else {
		dst.TimeSeriesResponsePublicHeartRateRow = nil
	}

	return fmt.Errorf("data failed to match schemas in anyOf(ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet) MarshalJSON() ([]byte, error) {
	if src.TimeSeriesResponseDict != nil {
		return json.Marshal(&src.TimeSeriesResponseDict)
	}

	if src.TimeSeriesResponsePublicHeartRateRow != nil {
		return json.Marshal(&src.TimeSeriesResponsePublicHeartRateRow)
	}
...
type NullableResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet struct {
	value *ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet
	isSet bool
}

func (v NullableResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet) Get() *ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet {
	return v.value
}

func (v *NullableResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet) Set(val *ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet(val *ResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet) *NullableResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet {
	return &NullableResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet{value: val, isSet: true}
}

func (v NullableResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseSandboxMultipleHeartrateDocumentsV2SandboxUsercollectionHeartrateGet) UnmarshalJSON(src []byte) error {
	v.isSet = true
