...
// checks if the TimeSeriesResponsePublicHeartRateRow type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TimeSeriesResponsePublicHeartRateRow{}

// TimeSeriesResponsePublicHeartRateRow struct for TimeSeriesResponsePublicHeartRateRow
type TimeSeriesResponsePublicHeartRateRow struct {
	Data []PublicHeartRateRow `json:"data"`
	NextToken NullableString `json:"next_token,omitempty"`
}

type _TimeSeriesResponsePublicHeartRateRow TimeSeriesResponsePublicHeartRateRow

// NewTimeSeriesResponsePublicHeartRateRow instantiates a new TimeSeriesResponsePublicHeartRateRow object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewTimeSeriesResponsePublicHeartRateRow(data []PublicHeartRateRow) *TimeSeriesResponsePublicHeartRateRow {
	this := TimeSeriesResponsePublicHeartRateRow{}
	this.Data = data
	return &this
}

// NewTimeSeriesResponsePublicHeartRateRowWithDefaults instantiates a new TimeSeriesResponsePublicHeartRateRow object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewTimeSeriesResponsePublicHeartRateRowWithDefaults() *TimeSeriesResponsePublicHeartRateRow {
	this := TimeSeriesResponsePublicHeartRateRow{}
	return &this
}

// GetData returns the Data field value
func (o *TimeSeriesResponsePublicHeartRateRow) GetData() []PublicHeartRateRow {
	if o == nil {
		var ret []PublicHeartRateRow
		return ret
	}
...
func (o *TimeSeriesResponsePublicHeartRateRow) GetDataOk() ([]PublicHeartRateRow, bool) {
	if o == nil {
		return nil, false
	}
	return o.Data, true
...
func (o *TimeSeriesResponsePublicHeartRateRow) SetData(v []PublicHeartRateRow) {
	o.Data = v
}

// GetNextToken returns the NextToken field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *TimeSeriesResponsePublicHeartRateRow) GetNextToken() string {
...
func (o *TimeSeriesResponsePublicHeartRateRow) GetNextTokenOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TimeSeriesResponsePublicHeartRateRow) HasNextToken() bool {
...
func (o *TimeSeriesResponsePublicHeartRateRow) SetNextToken(v string) {
	o.NextToken.Set(&v)
}
// SetNextTokenNil sets the value for NextToken to be an explicit nil
func (o *TimeSeriesResponsePublicHeartRateRow) SetNextTokenNil() {
	o.NextToken.Set(nil)
}

// UnsetNextToken ensures that no value is present for NextToken, not even an explicit nil
func (o *TimeSeriesResponsePublicHeartRateRow) UnsetNextToken() {
	o.NextToken.Unset()
}

func (o TimeSeriesResponsePublicHeartRateRow) MarshalJSON() ([]byte, error) {
...
func (o TimeSeriesResponsePublicHeartRateRow) ToMap() (map[string]interface{}, error) {
...
func (o *TimeSeriesResponsePublicHeartRateRow) UnmarshalJSON(data []byte) (err error) {
	...
	varTimeSeriesResponsePublicHeartRateRow := _TimeSeriesResponsePublicHeartRateRow{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTimeSeriesResponsePublicHeartRateRow)

	if err != nil {
		return err
	}

	*o = TimeSeriesResponsePublicHeartRateRow(varTimeSeriesResponsePublicHeartRateRow)

	return err
}

type NullableTimeSeriesResponsePublicHeartRateRow struct {
	value *TimeSeriesResponsePublicHeartRateRow
	isSet bool
}

func (v NullableTimeSeriesResponsePublicHeartRateRow) Get() *TimeSeriesResponsePublicHeartRateRow {
	return v.value
}

func (v *NullableTimeSeriesResponsePublicHeartRateRow) Set(val *TimeSeriesResponsePublicHeartRateRow) {
	v.value = val
	v.isSet = true
}

func (v NullableTimeSeriesResponsePublicHeartRateRow) IsSet() bool {
	return v.isSet
}

func (v *NullableTimeSeriesResponsePublicHeartRateRow) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTimeSeriesResponsePublicHeartRateRow(val *TimeSeriesResponsePublicHeartRateRow) *NullableTimeSeriesResponsePublicHeartRateRow {
	return &NullableTimeSeriesResponsePublicHeartRateRow{value: val, isSet: true}
}

func (v NullableTimeSeriesResponsePublicHeartRateRow) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTimeSeriesResponsePublicHeartRateRow) UnmarshalJSON(src []byte) error {
	v.isSet = true
