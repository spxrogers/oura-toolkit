...
// checks if the MultiDocumentResponsePublicModifiedSleepModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MultiDocumentResponsePublicModifiedSleepModel{}

// MultiDocumentResponsePublicModifiedSleepModel struct for MultiDocumentResponsePublicModifiedSleepModel
type MultiDocumentResponsePublicModifiedSleepModel struct {
	Data []PublicModifiedSleepModel `json:"data"`
	NextToken NullableString `json:"next_token"`
}

type _MultiDocumentResponsePublicModifiedSleepModel MultiDocumentResponsePublicModifiedSleepModel

// NewMultiDocumentResponsePublicModifiedSleepModel instantiates a new MultiDocumentResponsePublicModifiedSleepModel object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewMultiDocumentResponsePublicModifiedSleepModel(data []PublicModifiedSleepModel, nextToken NullableString) *MultiDocumentResponsePublicModifiedSleepModel {
	this := MultiDocumentResponsePublicModifiedSleepModel{}
	this.Data = data
	this.NextToken = nextToken
	return &this
}

// NewMultiDocumentResponsePublicModifiedSleepModelWithDefaults instantiates a new MultiDocumentResponsePublicModifiedSleepModel object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewMultiDocumentResponsePublicModifiedSleepModelWithDefaults() *MultiDocumentResponsePublicModifiedSleepModel {
	this := MultiDocumentResponsePublicModifiedSleepModel{}
	return &this
}

// GetData returns the Data field value
func (o *MultiDocumentResponsePublicModifiedSleepModel) GetData() []PublicModifiedSleepModel {
	if o == nil {
		var ret []PublicModifiedSleepModel
		return ret
	}
...
func (o *MultiDocumentResponsePublicModifiedSleepModel) GetDataOk() ([]PublicModifiedSleepModel, bool) {
	if o == nil {
		return nil, false
	}
	return o.Data, true
...
func (o *MultiDocumentResponsePublicModifiedSleepModel) SetData(v []PublicModifiedSleepModel) {
	o.Data = v
}

// GetNextToken returns the NextToken field value
// If the value is explicit nil, the zero value for string will be returned
func (o *MultiDocumentResponsePublicModifiedSleepModel) GetNextToken() string {
...
func (o *MultiDocumentResponsePublicModifiedSleepModel) GetNextTokenOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *MultiDocumentResponsePublicModifiedSleepModel) SetNextToken(v string) {
	o.NextToken.Set(&v)
}

func (o MultiDocumentResponsePublicModifiedSleepModel) MarshalJSON() ([]byte, error) {
...
func (o MultiDocumentResponsePublicModifiedSleepModel) ToMap() (map[string]interface{}, error) {
...
func (o *MultiDocumentResponsePublicModifiedSleepModel) UnmarshalJSON(data []byte) (err error) {
	...
	varMultiDocumentResponsePublicModifiedSleepModel := _MultiDocumentResponsePublicModifiedSleepModel{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMultiDocumentResponsePublicModifiedSleepModel)

	if err != nil {
		return err
	}

	*o = MultiDocumentResponsePublicModifiedSleepModel(varMultiDocumentResponsePublicModifiedSleepModel)

	return err
}

type NullableMultiDocumentResponsePublicModifiedSleepModel struct {
	value *MultiDocumentResponsePublicModifiedSleepModel
	isSet bool
}

func (v NullableMultiDocumentResponsePublicModifiedSleepModel) Get() *MultiDocumentResponsePublicModifiedSleepModel {
	return v.value
}

func (v *NullableMultiDocumentResponsePublicModifiedSleepModel) Set(val *MultiDocumentResponsePublicModifiedSleepModel) {
	v.value = val
	v.isSet = true
}

func (v NullableMultiDocumentResponsePublicModifiedSleepModel) IsSet() bool {
	return v.isSet
}

func (v *NullableMultiDocumentResponsePublicModifiedSleepModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMultiDocumentResponsePublicModifiedSleepModel(val *MultiDocumentResponsePublicModifiedSleepModel) *NullableMultiDocumentResponsePublicModifiedSleepModel {
	return &NullableMultiDocumentResponsePublicModifiedSleepModel{value: val, isSet: true}
}

func (v NullableMultiDocumentResponsePublicModifiedSleepModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMultiDocumentResponsePublicModifiedSleepModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
