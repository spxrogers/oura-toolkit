...
// SessionRoutesAPIService SessionRoutesAPI service
type SessionRoutesAPIService service

type ApiMultipleSessionDocumentsV2UsercollectionSessionGetRequest struct {
	ctx context.Context
	ApiService *SessionRoutesAPIService
	startDate *string
	endDate *string
	nextToken *string
	fields *string
...
func (r ApiMultipleSessionDocumentsV2UsercollectionSessionGetRequest) StartDate(startDate string) ApiMultipleSessionDocumentsV2UsercollectionSessionGetRequest {
	r.startDate = &startDate
	return r
}

func (r ApiMultipleSessionDocumentsV2UsercollectionSessionGetRequest) EndDate(endDate string) ApiMultipleSessionDocumentsV2UsercollectionSessionGetRequest {
	r.endDate = &endDate
	return r
}

func (r ApiMultipleSessionDocumentsV2UsercollectionSessionGetRequest) NextToken(nextToken string) ApiMultipleSessionDocumentsV2UsercollectionSessionGetRequest {
...
func (r ApiMultipleSessionDocumentsV2UsercollectionSessionGetRequest) Fields(fields string) ApiMultipleSessionDocumentsV2UsercollectionSessionGetRequest {
	r.fields = &fields
	return r
}

func (r ApiMultipleSessionDocumentsV2UsercollectionSessionGetRequest) Execute() (*MultiDocumentResponsePublicSession, *http.Response, error) {
	return r.ApiService.MultipleSessionDocumentsV2UsercollectionSessionGetExecute(r)
}

/*
MultipleSessionDocumentsV2UsercollectionSessionGet Multiple Session Documents

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiMultipleSessionDocumentsV2UsercollectionSessionGetRequest
*/
func (a *SessionRoutesAPIService) MultipleSessionDocumentsV2UsercollectionSessionGet(ctx context.Context) ApiMultipleSessionDocumentsV2UsercollectionSessionGetRequest {
	return ApiMultipleSessionDocumentsV2UsercollectionSessionGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SessionRoutesAPIService) MultipleSessionDocumentsV2UsercollectionSessionGetExecute(r ApiMultipleSessionDocumentsV2UsercollectionSessionGetRequest) (*MultiDocumentResponsePublicSession, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SessionRoutesAPIService.MultipleSessionDocumentsV2UsercollectionSessionGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/usercollection/session"
...
type ApiSingleSessionDocumentV2UsercollectionSessionDocumentIdGetRequest struct {
	ctx context.Context
	ApiService *SessionRoutesAPIService
	documentId string
}

func (r ApiSingleSessionDocumentV2UsercollectionSessionDocumentIdGetRequest) Execute() (*PublicSession, *http.Response, error) {
	return r.ApiService.SingleSessionDocumentV2UsercollectionSessionDocumentIdGetExecute(r)
}

/*
SingleSessionDocumentV2UsercollectionSessionDocumentIdGet Single Session Document

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param documentId
 @return ApiSingleSessionDocumentV2UsercollectionSessionDocumentIdGetRequest
*/
func (a *SessionRoutesAPIService) SingleSessionDocumentV2UsercollectionSessionDocumentIdGet(ctx context.Context, documentId string) ApiSingleSessionDocumentV2UsercollectionSessionDocumentIdGetRequest {
	return ApiSingleSessionDocumentV2UsercollectionSessionDocumentIdGetRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *SessionRoutesAPIService) SingleSessionDocumentV2UsercollectionSessionDocumentIdGetExecute(r ApiSingleSessionDocumentV2UsercollectionSessionDocumentIdGetRequest) (*PublicSession, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SessionRoutesAPIService.SingleSessionDocumentV2UsercollectionSessionDocumentIdGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/usercollection/session/{document_id}"
