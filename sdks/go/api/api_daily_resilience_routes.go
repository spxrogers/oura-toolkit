...
// DailyResilienceRoutesAPIService DailyResilienceRoutesAPI service
type DailyResilienceRoutesAPIService service

type ApiMultipleDailyResilienceDocumentsV2UsercollectionDailyResilienceGetRequest struct {
	ctx context.Context
	ApiService *DailyResilienceRoutesAPIService
	startDate *string
	endDate *string
	nextToken *string
	fields *string
...
func (r ApiMultipleDailyResilienceDocumentsV2UsercollectionDailyResilienceGetRequest) StartDate(startDate string) ApiMultipleDailyResilienceDocumentsV2UsercollectionDailyResilienceGetRequest {
	r.startDate = &startDate
	return r
}

func (r ApiMultipleDailyResilienceDocumentsV2UsercollectionDailyResilienceGetRequest) EndDate(endDate string) ApiMultipleDailyResilienceDocumentsV2UsercollectionDailyResilienceGetRequest {
	r.endDate = &endDate
	return r
}

func (r ApiMultipleDailyResilienceDocumentsV2UsercollectionDailyResilienceGetRequest) NextToken(nextToken string) ApiMultipleDailyResilienceDocumentsV2UsercollectionDailyResilienceGetRequest {
	r.nextToken = &nextToken
	return r
}

// N/A. This route does not support field selection yet, all fields will be returned.
func (r ApiMultipleDailyResilienceDocumentsV2UsercollectionDailyResilienceGetRequest) Fields(fields string) ApiMultipleDailyResilienceDocumentsV2UsercollectionDailyResilienceGetRequest {
	r.fields = &fields
	return r
}

func (r ApiMultipleDailyResilienceDocumentsV2UsercollectionDailyResilienceGetRequest) Execute() (*MultiDocumentResponseDailyResilienceModel, *http.Response, error) {
	return r.ApiService.MultipleDailyResilienceDocumentsV2UsercollectionDailyResilienceGetExecute(r)
}

/*
MultipleDailyResilienceDocumentsV2UsercollectionDailyResilienceGet Multiple Daily Resilience Documents

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiMultipleDailyResilienceDocumentsV2UsercollectionDailyResilienceGetRequest
*/
func (a *DailyResilienceRoutesAPIService) MultipleDailyResilienceDocumentsV2UsercollectionDailyResilienceGet(ctx context.Context) ApiMultipleDailyResilienceDocumentsV2UsercollectionDailyResilienceGetRequest {
	return ApiMultipleDailyResilienceDocumentsV2UsercollectionDailyResilienceGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *DailyResilienceRoutesAPIService) MultipleDailyResilienceDocumentsV2UsercollectionDailyResilienceGetExecute(r ApiMultipleDailyResilienceDocumentsV2UsercollectionDailyResilienceGetRequest) (*MultiDocumentResponseDailyResilienceModel, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DailyResilienceRoutesAPIService.MultipleDailyResilienceDocumentsV2UsercollectionDailyResilienceGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/usercollection/daily_resilience"
...
type ApiSingleDailyResilienceDocumentV2UsercollectionDailyResilienceDocumentIdGetRequest struct {
	ctx context.Context
	ApiService *DailyResilienceRoutesAPIService
	documentId string
}

func (r ApiSingleDailyResilienceDocumentV2UsercollectionDailyResilienceDocumentIdGetRequest) Execute() (*DailyResilienceModel, *http.Response, error) {
	return r.ApiService.SingleDailyResilienceDocumentV2UsercollectionDailyResilienceDocumentIdGetExecute(r)
}

/*
SingleDailyResilienceDocumentV2UsercollectionDailyResilienceDocumentIdGet Single Daily Resilience Document

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param documentId
 @return ApiSingleDailyResilienceDocumentV2UsercollectionDailyResilienceDocumentIdGetRequest
*/
func (a *DailyResilienceRoutesAPIService) SingleDailyResilienceDocumentV2UsercollectionDailyResilienceDocumentIdGet(ctx context.Context, documentId string) ApiSingleDailyResilienceDocumentV2UsercollectionDailyResilienceDocumentIdGetRequest {
	return ApiSingleDailyResilienceDocumentV2UsercollectionDailyResilienceDocumentIdGetRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *DailyResilienceRoutesAPIService) SingleDailyResilienceDocumentV2UsercollectionDailyResilienceDocumentIdGetExecute(r ApiSingleDailyResilienceDocumentV2UsercollectionDailyResilienceDocumentIdGetRequest) (*DailyResilienceModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DailyResilienceRoutesAPIService.SingleDailyResilienceDocumentV2UsercollectionDailyResilienceDocumentIdGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/usercollection/daily_resilience/{document_id}"
