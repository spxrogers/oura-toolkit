...
// checks if the MultiDocumentResponsePublicDailySpO2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MultiDocumentResponsePublicDailySpO2{}

// MultiDocumentResponsePublicDailySpO2 struct for MultiDocumentResponsePublicDailySpO2
type MultiDocumentResponsePublicDailySpO2 struct {
	Data []PublicDailySpO2 `json:"data"`
	NextToken NullableString `json:"next_token"`
}

type _MultiDocumentResponsePublicDailySpO2 MultiDocumentResponsePublicDailySpO2

// NewMultiDocumentResponsePublicDailySpO2 instantiates a new MultiDocumentResponsePublicDailySpO2 object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewMultiDocumentResponsePublicDailySpO2(data []PublicDailySpO2, nextToken NullableString) *MultiDocumentResponsePublicDailySpO2 {
	this := MultiDocumentResponsePublicDailySpO2{}
	this.Data = data
	this.NextToken = nextToken
	return &this
}

// NewMultiDocumentResponsePublicDailySpO2WithDefaults instantiates a new MultiDocumentResponsePublicDailySpO2 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewMultiDocumentResponsePublicDailySpO2WithDefaults() *MultiDocumentResponsePublicDailySpO2 {
	this := MultiDocumentResponsePublicDailySpO2{}
	return &this
}

// GetData returns the Data field value
func (o *MultiDocumentResponsePublicDailySpO2) GetData() []PublicDailySpO2 {
	if o == nil {
		var ret []PublicDailySpO2
		return ret
	}
...
func (o *MultiDocumentResponsePublicDailySpO2) GetDataOk() ([]PublicDailySpO2, bool) {
	if o == nil {
		return nil, false
	}
	return o.Data, true
...
func (o *MultiDocumentResponsePublicDailySpO2) SetData(v []PublicDailySpO2) {
	o.Data = v
}

// GetNextToken returns the NextToken field value
// If the value is explicit nil, the zero value for string will be returned
func (o *MultiDocumentResponsePublicDailySpO2) GetNextToken() string {
...
func (o *MultiDocumentResponsePublicDailySpO2) GetNextTokenOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *MultiDocumentResponsePublicDailySpO2) SetNextToken(v string) {
	o.NextToken.Set(&v)
}

func (o MultiDocumentResponsePublicDailySpO2) MarshalJSON() ([]byte, error) {
...
func (o MultiDocumentResponsePublicDailySpO2) ToMap() (map[string]interface{}, error) {
...
func (o *MultiDocumentResponsePublicDailySpO2) UnmarshalJSON(data []byte) (err error) {
	...
	varMultiDocumentResponsePublicDailySpO2 := _MultiDocumentResponsePublicDailySpO2{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMultiDocumentResponsePublicDailySpO2)

	if err != nil {
		return err
	}

	*o = MultiDocumentResponsePublicDailySpO2(varMultiDocumentResponsePublicDailySpO2)

	return err
}

type NullableMultiDocumentResponsePublicDailySpO2 struct {
	value *MultiDocumentResponsePublicDailySpO2
	isSet bool
}

func (v NullableMultiDocumentResponsePublicDailySpO2) Get() *MultiDocumentResponsePublicDailySpO2 {
	return v.value
}

func (v *NullableMultiDocumentResponsePublicDailySpO2) Set(val *MultiDocumentResponsePublicDailySpO2) {
	v.value = val
	v.isSet = true
}

func (v NullableMultiDocumentResponsePublicDailySpO2) IsSet() bool {
	return v.isSet
}

func (v *NullableMultiDocumentResponsePublicDailySpO2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMultiDocumentResponsePublicDailySpO2(val *MultiDocumentResponsePublicDailySpO2) *NullableMultiDocumentResponsePublicDailySpO2 {
	return &NullableMultiDocumentResponsePublicDailySpO2{value: val, isSet: true}
}

func (v NullableMultiDocumentResponsePublicDailySpO2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMultiDocumentResponsePublicDailySpO2) UnmarshalJSON(src []byte) error {
	v.isSet = true
