...
// PublicSleepTimeStatus Possible public SleepTime status.
type PublicSleepTimeStatus string

// List of PublicSleepTimeStatus
const (
	PUBLICSLEEPTIMESTATUS_NOT_ENOUGH_NIGHTS PublicSleepTimeStatus = "not_enough_nights"
	PUBLICSLEEPTIMESTATUS_NOT_ENOUGH_RECENT_NIGHTS PublicSleepTimeStatus = "not_enough_recent_nights"
	PUBLICSLEEPTIMESTATUS_BAD_SLEEP_QUALITY PublicSleepTimeStatus = "bad_sleep_quality"
	PUBLICSLEEPTIMESTATUS_ONLY_RECOMMENDED_FOUND PublicSleepTimeStatus = "only_recommended_found"
	PUBLICSLEEPTIMESTATUS_OPTIMAL_FOUND PublicSleepTimeStatus = "optimal_found"
)

// All allowed values of PublicSleepTimeStatus enum
var AllowedPublicSleepTimeStatusEnumValues = []PublicSleepTimeStatus{
	"not_enough_nights",
...
func (v *PublicSleepTimeStatus) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := PublicSleepTimeStatus(value)
	for _, existing := range AllowedPublicSleepTimeStatusEnumValues {
	...
	return fmt.Errorf("%+v is not a valid PublicSleepTimeStatus", value)
}

// NewPublicSleepTimeStatusFromValue returns a pointer to a valid PublicSleepTimeStatus
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewPublicSleepTimeStatusFromValue(v string) (*PublicSleepTimeStatus, error) {
	ev := PublicSleepTimeStatus(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for PublicSleepTimeStatus: valid values are %v", v, AllowedPublicSleepTimeStatusEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v PublicSleepTimeStatus) IsValid() bool {
	for _, existing := range AllowedPublicSleepTimeStatusEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to PublicSleepTimeStatus value
func (v PublicSleepTimeStatus) Ptr() *PublicSleepTimeStatus {
	return &v
}

type NullablePublicSleepTimeStatus struct {
	value *PublicSleepTimeStatus
	isSet bool
}

func (v NullablePublicSleepTimeStatus) Get() *PublicSleepTimeStatus {
	return v.value
}

func (v *NullablePublicSleepTimeStatus) Set(val *PublicSleepTimeStatus) {
	v.value = val
	v.isSet = true
}

func (v NullablePublicSleepTimeStatus) IsSet() bool {
	return v.isSet
}

func (v *NullablePublicSleepTimeStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePublicSleepTimeStatus(val *PublicSleepTimeStatus) *NullablePublicSleepTimeStatus {
	return &NullablePublicSleepTimeStatus{value: val, isSet: true}
}

func (v NullablePublicSleepTimeStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePublicSleepTimeStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
