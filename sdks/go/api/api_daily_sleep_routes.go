...
func (r ApiMultipleDailySleepDocumentsV2UsercollectionDailySleepGetRequest) StartDate(startDate string) ApiMultipleDailySleepDocumentsV2UsercollectionDailySleepGetRequest {
	r.startDate = &startDate
	return r
}

func (r ApiMultipleDailySleepDocumentsV2UsercollectionDailySleepGetRequest) EndDate(endDate string) ApiMultipleDailySleepDocumentsV2UsercollectionDailySleepGetRequest {
	r.endDate = &endDate
	return r
}
...
func (r ApiMultipleDailySleepDocumentsV2UsercollectionDailySleepGetRequest) Fields(fields string) ApiMultipleDailySleepDocumentsV2UsercollectionDailySleepGetRequest {
	r.fields = &fields
	return r
}

func (r ApiMultipleDailySleepDocumentsV2UsercollectionDailySleepGetRequest) Execute() (*MultiDocumentResponsePublicDailySleep, *http.Response, error) {
...
func (a *DailySleepRoutesAPIService) MultipleDailySleepDocumentsV2UsercollectionDailySleepGetExecute(r ApiMultipleDailySleepDocumentsV2UsercollectionDailySleepGetRequest) (*MultiDocumentResponsePublicDailySleep, *http.Response, error) {
	var (
...
func (r ApiSingleDailySleepDocumentV2UsercollectionDailySleepDocumentIdGetRequest) Execute() (*PublicDailySleep, *http.Response, error) {
...
func (a *DailySleepRoutesAPIService) SingleDailySleepDocumentV2UsercollectionDailySleepDocumentIdGetExecute(r ApiSingleDailySleepDocumentV2UsercollectionDailySleepDocumentIdGetRequest) (*PublicDailySleep, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
