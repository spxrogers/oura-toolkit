...
// PublicSleepAnalysisReason Possible sleep analysis reasons.
type PublicSleepAnalysisReason string

// List of PublicSleepAnalysisReason
const (
	PUBLICSLEEPANALYSISREASON_FOREGROUND_SLEEP_ANALYSIS PublicSleepAnalysisReason = "foreground_sleep_analysis"
	PUBLICSLEEPANALYSISREASON_BEDTIME_EDIT PublicSleepAnalysisReason = "bedtime_edit"
	PUBLICSLEEPANALYSISREASON_BACKGROUND_SLEEP_ANALYSIS PublicSleepAnalysisReason = "background_sleep_analysis"
	PUBLICSLEEPANALYSISREASON_BACKGROUND_CREATED_FOREGROUND_UPDATED PublicSleepAnalysisReason = "background_created_foreground_updated"
)

// All allowed values of PublicSleepAnalysisReason enum
var AllowedPublicSleepAnalysisReasonEnumValues = []PublicSleepAnalysisReason{
...
func (v *PublicSleepAnalysisReason) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := PublicSleepAnalysisReason(value)
	for _, existing := range AllowedPublicSleepAnalysisReasonEnumValues {
	...
	return fmt.Errorf("%+v is not a valid PublicSleepAnalysisReason", value)
}

// NewPublicSleepAnalysisReasonFromValue returns a pointer to a valid PublicSleepAnalysisReason
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewPublicSleepAnalysisReasonFromValue(v string) (*PublicSleepAnalysisReason, error) {
	ev := PublicSleepAnalysisReason(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for PublicSleepAnalysisReason: valid values are %v", v, AllowedPublicSleepAnalysisReasonEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v PublicSleepAnalysisReason) IsValid() bool {
	for _, existing := range AllowedPublicSleepAnalysisReasonEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to PublicSleepAnalysisReason value
func (v PublicSleepAnalysisReason) Ptr() *PublicSleepAnalysisReason {
	return &v
}

type NullablePublicSleepAnalysisReason struct {
	value *PublicSleepAnalysisReason
	isSet bool
}

func (v NullablePublicSleepAnalysisReason) Get() *PublicSleepAnalysisReason {
	return v.value
}

func (v *NullablePublicSleepAnalysisReason) Set(val *PublicSleepAnalysisReason) {
	v.value = val
	v.isSet = true
}

func (v NullablePublicSleepAnalysisReason) IsSet() bool {
	return v.isSet
}

func (v *NullablePublicSleepAnalysisReason) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePublicSleepAnalysisReason(val *PublicSleepAnalysisReason) *NullablePublicSleepAnalysisReason {
	return &NullablePublicSleepAnalysisReason{value: val, isSet: true}
}

func (v NullablePublicSleepAnalysisReason) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePublicSleepAnalysisReason) UnmarshalJSON(src []byte) error {
	v.isSet = true
