...
// PublicMomentType Possible Moment types.
type PublicMomentType string

// List of PublicMomentType
const (
	PUBLICMOMENTTYPE_BREATHING PublicMomentType = "breathing"
	PUBLICMOMENTTYPE_MEDITATION PublicMomentType = "meditation"
	PUBLICMOMENTTYPE_NAP PublicMomentType = "nap"
	PUBLICMOMENTTYPE_RELAXATION PublicMomentType = "relaxation"
	PUBLICMOMENTTYPE_REST PublicMomentType = "rest"
	PUBLICMOMENTTYPE_BODY_STATUS PublicMomentType = "body_status"
)

// All allowed values of PublicMomentType enum
var AllowedPublicMomentTypeEnumValues = []PublicMomentType{
	"breathing",
	"meditation",
	"nap",
	"relaxation",
...
func (v *PublicMomentType) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := PublicMomentType(value)
	for _, existing := range AllowedPublicMomentTypeEnumValues {
	...
	return fmt.Errorf("%+v is not a valid PublicMomentType", value)
}

// NewPublicMomentTypeFromValue returns a pointer to a valid PublicMomentType
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewPublicMomentTypeFromValue(v string) (*PublicMomentType, error) {
	ev := PublicMomentType(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for PublicMomentType: valid values are %v", v, AllowedPublicMomentTypeEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v PublicMomentType) IsValid() bool {
	for _, existing := range AllowedPublicMomentTypeEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to PublicMomentType value
func (v PublicMomentType) Ptr() *PublicMomentType {
	return &v
}

type NullablePublicMomentType struct {
	value *PublicMomentType
	isSet bool
}

func (v NullablePublicMomentType) Get() *PublicMomentType {
	return v.value
}

func (v *NullablePublicMomentType) Set(val *PublicMomentType) {
	v.value = val
	v.isSet = true
}

func (v NullablePublicMomentType) IsSet() bool {
	return v.isSet
}

func (v *NullablePublicMomentType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePublicMomentType(val *PublicMomentType) *NullablePublicMomentType {
	return &NullablePublicMomentType{value: val, isSet: true}
}

func (v NullablePublicMomentType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePublicMomentType) UnmarshalJSON(src []byte) error {
	v.isSet = true
