...
// checks if the MultiDocumentResponsePublicRingConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MultiDocumentResponsePublicRingConfiguration{}

// MultiDocumentResponsePublicRingConfiguration struct for MultiDocumentResponsePublicRingConfiguration
type MultiDocumentResponsePublicRingConfiguration struct {
	Data []PublicRingConfiguration `json:"data"`
	NextToken NullableString `json:"next_token"`
}

type _MultiDocumentResponsePublicRingConfiguration MultiDocumentResponsePublicRingConfiguration

// NewMultiDocumentResponsePublicRingConfiguration instantiates a new MultiDocumentResponsePublicRingConfiguration object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewMultiDocumentResponsePublicRingConfiguration(data []PublicRingConfiguration, nextToken NullableString) *MultiDocumentResponsePublicRingConfiguration {
	this := MultiDocumentResponsePublicRingConfiguration{}
	this.Data = data
	this.NextToken = nextToken
	return &this
}

// NewMultiDocumentResponsePublicRingConfigurationWithDefaults instantiates a new MultiDocumentResponsePublicRingConfiguration object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewMultiDocumentResponsePublicRingConfigurationWithDefaults() *MultiDocumentResponsePublicRingConfiguration {
	this := MultiDocumentResponsePublicRingConfiguration{}
	return &this
}

// GetData returns the Data field value
func (o *MultiDocumentResponsePublicRingConfiguration) GetData() []PublicRingConfiguration {
	if o == nil {
		var ret []PublicRingConfiguration
		return ret
	}
...
func (o *MultiDocumentResponsePublicRingConfiguration) GetDataOk() ([]PublicRingConfiguration, bool) {
	if o == nil {
		return nil, false
	}
	return o.Data, true
...
func (o *MultiDocumentResponsePublicRingConfiguration) SetData(v []PublicRingConfiguration) {
	o.Data = v
}

// GetNextToken returns the NextToken field value
// If the value is explicit nil, the zero value for string will be returned
func (o *MultiDocumentResponsePublicRingConfiguration) GetNextToken() string {
...
func (o *MultiDocumentResponsePublicRingConfiguration) GetNextTokenOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *MultiDocumentResponsePublicRingConfiguration) SetNextToken(v string) {
	o.NextToken.Set(&v)
}

func (o MultiDocumentResponsePublicRingConfiguration) MarshalJSON() ([]byte, error) {
...
func (o MultiDocumentResponsePublicRingConfiguration) ToMap() (map[string]interface{}, error) {
...
func (o *MultiDocumentResponsePublicRingConfiguration) UnmarshalJSON(data []byte) (err error) {
	...
	varMultiDocumentResponsePublicRingConfiguration := _MultiDocumentResponsePublicRingConfiguration{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMultiDocumentResponsePublicRingConfiguration)

	if err != nil {
		return err
	}

	*o = MultiDocumentResponsePublicRingConfiguration(varMultiDocumentResponsePublicRingConfiguration)

	return err
}

type NullableMultiDocumentResponsePublicRingConfiguration struct {
	value *MultiDocumentResponsePublicRingConfiguration
	isSet bool
}

func (v NullableMultiDocumentResponsePublicRingConfiguration) Get() *MultiDocumentResponsePublicRingConfiguration {
	return v.value
}

func (v *NullableMultiDocumentResponsePublicRingConfiguration) Set(val *MultiDocumentResponsePublicRingConfiguration) {
	v.value = val
	v.isSet = true
}

func (v NullableMultiDocumentResponsePublicRingConfiguration) IsSet() bool {
	return v.isSet
}

func (v *NullableMultiDocumentResponsePublicRingConfiguration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMultiDocumentResponsePublicRingConfiguration(val *MultiDocumentResponsePublicRingConfiguration) *NullableMultiDocumentResponsePublicRingConfiguration {
	return &NullableMultiDocumentResponsePublicRingConfiguration{value: val, isSet: true}
}

func (v NullableMultiDocumentResponsePublicRingConfiguration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMultiDocumentResponsePublicRingConfiguration) UnmarshalJSON(src []byte) error {
	v.isSet = true
