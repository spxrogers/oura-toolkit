...
// checks if the MultiDocumentResponsePublicDailyActivity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MultiDocumentResponsePublicDailyActivity{}

// MultiDocumentResponsePublicDailyActivity struct for MultiDocumentResponsePublicDailyActivity
type MultiDocumentResponsePublicDailyActivity struct {
	Data []PublicDailyActivity `json:"data"`
	NextToken NullableString `json:"next_token"`
}

type _MultiDocumentResponsePublicDailyActivity MultiDocumentResponsePublicDailyActivity

// NewMultiDocumentResponsePublicDailyActivity instantiates a new MultiDocumentResponsePublicDailyActivity object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewMultiDocumentResponsePublicDailyActivity(data []PublicDailyActivity, nextToken NullableString) *MultiDocumentResponsePublicDailyActivity {
	this := MultiDocumentResponsePublicDailyActivity{}
	this.Data = data
	this.NextToken = nextToken
	return &this
}

// NewMultiDocumentResponsePublicDailyActivityWithDefaults instantiates a new MultiDocumentResponsePublicDailyActivity object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewMultiDocumentResponsePublicDailyActivityWithDefaults() *MultiDocumentResponsePublicDailyActivity {
	this := MultiDocumentResponsePublicDailyActivity{}
	return &this
}

// GetData returns the Data field value
func (o *MultiDocumentResponsePublicDailyActivity) GetData() []PublicDailyActivity {
	if o == nil {
		var ret []PublicDailyActivity
		return ret
	}
...
func (o *MultiDocumentResponsePublicDailyActivity) GetDataOk() ([]PublicDailyActivity, bool) {
	if o == nil {
		return nil, false
	}
	return o.Data, true
...
func (o *MultiDocumentResponsePublicDailyActivity) SetData(v []PublicDailyActivity) {
	o.Data = v
}

// GetNextToken returns the NextToken field value
// If the value is explicit nil, the zero value for string will be returned
func (o *MultiDocumentResponsePublicDailyActivity) GetNextToken() string {
...
func (o *MultiDocumentResponsePublicDailyActivity) GetNextTokenOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *MultiDocumentResponsePublicDailyActivity) SetNextToken(v string) {
	o.NextToken.Set(&v)
}

func (o MultiDocumentResponsePublicDailyActivity) MarshalJSON() ([]byte, error) {
...
func (o MultiDocumentResponsePublicDailyActivity) ToMap() (map[string]interface{}, error) {
...
func (o *MultiDocumentResponsePublicDailyActivity) UnmarshalJSON(data []byte) (err error) {
	...
	varMultiDocumentResponsePublicDailyActivity := _MultiDocumentResponsePublicDailyActivity{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMultiDocumentResponsePublicDailyActivity)

	if err != nil {
		return err
	}

	*o = MultiDocumentResponsePublicDailyActivity(varMultiDocumentResponsePublicDailyActivity)

	return err
}

type NullableMultiDocumentResponsePublicDailyActivity struct {
	value *MultiDocumentResponsePublicDailyActivity
	isSet bool
}

func (v NullableMultiDocumentResponsePublicDailyActivity) Get() *MultiDocumentResponsePublicDailyActivity {
	return v.value
}

func (v *NullableMultiDocumentResponsePublicDailyActivity) Set(val *MultiDocumentResponsePublicDailyActivity) {
	v.value = val
	v.isSet = true
}

func (v NullableMultiDocumentResponsePublicDailyActivity) IsSet() bool {
	return v.isSet
}

func (v *NullableMultiDocumentResponsePublicDailyActivity) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMultiDocumentResponsePublicDailyActivity(val *MultiDocumentResponsePublicDailyActivity) *NullableMultiDocumentResponsePublicDailyActivity {
	return &NullableMultiDocumentResponsePublicDailyActivity{value: val, isSet: true}
}

func (v NullableMultiDocumentResponsePublicDailyActivity) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMultiDocumentResponsePublicDailyActivity) UnmarshalJSON(src []byte) error {
	v.isSet = true
