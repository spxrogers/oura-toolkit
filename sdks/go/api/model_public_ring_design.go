...
// PublicRingDesign Possible ring designs.
type PublicRingDesign string

// List of PublicRingDesign
const (
	PUBLICRINGDESIGN_HERITAGE PublicRingDesign = "heritage"
	PUBLICRINGDESIGN_BALANCE PublicRingDesign = "balance"
	PUBLICRINGDESIGN_BALANCE_DIAMOND PublicRingDesign = "balance_diamond"
	PUBLICRINGDESIGN_HORIZON PublicRingDesign = "horizon"
	PUBLICRINGDESIGN_CERAMIC PublicRingDesign = "ceramic"
)

// All allowed values of PublicRingDesign enum
var AllowedPublicRingDesignEnumValues = []PublicRingDesign{
	"heritage",
	"balance",
	"balance_diamond",
	"horizon",
...
func (v *PublicRingDesign) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := PublicRingDesign(value)
	for _, existing := range AllowedPublicRingDesignEnumValues {
	...
	return fmt.Errorf("%+v is not a valid PublicRingDesign", value)
}

// NewPublicRingDesignFromValue returns a pointer to a valid PublicRingDesign
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewPublicRingDesignFromValue(v string) (*PublicRingDesign, error) {
	ev := PublicRingDesign(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for PublicRingDesign: valid values are %v", v, AllowedPublicRingDesignEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v PublicRingDesign) IsValid() bool {
	for _, existing := range AllowedPublicRingDesignEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to PublicRingDesign value
func (v PublicRingDesign) Ptr() *PublicRingDesign {
	return &v
}

type NullablePublicRingDesign struct {
	value *PublicRingDesign
	isSet bool
}

func (v NullablePublicRingDesign) Get() *PublicRingDesign {
	return v.value
}

func (v *NullablePublicRingDesign) Set(val *PublicRingDesign) {
	v.value = val
	v.isSet = true
}

func (v NullablePublicRingDesign) IsSet() bool {
	return v.isSet
}

func (v *NullablePublicRingDesign) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePublicRingDesign(val *PublicRingDesign) *NullablePublicRingDesign {
	return &NullablePublicRingDesign{value: val, isSet: true}
}

func (v NullablePublicRingDesign) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePublicRingDesign) UnmarshalJSON(src []byte) error {
	v.isSet = true
