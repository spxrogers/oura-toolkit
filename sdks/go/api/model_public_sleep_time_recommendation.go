...
// PublicSleepTimeRecommendation Possible public SleepTime recommendation.
type PublicSleepTimeRecommendation string

// List of PublicSleepTimeRecommendation
const (
	PUBLICSLEEPTIMERECOMMENDATION_IMPROVE_EFFICIENCY PublicSleepTimeRecommendation = "improve_efficiency"
	PUBLICSLEEPTIMERECOMMENDATION_EARLIER_BEDTIME PublicSleepTimeRecommendation = "earlier_bedtime"
	PUBLICSLEEPTIMERECOMMENDATION_LATER_BEDTIME PublicSleepTimeRecommendation = "later_bedtime"
	PUBLICSLEEPTIMERECOMMENDATION_EARLIER_WAKE_UP_TIME PublicSleepTimeRecommendation = "earlier_wake_up_time"
	PUBLICSLEEPTIMERECOMMENDATION_LATER_WAKE_UP_TIME PublicSleepTimeRecommendation = "later_wake_up_time"
	PUBLICSLEEPTIMERECOMMENDATION_FOLLOW_OPTIMAL_BEDTIME PublicSleepTimeRecommendation = "follow_optimal_bedtime"
)

// All allowed values of PublicSleepTimeRecommendation enum
var AllowedPublicSleepTimeRecommendationEnumValues = []PublicSleepTimeRecommendation{
	"improve_efficiency",
	"earlier_bedtime",
	"later_bedtime",
...
func (v *PublicSleepTimeRecommendation) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := PublicSleepTimeRecommendation(value)
	for _, existing := range AllowedPublicSleepTimeRecommendationEnumValues {
	...
	return fmt.Errorf("%+v is not a valid PublicSleepTimeRecommendation", value)
}

// NewPublicSleepTimeRecommendationFromValue returns a pointer to a valid PublicSleepTimeRecommendation
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewPublicSleepTimeRecommendationFromValue(v string) (*PublicSleepTimeRecommendation, error) {
	ev := PublicSleepTimeRecommendation(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for PublicSleepTimeRecommendation: valid values are %v", v, AllowedPublicSleepTimeRecommendationEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v PublicSleepTimeRecommendation) IsValid() bool {
	for _, existing := range AllowedPublicSleepTimeRecommendationEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to PublicSleepTimeRecommendation value
func (v PublicSleepTimeRecommendation) Ptr() *PublicSleepTimeRecommendation {
	return &v
}

type NullablePublicSleepTimeRecommendation struct {
	value *PublicSleepTimeRecommendation
	isSet bool
}

func (v NullablePublicSleepTimeRecommendation) Get() *PublicSleepTimeRecommendation {
	return v.value
}

func (v *NullablePublicSleepTimeRecommendation) Set(val *PublicSleepTimeRecommendation) {
	v.value = val
	v.isSet = true
}

func (v NullablePublicSleepTimeRecommendation) IsSet() bool {
	return v.isSet
}

func (v *NullablePublicSleepTimeRecommendation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePublicSleepTimeRecommendation(val *PublicSleepTimeRecommendation) *NullablePublicSleepTimeRecommendation {
	return &NullablePublicSleepTimeRecommendation{value: val, isSet: true}
}

func (v NullablePublicSleepTimeRecommendation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePublicSleepTimeRecommendation) UnmarshalJSON(src []byte) error {
	v.isSet = true
