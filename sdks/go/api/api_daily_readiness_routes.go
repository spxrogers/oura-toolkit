...
func (r ApiMultipleDailyReadinessDocumentsV2UsercollectionDailyReadinessGetRequest) StartDate(startDate string) ApiMultipleDailyReadinessDocumentsV2UsercollectionDailyReadinessGetRequest {
	r.startDate = &startDate
	return r
}

func (r ApiMultipleDailyReadinessDocumentsV2UsercollectionDailyReadinessGetRequest) EndDate(endDate string) ApiMultipleDailyReadinessDocumentsV2UsercollectionDailyReadinessGetRequest {
	r.endDate = &endDate
	return r
}
...
func (r ApiMultipleDailyReadinessDocumentsV2UsercollectionDailyReadinessGetRequest) Fields(fields string) ApiMultipleDailyReadinessDocumentsV2UsercollectionDailyReadinessGetRequest {
	r.fields = &fields
	return r
}

func (r ApiMultipleDailyReadinessDocumentsV2UsercollectionDailyReadinessGetRequest) Execute() (*MultiDocumentResponsePublicDailyReadiness, *http.Response, error) {
...
func (a *DailyReadinessRoutesAPIService) MultipleDailyReadinessDocumentsV2UsercollectionDailyReadinessGetExecute(r ApiMultipleDailyReadinessDocumentsV2UsercollectionDailyReadinessGetRequest) (*MultiDocumentResponsePublicDailyReadiness, *http.Response, error) {
	var (
...
func (r ApiSingleDailyReadinessDocumentV2UsercollectionDailyReadinessDocumentIdGetRequest) Execute() (*PublicDailyReadiness, *http.Response, error) {
...
func (a *DailyReadinessRoutesAPIService) SingleDailyReadinessDocumentV2UsercollectionDailyReadinessDocumentIdGetExecute(r ApiSingleDailyReadinessDocumentV2UsercollectionDailyReadinessDocumentIdGetRequest) (*PublicDailyReadiness, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
