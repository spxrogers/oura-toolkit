...
// List of PublicWorkoutIntensity
const (
	PUBLICWORKOUTINTENSITY_EASY PublicWorkoutIntensity = "easy"
	PUBLICWORKOUTINTENSITY_MODERATE PublicWorkoutIntensity = "moderate"
	PUBLICWORKOUTINTENSITY_HARD PublicWorkoutIntensity = "hard"
)

// All allowed values of PublicWorkoutIntensity enum
var AllowedPublicWorkoutIntensityEnumValues = []PublicWorkoutIntensity{
	"easy",
	"moderate",
	"hard",
}

func (v *PublicWorkoutIntensity) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := PublicWorkoutIntensity(value)
	for _, existing := range AllowedPublicWorkoutIntensityEnumValues {
	...
	return fmt.Errorf("%+v is not a valid PublicWorkoutIntensity", value)
}

// NewPublicWorkoutIntensityFromValue returns a pointer to a valid PublicWorkoutIntensity
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewPublicWorkoutIntensityFromValue(v string) (*PublicWorkoutIntensity, error) {
	ev := PublicWorkoutIntensity(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for PublicWorkoutIntensity: valid values are %v", v, AllowedPublicWorkoutIntensityEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v PublicWorkoutIntensity) IsValid() bool {
	for _, existing := range AllowedPublicWorkoutIntensityEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to PublicWorkoutIntensity value
func (v PublicWorkoutIntensity) Ptr() *PublicWorkoutIntensity {
	return &v
}

type NullablePublicWorkoutIntensity struct {
	value *PublicWorkoutIntensity
	isSet bool
}

func (v NullablePublicWorkoutIntensity) Get() *PublicWorkoutIntensity {
	return v.value
}

func (v *NullablePublicWorkoutIntensity) Set(val *PublicWorkoutIntensity) {
	v.value = val
	v.isSet = true
}

func (v NullablePublicWorkoutIntensity) IsSet() bool {
	return v.isSet
}

func (v *NullablePublicWorkoutIntensity) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePublicWorkoutIntensity(val *PublicWorkoutIntensity) *NullablePublicWorkoutIntensity {
	return &NullablePublicWorkoutIntensity{value: val, isSet: true}
}

func (v NullablePublicWorkoutIntensity) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePublicWorkoutIntensity) UnmarshalJSON(src []byte) error {
	v.isSet = true
