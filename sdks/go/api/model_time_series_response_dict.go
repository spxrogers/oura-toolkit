...
// checks if the TimeSeriesResponseDict type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TimeSeriesResponseDict{}

// TimeSeriesResponseDict struct for TimeSeriesResponseDict
type TimeSeriesResponseDict struct {
	Data []map[string]interface{} `json:"data"`
	NextToken NullableString `json:"next_token,omitempty"`
}

type _TimeSeriesResponseDict TimeSeriesResponseDict

// NewTimeSeriesResponseDict instantiates a new TimeSeriesResponseDict object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewTimeSeriesResponseDict(data []map[string]interface{}) *TimeSeriesResponseDict {
	this := TimeSeriesResponseDict{}
	this.Data = data
	return &this
}

// NewTimeSeriesResponseDictWithDefaults instantiates a new TimeSeriesResponseDict object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewTimeSeriesResponseDictWithDefaults() *TimeSeriesResponseDict {
	this := TimeSeriesResponseDict{}
	return &this
}

// GetData returns the Data field value
func (o *TimeSeriesResponseDict) GetData() []map[string]interface{} {
	if o == nil {
...
func (o *TimeSeriesResponseDict) GetDataOk() ([]map[string]interface{}, bool) {
	if o == nil {
		return nil, false
	}
	return o.Data, true
...
func (o *TimeSeriesResponseDict) GetNextTokenOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TimeSeriesResponseDict) HasNextToken() bool {
...
func (o *TimeSeriesResponseDict) SetNextToken(v string) {
	o.NextToken.Set(&v)
}
// SetNextTokenNil sets the value for NextToken to be an explicit nil
func (o *TimeSeriesResponseDict) SetNextTokenNil() {
	o.NextToken.Set(nil)
}

// UnsetNextToken ensures that no value is present for NextToken, not even an explicit nil
func (o *TimeSeriesResponseDict) UnsetNextToken() {
	o.NextToken.Unset()
}

func (o TimeSeriesResponseDict) MarshalJSON() ([]byte, error) {
...
func (o TimeSeriesResponseDict) ToMap() (map[string]interface{}, error) {
...
func (o *TimeSeriesResponseDict) UnmarshalJSON(data []byte) (err error) {
	...
	varTimeSeriesResponseDict := _TimeSeriesResponseDict{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTimeSeriesResponseDict)

	if err != nil {
		return err
	}

	*o = TimeSeriesResponseDict(varTimeSeriesResponseDict)

	return err
}

type NullableTimeSeriesResponseDict struct {
	value *TimeSeriesResponseDict
	isSet bool
}

func (v NullableTimeSeriesResponseDict) Get() *TimeSeriesResponseDict {
	return v.value
}

func (v *NullableTimeSeriesResponseDict) Set(val *TimeSeriesResponseDict) {
	v.value = val
	v.isSet = true
}

func (v NullableTimeSeriesResponseDict) IsSet() bool {
	return v.isSet
}

func (v *NullableTimeSeriesResponseDict) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTimeSeriesResponseDict(val *TimeSeriesResponseDict) *NullableTimeSeriesResponseDict {
	return &NullableTimeSeriesResponseDict{value: val, isSet: true}
}

func (v NullableTimeSeriesResponseDict) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTimeSeriesResponseDict) UnmarshalJSON(src []byte) error {
	v.isSet = true
