...
// checks if the MultiDocumentResponsePublicWorkout type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MultiDocumentResponsePublicWorkout{}

// MultiDocumentResponsePublicWorkout struct for MultiDocumentResponsePublicWorkout
type MultiDocumentResponsePublicWorkout struct {
	Data []PublicWorkout `json:"data"`
	NextToken NullableString `json:"next_token"`
}

type _MultiDocumentResponsePublicWorkout MultiDocumentResponsePublicWorkout

// NewMultiDocumentResponsePublicWorkout instantiates a new MultiDocumentResponsePublicWorkout object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewMultiDocumentResponsePublicWorkout(data []PublicWorkout, nextToken NullableString) *MultiDocumentResponsePublicWorkout {
	this := MultiDocumentResponsePublicWorkout{}
	this.Data = data
	this.NextToken = nextToken
	return &this
}

// NewMultiDocumentResponsePublicWorkoutWithDefaults instantiates a new MultiDocumentResponsePublicWorkout object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewMultiDocumentResponsePublicWorkoutWithDefaults() *MultiDocumentResponsePublicWorkout {
	this := MultiDocumentResponsePublicWorkout{}
	return &this
}

// GetData returns the Data field value
func (o *MultiDocumentResponsePublicWorkout) GetData() []PublicWorkout {
	if o == nil {
		var ret []PublicWorkout
		return ret
	}
...
func (o *MultiDocumentResponsePublicWorkout) GetDataOk() ([]PublicWorkout, bool) {
	if o == nil {
		return nil, false
	}
	return o.Data, true
...
func (o *MultiDocumentResponsePublicWorkout) SetData(v []PublicWorkout) {
	o.Data = v
}

// GetNextToken returns the NextToken field value
// If the value is explicit nil, the zero value for string will be returned
func (o *MultiDocumentResponsePublicWorkout) GetNextToken() string {
...
func (o *MultiDocumentResponsePublicWorkout) GetNextTokenOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *MultiDocumentResponsePublicWorkout) SetNextToken(v string) {
	o.NextToken.Set(&v)
}

func (o MultiDocumentResponsePublicWorkout) MarshalJSON() ([]byte, error) {
...
func (o MultiDocumentResponsePublicWorkout) ToMap() (map[string]interface{}, error) {
...
func (o *MultiDocumentResponsePublicWorkout) UnmarshalJSON(data []byte) (err error) {
	...
	varMultiDocumentResponsePublicWorkout := _MultiDocumentResponsePublicWorkout{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMultiDocumentResponsePublicWorkout)

	if err != nil {
		return err
	}

	*o = MultiDocumentResponsePublicWorkout(varMultiDocumentResponsePublicWorkout)

	return err
}

type NullableMultiDocumentResponsePublicWorkout struct {
	value *MultiDocumentResponsePublicWorkout
	isSet bool
}

func (v NullableMultiDocumentResponsePublicWorkout) Get() *MultiDocumentResponsePublicWorkout {
	return v.value
}

func (v *NullableMultiDocumentResponsePublicWorkout) Set(val *MultiDocumentResponsePublicWorkout) {
	v.value = val
	v.isSet = true
}

func (v NullableMultiDocumentResponsePublicWorkout) IsSet() bool {
	return v.isSet
}

func (v *NullableMultiDocumentResponsePublicWorkout) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMultiDocumentResponsePublicWorkout(val *MultiDocumentResponsePublicWorkout) *NullableMultiDocumentResponsePublicWorkout {
	return &NullableMultiDocumentResponsePublicWorkout{value: val, isSet: true}
}

func (v NullableMultiDocumentResponsePublicWorkout) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMultiDocumentResponsePublicWorkout) UnmarshalJSON(src []byte) error {
	v.isSet = true
