...
// PublicHeartRateSource Possible heart rate sources.
type PublicHeartRateSource string

// List of PublicHeartRateSource
const (
	PUBLICHEARTRATESOURCE_AWAKE PublicHeartRateSource = "awake"
	PUBLICHEARTRATESOURCE_WORKOUT PublicHeartRateSource = "workout"
	PUBLICHEARTRATESOURCE_REST PublicHeartRateSource = "rest"
	PUBLICHEARTRATESOURCE_SLEEP PublicHeartRateSource = "sleep"
	PUBLICHEARTRATESOURCE_LIVE PublicHeartRateSource = "live"
	PUBLICHEARTRATESOURCE_SESSION PublicHeartRateSource = "session"
)

// All allowed values of PublicHeartRateSource enum
var AllowedPublicHeartRateSourceEnumValues = []PublicHeartRateSource{
	"awake",
	"workout",
	"rest",
	"sleep",
...
func (v *PublicHeartRateSource) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := PublicHeartRateSource(value)
	for _, existing := range AllowedPublicHeartRateSourceEnumValues {
	...
	return fmt.Errorf("%+v is not a valid PublicHeartRateSource", value)
}

// NewPublicHeartRateSourceFromValue returns a pointer to a valid PublicHeartRateSource
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewPublicHeartRateSourceFromValue(v string) (*PublicHeartRateSource, error) {
	ev := PublicHeartRateSource(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for PublicHeartRateSource: valid values are %v", v, AllowedPublicHeartRateSourceEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v PublicHeartRateSource) IsValid() bool {
	for _, existing := range AllowedPublicHeartRateSourceEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to PublicHeartRateSource value
func (v PublicHeartRateSource) Ptr() *PublicHeartRateSource {
	return &v
}

type NullablePublicHeartRateSource struct {
	value *PublicHeartRateSource
	isSet bool
}

func (v NullablePublicHeartRateSource) Get() *PublicHeartRateSource {
	return v.value
}

func (v *NullablePublicHeartRateSource) Set(val *PublicHeartRateSource) {
	v.value = val
	v.isSet = true
}

func (v NullablePublicHeartRateSource) IsSet() bool {
	return v.isSet
}

func (v *NullablePublicHeartRateSource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePublicHeartRateSource(val *PublicHeartRateSource) *NullablePublicHeartRateSource {
	return &NullablePublicHeartRateSource{value: val, isSet: true}
}

func (v NullablePublicHeartRateSource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePublicHeartRateSource) UnmarshalJSON(src []byte) error {
	v.isSet = true
