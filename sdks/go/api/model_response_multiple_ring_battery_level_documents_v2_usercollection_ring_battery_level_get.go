...
// ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet struct for ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet
type ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet struct {
...
func (dst *ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet) UnmarshalJSON(data []byte) error {
	var err error
	...
	return fmt.Errorf("data failed to match schemas in anyOf(ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet) MarshalJSON() ([]byte, error) {
...
type NullableResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet struct {
	value *ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet
	isSet bool
}

func (v NullableResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet) Get() *ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet {
	return v.value
}

func (v *NullableResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet) Set(val *ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet(val *ResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet) *NullableResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet {
	return &NullableResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet{value: val, isSet: true}
}

func (v NullableResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseMultipleRingBatteryLevelDocumentsV2UsercollectionRingBatteryLevelGet) UnmarshalJSON(src []byte) error {
	v.isSet = true
