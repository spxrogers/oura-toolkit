...
// ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet struct for ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet
type ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet struct {
...
func (dst *ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet) UnmarshalJSON(data []byte) error {
	var err error
	...
	return fmt.Errorf("data failed to match schemas in anyOf(ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet) MarshalJSON() ([]byte, error) {
...
type NullableResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet struct {
	value *ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet
	isSet bool
}

func (v NullableResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet) Get() *ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet {
	return v.value
}

func (v *NullableResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet) Set(val *ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet(val *ResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet) *NullableResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet {
	return &NullableResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet{value: val, isSet: true}
}

func (v NullableResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseMultipleHeartrateDocumentsV2UsercollectionHeartrateGet) UnmarshalJSON(src []byte) error {
	v.isSet = true
