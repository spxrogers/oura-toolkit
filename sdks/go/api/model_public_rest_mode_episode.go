...
// checks if the PublicRestModeEpisode type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PublicRestModeEpisode{}

// PublicRestModeEpisode Object defining a public Rest Mode episode.
...
type _PublicRestModeEpisode PublicRestModeEpisode

// NewPublicRestModeEpisode instantiates a new PublicRestModeEpisode object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPublicRestModeEpisode(tags []string, timestamp NullableString) *PublicRestModeEpisode {
	this := PublicRestModeEpisode{}
	this.Tags = tags
	this.Timestamp = timestamp
	return &this
}

// NewPublicRestModeEpisodeWithDefaults instantiates a new PublicRestModeEpisode object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPublicRestModeEpisodeWithDefaults() *PublicRestModeEpisode {
	this := PublicRestModeEpisode{}
	return &this
}

// GetTags returns the Tags field value
func (o *PublicRestModeEpisode) GetTags() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
func (o *PublicRestModeEpisode) GetTagsOk() ([]string, bool) {
	if o == nil {
		return nil, false
	}
	return o.Tags, true
...
func (o *PublicRestModeEpisode) SetTags(v []string) {
	o.Tags = v
}

// GetTimestamp returns the Timestamp field value
// If the value is explicit nil, the zero value for string will be returned
func (o *PublicRestModeEpisode) GetTimestamp() string {
...
func (o *PublicRestModeEpisode) GetTimestampOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PublicRestModeEpisode) SetTimestamp(v string) {
	o.Timestamp.Set(&v)
}

func (o PublicRestModeEpisode) MarshalJSON() ([]byte, error) {
...
func (o PublicRestModeEpisode) ToMap() (map[string]interface{}, error) {
...
func (o *PublicRestModeEpisode) UnmarshalJSON(data []byte) (err error) {
	...
	varPublicRestModeEpisode := _PublicRestModeEpisode{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPublicRestModeEpisode)

	if err != nil {
		return err
	}

	*o = PublicRestModeEpisode(varPublicRestModeEpisode)

	return err
}

type NullablePublicRestModeEpisode struct {
	value *PublicRestModeEpisode
	isSet bool
}

func (v NullablePublicRestModeEpisode) Get() *PublicRestModeEpisode {
	return v.value
}

func (v *NullablePublicRestModeEpisode) Set(val *PublicRestModeEpisode) {
	v.value = val
	v.isSet = true
}

func (v NullablePublicRestModeEpisode) IsSet() bool {
	return v.isSet
}

func (v *NullablePublicRestModeEpisode) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePublicRestModeEpisode(val *PublicRestModeEpisode) *NullablePublicRestModeEpisode {
	return &NullablePublicRestModeEpisode{value: val, isSet: true}
}

func (v NullablePublicRestModeEpisode) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePublicRestModeEpisode) UnmarshalJSON(src []byte) error {
	v.isSet = true
