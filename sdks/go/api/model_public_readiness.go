...
// checks if the PublicReadiness type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PublicReadiness{}

// PublicReadiness Object defining readiness.
...
type _PublicReadiness PublicReadiness

// NewPublicReadiness instantiates a new PublicReadiness object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPublicReadiness(contributors PublicReadinessContributors) *PublicReadiness {
	this := PublicReadiness{}
	this.Contributors = contributors
	return &this
}

// NewPublicReadinessWithDefaults instantiates a new PublicReadiness object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPublicReadinessWithDefaults() *PublicReadiness {
	this := PublicReadiness{}
	return &this
}

// GetContributors returns the Contributors field value
func (o *PublicReadiness) GetContributors() PublicReadinessContributors {
	if o == nil {
...
func (o *PublicReadiness) GetContributorsOk() (*PublicReadinessContributors, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PublicReadiness) GetScoreOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PublicReadiness) HasScore() bool {
...
func (o *PublicReadiness) SetScore(v int32) {
	o.Score.Set(&v)
}
// SetScoreNil sets the value for Score to be an explicit nil
func (o *PublicReadiness) SetScoreNil() {
	o.Score.Set(nil)
}

// UnsetScore ensures that no value is present for Score, not even an explicit nil
func (o *PublicReadiness) UnsetScore() {
	o.Score.Unset()
}
...
func (o *PublicReadiness) GetTemperatureDeviation() float32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PublicReadiness) GetTemperatureDeviationOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PublicReadiness) HasTemperatureDeviation() bool {
...
func (o *PublicReadiness) UnsetTemperatureDeviation() {
...
func (o *PublicReadiness) GetTemperatureTrendDeviation() float32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PublicReadiness) GetTemperatureTrendDeviationOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PublicReadiness) HasTemperatureTrendDeviation() bool {
...
func (o *PublicReadiness) SetTemperatureTrendDeviation(v float32) {
...
func (o *PublicReadiness) SetTemperatureTrendDeviationNil() {
...
func (o *PublicReadiness) UnsetTemperatureTrendDeviation() {
	o.TemperatureTrendDeviation.Unset()
}

func (o PublicReadiness) MarshalJSON() ([]byte, error) {
...
func (o PublicReadiness) ToMap() (map[string]interface{}, error) {
...
func (o *PublicReadiness) UnmarshalJSON(data []byte) (err error) {
	...
	varPublicReadiness := _PublicReadiness{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPublicReadiness)

	if err != nil {
		return err
	}

	*o = PublicReadiness(varPublicReadiness)

	return err
}

type NullablePublicReadiness struct {
	value *PublicReadiness
	isSet bool
}

func (v NullablePublicReadiness) Get() *PublicReadiness {
	return v.value
}

func (v *NullablePublicReadiness) Set(val *PublicReadiness) {
	v.value = val
	v.isSet = true
}

func (v NullablePublicReadiness) IsSet() bool {
	return v.isSet
}

func (v *NullablePublicReadiness) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePublicReadiness(val *PublicReadiness) *NullablePublicReadiness {
	return &NullablePublicReadiness{value: val, isSet: true}
}

func (v NullablePublicReadiness) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePublicReadiness) UnmarshalJSON(src []byte) error {
	v.isSet = true
