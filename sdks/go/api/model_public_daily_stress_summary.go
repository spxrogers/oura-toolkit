...
// PublicDailyStressSummary Possible public daily stress summary types.
type PublicDailyStressSummary string

// List of PublicDailyStressSummary
const (
	PUBLICDAILYSTRESSSUMMARY_RESTORED PublicDailyStressSummary = "restored"
	PUBLICDAILYSTRESSSUMMARY_NORMAL PublicDailyStressSummary = "normal"
	PUBLICDAILYSTRESSSUMMARY_STRESSFUL PublicDailyStressSummary = "stressful"
)

// All allowed values of PublicDailyStressSummary enum
var AllowedPublicDailyStressSummaryEnumValues = []PublicDailyStressSummary{
	"restored",
	"normal",
	"stressful",
}

func (v *PublicDailyStressSummary) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := PublicDailyStressSummary(value)
	for _, existing := range AllowedPublicDailyStressSummaryEnumValues {
	...
	return fmt.Errorf("%+v is not a valid PublicDailyStressSummary", value)
}

// NewPublicDailyStressSummaryFromValue returns a pointer to a valid PublicDailyStressSummary
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewPublicDailyStressSummaryFromValue(v string) (*PublicDailyStressSummary, error) {
	ev := PublicDailyStressSummary(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for PublicDailyStressSummary: valid values are %v", v, AllowedPublicDailyStressSummaryEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v PublicDailyStressSummary) IsValid() bool {
	for _, existing := range AllowedPublicDailyStressSummaryEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to PublicDailyStressSummary value
func (v PublicDailyStressSummary) Ptr() *PublicDailyStressSummary {
	return &v
}

type NullablePublicDailyStressSummary struct {
	value *PublicDailyStressSummary
	isSet bool
}

func (v NullablePublicDailyStressSummary) Get() *PublicDailyStressSummary {
	return v.value
}

func (v *NullablePublicDailyStressSummary) Set(val *PublicDailyStressSummary) {
	v.value = val
	v.isSet = true
}

func (v NullablePublicDailyStressSummary) IsSet() bool {
	return v.isSet
}

func (v *NullablePublicDailyStressSummary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePublicDailyStressSummary(val *PublicDailyStressSummary) *NullablePublicDailyStressSummary {
	return &NullablePublicDailyStressSummary{value: val, isSet: true}
}

func (v NullablePublicDailyStressSummary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePublicDailyStressSummary) UnmarshalJSON(src []byte) error {
	v.isSet = true
