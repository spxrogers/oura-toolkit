...
// checks if the MultiDocumentResponsePublicSleepTime type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MultiDocumentResponsePublicSleepTime{}

// MultiDocumentResponsePublicSleepTime struct for MultiDocumentResponsePublicSleepTime
type MultiDocumentResponsePublicSleepTime struct {
	Data []PublicSleepTime `json:"data"`
	NextToken NullableString `json:"next_token"`
}

type _MultiDocumentResponsePublicSleepTime MultiDocumentResponsePublicSleepTime

// NewMultiDocumentResponsePublicSleepTime instantiates a new MultiDocumentResponsePublicSleepTime object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewMultiDocumentResponsePublicSleepTime(data []PublicSleepTime, nextToken NullableString) *MultiDocumentResponsePublicSleepTime {
	this := MultiDocumentResponsePublicSleepTime{}
	this.Data = data
	this.NextToken = nextToken
	return &this
}

// NewMultiDocumentResponsePublicSleepTimeWithDefaults instantiates a new MultiDocumentResponsePublicSleepTime object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewMultiDocumentResponsePublicSleepTimeWithDefaults() *MultiDocumentResponsePublicSleepTime {
	this := MultiDocumentResponsePublicSleepTime{}
	return &this
}

// GetData returns the Data field value
func (o *MultiDocumentResponsePublicSleepTime) GetData() []PublicSleepTime {
	if o == nil {
		var ret []PublicSleepTime
		return ret
	}
...
func (o *MultiDocumentResponsePublicSleepTime) GetDataOk() ([]PublicSleepTime, bool) {
	if o == nil {
		return nil, false
	}
	return o.Data, true
...
func (o *MultiDocumentResponsePublicSleepTime) SetData(v []PublicSleepTime) {
	o.Data = v
}

// GetNextToken returns the NextToken field value
// If the value is explicit nil, the zero value for string will be returned
func (o *MultiDocumentResponsePublicSleepTime) GetNextToken() string {
...
func (o *MultiDocumentResponsePublicSleepTime) GetNextTokenOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *MultiDocumentResponsePublicSleepTime) SetNextToken(v string) {
	o.NextToken.Set(&v)
}

func (o MultiDocumentResponsePublicSleepTime) MarshalJSON() ([]byte, error) {
...
func (o MultiDocumentResponsePublicSleepTime) ToMap() (map[string]interface{}, error) {
...
func (o *MultiDocumentResponsePublicSleepTime) UnmarshalJSON(data []byte) (err error) {
	...
	varMultiDocumentResponsePublicSleepTime := _MultiDocumentResponsePublicSleepTime{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMultiDocumentResponsePublicSleepTime)

	if err != nil {
		return err
	}

	*o = MultiDocumentResponsePublicSleepTime(varMultiDocumentResponsePublicSleepTime)

	return err
}

type NullableMultiDocumentResponsePublicSleepTime struct {
	value *MultiDocumentResponsePublicSleepTime
	isSet bool
}

func (v NullableMultiDocumentResponsePublicSleepTime) Get() *MultiDocumentResponsePublicSleepTime {
	return v.value
}

func (v *NullableMultiDocumentResponsePublicSleepTime) Set(val *MultiDocumentResponsePublicSleepTime) {
	v.value = val
	v.isSet = true
}

func (v NullableMultiDocumentResponsePublicSleepTime) IsSet() bool {
	return v.isSet
}

func (v *NullableMultiDocumentResponsePublicSleepTime) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMultiDocumentResponsePublicSleepTime(val *MultiDocumentResponsePublicSleepTime) *NullableMultiDocumentResponsePublicSleepTime {
	return &NullableMultiDocumentResponsePublicSleepTime{value: val, isSet: true}
}

func (v NullableMultiDocumentResponsePublicSleepTime) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMultiDocumentResponsePublicSleepTime) UnmarshalJSON(src []byte) error {
	v.isSet = true
