...
// checks if the MultiDocumentResponsePublicDailyReadiness type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MultiDocumentResponsePublicDailyReadiness{}

// MultiDocumentResponsePublicDailyReadiness struct for MultiDocumentResponsePublicDailyReadiness
type MultiDocumentResponsePublicDailyReadiness struct {
	Data []PublicDailyReadiness `json:"data"`
	NextToken NullableString `json:"next_token"`
}

type _MultiDocumentResponsePublicDailyReadiness MultiDocumentResponsePublicDailyReadiness

// NewMultiDocumentResponsePublicDailyReadiness instantiates a new MultiDocumentResponsePublicDailyReadiness object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewMultiDocumentResponsePublicDailyReadiness(data []PublicDailyReadiness, nextToken NullableString) *MultiDocumentResponsePublicDailyReadiness {
	this := MultiDocumentResponsePublicDailyReadiness{}
	this.Data = data
	this.NextToken = nextToken
	return &this
}

// NewMultiDocumentResponsePublicDailyReadinessWithDefaults instantiates a new MultiDocumentResponsePublicDailyReadiness object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewMultiDocumentResponsePublicDailyReadinessWithDefaults() *MultiDocumentResponsePublicDailyReadiness {
	this := MultiDocumentResponsePublicDailyReadiness{}
	return &this
}

// GetData returns the Data field value
func (o *MultiDocumentResponsePublicDailyReadiness) GetData() []PublicDailyReadiness {
	if o == nil {
		var ret []PublicDailyReadiness
		return ret
	}
...
func (o *MultiDocumentResponsePublicDailyReadiness) GetDataOk() ([]PublicDailyReadiness, bool) {
	if o == nil {
		return nil, false
	}
	return o.Data, true
...
func (o *MultiDocumentResponsePublicDailyReadiness) SetData(v []PublicDailyReadiness) {
	o.Data = v
}

// GetNextToken returns the NextToken field value
// If the value is explicit nil, the zero value for string will be returned
func (o *MultiDocumentResponsePublicDailyReadiness) GetNextToken() string {
...
func (o *MultiDocumentResponsePublicDailyReadiness) GetNextTokenOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *MultiDocumentResponsePublicDailyReadiness) SetNextToken(v string) {
	o.NextToken.Set(&v)
}

func (o MultiDocumentResponsePublicDailyReadiness) MarshalJSON() ([]byte, error) {
...
func (o MultiDocumentResponsePublicDailyReadiness) ToMap() (map[string]interface{}, error) {
...
func (o *MultiDocumentResponsePublicDailyReadiness) UnmarshalJSON(data []byte) (err error) {
	...
	varMultiDocumentResponsePublicDailyReadiness := _MultiDocumentResponsePublicDailyReadiness{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMultiDocumentResponsePublicDailyReadiness)

	if err != nil {
		return err
	}

	*o = MultiDocumentResponsePublicDailyReadiness(varMultiDocumentResponsePublicDailyReadiness)

	return err
}

type NullableMultiDocumentResponsePublicDailyReadiness struct {
	value *MultiDocumentResponsePublicDailyReadiness
	isSet bool
}

func (v NullableMultiDocumentResponsePublicDailyReadiness) Get() *MultiDocumentResponsePublicDailyReadiness {
	return v.value
}

func (v *NullableMultiDocumentResponsePublicDailyReadiness) Set(val *MultiDocumentResponsePublicDailyReadiness) {
	v.value = val
	v.isSet = true
}

func (v NullableMultiDocumentResponsePublicDailyReadiness) IsSet() bool {
	return v.isSet
}

func (v *NullableMultiDocumentResponsePublicDailyReadiness) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMultiDocumentResponsePublicDailyReadiness(val *MultiDocumentResponsePublicDailyReadiness) *NullableMultiDocumentResponsePublicDailyReadiness {
	return &NullableMultiDocumentResponsePublicDailyReadiness{value: val, isSet: true}
}

func (v NullableMultiDocumentResponsePublicDailyReadiness) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMultiDocumentResponsePublicDailyReadiness) UnmarshalJSON(src []byte) error {
	v.isSet = true
